...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewwrapperview?language=objc}UITableViewWrapperView} *)

let self = get_class "UITableViewWrapperView"
