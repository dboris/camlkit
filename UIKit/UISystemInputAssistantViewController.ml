...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uisysteminputassistantviewcontroller?language=objc}UISystemInputAssistantViewController} *)

let self = get_class "UISystemInputAssistantViewController"
...
let barFrame self = msg_send_stret ~self ~cmd:(selector "barFrame") ~typ:(returning CGRect.t) ~return_type:CGRect.t
...
let layoutFromAssistantBarStyle x self = msg_send ~self ~cmd:(selector "layoutFromAssistantBarStyle:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let setAssistantBarStyle x self = msg_send ~self ~cmd:(selector "setAssistantBarStyle:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let styleFromAssistantBarStyle x self = msg_send ~self ~cmd:(selector "styleFromAssistantBarStyle:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let updateAssistantBarStyle x self = msg_send ~self ~cmd:(selector "updateAssistantBarStyle:") ~typ:(llong @-> returning void) (LLong.of_int x)
