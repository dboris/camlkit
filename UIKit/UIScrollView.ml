...
let _PDFKitDocumentVisibleRectIncludingContentInsets self = msg_send ~self ~cmd:(selector "PDFKitDocumentVisibleRectIncludingContentInsets") ~typ:(returning CGRect.t)
let accessoryInsets self = msg_send ~self ~cmd:(selector "accessoryInsets") ~typ:(returning UIEdgeInsets.t)
...
let adjustedContentInset self = msg_send ~self ~cmd:(selector "adjustedContentInset") ~typ:(returning UIEdgeInsets.t)
...
let horizontalScrollIndicatorInsets self = msg_send ~self ~cmd:(selector "horizontalScrollIndicatorInsets") ~typ:(returning UIEdgeInsets.t)
...
let indexBarAccessoryView x ~contentOffsetForEntry ~atIndex self = msg_send ~self ~cmd:(selector "indexBarAccessoryView:contentOffsetForEntry:atIndex:") ~typ:(id @-> id @-> llong @-> returning CGPoint.t) x contentOffsetForEntry (LLong.of_int atIndex)
...
let scrollIndicatorInsets self = msg_send ~self ~cmd:(selector "scrollIndicatorInsets") ~typ:(returning UIEdgeInsets.t)
...
let scrollViewFrame self = msg_send ~self ~cmd:(selector "scrollViewFrame") ~typ:(returning CGRect.t)
...
let scrollerImp2 x ~convertRectFromBacking self = msg_send ~self ~cmd:(selector "scrollerImp:convertRectFromBacking:") ~typ:(id @-> CGRect.t @-> returning CGRect.t) x convertRectFromBacking
let scrollerImp3 x ~convertRectToBacking self = msg_send ~self ~cmd:(selector "scrollerImp:convertRectToBacking:") ~typ:(id @-> CGRect.t @-> returning CGRect.t) x convertRectToBacking
let scrollerImp4 x ~convertRectToLayer self = msg_send ~self ~cmd:(selector "scrollerImp:convertRectToLayer:") ~typ:(id @-> CGRect.t @-> returning CGRect.t) x convertRectToLayer
...
let scrollerImpPair3 x ~convertContentPoint ~toScrollerImp self = msg_send ~self ~cmd:(selector "scrollerImpPair:convertContentPoint:toScrollerImp:") ~typ:(id @-> CGPoint.t @-> id @-> returning CGPoint.t) x convertContentPoint toScrollerImp
...
let verticalScrollIndicatorInsets self = msg_send ~self ~cmd:(selector "verticalScrollIndicatorInsets") ~typ:(returning UIEdgeInsets.t)
let visibleBounds self = msg_send ~self ~cmd:(selector "visibleBounds") ~typ:(returning CGRect.t)
let visibleSize self = msg_send ~self ~cmd:(selector "visibleSize") ~typ:(returning CGSize.t)
