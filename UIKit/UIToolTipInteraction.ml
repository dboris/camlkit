...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitooltipinteraction?language=objc}UIToolTipInteraction} *)

let self = get_class "UIToolTipInteraction"
