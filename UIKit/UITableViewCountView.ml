...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewcountview?language=objc}UITableViewCountView} *)

let self = get_class "UITableViewCountView"
