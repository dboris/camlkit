...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiindirectscribbleinteraction?language=objc}UIIndirectScribbleInteraction} *)

let self = get_class "UIIndirectScribbleInteraction"
