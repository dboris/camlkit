...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uimoviescrubbertrackview?language=objc}UIMovieScrubberTrackView} *)

let self = get_class "UIMovieScrubberTrackView"
...
let setThumbnailImage x ~forTimestamp self = msg_send ~self ~cmd:(selector "setThumbnailImage:forTimestamp:") ~typ:((ptr CGImage.t) @-> id @-> returning void) x forTimestamp
