...
let contentOffsetForSegmentAtIndex x self = msg_send_stret ~self ~cmd:(selector "contentOffsetForSegmentAtIndex:") ~typ:(ullong @-> returning CGSize.t) ~return_type:CGSize.t (ULLong.of_int x)
let contentPositionAdjustmentForSegmentType x ~barMetrics self = msg_send_stret ~self ~cmd:(selector "contentPositionAdjustmentForSegmentType:barMetrics:") ~typ:(llong @-> llong @-> returning UIOffset.t) ~return_type:UIOffset.t (LLong.of_int x) (LLong.of_int barMetrics)
