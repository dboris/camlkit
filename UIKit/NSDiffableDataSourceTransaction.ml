...
let finalGlobalIndexForInitialGlobalIndex x self = msg_send ~self ~cmd:(selector "finalGlobalIndexForInitialGlobalIndex:") ~typ:(llong @-> returning llong) (LLong.of_int x) |> LLong.to_int
...
let finalSectionCount self = msg_send ~self ~cmd:(selector "finalSectionCount") ~typ:(returning llong) |> LLong.to_int
let finalSectionGlobalItemRangeForSection x self = msg_send_stret ~self ~cmd:(selector "finalSectionGlobalItemRangeForSection:") ~typ:(llong @-> returning NSRange.t) ~return_type:NSRange.t (LLong.of_int x)
let finalSectionIndexForInitialSectionIndex x self = msg_send ~self ~cmd:(selector "finalSectionIndexForInitialSectionIndex:") ~typ:(llong @-> returning llong) (LLong.of_int x) |> LLong.to_int
...
let initalSectionGlobalItemRangeForSection x self = msg_send_stret ~self ~cmd:(selector "initalSectionGlobalItemRangeForSection:") ~typ:(llong @-> returning NSRange.t) ~return_type:NSRange.t (LLong.of_int x)
let initialDataSourceSnapshotter self = msg_send ~self ~cmd:(selector "initialDataSourceSnapshotter") ~typ:(returning id)
let initialGlobalIndexForFinalGlobalIndex x self = msg_send ~self ~cmd:(selector "initialGlobalIndexForFinalGlobalIndex:") ~typ:(llong @-> returning llong) (LLong.of_int x) |> LLong.to_int
...
let initialSectionCount self = msg_send ~self ~cmd:(selector "initialSectionCount") ~typ:(returning llong) |> LLong.to_int
let initialSectionIndexForFinalSectionIndex x self = msg_send ~self ~cmd:(selector "initialSectionIndexForFinalSectionIndex:") ~typ:(llong @-> returning llong) (LLong.of_int x) |> LLong.to_int
...
let source self = msg_send ~self ~cmd:(selector "source") ~typ:(returning llong) |> LLong.to_int
