...
let rectWithSize x ~forContentRect ~withAlignmentRectInsets self = msg_send ~self ~cmd:(selector "rectWithSize:forContentRect:withAlignmentRectInsets:") ~typ:(CGSize.t @-> CGRect.t @-> UIEdgeInsets.t @-> returning CGRect.t) x forContentRect withAlignmentRectInsets
let setTapActionRegion x self = msg_send ~self ~cmd:(selector "setTapActionRegion:") ~typ:(CGRect.t @-> returning void) x
let tapActionRegion self = msg_send ~self ~cmd:(selector "tapActionRegion") ~typ:(returning CGRect.t)
