...
let self = get_class "UITextEffectsWindow"
...
let actualSceneFrame self = msg_send ~self ~cmd:(selector "actualSceneFrame") ~typ:(returning CGRect.t)
let actualSceneFrameForOrientation x self = msg_send ~self ~cmd:(selector "actualSceneFrameForOrientation:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
...
let convertPoint1 x ~fromWindow self = msg_send ~self ~cmd:(selector "convertPoint:fromWindow:") ~typ:(CGPoint.t @-> id @-> returning CGPoint.t) x fromWindow
let convertPoint2 x ~toView self = msg_send ~self ~cmd:(selector "convertPoint:toView:") ~typ:(CGPoint.t @-> id @-> returning CGPoint.t) x toView
let convertPoint3 x ~toWindow self = msg_send ~self ~cmd:(selector "convertPoint:toWindow:") ~typ:(CGPoint.t @-> id @-> returning CGPoint.t) x toWindow
...
let convertRect2 x ~toView self = msg_send ~self ~cmd:(selector "convertRect:toView:") ~typ:(CGRect.t @-> id @-> returning CGRect.t) x toView
...
let hostedFrame self = msg_send ~self ~cmd:(selector "hostedFrame") ~typ:(returning CGRect.t)
let hostedSafeInsets self = msg_send ~self ~cmd:(selector "hostedSafeInsets") ~typ:(returning UIEdgeInsets.t)
let hostedSceneSize self = msg_send ~self ~cmd:(selector "hostedSceneSize") ~typ:(returning CGSize.t)
let hostedWindowOffset self = msg_send ~self ~cmd:(selector "hostedWindowOffset") ~typ:(returning CGPoint.t)
...
let setHostedSafeInsets x self = msg_send ~self ~cmd:(selector "setHostedSafeInsets:") ~typ:(UIEdgeInsets.t @-> returning void) x
