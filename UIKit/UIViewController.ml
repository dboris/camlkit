...
let childViewControllersCount self = msg_send ~self ~cmd:(selector "childViewControllersCount") ~typ:(returning ullong) |> ULLong.to_int
...
let contentVisibility self = msg_send ~self ~cmd:(selector "contentVisibility") ~typ:(returning llong) |> LLong.to_int
...
let debugURLsForDiagnostics self = msg_send ~self ~cmd:(selector "debugURLsForDiagnostics") ~typ:(returning id)
...
let edgesForExtendedLayout self = msg_send ~self ~cmd:(selector "edgesForExtendedLayout") ~typ:(returning ullong) |> ULLong.to_int
...
let preferredScreenEdgesDeferringSystemGestures self = msg_send ~self ~cmd:(selector "preferredScreenEdgesDeferringSystemGestures") ~typ:(returning ullong) |> ULLong.to_int
let preferredStatusBarStyle self = msg_send ~self ~cmd:(selector "preferredStatusBarStyle") ~typ:(returning llong) |> LLong.to_int
let preferredStatusBarUpdateAnimation self = msg_send ~self ~cmd:(selector "preferredStatusBarUpdateAnimation") ~typ:(returning llong) |> LLong.to_int
let preferredUserInterfaceStyle self = msg_send ~self ~cmd:(selector "preferredUserInterfaceStyle") ~typ:(returning llong) |> LLong.to_int
let preferredWhitePointAdaptivityStyle self = msg_send ~self ~cmd:(selector "preferredWhitePointAdaptivityStyle") ~typ:(returning llong) |> LLong.to_int
