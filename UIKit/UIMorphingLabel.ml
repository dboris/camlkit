...
let self = get_class "UIMorphingLabel"

let alphaForFrame x self = msg_send ~self ~cmd:(selector "alphaForFrame:") ~typ:(CGRect.t @-> returning double) x
let animateAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "animateAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let animateChangeInWidthOutsideAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "animateChangeInWidthOutsideAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let animateDeletionAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "animateDeletionAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let animateInsertionAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "animateInsertionAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let animateMovementAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "animateMovementAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let animateSubstitutionAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "animateSubstitutionAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let calculateHardAlignmentAtIndex x ~fromGlyphsInRange ~toGlyphsInRange self = msg_send ~self ~cmd:(selector "calculateHardAlignmentAtIndex:fromGlyphsInRange:toGlyphsInRange:") ~typ:(ullong @-> NSRange.t @-> NSRange.t @-> returning ullong) (ULLong.of_int x) fromGlyphsInRange toGlyphsInRange
let canFitText x self = msg_send ~self ~cmd:(selector "canFitText:") ~typ:(id @-> returning bool) x
let changeInWidthDueToAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "changeInWidthDueToAlignmentHunkAtIndex:") ~typ:(ullong @-> returning double) (ULLong.of_int x)
...
let dstRangeOfAlignmentHunkAtIndex x self = msg_send_stret ~self ~cmd:(selector "dstRangeOfAlignmentHunkAtIndex:") ~typ:(ullong @-> returning NSRange.t) ~return_type:NSRange.t (ULLong.of_int x)
...
let initAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "initAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let initDeletionAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "initDeletionAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let initInsertionAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "initInsertionAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let initMovementAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "initMovementAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let initSubstitutionAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "initSubstitutionAlignmentHunkAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let srcRangeOfAlignmentHunkAtIndex x self = msg_send_stret ~self ~cmd:(selector "srcRangeOfAlignmentHunkAtIndex:") ~typ:(ullong @-> returning NSRange.t) ~return_type:NSRange.t (ULLong.of_int x)
...
let totalLeftOffsetForAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "totalLeftOffsetForAlignmentHunkAtIndex:") ~typ:(ullong @-> returning double) (ULLong.of_int x)
let totalRightOffsetForAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "totalRightOffsetForAlignmentHunkAtIndex:") ~typ:(ullong @-> returning double) (ULLong.of_int x)
