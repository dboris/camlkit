...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewanimation?language=objc}UICollectionViewAnimation} *)

let self = get_class "UICollectionViewAnimation"
