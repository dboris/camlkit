...
let bodyRect self = msg_send ~self ~cmd:(selector "bodyRect") ~typ:(returning CGRect.t)
let firstLineRect self = msg_send ~self ~cmd:(selector "firstLineRect") ~typ:(returning CGRect.t)
...
let lastLineRect self = msg_send ~self ~cmd:(selector "lastLineRect") ~typ:(returning CGRect.t)
