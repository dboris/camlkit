...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardglobekeyintroductionview?language=objc}UIKeyboardGlobeKeyIntroductionView} *)

let self = get_class "UIKeyboardGlobeKeyIntroductionView"
