...
let pointForGestureState x ~point ~translation self = msg_send_stret ~self ~cmd:(selector "pointForGestureState:point:translation:") ~typ:(llong @-> CGPoint.t @-> CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t (LLong.of_int x) point translation
