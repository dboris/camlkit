...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistoryboardseguetemplate?language=objc}UIStoryboardSegueTemplate} *)

let self = get_class "UIStoryboardSegueTemplate"
