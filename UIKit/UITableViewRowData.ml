...
let floatingRectForFooterInSection x ~visibleRect ~heightCanBeGuessed ~outIsFloating self = msg_send ~self ~cmd:(selector "floatingRectForFooterInSection:visibleRect:heightCanBeGuessed:outIsFloating:") ~typ:(llong @-> CGRect.t @-> bool @-> (ptr bool) @-> returning CGRect.t) (LLong.of_int x) visibleRect heightCanBeGuessed outIsFloating
let floatingRectForHeaderInSection x ~visibleRect ~heightCanBeGuessed ~outIsFloating self = msg_send ~self ~cmd:(selector "floatingRectForHeaderInSection:visibleRect:heightCanBeGuessed:outIsFloating:") ~typ:(llong @-> CGRect.t @-> bool @-> (ptr bool) @-> returning CGRect.t) (LLong.of_int x) visibleRect heightCanBeGuessed outIsFloating
...
let rectForFooterInSection x ~heightCanBeGuessed self = msg_send ~self ~cmd:(selector "rectForFooterInSection:heightCanBeGuessed:") ~typ:(llong @-> bool @-> returning CGRect.t) (LLong.of_int x) heightCanBeGuessed
let rectForGap self = msg_send ~self ~cmd:(selector "rectForGap") ~typ:(returning CGRect.t)
let rectForGlobalRow x ~heightCanBeGuessed self = msg_send ~self ~cmd:(selector "rectForGlobalRow:heightCanBeGuessed:") ~typ:(llong @-> bool @-> returning CGRect.t) (LLong.of_int x) heightCanBeGuessed
let rectForHeaderInSection x ~heightCanBeGuessed self = msg_send ~self ~cmd:(selector "rectForHeaderInSection:heightCanBeGuessed:") ~typ:(llong @-> bool @-> returning CGRect.t) (LLong.of_int x) heightCanBeGuessed
let rectForRow x ~inSection ~heightCanBeGuessed self = msg_send ~self ~cmd:(selector "rectForRow:inSection:heightCanBeGuessed:") ~typ:(llong @-> llong @-> bool @-> returning CGRect.t) (LLong.of_int x) (LLong.of_int inSection) heightCanBeGuessed
let rectForSection x self = msg_send ~self ~cmd:(selector "rectForSection:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
