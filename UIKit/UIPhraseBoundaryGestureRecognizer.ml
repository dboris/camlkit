...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiphraseboundarygesturerecognizer?language=objc}UIPhraseBoundaryGestureRecognizer} *)

let self = get_class "UIPhraseBoundaryGestureRecognizer"
