...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiundotutorialviewcontroller?language=objc}UIUndoTutorialViewController} *)

let self = get_class "UIUndoTutorialViewController"
