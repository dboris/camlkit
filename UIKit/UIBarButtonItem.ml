...
let backButtonTitlePositionAdjustmentForBarMetrics x self = msg_send_stret ~self ~cmd:(selector "backButtonTitlePositionAdjustmentForBarMetrics:") ~typ:(llong @-> returning UIOffset.t) ~return_type:UIOffset.t (LLong.of_int x)
...
let titlePositionAdjustmentForBarMetrics x self = msg_send_stret ~self ~cmd:(selector "titlePositionAdjustmentForBarMetrics:") ~typ:(llong @-> returning UIOffset.t) ~return_type:UIOffset.t (LLong.of_int x)
