...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiprintersetupconnectingview?language=objc}UIPrinterSetupConnectingView} *)

let self = get_class "UIPrinterSetupConnectingView"
