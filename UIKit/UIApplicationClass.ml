...
let interfaceOrientationForString x self = msg_send ~self ~cmd:(selector "interfaceOrientationForString:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let runningInStoreDemoModeFProgramNumber self = msg_send ~self ~cmd:(selector "runningInStoreDemoModeFProgramNumber") ~typ:(returning llong) |> LLong.to_int
...
let statusBarStyleForString x self = msg_send ~self ~cmd:(selector "statusBarStyleForString:") ~typ:(id @-> returning llong) x |> LLong.to_int
