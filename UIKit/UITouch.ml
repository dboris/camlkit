...
let azimuthUnitVectorInView x self = msg_send ~self ~cmd:(selector "azimuthUnitVectorInView:") ~typ:(id @-> returning CGVector.t) x
...
let preciseLocationInView x self = msg_send ~self ~cmd:(selector "preciseLocationInView:") ~typ:(id @-> returning CGPoint.t) x
let precisePreviousLocationInView x self = msg_send ~self ~cmd:(selector "precisePreviousLocationInView:") ~typ:(id @-> returning CGPoint.t) x
