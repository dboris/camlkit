...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiautocorrectbubblecontainer?language=objc}UIAutocorrectBubbleContainer} *)

let self = get_class "UIAutocorrectBubbleContainer"
...
let referenceRect self = msg_send ~self ~cmd:(selector "referenceRect") ~typ:(returning CGRect.t)
