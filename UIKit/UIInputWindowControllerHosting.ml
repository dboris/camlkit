...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinputwindowcontrollerhosting?language=objc}UIInputWindowControllerHosting} *)

let self = get_class "UIInputWindowControllerHosting"
