...
let ab_isDirectlyInPopover imp = Define.method_spec ~cmd:(selector "ab_isDirectlyInPopover") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let ab_isInPopover imp = Define.method_spec ~cmd:(selector "ab_isInPopover") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let ab_isInSheet imp = Define.method_spec ~cmd:(selector "ab_isInSheet") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let ab_shouldShowNavBarButtons imp = Define.method_spec ~cmd:(selector "ab_shouldShowNavBarButtons") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let ab_shouldUseTransparentBackgroundInPopovers imp = Define.method_spec ~cmd:(selector "ab_shouldUseTransparentBackgroundInPopovers") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
...
let bs_addChildViewController' imp = Define.method_spec ~cmd:(selector "bs_addChildViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let bs_addChildViewController'animated'transitionBlock' imp = Define.method_spec ~cmd:(selector "bs_addChildViewController:animated:transitionBlock:") ~typ:(id @-> bool @-> (ptr void) @-> returning (bool)) ~enc:"c36@0:8@16c24@?28" ~imp
let bs_addChildViewController'withSuperview' imp = Define.method_spec ~cmd:(selector "bs_addChildViewController:withSuperview:") ~typ:(id @-> id @-> returning (bool)) ~enc:"c32@0:8@16@24" ~imp
let bs_addChildViewController'withSuperview'animated'transitionBlock' imp = Define.method_spec ~cmd:(selector "bs_addChildViewController:withSuperview:animated:transitionBlock:") ~typ:(id @-> id @-> bool @-> (ptr void) @-> returning (bool)) ~enc:"c44@0:8@16@24c32@?36" ~imp
let bs_beginAppearanceTransition'animated' imp = Define.method_spec ~cmd:(selector "bs_beginAppearanceTransition:animated:") ~typ:(bool @-> bool @-> returning (bool)) ~enc:"c24@0:8c16c20" ~imp
let bs_beginAppearanceTransitionForChildViewController'toVisible'animated' imp = Define.method_spec ~cmd:(selector "bs_beginAppearanceTransitionForChildViewController:toVisible:animated:") ~typ:(id @-> bool @-> bool @-> returning (bool)) ~enc:"c32@0:8@16c24c28" ~imp
let bs_endAppearanceTransition imp = Define.method_spec ~cmd:(selector "bs_endAppearanceTransition") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let bs_endAppearanceTransition' imp = Define.method_spec ~cmd:(selector "bs_endAppearanceTransition:") ~typ:(bool @-> returning (bool)) ~enc:"c20@0:8c16" ~imp
let bs_endAppearanceTransitionForChildViewController' imp = Define.method_spec ~cmd:(selector "bs_endAppearanceTransitionForChildViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let bs_endAppearanceTransitionForChildViewController'toVisible' imp = Define.method_spec ~cmd:(selector "bs_endAppearanceTransitionForChildViewController:toVisible:") ~typ:(id @-> bool @-> returning (bool)) ~enc:"c28@0:8@16c24" ~imp
let bs_isAppearingOrAppeared imp = Define.method_spec ~cmd:(selector "bs_isAppearingOrAppeared") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let bs_isDisappearingOrDisappeared imp = Define.method_spec ~cmd:(selector "bs_isDisappearingOrDisappeared") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let bs_presentationContextDefiningViewController imp = Define.method_spec ~cmd:(selector "bs_presentationContextDefiningViewController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let bs_presentedViewControllerIncludingAncestors imp = Define.method_spec ~cmd:(selector "bs_presentedViewControllerIncludingAncestors") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let bs_removeChildViewController' imp = Define.method_spec ~cmd:(selector "bs_removeChildViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let bs_removeChildViewController'animated'transitionBlock' imp = Define.method_spec ~cmd:(selector "bs_removeChildViewController:animated:transitionBlock:") ~typ:(id @-> bool @-> (ptr void) @-> returning (bool)) ~enc:"c36@0:8@16c24@?28" ~imp
let bs_topPresentedViewController imp = Define.method_spec ~cmd:(selector "bs_topPresentedViewController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let bs_traitCollectionDidChange'forManagedTraitEnvironment' imp = Define.method_spec ~cmd:(selector "bs_traitCollectionDidChange:forManagedTraitEnvironment:") ~typ:(id @-> id @-> returning (void)) ~enc:"v32@0:8@16@24" ~imp
...
let cnui_addChildViewController' imp = Define.method_spec ~cmd:(selector "cnui_addChildViewController:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let cnui_appropriatePresentationController imp = Define.method_spec ~cmd:(selector "cnui_appropriatePresentationController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
...
let pl_isInPopover imp = Define.method_spec ~cmd:(selector "pl_isInPopover") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let pl_visitControllerHierarchyWithBlock' imp = Define.method_spec ~cmd:(selector "pl_visitControllerHierarchyWithBlock:") ~typ:((ptr void) @-> returning (bool)) ~enc:"c24@0:8@?16" ~imp
...
let pu_currentInteractiveModalTransition imp = Define.method_spec ~cmd:(selector "pu_currentInteractiveModalTransition") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let pu_currentInteractiveNavigationTransition imp = Define.method_spec ~cmd:(selector "pu_currentInteractiveNavigationTransition") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let pu_dismissViewControllerAnimated'interactive'completion' imp = Define.method_spec ~cmd:(selector "pu_dismissViewControllerAnimated:interactive:completion:") ~typ:(bool @-> bool @-> (ptr void) @-> returning (void)) ~enc:"v32@0:8c16c20@?24" ~imp
let pu_dismissViewControllerIfAllowedAnimated'forced' imp = Define.method_spec ~cmd:(selector "pu_dismissViewControllerIfAllowedAnimated:forced:") ~typ:(bool @-> bool @-> returning (bool)) ~enc:"c24@0:8c16c20" ~imp
let pu_isPresenting imp = Define.method_spec ~cmd:(selector "pu_isPresenting") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let pu_modalTransition imp = Define.method_spec ~cmd:(selector "pu_modalTransition") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let pu_navigationBarTintColor imp = Define.method_spec ~cmd:(selector "pu_navigationBarTintColor") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let pu_navigationController imp = Define.method_spec ~cmd:(selector "pu_navigationController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let pu_navigationTransition imp = Define.method_spec ~cmd:(selector "pu_navigationTransition") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let pu_performBarsVisibilityUpdatesWithAnimationSettings' imp = Define.method_spec ~cmd:(selector "pu_performBarsVisibilityUpdatesWithAnimationSettings:") ~typ:(PUBarAnimationSettings.t @-> returning (void)) ~enc:"v32@0:8{PUBarAnimationSettings=qd}16" ~imp
let pu_preferredBarStyle imp = Define.method_spec ~cmd:(selector "pu_preferredBarStyle") ~typ:(returning (llong)) ~enc:"q16@0:8" ~imp
let pu_preferredStatusBarUpdateAnimation imp = Define.method_spec ~cmd:(selector "pu_preferredStatusBarUpdateAnimation") ~typ:(returning (llong)) ~enc:"q16@0:8" ~imp
let pu_presentViewController'transition'animated'interactive'completion' imp = Define.method_spec ~cmd:(selector "pu_presentViewController:transition:animated:interactive:completion:") ~typ:(id @-> id @-> bool @-> bool @-> (ptr void) @-> returning (void)) ~enc:"v48@0:8@16@24c32c36@?40" ~imp
let pu_removeNavigationTransition imp = Define.method_spec ~cmd:(selector "pu_removeNavigationTransition") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let pu_restoreNavigationTransition imp = Define.method_spec ~cmd:(selector "pu_restoreNavigationTransition") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let pu_setModalTransition' imp = Define.method_spec ~cmd:(selector "pu_setModalTransition:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let pu_setNavigationTransition' imp = Define.method_spec ~cmd:(selector "pu_setNavigationTransition:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let pu_setupInitialBarsVisibilityOnViewWillAppearAnimated' imp = Define.method_spec ~cmd:(selector "pu_setupInitialBarsVisibilityOnViewWillAppearAnimated:") ~typ:(bool @-> returning (void)) ~enc:"v20@0:8c16" ~imp
let pu_shouldOptOutFromChromelessBars imp = Define.method_spec ~cmd:(selector "pu_shouldOptOutFromChromelessBars") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let pu_toolbarViewModel imp = Define.method_spec ~cmd:(selector "pu_toolbarViewModel") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let pu_wantsNavigationBarVisible imp = Define.method_spec ~cmd:(selector "pu_wantsNavigationBarVisible") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let pu_wantsTabBarVisible imp = Define.method_spec ~cmd:(selector "pu_wantsTabBarVisible") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let pu_wantsToolbarVisible imp = Define.method_spec ~cmd:(selector "pu_wantsToolbarVisible") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let purgeMemoryForReason' imp = Define.method_spec ~cmd:(selector "purgeMemoryForReason:") ~typ:(int @-> returning (void)) ~enc:"v20@0:8i16" ~imp
let px_HDRFocus imp = Define.method_spec ~cmd:(selector "px_HDRFocus") ~typ:(returning (double)) ~enc:"d16@0:8" ~imp
let px_addOrReplaceChildViewController'activateConstraints' imp = Define.method_spec ~cmd:(selector "px_addOrReplaceChildViewController:activateConstraints:") ~typ:(id @-> bool @-> returning (void)) ~enc:"v28@0:8@16c24" ~imp
let px_allowsTabSwitching imp = Define.method_spec ~cmd:(selector "px_allowsTabSwitching") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let px_barAppearance imp = Define.method_spec ~cmd:(selector "px_barAppearance") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_canPerformCrossfadeTransitionWithDetailViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformCrossfadeTransitionWithDetailViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPerformCrossfadeTransitionWithMasterViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformCrossfadeTransitionWithMasterViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPerformPinchTransitionWithDetailViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformPinchTransitionWithDetailViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPerformPinchTransitionWithMasterViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformPinchTransitionWithMasterViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPerformSwipeDownTransitionWithDetailViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformSwipeDownTransitionWithDetailViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPerformSwipeDownTransitionWithMasterViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformSwipeDownTransitionWithMasterViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPerformZoomTransitionWithDetailViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformZoomTransitionWithDetailViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPerformZoomTransitionWithMasterViewController' imp = Define.method_spec ~cmd:(selector "px_canPerformZoomTransitionWithMasterViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_canPresentViewControllerAnimated' imp = Define.method_spec ~cmd:(selector "px_canPresentViewControllerAnimated:") ~typ:(bool @-> returning (bool)) ~enc:"c20@0:8c16" ~imp
let px_defaultTransitionEndPoint imp = Define.method_spec ~cmd:(selector "px_defaultTransitionEndPoint") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_determinesPreferredStatusBarHidden imp = Define.method_spec ~cmd:(selector "px_determinesPreferredStatusBarHidden") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let px_determinesPreferredStatusBarStyle imp = Define.method_spec ~cmd:(selector "px_determinesPreferredStatusBarStyle") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let px_didTransitionBars imp = Define.method_spec ~cmd:(selector "px_didTransitionBars") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_effectiveHDRFocus imp = Define.method_spec ~cmd:(selector "px_effectiveHDRFocus") ~typ:(returning (double)) ~enc:"d16@0:8" ~imp
let px_effectiveImageModulationIntensity imp = Define.method_spec ~cmd:(selector "px_effectiveImageModulationIntensity") ~typ:(returning (double)) ~enc:"d16@0:8" ~imp
let px_effectiveImageModulationIntensityWithProposedValue' imp = Define.method_spec ~cmd:(selector "px_effectiveImageModulationIntensityWithProposedValue:") ~typ:(double @-> returning (double)) ~enc:"d24@0:8d16" ~imp
let px_enableBarAppearance imp = Define.method_spec ~cmd:(selector "px_enableBarAppearance") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_enableExtendedTraitCollection imp = Define.method_spec ~cmd:(selector "px_enableExtendedTraitCollection") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_enableImageModulation imp = Define.method_spec ~cmd:(selector "px_enableImageModulation") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_enableNavigationBanner imp = Define.method_spec ~cmd:(selector "px_enableNavigationBanner") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_enableOneUpPresentation imp = Define.method_spec ~cmd:(selector "px_enableOneUpPresentation") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_enableOneUpPresentationFromViewController' imp = Define.method_spec ~cmd:(selector "px_enableOneUpPresentationFromViewController:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let px_endPointForTransition' imp = Define.method_spec ~cmd:(selector "px_endPointForTransition:") ~typ:(id @-> returning (id)) ~enc:"@24@0:8@16" ~imp
let px_enumerateDescendantViewControllersWithOptions'usingBlock' imp = Define.method_spec ~cmd:(selector "px_enumerateDescendantViewControllersWithOptions:usingBlock:") ~typ:(ullong @-> (ptr void) @-> returning (void)) ~enc:"v32@0:8Q16@?24" ~imp
let px_extendedTraitCollection imp = Define.method_spec ~cmd:(selector "px_extendedTraitCollection") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_gridPresentation imp = Define.method_spec ~cmd:(selector "px_gridPresentation") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_imageModulationIntensity imp = Define.method_spec ~cmd:(selector "px_imageModulationIntensity") ~typ:(returning (double)) ~enc:"d16@0:8" ~imp
let px_imageModulationManager imp = Define.method_spec ~cmd:(selector "px_imageModulationManager") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_isDescendantOfViewController' imp = Define.method_spec ~cmd:(selector "px_isDescendantOfViewController:") ~typ:(id @-> returning (bool)) ~enc:"c24@0:8@16" ~imp
let px_isImageModulationEnabled imp = Define.method_spec ~cmd:(selector "px_isImageModulationEnabled") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let px_isVisible imp = Define.method_spec ~cmd:(selector "px_isVisible") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let px_layoutMargins imp = Define.method_spec ~cmd:(selector "px_layoutMargins") ~typ:(returning (UIEdgeInsets.t)) ~enc:"{UIEdgeInsets=dddd}16@0:8" ~imp
let px_navigateToStateAllowingTabSwitchingWithOptions'completionHandler' imp = Define.method_spec ~cmd:(selector "px_navigateToStateAllowingTabSwitchingWithOptions:completionHandler:") ~typ:(ullong @-> (ptr void) @-> returning (void)) ~enc:"v32@0:8Q16@?24" ~imp
let px_navigationBannerHelper imp = Define.method_spec ~cmd:(selector "px_navigationBannerHelper") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_navigationDestination imp = Define.method_spec ~cmd:(selector "px_navigationDestination") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_navigationDestinationWillChange' imp = Define.method_spec ~cmd:(selector "px_navigationDestinationWillChange:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let px_nextViewControllerInNavigationController imp = Define.method_spec ~cmd:(selector "px_nextViewControllerInNavigationController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_oneUpPresentation imp = Define.method_spec ~cmd:(selector "px_oneUpPresentation") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_photosUICategoriesAvailable imp = Define.method_spec ~cmd:(selector "px_photosUICategoriesAvailable") ~typ:(returning (bool)) ~enc:"c16@0:8" ~imp
let px_presentOverTopmostPresentedViewController'animated'completion' imp = Define.method_spec ~cmd:(selector "px_presentOverTopmostPresentedViewController:animated:completion:") ~typ:(id @-> bool @-> (ptr void) @-> returning (void)) ~enc:"v36@0:8@16c24@?28" ~imp
let px_presentViewControllerInNavigationController'animated'dimissButtonLocation'completion' imp = Define.method_spec ~cmd:(selector "px_presentViewControllerInNavigationController:animated:dimissButtonLocation:completion:") ~typ:(id @-> bool @-> llong @-> (ptr void) @-> returning (void)) ~enc:"v44@0:8@16c24q28@?36" ~imp
let px_previewActionMenus imp = Define.method_spec ~cmd:(selector "px_previewActionMenus") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_previousViewControllerInNavigationController imp = Define.method_spec ~cmd:(selector "px_previousViewControllerInNavigationController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_referenceSize imp = Define.method_spec ~cmd:(selector "px_referenceSize") ~typ:(returning (CGSize.t)) ~enc:"{CGSize=dd}16@0:8" ~imp
let px_safeAreaInsets imp = Define.method_spec ~cmd:(selector "px_safeAreaInsets") ~typ:(returning (UIEdgeInsets.t)) ~enc:"{UIEdgeInsets=dddd}16@0:8" ~imp
let px_setDefaultTransitionEndPoint' imp = Define.method_spec ~cmd:(selector "px_setDefaultTransitionEndPoint:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let px_setImageModulationEnabled' imp = Define.method_spec ~cmd:(selector "px_setImageModulationEnabled:") ~typ:(bool @-> returning (void)) ~enc:"v20@0:8c16" ~imp
let px_setNeedsHDRFocusUpdate imp = Define.method_spec ~cmd:(selector "px_setNeedsHDRFocusUpdate") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_setNeedsImageModulationIntensityUpdate imp = Define.method_spec ~cmd:(selector "px_setNeedsImageModulationIntensityUpdate") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_setPreviewActionMenus' imp = Define.method_spec ~cmd:(selector "px_setPreviewActionMenus:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let px_setSubtitle' imp = Define.method_spec ~cmd:(selector "px_setSubtitle:") ~typ:(id @-> returning (void)) ~enc:"v24@0:8@16" ~imp
let px_splitViewController imp = Define.method_spec ~cmd:(selector "px_splitViewController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_subtitle imp = Define.method_spec ~cmd:(selector "px_subtitle") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_topmostPresentedViewController imp = Define.method_spec ~cmd:(selector "px_topmostPresentedViewController") ~typ:(returning (id)) ~enc:"@16@0:8" ~imp
let px_willTransitionBars imp = Define.method_spec ~cmd:(selector "px_willTransitionBars") ~typ:(returning (void)) ~enc:"v16@0:8" ~imp
let px_windowReferenceSize imp = Define.method_spec ~cmd:(selector "px_windowReferenceSize") ~typ:(returning (CGSize.t)) ~enc:"{CGSize=dd}16@0:8" ~imp
