...
let statusBarFrameForStatusBarHeight' x ~inOrientation self = msg_send ~self ~cmd:(selector "statusBarFrameForStatusBarHeight:inOrientation:") ~typ:(double @-> llong @-> returning CGRect.t) x (LLong.of_int inOrientation)
