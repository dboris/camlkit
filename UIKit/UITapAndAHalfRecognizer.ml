...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitapandahalfrecognizer?language=objc}UITapAndAHalfRecognizer} *)

let self = get_class "UITapAndAHalfRecognizer"
...
let locationOfFirstTap self = msg_send_stret ~self ~cmd:(selector "locationOfFirstTap") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
...
let translationInWindowCoordinates self = msg_send_stret ~self ~cmd:(selector "translationInWindowCoordinates") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t