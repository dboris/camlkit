...
let controlFrame self = msg_send_stret ~self ~cmd:(selector "controlFrame") ~typ:(returning CGRect.t) ~return_type:CGRect.t
...
let pointAboveControls self = msg_send_stret ~self ~cmd:(selector "pointAboveControls") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let pointBelowControls self = msg_send_stret ~self ~cmd:(selector "pointBelowControls") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
...
let pointLeftOfControls self = msg_send_stret ~self ~cmd:(selector "pointLeftOfControls") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let pointRightOfControls self = msg_send_stret ~self ~cmd:(selector "pointRightOfControls") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
...
let targetPoint self = msg_send_stret ~self ~cmd:(selector "targetPoint") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
...
let textEffectsWindowSafeArea self = msg_send_stret ~self ~cmd:(selector "textEffectsWindowSafeArea") ~typ:(returning CGRect.t) ~return_type:CGRect.t
