...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardextensioninputmode?language=objc}UIKeyboardExtensionInputMode} *)

let self = get_class "UIKeyboardExtensionInputMode"
