...
let cellDragState self = msg_send ~self ~cmd:(selector "cellDragState") ~typ:(returning llong) |> LLong.to_int
let cellDropState self = msg_send ~self ~cmd:(selector "cellDropState") ~typ:(returning llong) |> LLong.to_int
