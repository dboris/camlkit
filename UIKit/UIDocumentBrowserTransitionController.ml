...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidocumentbrowsertransitioncontroller?language=objc}UIDocumentBrowserTransitionController} *)

let self = get_class "UIDocumentBrowserTransitionController"
