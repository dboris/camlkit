...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiweboverflowscrollview?language=objc}UIWebOverflowScrollView} *)

let self = get_class "UIWebOverflowScrollView"
