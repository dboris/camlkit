...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebselectsinglepicker?language=objc}UIWebSelectSinglePicker} *)

let self = get_class "UIWebSelectSinglePicker"
