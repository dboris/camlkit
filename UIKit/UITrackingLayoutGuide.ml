...
let triggerInsetsForLandscape self = msg_send_stret ~self ~cmd:(selector "triggerInsetsForLandscape") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
let triggerInsetsForPortrait self = msg_send_stret ~self ~cmd:(selector "triggerInsetsForPortrait") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
let triggerProportions self = msg_send_stret ~self ~cmd:(selector "triggerProportions") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
