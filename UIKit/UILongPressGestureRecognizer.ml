...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uilongpressgesturerecognizer?language=objc}UILongPressGestureRecognizer} *)

let self = get_class "UILongPressGestureRecognizer"
...
let centroid self = msg_send ~self ~cmd:(selector "centroid") ~typ:(returning CGPoint.t)
...
let lastSceneReferenceLocation self = msg_send ~self ~cmd:(selector "lastSceneReferenceLocation") ~typ:(returning CGPoint.t)
let lastTouchTime self = msg_send ~self ~cmd:(selector "lastTouchTime") ~typ:(returning double)
let lastUnadjustedSceneReferenceLocation self = msg_send ~self ~cmd:(selector "lastUnadjustedSceneReferenceLocation") ~typ:(returning CGPoint.t)
