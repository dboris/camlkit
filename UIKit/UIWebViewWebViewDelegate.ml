...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebviewwebviewdelegate?language=objc}UIWebViewWebViewDelegate} *)

let self = get_class "UIWebViewWebViewDelegate"
