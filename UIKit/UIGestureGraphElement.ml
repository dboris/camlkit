...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uigesturegraphelement?language=objc}UIGestureGraphElement} *)

let self = get_class "UIGestureGraphElement"
