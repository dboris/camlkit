...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uisheetpresentationcontroller?language=objc}UISheetPresentationController} *)

let self = get_class "UISheetPresentationController"
...
let offsetForInterruptedAnimationInSheetInteraction x self = msg_send ~self ~cmd:(selector "offsetForInterruptedAnimationInSheetInteraction:") ~typ:(id @-> returning CGPoint.t) x
