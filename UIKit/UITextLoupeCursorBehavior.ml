...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextloupecursorbehavior?language=objc}UITextLoupeCursorBehavior} *)

let self = get_class "UITextLoupeCursorBehavior"
