...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiavoidancecoordinator?language=objc}UIAvoidanceCoordinator} *)
...
let releaseAll x ~withType self = msg_send ~self ~cmd:(selector "releaseAll:withType:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int withType)
