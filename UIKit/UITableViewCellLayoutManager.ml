...
let self = get_class "UITableViewCellLayoutManager"

let accessoryEndingRectForCell x ~forNewEditingState ~showingDeleteConfirmation self = msg_send_stret ~self ~cmd:(selector "accessoryEndingRectForCell:forNewEditingState:showingDeleteConfirmation:") ~typ:(id @-> bool @-> bool @-> returning CGRect.t) ~return_type:CGRect.t x forNewEditingState showingDeleteConfirmation
...
let accessoryStartingRectForCell x ~forNewEditingState ~showingDeleteConfirmation self = msg_send_stret ~self ~cmd:(selector "accessoryStartingRectForCell:forNewEditingState:showingDeleteConfirmation:") ~typ:(id @-> bool @-> bool @-> returning CGRect.t) ~return_type:CGRect.t x forNewEditingState showingDeleteConfirmation
...
let editControlEndingRectForCell x ~forNewEditingState self = msg_send_stret ~self ~cmd:(selector "editControlEndingRectForCell:forNewEditingState:") ~typ:(id @-> bool @-> returning CGRect.t) ~return_type:CGRect.t x forNewEditingState
...
let selectedBackgroundEndingRectForCell x ~forNewEditingState self = msg_send_stret ~self ~cmd:(selector "selectedBackgroundEndingRectForCell:forNewEditingState:") ~typ:(id @-> bool @-> returning CGRect.t) ~return_type:CGRect.t x forNewEditingState
...
let textRectForCell x self = msg_send_stret ~self ~cmd:(selector "textRectForCell:") ~typ:(id @-> returning CGRect.t) ~return_type:CGRect.t x
let textRectForCell1 x ~rowWidth self = msg_send_stret ~self ~cmd:(selector "textRectForCell:rowWidth:") ~typ:(id @-> double @-> returning CGRect.t) ~return_type:CGRect.t x rowWidth
let textRectForCell2 x ~rowWidth ~forSizing self = msg_send_stret ~self ~cmd:(selector "textRectForCell:rowWidth:forSizing:") ~typ:(id @-> double @-> bool @-> returning CGRect.t) ~return_type:CGRect.t x rowWidth forSizing