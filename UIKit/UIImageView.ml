...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiimageview?language=objc}UIImageView} *)

let self = get_class "UIImageView"
...
let setAnimationRepeatCount x self = msg_send ~self ~cmd:(selector "setAnimationRepeatCount:") ~typ:(llong @-> returning void) (LLong.of_int x)
let setBackgroundColor x self = msg_send ~self ~cmd:(selector "setBackgroundColor:") ~typ:(id @-> returning void) x
let setBounds x self = msg_send ~self ~cmd:(selector "setBounds:") ~typ:(CGRect.t @-> returning void) x
let setCGImageRef x self = msg_send ~self ~cmd:(selector "setCGImageRef:") ~typ:((ptr CGImage.t) @-> returning void) x
