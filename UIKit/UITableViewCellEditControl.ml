...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewcelleditcontrol?language=objc}UITableViewCellEditControl} *)

let self = get_class "UITableViewCellEditControl"
