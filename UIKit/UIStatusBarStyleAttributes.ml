...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarstyleattributes?language=objc}UIStatusBarStyleAttributes} *)

let self = get_class "UIStatusBarStyleAttributes"
