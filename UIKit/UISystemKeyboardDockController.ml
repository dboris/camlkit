...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uisystemkeyboarddockcontroller?language=objc}UISystemKeyboardDockController} *)

let self = get_class "UISystemKeyboardDockController"
