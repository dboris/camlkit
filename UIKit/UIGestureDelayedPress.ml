...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uigesturedelayedpress?language=objc}UIGestureDelayedPress} *)

let self = get_class "UIGestureDelayedPress"
