...
let badgeOffset self = msg_send ~self ~cmd:(selector "badgeOffset") ~typ:(returning UIOffset.t)
...
let landscapePhoneBadgeOffset self = msg_send ~self ~cmd:(selector "landscapePhoneBadgeOffset") ~typ:(returning UIOffset.t)
