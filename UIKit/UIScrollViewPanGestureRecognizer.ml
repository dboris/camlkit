...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiscrollviewpangesturerecognizer?language=objc}UIScrollViewPanGestureRecognizer} *)

let self = get_class "UIScrollViewPanGestureRecognizer"
