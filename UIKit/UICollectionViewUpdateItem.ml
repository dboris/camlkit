...
let compareIndexPaths x self = msg_send ~self ~cmd:(selector "compareIndexPaths:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let inverseCompareIndexPaths x self = msg_send ~self ~cmd:(selector "inverseCompareIndexPaths:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let updateAction self = msg_send ~self ~cmd:(selector "updateAction") ~typ:(returning llong) |> LLong.to_int