...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewcell?language=objc}UICollectionViewCell} *)

let self = get_class "UICollectionViewCell"
