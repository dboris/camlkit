...
let edgesAddingLayoutMarginsToBackgroundInsets self = msg_send ~self ~cmd:(selector "edgesAddingLayoutMarginsToBackgroundInsets") ~typ:(returning ullong) |> ULLong.to_int
let encodeWithCoder x self = msg_send ~self ~cmd:(selector "encodeWithCoder:") ~typ:(id @-> returning void) x
let hash self = msg_send ~self ~cmd:(selector "hash") ~typ:(returning ullong) |> ULLong.to_int
let image self = msg_send ~self ~cmd:(selector "image") ~typ:(returning id)
let imageContentMode self = msg_send ~self ~cmd:(selector "imageContentMode") ~typ:(returning llong) |> LLong.to_int
