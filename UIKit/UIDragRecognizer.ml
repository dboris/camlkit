...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidragrecognizer?language=objc}UIDragRecognizer} *)

let self = get_class "UIDragRecognizer"
...
let startPosition self = msg_send ~self ~cmd:(selector "startPosition") ~typ:(returning CGPoint.t)
