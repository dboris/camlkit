...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidocument?language=objc}UIDocument} *)

let self = get_class "UIDocument"
...
let changeCountTokenForSaveOperation x self = msg_send ~self ~cmd:(selector "changeCountTokenForSaveOperation:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let fileNameExtensionForType x ~saveOperation self = msg_send ~self ~cmd:(selector "fileNameExtensionForType:saveOperation:") ~typ:(id @-> llong @-> returning id) x (LLong.of_int saveOperation)
...
let saveToURL x ~forSaveOperation ~completionHandler self = msg_send ~self ~cmd:(selector "saveToURL:forSaveOperation:completionHandler:") ~typ:(id @-> llong @-> (ptr void) @-> returning void) x (LLong.of_int forSaveOperation) completionHandler
...
let updateChangeCount x self = msg_send ~self ~cmd:(selector "updateChangeCount:") ~typ:(llong @-> returning void) (LLong.of_int x)
let updateChangeCountWithToken x ~forSaveOperation self = msg_send ~self ~cmd:(selector "updateChangeCountWithToken:forSaveOperation:") ~typ:(id @-> llong @-> returning void) x (LLong.of_int forSaveOperation)
