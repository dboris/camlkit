...
let self = get_class "UIWebBrowserView"
...
let contentSizeForScrollView x self = msg_send_stret ~self ~cmd:(selector "contentSizeForScrollView:") ~typ:(id @-> returning CGSize.t) ~return_type:CGSize.t x
