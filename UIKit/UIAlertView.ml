...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uialertview?language=objc}UIAlertView} *)

let self = get_class "UIAlertView"

let addButtonWithTitle x self = msg_send ~self ~cmd:(selector "addButtonWithTitle:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let alertViewStyle self = msg_send ~self ~cmd:(selector "alertViewStyle") ~typ:(returning llong) |> LLong.to_int
...
let cancelButtonIndex self = msg_send ~self ~cmd:(selector "cancelButtonIndex") ~typ:(returning llong) |> LLong.to_int
let context self = msg_send ~self ~cmd:(selector "context") ~typ:(returning id)
let dealloc self = msg_send ~self ~cmd:(selector "dealloc") ~typ:(returning void)
let defaultButtonIndex self = msg_send ~self ~cmd:(selector "defaultButtonIndex") ~typ:(returning llong) |> LLong.to_int
...
let firstOtherButtonIndex self = msg_send ~self ~cmd:(selector "firstOtherButtonIndex") ~typ:(returning llong) |> LLong.to_int
...
let numberOfButtons self = msg_send ~self ~cmd:(selector "numberOfButtons") ~typ:(returning llong) |> LLong.to_int
let numberOfRows self = msg_send ~self ~cmd:(selector "numberOfRows") ~typ:(returning llong) |> LLong.to_int
let setAlertViewStyle x self = msg_send ~self ~cmd:(selector "setAlertViewStyle:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let setDefaultButtonIndex x self = msg_send ~self ~cmd:(selector "setDefaultButtonIndex:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let setNumberOfRows x self = msg_send ~self ~cmd:(selector "setNumberOfRows:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let textFieldAtIndex x self = msg_send ~self ~cmd:(selector "textFieldAtIndex:") ~typ:(llong @-> returning id) (LLong.of_int x)
