...
let rectForGlobalItemIndex x self = msg_send_stret ~self ~cmd:(selector "rectForGlobalItemIndex:") ~typ:(llong @-> returning CGRect.t) ~return_type:CGRect.t (LLong.of_int x)
