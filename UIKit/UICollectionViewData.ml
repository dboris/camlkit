...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewdata?language=objc}UICollectionViewData} *)

let self = get_class "UICollectionViewData"
...
let collectionViewContentRect self = msg_send ~self ~cmd:(selector "collectionViewContentRect") ~typ:(returning CGRect.t)
...
let existingSupplementaryLayoutAttributesInSection x self = msg_send ~self ~cmd:(selector "existingSupplementaryLayoutAttributesInSection:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let indexPathForItemAtGlobalIndex x self = msg_send ~self ~cmd:(selector "indexPathForItemAtGlobalIndex:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let isGlobalIndexValid x self = msg_send ~self ~cmd:(selector "isGlobalIndexValid:") ~typ:(llong @-> returning bool) (LLong.of_int x)
...
let layoutAttributesForElementsInSection x self = msg_send ~self ~cmd:(selector "layoutAttributesForElementsInSection:") ~typ:(llong @-> returning id) (LLong.of_int x)
let layoutAttributesForGlobalItemIndex x self = msg_send ~self ~cmd:(selector "layoutAttributesForGlobalItemIndex:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let numberOfItemsBeforeSection x self = msg_send ~self ~cmd:(selector "numberOfItemsBeforeSection:") ~typ:(llong @-> returning llong) (LLong.of_int x)
...
let rectForDecorationElementOfKind x ~atIndexPath self = msg_send ~self ~cmd:(selector "rectForDecorationElementOfKind:atIndexPath:") ~typ:(id @-> id @-> returning CGRect.t) x atIndexPath
let rectForGlobalItemIndex x self = msg_send ~self ~cmd:(selector "rectForGlobalItemIndex:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
let rectForItemAtIndexPath x self = msg_send ~self ~cmd:(selector "rectForItemAtIndexPath:") ~typ:(id @-> returning CGRect.t) x
let rectForSupplementaryElementOfKind x ~atIndexPath self = msg_send ~self ~cmd:(selector "rectForSupplementaryElementOfKind:atIndexPath:") ~typ:(id @-> id @-> returning CGRect.t) x atIndexPath
...
let validatedIndexPathForItemAtGlobalIndex x self = msg_send ~self ~cmd:(selector "validatedIndexPathForItemAtGlobalIndex:") ~typ:(llong @-> returning id) (LLong.of_int x)