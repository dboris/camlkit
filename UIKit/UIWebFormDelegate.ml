...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebformdelegate?language=objc}UIWebFormDelegate} *)

let self = get_class "UIWebFormDelegate"
...
let suggestionsForString x ~inputIndex self = msg_send ~self ~cmd:(selector "suggestionsForString:inputIndex:") ~typ:(id @-> uint @-> returning void) x inputIndex
