...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidocumentbrowseraction?language=objc}UIDocumentBrowserAction} *)

let self = get_class "UIDocumentBrowserAction"

let actionStyle self = msg_send ~self ~cmd:(selector "actionStyle") ~typ:(returning llong) |> LLong.to_int
let availability self = msg_send ~self ~cmd:(selector "availability") ~typ:(returning llong) |> LLong.to_int
...
let menuSortOrder self = msg_send ~self ~cmd:(selector "menuSortOrder") ~typ:(returning ullong) |> ULLong.to_int
let navigationSide self = msg_send ~self ~cmd:(selector "navigationSide") ~typ:(returning llong) |> LLong.to_int
