...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitouchforcegesturerecognizer?language=objc}UITouchForceGestureRecognizer} *)

let self = get_class "UITouchForceGestureRecognizer"
