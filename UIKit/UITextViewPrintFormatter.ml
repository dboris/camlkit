...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextviewprintformatter?language=objc}UITextViewPrintFormatter} *)

let self = get_class "UITextViewPrintFormatter"
...
let rectForPageAtIndex x self = msg_send ~self ~cmd:(selector "rectForPageAtIndex:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
