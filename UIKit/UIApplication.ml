...
let activeInterfaceOrientation self = msg_send ~self ~cmd:(selector "activeInterfaceOrientation") ~typ:(returning llong) |> LLong.to_int
...
let alertInterfaceOrientation self = msg_send ~self ~cmd:(selector "alertInterfaceOrientation") ~typ:(returning llong) |> LLong.to_int
...
let applicationIconBadgeNumber self = msg_send ~self ~cmd:(selector "applicationIconBadgeNumber") ~typ:(returning llong) |> LLong.to_int
...
let applicationState self = msg_send ~self ~cmd:(selector "applicationState") ~typ:(returning llong) |> LLong.to_int
...
let backgroundRefreshStatus self = msg_send ~self ~cmd:(selector "backgroundRefreshStatus") ~typ:(returning llong) |> LLong.to_int
...
let beginBackgroundTaskWithExpirationHandler x self = msg_send ~self ~cmd:(selector "beginBackgroundTaskWithExpirationHandler:") ~typ:((ptr void) @-> returning ullong) x |> ULLong.to_int
let beginBackgroundTaskWithName x ~expirationHandler self = msg_send ~self ~cmd:(selector "beginBackgroundTaskWithName:expirationHandler:") ~typ:(id @-> (ptr void) @-> returning ullong) x expirationHandler |> ULLong.to_int
...
let blockInteractionEventsCount self = msg_send ~self ~cmd:(selector "blockInteractionEventsCount") ~typ:(returning ullong) |> ULLong.to_int
...
let hidUsageFromUIKeyInput x self = msg_send ~self ~cmd:(selector "hidUsageFromUIKeyInput:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let notificationSuppressionContextManager self = msg_send ~self ~cmd:(selector "notificationSuppressionContextManager") ~typ:(returning id)
...
let overriddenRequestedStyleFromStyle x self = msg_send ~self ~cmd:(selector "overriddenRequestedStyleFromStyle:") ~typ:(llong @-> returning llong) (LLong.of_int x) |> LLong.to_int
...
let pureUserInterfaceLayoutDirection self = msg_send ~self ~cmd:(selector "pureUserInterfaceLayoutDirection") ~typ:(returning llong) |> LLong.to_int
...
let setDelaySuspend x self = msg_send ~self ~cmd:(selector "setDelaySuspend:") ~typ:(bool @-> returning void) x
...
let statusBar1 x ~effectiveStyleOverridesForRequestedStyle ~overrides self = msg_send ~self ~cmd:(selector "statusBar:effectiveStyleOverridesForRequestedStyle:overrides:") ~typ:(id @-> llong @-> ullong @-> returning ullong) x (LLong.of_int effectiveStyleOverridesForRequestedStyle) (ULLong.of_int overrides) |> ULLong.to_int
let statusBar2 x ~styleForRequestedStyle ~overrides self = msg_send ~self ~cmd:(selector "statusBar:styleForRequestedStyle:overrides:") ~typ:(id @-> llong @-> ullong @-> returning llong) x (LLong.of_int styleForRequestedStyle) (ULLong.of_int overrides) |> LLong.to_int
...
let statusBarOrientation self = msg_send ~self ~cmd:(selector "statusBarOrientation") ~typ:(returning llong) |> LLong.to_int
...
let supportedInterfaceOrientationsForWindow x self = msg_send ~self ~cmd:(selector "supportedInterfaceOrientationsForWindow:") ~typ:(id @-> returning ullong) x |> ULLong.to_int
