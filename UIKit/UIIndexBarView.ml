...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiindexbarview?language=objc}UIIndexBarView} *)

let self = get_class "UIIndexBarView"
...
let setHighlightStyle x self = msg_send ~self ~cmd:(selector "setHighlightStyle:") ~typ:(llong @-> returning void) (LLong.of_int x)
