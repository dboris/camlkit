...
let self = get_class "UIDynamicItemBehavior"
...
let linearVelocityForItem x self = msg_send_stret ~self ~cmd:(selector "linearVelocityForItem:") ~typ:(id @-> returning CGPoint.t) ~return_type:CGPoint.t x
