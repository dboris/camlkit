...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uivariabledelayloupegesture?language=objc}UIVariableDelayLoupeGesture} *)

let self = get_class "UIVariableDelayLoupeGesture"
