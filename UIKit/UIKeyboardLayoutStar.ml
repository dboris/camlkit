...
let self = get_class "UIKeyboardLayoutStar"
...
let cachedCompositeImageWithCacheKey x self = msg_send ~self ~cmd:(selector "cachedCompositeImageWithCacheKey:") ~typ:(id @-> returning (ptr CGImage.t)) x
...
let renderedImageWithStateFallbacksForToken x self = msg_send ~self ~cmd:(selector "renderedImageWithStateFallbacksForToken:") ~typ:(id @-> returning (ptr CGImage.t)) x
let renderedImageWithToken x self = msg_send ~self ~cmd:(selector "renderedImageWithToken:") ~typ:(id @-> returning (ptr CGImage.t)) x
let renderedKeyplaneWithToken x ~split self = msg_send ~self ~cmd:(selector "renderedKeyplaneWithToken:split:") ~typ:(id @-> bool @-> returning (ptr CGImage.t)) x split
