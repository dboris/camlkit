...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicellaccessoryconfiguration?language=objc}UICellAccessoryConfiguration} *)

let self = get_class "UICellAccessoryConfiguration"
