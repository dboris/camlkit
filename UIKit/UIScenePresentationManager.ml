...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiscenepresentationmanager?language=objc}UIScenePresentationManager} *)

let self = get_class "UIScenePresentationManager"
