...
let fadeWithDelay' x ~forSelectionAtIndex self = msg_send ~self ~cmd:(selector "fadeWithDelay:forSelectionAtIndex:") ~typ:(double @-> ullong @-> returning (void)) x forSelectionAtIndex
...
let highlightRow x self = msg_send ~self ~cmd:(selector "highlightRow:") ~typ:(ullong @-> returning (void)) x
...
let setIndexForSelectedFastSwitchMode x self = msg_send ~self ~cmd:(selector "setIndexForSelectedFastSwitchMode:") ~typ:(llong @-> returning (void)) x
let setIndexForUnselectedFastSwitchMode x self = msg_send ~self ~cmd:(selector "setIndexForUnselectedFastSwitchMode:") ~typ:(llong @-> returning (void)) x
