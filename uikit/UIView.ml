...
let customAlignmentRectInsets self = msg_send ~self ~cmd:(selector "customAlignmentRectInsets") ~typ:(returning UIEdgeInsets.t)
...
let effectiveAlignmentRectInsets self = msg_send ~self ~cmd:(selector "effectiveAlignmentRectInsets") ~typ:(returning UIEdgeInsets.t)
...
let hitTestDirectionalInsets self = msg_send ~self ~cmd:(selector "hitTestDirectionalInsets") ~typ:(returning NSDirectionalEdgeInsets.t)
let hitTestInsets self = msg_send ~self ~cmd:(selector "hitTestInsets") ~typ:(returning UIEdgeInsets.t)
...
let largeContentImageInsets self = msg_send ~self ~cmd:(selector "largeContentImageInsets") ~typ:(returning UIEdgeInsets.t)
