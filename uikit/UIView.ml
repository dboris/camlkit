...
let resizableSnapshotFromRect x ~withCapInsets self = msg_send ~self ~cmd:(selector "resizableSnapshotFromRect:withCapInsets:") ~typ:(CGRect.t @-> ptr void @-> returning (id)) x withCapInsets
let resizableSnapshotViewFromRect x ~withCapInsets self = msg_send ~self ~cmd:(selector "resizableSnapshotViewFromRect:withCapInsets:") ~typ:(CGRect.t @-> ptr void @-> returning (id)) x withCapInsets
let resizableSnapshotViewFromRect' x ~afterScreenUpdates ~withCapInsets self = msg_send ~self ~cmd:(selector "resizableSnapshotViewFromRect:afterScreenUpdates:withCapInsets:") ~typ:(CGRect.t @-> bool @-> ptr void @-> returning (id)) x afterScreenUpdates withCapInsets
...
let setHitTestDirectionalInsets x self = msg_send ~self ~cmd:(selector "setHitTestDirectionalInsets:") ~typ:(ptr void @-> returning (void)) x
let setHitTestInsets x self = msg_send ~self ~cmd:(selector "setHitTestInsets:") ~typ:(ptr void @-> returning (void)) x
...
let setLargeContentImageInsets x self = msg_send ~self ~cmd:(selector "setLargeContentImageInsets:") ~typ:(ptr void @-> returning (void)) x
