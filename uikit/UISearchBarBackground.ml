...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uisearchbarbackground?language=objc}UISearchBarBackground} *)

let self = get_class "UISearchBarBackground"
