...
let _class_ = get_class "UICollisionBehavior"
...
let setTranslatesReferenceBoundsIntoBoundaryWithInsets x self = msg_send ~self ~cmd:(selector "setTranslatesReferenceBoundsIntoBoundaryWithInsets:") ~typ:(ptr void @-> returning (void)) x
