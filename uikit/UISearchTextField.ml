...
let _class_ = get_class "UISearchTextField"
...
let insertToken x ~atIndex self = msg_send ~self ~cmd:(selector "insertToken:atIndex:") ~typ:(id @-> llong @-> returning (void)) x atIndex
...
let positionOfTokenAtIndex x self = msg_send ~self ~cmd:(selector "positionOfTokenAtIndex:") ~typ:(llong @-> returning (id)) x
let removeTokenAtIndex x self = msg_send ~self ~cmd:(selector "removeTokenAtIndex:") ~typ:(llong @-> returning (void)) x
...
let replaceTextualPortionOfRange x ~withToken ~atIndex self = msg_send ~self ~cmd:(selector "replaceTextualPortionOfRange:withToken:atIndex:") ~typ:(id @-> id @-> ullong @-> returning (void)) x withToken atIndex
...
let updateForBackdropStyle x self = msg_send ~self ~cmd:(selector "updateForBackdropStyle:") ~typ:(ullong @-> returning (void)) x