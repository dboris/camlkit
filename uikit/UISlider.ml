...
let _class_ = get_class "UISlider"
...
let maximumTrackImageForState x self = msg_send ~self ~cmd:(selector "maximumTrackImageForState:") ~typ:(ullong @-> returning (id)) x
...
let maximumValueImageRectForBounds x self = msg_send_stret ~self ~cmd:(selector "maximumValueImageRectForBounds:") ~typ:(CGRect.t @-> returning (CGRect.t)) ~return_type:CGRect.t x
let minimumTrackImageForState x self = msg_send ~self ~cmd:(selector "minimumTrackImageForState:") ~typ:(ullong @-> returning (id)) x
...
let setMaximumTrackImage x ~forState self = msg_send ~self ~cmd:(selector "setMaximumTrackImage:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
let setMaximumTrackImage' x ~forStates self = msg_send ~self ~cmd:(selector "setMaximumTrackImage:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
...
let setMinimumTrackImage x ~forState self = msg_send ~self ~cmd:(selector "setMinimumTrackImage:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
let setMinimumTrackImage' x ~forStates self = msg_send ~self ~cmd:(selector "setMinimumTrackImage:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
...
let setPreferredBehavioralStyle x self = msg_send ~self ~cmd:(selector "setPreferredBehavioralStyle:") ~typ:(ullong @-> returning (void)) x
...
let setThumbImage x ~forState self = msg_send ~self ~cmd:(selector "setThumbImage:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
let setThumbImage' x ~forStates self = msg_send ~self ~cmd:(selector "setThumbImage:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
...
let thumbImageForState x self = msg_send ~self ~cmd:(selector "thumbImageForState:") ~typ:(ullong @-> returning (id)) x
let thumbRectForBounds x ~trackRect ~value self = msg_send_stret ~self ~cmd:(selector "thumbRectForBounds:trackRect:value:") ~typ:(CGRect.t @-> CGRect.t @-> float @-> returning (CGRect.t)) ~return_type:CGRect.t x trackRect value
let thumbTintColor self = msg_send ~self ~cmd:(selector "thumbTintColor") ~typ:(returning (id))
let trackRectForBounds x self = msg_send_stret ~self ~cmd:(selector "trackRectForBounds:") ~typ:(CGRect.t @-> returning (CGRect.t)) ~return_type:CGRect.t x
let traitCollectionDidChange x self = msg_send ~self ~cmd:(selector "traitCollectionDidChange:") ~typ:(id @-> returning (void)) x
let value self = msg_send ~self ~cmd:(selector "value") ~typ:(returning (float))
let valueTextRectForBounds x self = msg_send_stret ~self ~cmd:(selector "valueTextRectForBounds:") ~typ:(CGRect.t @-> returning (CGRect.t)) ~return_type:CGRect.t x