...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uihandlelocalnotificationaction?language=objc}UIHandleLocalNotificationAction} *)

let self = get_class "UIHandleLocalNotificationAction"
