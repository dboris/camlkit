...
let _class_ = get_class "UIPageViewController"
...
module Class = struct
  ...
  let stringForSpineLocation x self = msg_send ~self ~cmd:(selector "stringForSpineLocation:") ~typ:(llong @-> returning (id)) x
end
...
let initWithTransitionStyle x ~navigationOrientation ~options self = msg_send ~self ~cmd:(selector "initWithTransitionStyle:navigationOrientation:options:") ~typ:(llong @-> llong @-> id @-> returning (id)) x navigationOrientation options
...
let queuingScrollView x ~attemptToPageInDirection self = msg_send ~self ~cmd:(selector "queuingScrollView:attemptToPageInDirection:") ~typ:(id @-> llong @-> returning (void)) x attemptToPageInDirection
...
let setViewControllers x ~direction ~animated ~completion self = msg_send ~self ~cmd:(selector "setViewControllers:direction:animated:completion:") ~typ:(id @-> llong @-> bool @-> ptr void @-> returning (void)) x direction animated completion
