...
let finalSectionGlobalItemRangeForSection x self = msg_send ~self ~cmd:(selector "finalSectionGlobalItemRangeForSection:") ~typ:(llong @-> returning (NSRange.t)) x
...
let initalSectionGlobalItemRangeForSection x self = msg_send ~self ~cmd:(selector "initalSectionGlobalItemRangeForSection:") ~typ:(llong @-> returning (NSRange.t)) x
