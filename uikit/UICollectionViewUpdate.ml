...
let _class_ = get_class "UICollectionViewUpdate"

let dealloc self = msg_send ~self ~cmd:(selector "dealloc") ~typ:(returning (void))
let description self = msg_send ~self ~cmd:(selector "description") ~typ:(returning (id))
let finalGlobalIndexForInitialGlobalIndex x self = msg_send ~self ~cmd:(selector "finalGlobalIndexForInitialGlobalIndex:") ~typ:(llong @-> returning (llong)) x
...
let finalSectionGlobalItemRangeForSection x self = msg_send_stret ~self ~cmd:(selector "finalSectionGlobalItemRangeForSection:") ~typ:(llong @-> returning (NSRange.t)) ~return_type:NSRange.t x
let finalSectionIndexForInitialSectionIndex x self = msg_send ~self ~cmd:(selector "finalSectionIndexForInitialSectionIndex:") ~typ:(llong @-> returning (llong)) x
...
let initalSectionGlobalItemRangeForSection x self = msg_send_stret ~self ~cmd:(selector "initalSectionGlobalItemRangeForSection:") ~typ:(llong @-> returning (NSRange.t)) ~return_type:NSRange.t x
let initialGlobalIndexForFinalGlobalIndex x self = msg_send ~self ~cmd:(selector "initialGlobalIndexForFinalGlobalIndex:") ~typ:(llong @-> returning (llong)) x
...
let initialSectionIndexForFinalSectionIndex x self = msg_send ~self ~cmd:(selector "initialSectionIndexForFinalSectionIndex:") ~typ:(llong @-> returning (llong)) x
