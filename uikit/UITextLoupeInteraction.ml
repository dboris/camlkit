...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextloupeinteraction?language=objc}UITextLoupeInteraction} *)

let self = get_class "UITextLoupeInteraction"
...
let setInheritedGranularity x self = msg_send ~self ~cmd:(selector "setInheritedGranularity:") ~typ:(llong @-> returning void) (LLong.of_int x)
