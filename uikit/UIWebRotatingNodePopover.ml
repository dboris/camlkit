...
let _class_ = get_class "UIWebRotatingNodePopover"
...
let presentationPoint self = msg_send_stret ~self ~cmd:(selector "presentationPoint") ~typ:(returning (CGPoint.t)) ~return_type:CGPoint.t
