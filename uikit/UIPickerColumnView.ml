...
let pickerTableView x ~didChangeSelectionBarRowFrom ~to_ self = msg_send ~self ~cmd:(selector "pickerTableView:didChangeSelectionBarRowFrom:to:") ~typ:(id @-> llong @-> llong @-> returning (void)) x didChangeSelectionBarRowFrom to_
