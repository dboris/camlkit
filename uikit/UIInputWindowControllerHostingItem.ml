...
let constructNotificationInfoForScrollWithMode x self = msg_send ~self ~cmd:(selector "constructNotificationInfoForScrollWithMode:") ~typ:(ullong @-> returning (id)) x
...
let viewMatchingConstraintForAttribute x ~primaryView ~secondaryView self = msg_send ~self ~cmd:(selector "viewMatchingConstraintForAttribute:primaryView:secondaryView:") ~typ:(llong @-> id @-> id @-> returning (id)) x primaryView secondaryView
