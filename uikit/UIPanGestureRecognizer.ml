...
let setAllowedScrollTypesMask x self = msg_send ~self ~cmd:(selector "setAllowedScrollTypesMask:") ~typ:(llong @-> returning (void)) x
...
let setMaximumNumberOfTouches x self = msg_send ~self ~cmd:(selector "setMaximumNumberOfTouches:") ~typ:(ullong @-> returning (void)) x
