...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewcellfocusablereordercontrol?language=objc}UITableViewCellFocusableReorderControl} *)

let self = get_class "UITableViewCellFocusableReorderControl"
