...
let setBackButtonTitlePositionAdjustment x ~forBarMetrics self = msg_send ~self ~cmd:(selector "setBackButtonTitlePositionAdjustment:forBarMetrics:") ~typ:(ptr void @-> llong @-> returning (void)) x (LLong.of_int forBarMetrics)
...
let setTitlePositionAdjustment x ~forBarMetrics self = msg_send ~self ~cmd:(selector "setTitlePositionAdjustment:forBarMetrics:") ~typ:(ptr void @-> llong @-> returning (void)) x (LLong.of_int forBarMetrics)
