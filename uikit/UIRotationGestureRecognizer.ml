...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uirotationgesturerecognizer?language=objc}UIRotationGestureRecognizer} *)

let self = get_class "UIRotationGestureRecognizer"
