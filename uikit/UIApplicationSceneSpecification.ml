...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiapplicationscenespecification?language=objc}UIApplicationSceneSpecification} *)

let self = get_class "UIApplicationSceneSpecification"
