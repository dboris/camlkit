...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidocumentmenuviewcontroller?language=objc}UIDocumentMenuViewController} *)

let self = get_class "UIDocumentMenuViewController"
