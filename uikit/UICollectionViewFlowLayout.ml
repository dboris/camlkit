...
let estimatedItemSize self = msg_send ~self ~cmd:(selector "estimatedItemSize") ~typ:(returning (CGSize.t))
...
let finalLayoutAttributesForFooterInDeletedSection x self = msg_send ~self ~cmd:(selector "finalLayoutAttributesForFooterInDeletedSection:") ~typ:(llong @-> returning (id)) x
let finalLayoutAttributesForHeaderInDeletedSection x self = msg_send ~self ~cmd:(selector "finalLayoutAttributesForHeaderInDeletedSection:") ~typ:(llong @-> returning (id)) x
let footerReferenceSize self = msg_send ~self ~cmd:(selector "footerReferenceSize") ~typ:(returning (CGSize.t))
let headerReferenceSize self = msg_send ~self ~cmd:(selector "headerReferenceSize") ~typ:(returning (CGSize.t))
...
let initialLayoutAttributesForFooterInInsertedSection x self = msg_send ~self ~cmd:(selector "initialLayoutAttributesForFooterInInsertedSection:") ~typ:(llong @-> returning (id)) x
let initialLayoutAttributesForHeaderInInsertedSection x self = msg_send ~self ~cmd:(selector "initialLayoutAttributesForHeaderInInsertedSection:") ~typ:(llong @-> returning (id)) x
...
let layoutAttributesForFooterInSection x self = msg_send ~self ~cmd:(selector "layoutAttributesForFooterInSection:") ~typ:(llong @-> returning (id)) x
let layoutAttributesForFooterInSection' x ~usingData self = msg_send ~self ~cmd:(selector "layoutAttributesForFooterInSection:usingData:") ~typ:(llong @-> id @-> returning (id)) x usingData
let layoutAttributesForHeaderInSection x self = msg_send ~self ~cmd:(selector "layoutAttributesForHeaderInSection:") ~typ:(llong @-> returning (id)) x
let layoutAttributesForHeaderInSection' x ~usingData self = msg_send ~self ~cmd:(selector "layoutAttributesForHeaderInSection:usingData:") ~typ:(llong @-> id @-> returning (id)) x usingData
...
let setScrollDirection x self = msg_send ~self ~cmd:(selector "setScrollDirection:") ~typ:(llong @-> returning (void)) x
...
let setSectionInsetReference x self = msg_send ~self ~cmd:(selector "setSectionInsetReference:") ~typ:(llong @-> returning (void)) x
...
let synchronizeLayout self = msg_send ~self ~cmd:(selector "synchronizeLayout") ~typ:(returning (CGSize.t))