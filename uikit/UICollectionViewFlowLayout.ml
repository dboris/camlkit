...
let sectionInset self = msg_send ~self ~cmd:(selector "sectionInset") ~typ:(returning UIEdgeInsets.t)
...
let setSectionInset x self = msg_send ~self ~cmd:(selector "setSectionInset:") ~typ:(UIEdgeInsets.t @-> returning void) x
