...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiindexbardisplayentry?language=objc}UIIndexBarDisplayEntry} *)

let self = get_class "UIIndexBarDisplayEntry"
