...
let setDisplayEntryIndex x self = msg_send ~self ~cmd:(selector "setDisplayEntryIndex:") ~typ:(llong @-> returning (void)) x
let setEntry x self = msg_send ~self ~cmd:(selector "setEntry:") ~typ:(id @-> returning (void)) x
let setEntryIndex x self = msg_send ~self ~cmd:(selector "setEntryIndex:") ~typ:(llong @-> returning (void)) x