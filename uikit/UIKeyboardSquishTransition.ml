...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardsquishtransition?language=objc}UIKeyboardSquishTransition} *)

let self = get_class "UIKeyboardSquishTransition"
...
let setAnimationType x self = msg_send ~self ~cmd:(selector "setAnimationType:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
