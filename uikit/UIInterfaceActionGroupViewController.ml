...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinterfaceactiongroupviewcontroller?language=objc}UIInterfaceActionGroupViewController} *)

let self = get_class "UIInterfaceActionGroupViewController"
