...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiweboverflowscrollinfo?language=objc}UIWebOverflowScrollInfo} *)

let self = get_class "UIWebOverflowScrollInfo"
