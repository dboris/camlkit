...
let swipeHandler1 x ~didConfirmSwipeWithInfo self = msg_send ~self ~cmd:(selector "swipeHandler:didConfirmSwipeWithInfo:") ~typ:(id @-> ptr void @-> returning (void)) x didConfirmSwipeWithInfo
let swipeHandler2 x ~didGenerateSwipeWithInfo ~isTracking self = msg_send ~self ~cmd:(selector "swipeHandler:didGenerateSwipeWithInfo:isTracking:") ~typ:(id @-> ptr void @-> bool @-> returning (void)) x didGenerateSwipeWithInfo isTracking
