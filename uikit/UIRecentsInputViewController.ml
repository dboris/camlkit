...
let setContainingEffectStyle x self = msg_send ~self ~cmd:(selector "setContainingEffectStyle:") ~typ:(llong @-> returning (void)) x
...
let tableView6 x ~numberOfRowsInSection self = msg_send ~self ~cmd:(selector "tableView:numberOfRowsInSection:") ~typ:(id @-> llong @-> returning (llong)) x numberOfRowsInSection
let tableView7 x ~titleForHeaderInSection self = msg_send ~self ~cmd:(selector "tableView:titleForHeaderInSection:") ~typ:(id @-> llong @-> returning (id)) x titleForHeaderInSection
