...
let _class_ = get_class "UICollectionViewController"
...
let contentScrollViewForEdge x self = msg_send ~self ~cmd:(selector "contentScrollViewForEdge:") ~typ:(ullong @-> returning (id)) x
