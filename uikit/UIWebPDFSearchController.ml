...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebpdfsearchcontroller?language=objc}UIWebPDFSearchController} *)

let self = get_class "UIWebPDFSearchController"
