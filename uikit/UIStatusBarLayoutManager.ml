...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarlayoutmanager?language=objc}UIStatusBarLayoutManager} *)

let self = get_class "UIStatusBarLayoutManager"
...
let rectForItems x self = msg_send ~self ~cmd:(selector "rectForItems:") ~typ:(id @-> returning CGRect.t) x
