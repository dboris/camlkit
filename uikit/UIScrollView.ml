...
let setHorizontalScrollIndicatorInsets x self = msg_send ~self ~cmd:(selector "setHorizontalScrollIndicatorInsets:") ~typ:(ptr void @-> returning (void)) x
...
let setScrollIndicatorInsets x self = msg_send ~self ~cmd:(selector "setScrollIndicatorInsets:") ~typ:(ptr void @-> returning (void)) x
...
let setVerticalScrollIndicatorInsets x self = msg_send ~self ~cmd:(selector "setVerticalScrollIndicatorInsets:") ~typ:(ptr void @-> returning (void)) x
