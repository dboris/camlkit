...
let contentSizeForViewInPopoverView self = msg_send ~self ~cmd:(selector "contentSizeForViewInPopoverView") ~typ:(returning (CGSize.t))
...
let formSheetSize self = msg_send ~self ~cmd:(selector "formSheetSize") ~typ:(returning (CGSize.t))
...
let setContentScrollView x ~forEdge self = msg_send ~self ~cmd:(selector "setContentScrollView:forEdge:") ~typ:(id @-> ullong @-> returning (void)) x forEdge
...
let setContentVisibility x self = msg_send ~self ~cmd:(selector "setContentVisibility:") ~typ:(llong @-> returning (void)) x
...
let setPreferredUserInterfaceStyle x self = msg_send ~self ~cmd:(selector "setPreferredUserInterfaceStyle:") ~typ:(llong @-> returning (void)) x
...
let window x ~didAnimateFirstHalfOfRotationToInterfaceOrientation self = msg_send ~self ~cmd:(selector "window:didAnimateFirstHalfOfRotationToInterfaceOrientation:") ~typ:(id @-> llong @-> returning (void)) x didAnimateFirstHalfOfRotationToInterfaceOrientation
let window1 x ~didRotateFromInterfaceOrientation self = msg_send ~self ~cmd:(selector "window:didRotateFromInterfaceOrientation:") ~typ:(id @-> llong @-> returning (void)) x didRotateFromInterfaceOrientation
let window2 x ~resizeFromOrientation self = msg_send ~self ~cmd:(selector "window:resizeFromOrientation:") ~typ:(id @-> llong @-> returning (void)) x resizeFromOrientation
let window3 x ~setupWithInterfaceOrientation self = msg_send ~self ~cmd:(selector "window:setupWithInterfaceOrientation:") ~typ:(id @-> llong @-> returning (void)) x setupWithInterfaceOrientation
let window4 x ~didRotateFromInterfaceOrientation ~oldSize self = msg_send ~self ~cmd:(selector "window:didRotateFromInterfaceOrientation:oldSize:") ~typ:(id @-> llong @-> CGSize.t @-> returning (void)) x didRotateFromInterfaceOrientation oldSize
...
let window6 x ~willAnimateFirstHalfOfRotationToInterfaceOrientation ~duration self = msg_send ~self ~cmd:(selector "window:willAnimateFirstHalfOfRotationToInterfaceOrientation:duration:") ~typ:(id @-> llong @-> double @-> returning (void)) x willAnimateFirstHalfOfRotationToInterfaceOrientation duration
...
let window8 x ~willAnimateRotationToInterfaceOrientation ~duration self = msg_send ~self ~cmd:(selector "window:willAnimateRotationToInterfaceOrientation:duration:") ~typ:(id @-> llong @-> double @-> returning (void)) x willAnimateRotationToInterfaceOrientation duration
let window9 x ~willAnimateSecondHalfOfRotationFromInterfaceOrientation ~duration self = msg_send ~self ~cmd:(selector "window:willAnimateSecondHalfOfRotationFromInterfaceOrientation:duration:") ~typ:(id @-> llong @-> double @-> returning (void)) x willAnimateSecondHalfOfRotationFromInterfaceOrientation duration
let window10 x ~willRotateToInterfaceOrientation ~duration self = msg_send ~self ~cmd:(selector "window:willRotateToInterfaceOrientation:duration:") ~typ:(id @-> llong @-> double @-> returning (void)) x willRotateToInterfaceOrientation duration
...
let window12 x ~willAnimateRotationToInterfaceOrientation ~duration ~newSize self = msg_send ~self ~cmd:(selector "window:willAnimateRotationToInterfaceOrientation:duration:newSize:") ~typ:(id @-> llong @-> double @-> CGSize.t @-> returning (void)) x willAnimateRotationToInterfaceOrientation duration newSize
let window13 x ~willRotateToInterfaceOrientation ~duration ~newSize self = msg_send ~self ~cmd:(selector "window:willRotateToInterfaceOrientation:duration:newSize:") ~typ:(id @-> llong @-> double @-> CGSize.t @-> returning (void)) x willRotateToInterfaceOrientation duration newSize