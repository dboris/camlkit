...
let inputAccessoryViewBounds self = msg_send_stret ~self ~cmd:(selector "inputAccessoryViewBounds") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
let inputAssistantView self = msg_send ~self ~cmd:(selector "inputAssistantView") ~typ:(returning (id))
let inputAssistantViewBounds self = msg_send_stret ~self ~cmd:(selector "inputAssistantViewBounds") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
...
let inputViewBounds self = msg_send_stret ~self ~cmd:(selector "inputViewBounds") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
