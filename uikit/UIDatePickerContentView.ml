...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidatepickercontentview?language=objc}UIDatePickerContentView} *)

let self = get_class "UIDatePickerContentView"
