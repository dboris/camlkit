...
let akLocationInWindow self = msg_send ~self ~cmd:(selector "akLocationInWindow") ~typ:(returning (CGPoint.t))
let akNumberOfTouches self = msg_send ~self ~cmd:(selector "akNumberOfTouches") ~typ:(returning (ullong))
...
let currentPreviewForceState self = msg_send ~self ~cmd:(selector "currentPreviewForceState") ~typ:(returning (llong))
...
let requiredPreviewForceState self = msg_send ~self ~cmd:(selector "requiredPreviewForceState") ~typ:(returning (llong))
