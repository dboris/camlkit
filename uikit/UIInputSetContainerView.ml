...
let _class_ = get_class "UIInputSetContainerView"
...
let offsetOrigin self = msg_send_stret ~self ~cmd:(selector "offsetOrigin") ~typ:(returning (CGPoint.t)) ~return_type:CGPoint.t
