...
let _class_ = get_class "UIStatusBarManager"
...
let defaultStatusBarHeightInOrientation x self = msg_send ~self ~cmd:(selector "defaultStatusBarHeightInOrientation:") ~typ:(llong @-> returning (double)) x
...
let statusBarFrameForStatusBarHeight x self = msg_send ~self ~cmd:(selector "statusBarFrameForStatusBarHeight:") ~typ:(double @-> returning (CGRect.t)) x
let statusBarFrameForStatusBarHeight' x ~inOrientation self = msg_send ~self ~cmd:(selector "statusBarFrameForStatusBarHeight:inOrientation:") ~typ:(double @-> llong @-> returning (CGRect.t)) x inOrientation
