...
let _class_ = get_class "UITextMultiTapRecognizer"
...
let setMinimumNumberOfTapsRequired x self = msg_send ~self ~cmd:(selector "setMinimumNumberOfTapsRequired:") ~typ:(ullong @-> returning (void)) x
