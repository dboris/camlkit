...
let checkGrammarOfString x ~startingAt ~language ~wrap ~details self = msg_send_stret ~self ~cmd:(selector "checkGrammarOfString:startingAt:language:wrap:details:") ~typ:(id @-> llong @-> id @-> bool @-> ptr (id) @-> returning (NSRange.t)) ~return_type:NSRange.t x startingAt language wrap details
let checkSpellingOfString x ~startingAt ~language ~wrap ~correction self = msg_send_stret ~self ~cmd:(selector "checkSpellingOfString:startingAt:language:wrap:correction:") ~typ:(id @-> llong @-> id @-> bool @-> ptr (id) @-> returning (NSRange.t)) ~return_type:NSRange.t x startingAt language wrap correction
let checkSpellingOfString' x ~startingAt ~languages ~wrap ~correction self = msg_send_stret ~self ~cmd:(selector "checkSpellingOfString:startingAt:languages:wrap:correction:") ~typ:(id @-> llong @-> id @-> bool @-> ptr (id) @-> returning (NSRange.t)) ~return_type:NSRange.t x startingAt languages wrap correction
...
let rangeOfMisspelledWordInString x ~range ~startingAt ~wrap ~language self = msg_send_stret ~self ~cmd:(selector "rangeOfMisspelledWordInString:range:startingAt:wrap:language:") ~typ:(id @-> NSRange.t @-> llong @-> bool @-> id @-> returning (NSRange.t)) ~return_type:NSRange.t x range startingAt wrap language
let rangeOfMisspelledWordInString' x ~range ~startingAt ~wrap ~languages self = msg_send_stret ~self ~cmd:(selector "rangeOfMisspelledWordInString:range:startingAt:wrap:languages:") ~typ:(id @-> NSRange.t @-> llong @-> bool @-> id @-> returning (NSRange.t)) ~return_type:NSRange.t x range startingAt wrap languages
