...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uianimatableproperty?language=objc}UIAnimatableProperty} *)

let self = get_class "UIAnimatableProperty"
