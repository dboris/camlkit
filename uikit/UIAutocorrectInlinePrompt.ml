...
let _class_ = get_class "UIAutocorrectInlinePrompt"
...
let correctionFrameFromDesiredFrame x ~textHeight ~withExtraGap self = msg_send ~self ~cmd:(selector "correctionFrameFromDesiredFrame:textHeight:withExtraGap:") ~typ:(CGRect.t @-> int @-> double @-> returning (CGRect.t)) x textHeight withExtraGap
...
let horizontallySquishedCorrectionFrame x self = msg_send ~self ~cmd:(selector "horizontallySquishedCorrectionFrame:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
...
let shadowFrameForFrame x self = msg_send ~self ~cmd:(selector "shadowFrameForFrame:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
