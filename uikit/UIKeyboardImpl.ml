...
module Class = struct
  ...
  let additionalInstanceHeightForInterfaceOrientation x self = msg_send ~self ~cmd:(selector "additionalInstanceHeightForInterfaceOrientation:") ~typ:(llong @-> returning (double)) x
  let additionalInstanceHeightForInterfaceOrientation' x ~hasInputView self = msg_send ~self ~cmd:(selector "additionalInstanceHeightForInterfaceOrientation:hasInputView:") ~typ:(llong @-> bool @-> returning (double)) x hasInputView
  ...
  let defaultSizeForInterfaceOrientation x self = msg_send ~self ~cmd:(selector "defaultSizeForInterfaceOrientation:") ~typ:(llong @-> returning (CGSize.t)) x
  ...
  let keyboardOrientation x ~isEquivalentToOrientation self = msg_send ~self ~cmd:(selector "keyboardOrientation:isEquivalentToOrientation:") ~typ:(llong @-> llong @-> returning (bool)) x isEquivalentToOrientation
  let keyboardScreen self = msg_send ~self ~cmd:(selector "keyboardScreen") ~typ:(returning (id))
  let keyboardSizeForInterfaceOrientation x self = msg_send ~self ~cmd:(selector "keyboardSizeForInterfaceOrientation:") ~typ:(llong @-> returning (CGSize.t)) x
  let keyboardWidthForScreen x ~withOrientation self = msg_send ~self ~cmd:(selector "keyboardWidthForScreen:withOrientation:") ~typ:(id @-> llong @-> returning (double)) x withOrientation
  ...
  let layoutClassForInputMode x ~keyboardType ~screenTraits self = msg_send ~self ~cmd:(selector "layoutClassForInputMode:keyboardType:screenTraits:") ~typ:(id @-> llong @-> id @-> returning (_Class)) x keyboardType screenTraits
  ...
  let sizeForInterfaceOrientation x self = msg_send ~self ~cmd:(selector "sizeForInterfaceOrientation:") ~typ:(llong @-> returning (CGSize.t)) x
  let sizeForInterfaceOrientation' x ~ignoreInputView self = msg_send ~self ~cmd:(selector "sizeForInterfaceOrientation:ignoreInputView:") ~typ:(llong @-> bool @-> returning (CGSize.t)) x ignoreInputView
  ...
  let topMarginForInterfaceOrientation x self = msg_send ~self ~cmd:(selector "topMarginForInterfaceOrientation:") ~typ:(llong @-> returning (double)) x
  let uniqueNumberPadInputModesFromInputModes x ~forKeyboardType self = msg_send ~self ~cmd:(selector "uniqueNumberPadInputModesFromInputModes:forKeyboardType:") ~typ:(id @-> llong @-> returning (id)) x forKeyboardType
end
...
let acceptWord x ~firstDelete self = msg_send ~self ~cmd:(selector "acceptWord:firstDelete:") ~typ:(id @-> ullong @-> returning (bool)) x firstDelete
let acceptWord' x ~firstDelete ~forInput self = msg_send ~self ~cmd:(selector "acceptWord:firstDelete:forInput:") ~typ:(id @-> ullong @-> id @-> returning (bool)) x firstDelete forInput
...
let addInputString2 x ~withFlags self = msg_send ~self ~cmd:(selector "addInputString:withFlags:") ~typ:(id @-> ullong @-> returning (void)) x withFlags
let addInputString3 x ~withFlags ~executionContext self = msg_send ~self ~cmd:(selector "addInputString:withFlags:executionContext:") ~typ:(id @-> ullong @-> id @-> returning (void)) x withFlags executionContext
let addInputString4 x ~withFlags ~withInputManagerHint self = msg_send ~self ~cmd:(selector "addInputString:withFlags:withInputManagerHint:") ~typ:(id @-> ullong @-> id @-> returning (void)) x withFlags withInputManagerHint
let addInputString5 x ~withFlags ~withInputManagerHint ~executionContext self = msg_send ~self ~cmd:(selector "addInputString:withFlags:withInputManagerHint:executionContext:") ~typ:(id @-> ullong @-> id @-> id @-> returning (void)) x withFlags withInputManagerHint executionContext
...
let adjustSegmentSize x self = msg_send ~self ~cmd:(selector "adjustSegmentSize:") ~typ:(llong @-> returning (void)) x
...
let convertRectToAutocorrectRect x ~delegateView ~container self = msg_send ~self ~cmd:(selector "convertRectToAutocorrectRect:delegateView:container:") ~typ:(CGRect.t @-> id @-> id @-> returning (CGRect.t)) x delegateView container
let copyOperation self = msg_send ~self ~cmd:(selector "copyOperation") ~typ:(returning (void))
let correctionRect self = msg_send ~self ~cmd:(selector "correctionRect") ~typ:(returning (CGRect.t))
...
let deleteFromInputWithFlags x self = msg_send ~self ~cmd:(selector "deleteFromInputWithFlags:") ~typ:(ullong @-> returning (void)) x
let deleteFromInputWithFlags' x ~executionContext self = msg_send ~self ~cmd:(selector "deleteFromInputWithFlags:executionContext:") ~typ:(ullong @-> id @-> returning (void)) x executionContext
...
let getCorrectionRectIsVertical x self = msg_send ~self ~cmd:(selector "getCorrectionRectIsVertical:") ~typ:(ptr (bool) @-> returning (CGRect.t)) x
...
let handleKeyCommand' x ~repeatOkay ~options self = msg_send ~self ~cmd:(selector "handleKeyCommand:repeatOkay:options:") ~typ:(id @-> ptr (bool) @-> ullong @-> returning (ullong)) x repeatOkay options
...
let handleStringInput x ~withFlags ~withInputManagerHint ~executionContext self = msg_send ~self ~cmd:(selector "handleStringInput:withFlags:withInputManagerHint:executionContext:") ~typ:(id @-> ullong @-> id @-> id @-> returning (void)) x withFlags withInputManagerHint executionContext
...
let moveCursorByAmount x self = msg_send ~self ~cmd:(selector "moveCursorByAmount:") ~typ:(llong @-> returning (void)) x
...
let movePhraseBoundaryToDirection x ~granularity self = msg_send ~self ~cmd:(selector "movePhraseBoundaryToDirection:granularity:") ~typ:(llong @-> llong @-> returning (void)) x granularity
...
let performKeyboardOutputAsInputViewControllerOutput' x ~textInputSource self = msg_send ~self ~cmd:(selector "performKeyboardOutputAsInputViewControllerOutput:textInputSource:") ~typ:(id @-> llong @-> returning (void)) x textInputSource
...
let performOperations x ~withTextInputSource self = msg_send ~self ~cmd:(selector "performOperations:withTextInputSource:") ~typ:(ptr void @-> llong @-> returning (void)) x withTextInputSource
...
let prepareLayoutForInterfaceOrientation x self = msg_send ~self ~cmd:(selector "prepareLayoutForInterfaceOrientation:") ~typ:(llong @-> returning (void)) x
...
let setCandidateViewOffset x self = msg_send ~self ~cmd:(selector "setCandidateViewOffset:") ~typ:(llong @-> returning (void)) x
...
let showFirstTextAlternativeWithRangeAdjustment x self = msg_send ~self ~cmd:(selector "showFirstTextAlternativeWithRangeAdjustment:") ~typ:(llong @-> returning (void)) x
...
let smartSelectionForTextInDocument x ~inRange ~options ~completion self = msg_send ~self ~cmd:(selector "smartSelectionForTextInDocument:inRange:options:completion:") ~typ:(id @-> NSRange.t @-> ullong @-> ptr void @-> returning (void)) x inRange options completion
...
let subtractKeyboardFrameFromRect x ~inView self = msg_send ~self ~cmd:(selector "subtractKeyboardFrameFromRect:inView:") ~typ:(CGRect.t @-> id @-> returning (CGRect.t)) x inView
