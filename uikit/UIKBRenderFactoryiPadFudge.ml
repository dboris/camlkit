...
let deleteKeyOffset x self = msg_send ~self ~cmd:(selector "deleteKeyOffset:") ~typ:(ullong @-> returning (CGPoint.t)) x
...
let dualStringKeyBottomTextOffset x self = msg_send ~self ~cmd:(selector "dualStringKeyBottomTextOffset:") ~typ:(ullong @-> returning (CGPoint.t)) x
let dualStringKeyBottomTextOffset' x ~keyplane self = msg_send ~self ~cmd:(selector "dualStringKeyBottomTextOffset:keyplane:") ~typ:(id @-> id @-> returning (CGPoint.t)) x keyplane
let dualStringKeyTopFontSize x self = msg_send ~self ~cmd:(selector "dualStringKeyTopFontSize:") ~typ:(ullong @-> returning (double)) x
let dualStringKeyTopTextOffset x self = msg_send ~self ~cmd:(selector "dualStringKeyTopTextOffset:") ~typ:(ullong @-> returning (CGPoint.t)) x
let dualStringKeyTopTextOffset' x ~keyplane self = msg_send ~self ~cmd:(selector "dualStringKeyTopTextOffset:keyplane:") ~typ:(id @-> id @-> returning (CGPoint.t)) x keyplane
...
let stringKeyOffset x self = msg_send ~self ~cmd:(selector "stringKeyOffset:") ~typ:(ullong @-> returning (CGPoint.t)) x
