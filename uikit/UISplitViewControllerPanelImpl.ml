...
let _class_ = get_class "UISplitViewControllerPanelImpl"

let allowedDisplayModeForCurrentSplitBehaviorGivenDisplayMode x self = msg_send ~self ~cmd:(selector "allowedDisplayModeForCurrentSplitBehaviorGivenDisplayMode:") ~typ:(llong @-> returning (llong)) x
...
let defaultDisplayModeForSplitBehavior x self = msg_send ~self ~cmd:(selector "defaultDisplayModeForSplitBehavior:") ~typ:(llong @-> returning (llong)) x
...
let getPrimaryColumnWidth x ~supplementaryColumnWidth ~forSize ~displayMode ~shouldUseOverlay self = msg_send ~self ~cmd:(selector "getPrimaryColumnWidth:supplementaryColumnWidth:forSize:displayMode:shouldUseOverlay:") ~typ:(ptr (double) @-> ptr (double) @-> CGSize.t @-> llong @-> bool @-> returning (void)) x supplementaryColumnWidth forSize displayMode shouldUseOverlay
let getPrimaryColumnWidth' x ~supplementaryColumnWidth ~forSize ~displayMode ~isCompact ~shouldUseOverlay self = msg_send ~self ~cmd:(selector "getPrimaryColumnWidth:supplementaryColumnWidth:forSize:displayMode:isCompact:shouldUseOverlay:") ~typ:(ptr (double) @-> ptr (double) @-> CGSize.t @-> llong @-> bool @-> bool @-> returning (void)) x supplementaryColumnWidth forSize displayMode isCompact shouldUseOverlay
...
let panelController3 x ~didEndResizingColumn self = msg_send ~self ~cmd:(selector "panelController:didEndResizingColumn:") ~typ:(id @-> llong @-> returning (void)) x didEndResizingColumn
...
let panelController9 x ~willBeginResizingColumn self = msg_send ~self ~cmd:(selector "panelController:willBeginResizingColumn:") ~typ:(id @-> llong @-> returning (void)) x willBeginResizingColumn
...
let panelController14 x ~requestResizeColumn ~toWidth self = msg_send ~self ~cmd:(selector "panelController:requestResizeColumn:toWidth:") ~typ:(id @-> llong @-> double @-> returning (void)) x requestResizeColumn toWidth
...
let sendColumnShowHideNotificationsForNewState x ~newDisplayMode ~oldDisplayMode self = msg_send ~self ~cmd:(selector "sendColumnShowHideNotificationsForNewState:newDisplayMode:oldDisplayMode:") ~typ:(id @-> llong @-> llong @-> returning (void)) x newDisplayMode oldDisplayMode
let sendWillHideColumn x self = msg_send ~self ~cmd:(selector "sendWillHideColumn:") ~typ:(llong @-> returning (void)) x
let sendWillShowColumn x self = msg_send ~self ~cmd:(selector "sendWillShowColumn:") ~typ:(llong @-> returning (void)) x
...
let setUserGeneratedDisplayMode x self = msg_send ~self ~cmd:(selector "setUserGeneratedDisplayMode:") ~typ:(llong @-> returning (void)) x
...
let updatePanelControllerForViewControllerChangeInColumn x self = msg_send ~self ~cmd:(selector "updatePanelControllerForViewControllerChangeInColumn:") ~typ:(llong @-> returning (void)) x
let updatePanelControllerForViewControllerChangeInColumn' x ~alwaysAnimate self = msg_send ~self ~cmd:(selector "updatePanelControllerForViewControllerChangeInColumn:alwaysAnimate:") ~typ:(llong @-> bool @-> returning (void)) x alwaysAnimate
