...
let setFloatingKeyboardEdgeInsets x self = msg_send ~self ~cmd:(selector "setFloatingKeyboardEdgeInsets:") ~typ:(ptr void @-> returning (void)) x
...
let setSelectionEdgeInsets x self = msg_send ~self ~cmd:(selector "setSelectionEdgeInsets:") ~typ:(ptr void @-> returning (void)) x
