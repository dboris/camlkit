...
let _class_ = get_class "UITextInputTraits"

module Class = struct
  let accessibleAppearanceForAppearance x self = msg_send ~self ~cmd:(selector "accessibleAppearanceForAppearance:") ~typ:(llong @-> returning (llong)) x
  let configuredAppearanceForAppearance x ~withTraitEnvironment self = msg_send ~self ~cmd:(selector "configuredAppearanceForAppearance:withTraitEnvironment:") ~typ:(llong @-> id @-> returning (llong)) x withTraitEnvironment
  let defaultTextInputTraits self = msg_send ~self ~cmd:(selector "defaultTextInputTraits") ~typ:(returning (id))
  let keyboardTypeRequiresASCIICapable x self = msg_send ~self ~cmd:(selector "keyboardTypeRequiresASCIICapable:") ~typ:(llong @-> returning (bool)) x
  ...
  let translateToUIAutocapitalizationType x self = msg_send ~self ~cmd:(selector "translateToUIAutocapitalizationType:") ~typ:(ullong @-> returning (llong)) x
  let translateToUIAutocorrectionType x self = msg_send ~self ~cmd:(selector "translateToUIAutocorrectionType:") ~typ:(ullong @-> returning (llong)) x
  let translateToUIKeyboardAppearance x self = msg_send ~self ~cmd:(selector "translateToUIKeyboardAppearance:") ~typ:(ullong @-> returning (llong)) x
  let translateToUIKeyboardType x self = msg_send ~self ~cmd:(selector "translateToUIKeyboardType:") ~typ:(ullong @-> returning (llong)) x
  let translateToUIReturnKeyType x self = msg_send ~self ~cmd:(selector "translateToUIReturnKeyType:") ~typ:(ullong @-> returning (llong)) x
  ...
  let translateToUISpellCheckingType x self = msg_send ~self ~cmd:(selector "translateToUISpellCheckingType:") ~typ:(ullong @-> returning (llong)) x
  let translateToUITextScriptType x self = msg_send ~self ~cmd:(selector "translateToUITextScriptType:") ~typ:(ullong @-> returning (llong)) x
end
...
let setAutocapitalizationType x self = msg_send ~self ~cmd:(selector "setAutocapitalizationType:") ~typ:(llong @-> returning (void)) x
...
let setForceDictationKeyboardType x self = msg_send ~self ~cmd:(selector "setForceDictationKeyboardType:") ~typ:(llong @-> returning (void)) x
...
let setInsertionPointWidth x self = msg_send ~self ~cmd:(selector "setInsertionPointWidth:") ~typ:(ullong @-> returning (void)) x
...
let setPreferredKeyboardStyle x self = msg_send ~self ~cmd:(selector "setPreferredKeyboardStyle:") ~typ:(llong @-> returning (void)) x
...
let setReturnKeyType x self = msg_send ~self ~cmd:(selector "setReturnKeyType:") ~typ:(llong @-> returning (void)) x
...
let setTextScriptType x self = msg_send ~self ~cmd:(selector "setTextScriptType:") ~typ:(llong @-> returning (void)) x
...
let setTextTrimmingSet x self = msg_send ~self ~cmd:(selector "setTextTrimmingSet:") ~typ:(id @-> returning (void)) x
...
let textTrimmingSet self = msg_send ~self ~cmd:(selector "textTrimmingSet") ~typ:(returning (id))
