...
let _class_ = get_class "UIInputContextHistory"
...
let mostRecentTextEntries x self = msg_send ~self ~cmd:(selector "mostRecentTextEntries:") ~typ:(ullong @-> returning (id)) x
