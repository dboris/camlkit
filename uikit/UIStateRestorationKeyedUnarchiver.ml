...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistaterestorationkeyedunarchiver?language=objc}UIStateRestorationKeyedUnarchiver} *)

let self = get_class "UIStateRestorationKeyedUnarchiver"
