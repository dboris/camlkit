...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uipanelcontroller?language=objc}UIPanelController} *)
...
let setAdditionalSidebarSafeAreaInsets x self = msg_send ~self ~cmd:(selector "setAdditionalSidebarSafeAreaInsets:") ~typ:(UIEdgeInsets.t @-> returning void) x
