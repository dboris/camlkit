...
let cursorInteraction x ~cursorForGestureRecognizerState self = msg_send ~self ~cmd:(selector "cursorInteraction:cursorForGestureRecognizerState:") ~typ:(id @-> llong @-> returning (id)) x cursorForGestureRecognizerState
