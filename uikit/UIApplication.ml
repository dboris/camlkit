...
module Class = struct
  ...
  let stringForInterfaceOrientation x self = msg_send ~self ~cmd:(selector "stringForInterfaceOrientation:") ~typ:(llong @-> returning (id)) x
  let stringForStatusBarStyle x self = msg_send ~self ~cmd:(selector "stringForStatusBarStyle:") ~typ:(llong @-> returning (id)) x
  let stringForStatusBarStyleOverrides x self = msg_send ~self ~cmd:(selector "stringForStatusBarStyleOverrides:") ~typ:(ullong @-> returning (id)) x
end
...
let _GSKeyboardForHWLayout2 x ~senderID ~forceRebuild ~createIfNeeded self = msg_send ~self ~cmd:(selector "GSKeyboardForHWLayout:senderID:forceRebuild:createIfNeeded:") ~typ:(id @-> ullong @-> bool @-> bool @-> returning (ptr void)) x senderID forceRebuild createIfNeeded
...
let endBackgroundTask x self = msg_send ~self ~cmd:(selector "endBackgroundTask:") ~typ:(ullong @-> returning (void)) x
...
let overriddenRequestedStyleFromStyle x self = msg_send ~self ~cmd:(selector "overriddenRequestedStyleFromStyle:") ~typ:(llong @-> returning (llong)) x
...
let repeatedActionWillInvokeWithObject x ~forPhase self = msg_send ~self ~cmd:(selector "repeatedActionWillInvokeWithObject:forPhase:") ~typ:(id @-> ullong @-> returning (id)) x forPhase
...
let rotateIfNeeded x self = msg_send ~self ~cmd:(selector "rotateIfNeeded:") ~typ:(llong @-> returning (bool)) x
let rotateIfNeeded1 x ~completion self = msg_send ~self ~cmd:(selector "rotateIfNeeded:completion:") ~typ:(llong @-> ptr void @-> returning (void)) x completion
let rotateIfNeeded2 x ~before ~after self = msg_send ~self ~cmd:(selector "rotateIfNeeded:before:after:") ~typ:(llong @-> ptr void @-> ptr void @-> returning (void)) x before after
...
let setDoubleHeightStatusText' x ~forStyle self = msg_send ~self ~cmd:(selector "setDoubleHeightStatusText:forStyle:") ~typ:(id @-> llong @-> returning (void)) x forStyle
...
let setGlowAnimationEnabled x ~forStyle self = msg_send ~self ~cmd:(selector "setGlowAnimationEnabled:forStyle:") ~typ:(bool @-> llong @-> returning (void)) x forStyle
...
let setStatusBarHidden4 x ~withAnimation self = msg_send ~self ~cmd:(selector "setStatusBarHidden:withAnimation:") ~typ:(bool @-> llong @-> returning (void)) x withAnimation
...
let setStatusBarOrientation x self = msg_send ~self ~cmd:(selector "setStatusBarOrientation:") ~typ:(llong @-> returning (void)) x
let setStatusBarOrientation1 x ~animated self = msg_send ~self ~cmd:(selector "setStatusBarOrientation:animated:") ~typ:(llong @-> bool @-> returning (void)) x animated
let setStatusBarOrientation2 x ~animationParameters self = msg_send ~self ~cmd:(selector "setStatusBarOrientation:animationParameters:") ~typ:(llong @-> id @-> returning (void)) x animationParameters
let setStatusBarOrientation3 x ~animation ~duration self = msg_send ~self ~cmd:(selector "setStatusBarOrientation:animation:duration:") ~typ:(llong @-> int @-> double @-> returning (void)) x animation duration
let setStatusBarOrientation4 x ~fromOrientation ~windowScene ~animationParameters ~updateBlock self = msg_send ~self ~cmd:(selector "setStatusBarOrientation:fromOrientation:windowScene:animationParameters:updateBlock:") ~typ:(llong @-> llong @-> id @-> id @-> ptr void @-> returning (void)) x fromOrientation windowScene animationParameters updateBlock
let setStatusBarShowsProgress x self = msg_send ~self ~cmd:(selector "setStatusBarShowsProgress:") ~typ:(bool @-> returning (void)) x
let setStatusBarStyle x self = msg_send ~self ~cmd:(selector "setStatusBarStyle:") ~typ:(llong @-> returning (void)) x
let setStatusBarStyle1 x ~animated self = msg_send ~self ~cmd:(selector "setStatusBarStyle:animated:") ~typ:(llong @-> bool @-> returning (void)) x animated
let setStatusBarStyle2 x ~animation self = msg_send ~self ~cmd:(selector "setStatusBarStyle:animation:") ~typ:(llong @-> int @-> returning (void)) x animation
let setStatusBarStyle3 x ~animationParameters self = msg_send ~self ~cmd:(selector "setStatusBarStyle:animationParameters:") ~typ:(llong @-> id @-> returning (void)) x animationParameters
let setStatusBarStyle4 x ~duration self = msg_send ~self ~cmd:(selector "setStatusBarStyle:duration:") ~typ:(llong @-> double @-> returning (void)) x duration
let setStatusBarStyle5 x ~animation ~startTime ~duration ~curve self = msg_send ~self ~cmd:(selector "setStatusBarStyle:animation:startTime:duration:curve:") ~typ:(llong @-> int @-> double @-> double @-> llong @-> returning (void)) x animation startTime duration curve
...
let statusBar1 x ~effectiveStyleOverridesForRequestedStyle ~overrides self = msg_send ~self ~cmd:(selector "statusBar:effectiveStyleOverridesForRequestedStyle:overrides:") ~typ:(id @-> llong @-> ullong @-> returning (ullong)) x effectiveStyleOverridesForRequestedStyle overrides
let statusBar2 x ~styleForRequestedStyle ~overrides self = msg_send ~self ~cmd:(selector "statusBar:styleForRequestedStyle:overrides:") ~typ:(id @-> llong @-> ullong @-> returning (llong)) x styleForRequestedStyle overrides
...
let statusBarFrameForOrientation x self = msg_send_stret ~self ~cmd:(selector "statusBarFrameForOrientation:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let statusBarHeight self = msg_send ~self ~cmd:(selector "statusBarHeight") ~typ:(returning (double))
let statusBarHeightForOrientation x self = msg_send ~self ~cmd:(selector "statusBarHeightForOrientation:") ~typ:(llong @-> returning (double)) x
let statusBarHeightForOrientation' x ~ignoreHidden self = msg_send ~self ~cmd:(selector "statusBarHeightForOrientation:ignoreHidden:") ~typ:(llong @-> bool @-> returning (double)) x ignoreHidden
