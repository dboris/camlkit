...
module Class = struct
  let backgroundColorForBlurEffectStyle x self = msg_send ~self ~cmd:(selector "backgroundColorForBlurEffectStyle:") ~typ:(llong @-> returning (id)) x
  let focusedTextColorForBlurEffectStyle x self = msg_send ~self ~cmd:(selector "focusedTextColorForBlurEffectStyle:") ~typ:(llong @-> returning (id)) x
  let unfocusedTextColorForBlurEffectStyle x self = msg_send ~self ~cmd:(selector "unfocusedTextColorForBlurEffectStyle:") ~typ:(llong @-> returning (id)) x
end
...
let setInputText x ~withBlurStyle self = msg_send ~self ~cmd:(selector "setInputText:withBlurStyle:") ~typ:(id @-> llong @-> returning (void)) x withBlurStyle
