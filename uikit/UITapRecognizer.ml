...
let self = get_class "UITapRecognizer"
...
let locationInView' x ~focusSystem self = msg_send ~self ~cmd:(selector "locationInView:focusSystem:") ~typ:(id @-> id @-> returning CGPoint.t) x focusSystem
