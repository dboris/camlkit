...
let _class_ = get_class "UIPopoverController"
...
let presentPopoverFromBarButtonItem x ~permittedArrowDirections ~animated self = msg_send ~self ~cmd:(selector "presentPopoverFromBarButtonItem:permittedArrowDirections:animated:") ~typ:(id @-> ullong @-> bool @-> returning (void)) x permittedArrowDirections animated
let presentPopoverFromRect x ~inView ~permittedArrowDirections ~animated self = msg_send ~self ~cmd:(selector "presentPopoverFromRect:inView:permittedArrowDirections:animated:") ~typ:(CGRect.t @-> id @-> ullong @-> bool @-> returning (void)) x inView permittedArrowDirections animated
