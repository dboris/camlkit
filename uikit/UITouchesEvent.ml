...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitouchesevent?language=objc}UITouchesEvent} *)

let self = get_class "UITouchesEvent"
...
let setSingleAllowableExternalTouchPathIndex x self = msg_send ~self ~cmd:(selector "setSingleAllowableExternalTouchPathIndex:") ~typ:(llong @-> returning void) (LLong.of_int x)
