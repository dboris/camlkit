...
let activeTouchPoint self = msg_send ~self ~cmd:(selector "activeTouchPoint") ~typ:(returning CGPoint.t)
...
let applyTouchOffset x self = msg_send ~self ~cmd:(selector "applyTouchOffset:") ~typ:(CGPoint.t @-> returning CGPoint.t) x
...
let basePoint self = msg_send ~self ~cmd:(selector "basePoint") ~typ:(returning CGPoint.t)
...
let caretRectForTextRangeAdjustmentInteraction x self = msg_send ~self ~cmd:(selector "caretRectForTextRangeAdjustmentInteraction:") ~typ:(id @-> returning CGRect.t) x
...
let convertFromMagnifierPoint x self = msg_send ~self ~cmd:(selector "convertFromMagnifierPoint:") ~typ:(CGPoint.t @-> returning CGPoint.t) x
...
let endEdge self = msg_send ~self ~cmd:(selector "endEdge") ~typ:(returning CGRect.t)
let endGrabber self = msg_send ~self ~cmd:(selector "endGrabber") ~typ:(returning id)
let extentPoint self = msg_send ~self ~cmd:(selector "extentPoint") ~typ:(returning CGPoint.t)
...
let initialExtentPoint self = msg_send ~self ~cmd:(selector "initialExtentPoint") ~typ:(returning CGPoint.t)
...
let magnifierPoint self = msg_send ~self ~cmd:(selector "magnifierPoint") ~typ:(returning CGPoint.t)
...
let startEdge self = msg_send ~self ~cmd:(selector "startEdge") ~typ:(returning CGRect.t)
