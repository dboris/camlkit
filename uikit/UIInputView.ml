...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinputview?language=objc}UIInputView} *)

let self = get_class "UIInputView"
...
let backgroundEdgeInsets self = msg_send ~self ~cmd:(selector "backgroundEdgeInsets") ~typ:(returning UIEdgeInsets.t)
...
let leftContentViewSize self = msg_send ~self ~cmd:(selector "leftContentViewSize") ~typ:(returning CGSize.t)
...
let rightContentViewSize self = msg_send ~self ~cmd:(selector "rightContentViewSize") ~typ:(returning CGSize.t)
...
let setBackgroundEdgeInsets x self = msg_send ~self ~cmd:(selector "setBackgroundEdgeInsets:") ~typ:(UIEdgeInsets.t @-> returning void) x
