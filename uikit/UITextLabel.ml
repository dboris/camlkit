...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextlabel?language=objc}UITextLabel} *)

let self = get_class "UITextLabel"
...
let ellipsizedTextSize self = msg_send ~self ~cmd:(selector "ellipsizedTextSize") ~typ:(returning CGSize.t)
