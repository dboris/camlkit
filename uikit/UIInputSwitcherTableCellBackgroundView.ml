...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinputswitchertablecellbackgroundview?language=objc}UIInputSwitcherTableCellBackgroundView} *)

let self = get_class "UIInputSwitcherTableCellBackgroundView"
