...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidraggesturerecognizer?language=objc}UIDragGestureRecognizer} *)

let self = get_class "UIDragGestureRecognizer"
