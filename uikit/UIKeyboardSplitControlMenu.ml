...
let _class_ = get_class "UIKeyboardSplitControlMenu"
...
let visibleItemForIndex x self = msg_send ~self ~cmd:(selector "visibleItemForIndex:") ~typ:(ullong @-> returning (int)) x