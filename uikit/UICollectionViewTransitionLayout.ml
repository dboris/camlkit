...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewtransitionlayout?language=objc}UICollectionViewTransitionLayout} *)

let self = get_class "UICollectionViewTransitionLayout"
