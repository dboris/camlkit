...
let prepareForRotationOfKeyboard x ~toOrientation self = msg_send ~self ~cmd:(selector "prepareForRotationOfKeyboard:toOrientation:") ~typ:(id @-> llong @-> returning (void)) x toOrientation
let prepareForRotationToOrientation x self = msg_send ~self ~cmd:(selector "prepareForRotationToOrientation:") ~typ:(llong @-> returning (void)) x
...
let rotateKeyboard x ~toOrientation self = msg_send ~self ~cmd:(selector "rotateKeyboard:toOrientation:") ~typ:(id @-> llong @-> returning (void)) x toOrientation
let rotateToOrientation x self = msg_send ~self ~cmd:(selector "rotateToOrientation:") ~typ:(llong @-> returning (void)) x
...
let sizeOfInputViewForInputViewSet x ~withInterfaceOrientation self = msg_send ~self ~cmd:(selector "sizeOfInputViewForInputViewSet:withInterfaceOrientation:") ~typ:(id @-> llong @-> returning (CGSize.t)) x withInterfaceOrientation
...
let totalPeripheralSizeForOrientation x self = msg_send ~self ~cmd:(selector "totalPeripheralSizeForOrientation:") ~typ:(llong @-> returning (CGSize.t)) x
