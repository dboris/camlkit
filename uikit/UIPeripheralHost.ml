...
let sizeOfInputViewForInputViewSet x ~withInterfaceOrientation self = msg_send_stret ~self ~cmd:(selector "sizeOfInputViewForInputViewSet:withInterfaceOrientation:") ~typ:(id @-> llong @-> returning (CGSize.t)) ~return_type:CGSize.t x withInterfaceOrientation
...
let totalPeripheralSizeForOrientation x self = msg_send_stret ~self ~cmd:(selector "totalPeripheralSizeForOrientation:") ~typ:(llong @-> returning (CGSize.t)) ~return_type:CGSize.t x
