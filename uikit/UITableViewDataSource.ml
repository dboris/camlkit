...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewdatasource?language=objc}UITableViewDataSource} *)

let self = get_class "UITableViewDataSource"
...
let tableView4 x ~heightForFooterInSection self = msg_send ~self ~cmd:(selector "tableView:heightForFooterInSection:") ~typ:(id @-> llong @-> returning double) x (LLong.of_int heightForFooterInSection)
...
let tableView9 x ~titleForFooterInSection self = msg_send ~self ~cmd:(selector "tableView:titleForFooterInSection:") ~typ:(id @-> llong @-> returning id) x (LLong.of_int titleForFooterInSection)
let tableView10 x ~titleForHeaderInSection self = msg_send ~self ~cmd:(selector "tableView:titleForHeaderInSection:") ~typ:(id @-> llong @-> returning id) x (LLong.of_int titleForHeaderInSection)
