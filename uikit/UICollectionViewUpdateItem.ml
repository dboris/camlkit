...
let _class_ = get_class "UICollectionViewUpdateItem"
...
let initWithAction x ~forIndexPath self = msg_send ~self ~cmd:(selector "initWithAction:forIndexPath:") ~typ:(llong @-> id @-> returning (id)) x forIndexPath
let initWithInitialIndexPath x ~finalIndexPath ~updateAction self = msg_send ~self ~cmd:(selector "initWithInitialIndexPath:finalIndexPath:updateAction:") ~typ:(id @-> id @-> llong @-> returning (id)) x finalIndexPath updateAction
