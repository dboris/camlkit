...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uimulticolumnviewcontroller?language=objc}UIMultiColumnViewController} *)

let self = get_class "UIMultiColumnViewController"
...
let requestColumnCount x ~animated self = msg_send ~self ~cmd:(selector "requestColumnCount:animated:") ~typ:(ullong @-> bool @-> returning void) (ULLong.of_int x) animated
