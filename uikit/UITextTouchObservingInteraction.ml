...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitexttouchobservinginteraction?language=objc}UITextTouchObservingInteraction} *)

let self = get_class "UITextTouchObservingInteraction"
