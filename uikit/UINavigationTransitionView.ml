...
module Class = struct
  let defaultDurationForTransition x self = msg_send ~self ~cmd:(selector "defaultDurationForTransition:") ~typ:(llong @-> returning (double)) x
end
...
let transition x ~toView self = msg_send ~self ~cmd:(selector "transition:toView:") ~typ:(llong @-> id @-> returning (bool)) x toView
let transition' x ~fromView ~toView self = msg_send ~self ~cmd:(selector "transition:fromView:toView:") ~typ:(llong @-> id @-> id @-> returning (bool)) x fromView toView
