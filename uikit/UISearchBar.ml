...
let positionAdjustmentForSearchBarIcon x self = msg_send ~self ~cmd:(selector "positionAdjustmentForSearchBarIcon:") ~typ:(llong @-> returning UIOffset.t) (LLong.of_int x)
...
let searchFieldBackgroundPositionAdjustment self = msg_send ~self ~cmd:(selector "searchFieldBackgroundPositionAdjustment") ~typ:(returning UIOffset.t)
...
let searchTextPositionAdjustment self = msg_send ~self ~cmd:(selector "searchTextPositionAdjustment") ~typ:(returning UIOffset.t)
