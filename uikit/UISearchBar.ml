...
let setPositionAdjustment x ~forSearchBarIcon self = msg_send ~self ~cmd:(selector "setPositionAdjustment:forSearchBarIcon:") ~typ:(ptr void @-> llong @-> returning (void)) x (LLong.of_int forSearchBarIcon)
...
let setSearchFieldBackgroundPositionAdjustment x self = msg_send ~self ~cmd:(selector "setSearchFieldBackgroundPositionAdjustment:") ~typ:(ptr void @-> returning (void)) x
...
let setSearchTextPositionAdjustment x self = msg_send ~self ~cmd:(selector "setSearchTextPositionAdjustment:") ~typ:(ptr void @-> returning (void)) x
