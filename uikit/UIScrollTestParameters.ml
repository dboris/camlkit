...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiscrolltestparameters?language=objc}UIScrollTestParameters} *)

let self = get_class "UIScrollTestParameters"
...
let setIterations x self = msg_send ~self ~cmd:(selector "setIterations:") ~typ:(llong @-> returning void) (LLong.of_int x)
