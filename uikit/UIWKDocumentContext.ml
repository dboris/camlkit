...
let deltaForSelectionRange x self = msg_send ~self ~cmd:(selector "deltaForSelectionRange:") ~typ:(NSRange.t @-> returning (NSRange.t)) x
let enumerateLayoutRects x self = msg_send ~self ~cmd:(selector "enumerateLayoutRects:") ~typ:(ptr void @-> returning (void)) x
let enumerateLayoutRectsWithOptions x ~characterRange ~block self = msg_send ~self ~cmd:(selector "enumerateLayoutRectsWithOptions:characterRange:block:") ~typ:(ullong @-> NSRange.t @-> ptr void @-> returning (void)) x characterRange block
let init self = msg_send ~self ~cmd:(selector "init") ~typ:(returning (id))
let markedText self = msg_send ~self ~cmd:(selector "markedText") ~typ:(returning (id))
let markedTextRange self = msg_send ~self ~cmd:(selector "markedTextRange") ~typ:(returning (NSRange.t))
let rangeContainedWithinRect x self = msg_send ~self ~cmd:(selector "rangeContainedWithinRect:") ~typ:(CGRect.t @-> returning (NSRange.t)) x
let resetTextRects self = msg_send ~self ~cmd:(selector "resetTextRects") ~typ:(returning (void))
let selectedRangeInMarkedText self = msg_send ~self ~cmd:(selector "selectedRangeInMarkedText") ~typ:(returning (NSRange.t))
let selectedText self = msg_send ~self ~cmd:(selector "selectedText") ~typ:(returning (id))
let selectedTextRange self = msg_send ~self ~cmd:(selector "selectedTextRange") ~typ:(returning (NSRange.t))
