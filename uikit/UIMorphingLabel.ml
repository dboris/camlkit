...
let dstRangeOfAlignmentHunkAtIndex x self = msg_send_stret ~self ~cmd:(selector "dstRangeOfAlignmentHunkAtIndex:") ~typ:(ullong @-> returning (NSRange.t)) ~return_type:NSRange.t x
...
let srcRangeOfAlignmentHunkAtIndex x self = msg_send_stret ~self ~cmd:(selector "srcRangeOfAlignmentHunkAtIndex:") ~typ:(ullong @-> returning (NSRange.t)) ~return_type:NSRange.t x
