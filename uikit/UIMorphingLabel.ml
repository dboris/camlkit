...
let dstRangeOfAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "dstRangeOfAlignmentHunkAtIndex:") ~typ:(ullong @-> returning NSRange.t) (ULLong.of_int x)
...
let srcRangeOfAlignmentHunkAtIndex x self = msg_send ~self ~cmd:(selector "srcRangeOfAlignmentHunkAtIndex:") ~typ:(ullong @-> returning NSRange.t) (ULLong.of_int x)
