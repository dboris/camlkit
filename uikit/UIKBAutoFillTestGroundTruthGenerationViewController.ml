...
let _class_ = get_class "UIKBAutoFillTestGroundTruthGenerationViewController"
...
let taggerView3 x ~didTagFormRequest ~withSelectedType self = msg_send ~self ~cmd:(selector "taggerView:didTagFormRequest:withSelectedType:") ~typ:(id @-> id @-> llong @-> returning (void)) x didTagFormRequest withSelectedType
let taggerView4 x ~didTagTextFieldRequest ~withSelectedType self = msg_send ~self ~cmd:(selector "taggerView:didTagTextFieldRequest:withSelectedType:") ~typ:(id @-> id @-> llong @-> returning (void)) x didTagTextFieldRequest withSelectedType
