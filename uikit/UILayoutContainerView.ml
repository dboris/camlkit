...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uilayoutcontainerview?language=objc}UILayoutContainerView} *)

let self = get_class "UILayoutContainerView"
