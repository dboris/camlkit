...
module Class = struct
  ...
  let defaultSizeWithPromptForOrientation x self = msg_send_stret ~self ~cmd:(selector "defaultSizeWithPromptForOrientation:") ~typ:(llong @-> returning (CGSize.t)) ~return_type:CGSize.t x
end
