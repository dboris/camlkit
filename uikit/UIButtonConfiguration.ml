...
let _class_ = get_class "UIButtonConfiguration"
...
let setButtonSize x self = msg_send ~self ~cmd:(selector "setButtonSize:") ~typ:(llong @-> returning (void)) x
let setCornerStyle x self = msg_send ~self ~cmd:(selector "setCornerStyle:") ~typ:(llong @-> returning (void)) x
...
let setImagePlacement x self = msg_send ~self ~cmd:(selector "setImagePlacement:") ~typ:(ullong @-> returning (void)) x
let setImageReservation x self = msg_send ~self ~cmd:(selector "setImageReservation:") ~typ:(double @-> returning (void)) x
let setMacIdiomStyle x self = msg_send ~self ~cmd:(selector "setMacIdiomStyle:") ~typ:(llong @-> returning (void)) x
...
let setSubtitleLineBreakMode x self = msg_send ~self ~cmd:(selector "setSubtitleLineBreakMode:") ~typ:(llong @-> returning (void)) x
...
let setTitleLineBreakMode x self = msg_send ~self ~cmd:(selector "setTitleLineBreakMode:") ~typ:(llong @-> returning (void)) x
