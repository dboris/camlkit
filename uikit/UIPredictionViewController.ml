...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uipredictionviewcontroller?language=objc}UIPredictionViewController} *)

let self = get_class "UIPredictionViewController"
