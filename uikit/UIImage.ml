...
let capInsets self = msg_send ~self ~cmd:(selector "capInsets") ~typ:(returning UIEdgeInsets.t)
...
let padding self = msg_send ~self ~cmd:(selector "padding") ~typ:(returning UIEdgeInsets.t)
