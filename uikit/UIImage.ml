...
module C = struct
  ...
  let animatedResizableImageNamed x ~capInsets ~duration self = msg_send ~self ~cmd:(selector "animatedResizableImageNamed:capInsets:duration:") ~typ:(id @-> ptr void @-> double @-> returning (id)) x capInsets duration
  let animatedResizableImageNamed' x ~capInsets ~resizingMode ~duration self = msg_send ~self ~cmd:(selector "animatedResizableImageNamed:capInsets:resizingMode:duration:") ~typ:(id @-> ptr void @-> llong @-> double @-> returning (id)) x capInsets (LLong.of_int resizingMode) duration
  ...
  let imageWithCGImage' x ~scale ~orientation self = msg_send ~self ~cmd:(selector "imageWithCGImage:scale:orientation:") ~typ:(id @-> double @-> llong @-> returning (id)) x scale (LLong.of_int orientation)
...
let draw3PartImageWithSliceRects x ~inRect self = msg_send ~self ~cmd:(selector "draw3PartImageWithSliceRects:inRect:") ~typ:(ptr void @-> CGRect.t @-> returning (void)) x inRect
let draw3PartImageWithSliceRects1 x ~inRect ~fraction self = msg_send ~self ~cmd:(selector "draw3PartImageWithSliceRects:inRect:fraction:") ~typ:(ptr void @-> CGRect.t @-> double @-> returning (void)) x inRect fraction
let draw3PartImageWithSliceRects2 x ~inRect ~operation ~fraction self = msg_send ~self ~cmd:(selector "draw3PartImageWithSliceRects:inRect:operation:fraction:") ~typ:(ptr void @-> CGRect.t @-> int @-> double @-> returning (void)) x inRect operation fraction
let draw9PartImageWithSliceRects x ~inRect self = msg_send ~self ~cmd:(selector "draw9PartImageWithSliceRects:inRect:") ~typ:(ptr void @-> CGRect.t @-> returning (void)) x inRect
let draw9PartImageWithSliceRects1 x ~inRect ~fraction self = msg_send ~self ~cmd:(selector "draw9PartImageWithSliceRects:inRect:fraction:") ~typ:(ptr void @-> CGRect.t @-> double @-> returning (void)) x inRect fraction
let draw9PartImageWithSliceRects2 x ~inRect ~operation ~fraction self = msg_send ~self ~cmd:(selector "draw9PartImageWithSliceRects:inRect:operation:fraction:") ~typ:(ptr void @-> CGRect.t @-> int @-> double @-> returning (void)) x inRect operation fraction
...
let imageByAddingContentInsets x self = msg_send ~self ~cmd:(selector "imageByAddingContentInsets:") ~typ:(ptr void @-> returning (id)) x
let imageByAddingPadding x self = msg_send ~self ~cmd:(selector "imageByAddingPadding:") ~typ:(ptr void @-> returning (id)) x
...
let imageWithAlignmentRectInsets x self = msg_send ~self ~cmd:(selector "imageWithAlignmentRectInsets:") ~typ:(ptr void @-> returning (id)) x
...
let imageWithContentInsets x self = msg_send ~self ~cmd:(selector "imageWithContentInsets:") ~typ:(ptr void @-> returning (id)) x
...
let imageWithPadding x self = msg_send ~self ~cmd:(selector "imageWithPadding:") ~typ:(ptr void @-> returning (id)) x
...
let initWithCGImage1 x ~imageOrientation self = msg_send ~self ~cmd:(selector "initWithCGImage:imageOrientation:") ~typ:(id @-> llong @-> returning (id)) x (LLong.of_int imageOrientation)
let initWithCGImage2 x ~scale ~orientation self = msg_send ~self ~cmd:(selector "initWithCGImage:scale:orientation:") ~typ:(id @-> double @-> llong @-> returning (id)) x scale (LLong.of_int orientation)
...
let resizableImageWithCapInsets x self = msg_send ~self ~cmd:(selector "resizableImageWithCapInsets:") ~typ:(ptr void @-> returning (id)) x
let resizableImageWithCapInsets' x ~resizingMode self = msg_send ~self ~cmd:(selector "resizableImageWithCapInsets:resizingMode:") ~typ:(ptr void @-> llong @-> returning (id)) x (LLong.of_int resizingMode)
