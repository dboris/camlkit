...
let collectionView4 x ~layout ~sizeForItemAtIndexPath self = msg_send ~self ~cmd:(selector "collectionView:layout:sizeForItemAtIndexPath:") ~typ:(id @-> id @-> id @-> returning (CGSize.t)) x layout sizeForItemAtIndexPath
