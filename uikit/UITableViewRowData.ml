...
let rectForFooterInSection x ~heightCanBeGuessed self = msg_send_stret ~self ~cmd:(selector "rectForFooterInSection:heightCanBeGuessed:") ~typ:(llong @-> bool @-> returning (CGRect.t)) ~return_type:CGRect.t x heightCanBeGuessed
let rectForGap self = msg_send_stret ~self ~cmd:(selector "rectForGap") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
let rectForGlobalRow x ~heightCanBeGuessed self = msg_send_stret ~self ~cmd:(selector "rectForGlobalRow:heightCanBeGuessed:") ~typ:(llong @-> bool @-> returning (CGRect.t)) ~return_type:CGRect.t x heightCanBeGuessed
let rectForHeaderInSection x ~heightCanBeGuessed self = msg_send_stret ~self ~cmd:(selector "rectForHeaderInSection:heightCanBeGuessed:") ~typ:(llong @-> bool @-> returning (CGRect.t)) ~return_type:CGRect.t x heightCanBeGuessed
let rectForRow x ~inSection ~heightCanBeGuessed self = msg_send_stret ~self ~cmd:(selector "rectForRow:inSection:heightCanBeGuessed:") ~typ:(llong @-> llong @-> bool @-> returning (CGRect.t)) ~return_type:CGRect.t x inSection heightCanBeGuessed
