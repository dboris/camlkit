...
let dropLocationForPoint x ~atIndexPath ~withInsets self = msg_send ~self ~cmd:(selector "dropLocationForPoint:atIndexPath:withInsets:") ~typ:(CGPoint.t @-> id @-> ptr void @-> returning (llong)) x atIndexPath withInsets
