...
let initWithAppearance x self = msg_send ~self ~cmd:(selector "initWithAppearance:") ~typ:(llong @-> returning (id)) x
...
let setFooterMode x self = msg_send ~self ~cmd:(selector "setFooterMode:") ~typ:(llong @-> returning (void)) x
let setHeaderMode x self = msg_send ~self ~cmd:(selector "setHeaderMode:") ~typ:(llong @-> returning (void)) x
