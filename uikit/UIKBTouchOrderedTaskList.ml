...
module Class = struct
  let taskListForTouchUUID x ~withPathIndex self = msg_send ~self ~cmd:(selector "taskListForTouchUUID:withPathIndex:") ~typ:(id @-> ullong @-> returning (id)) x withPathIndex
end
...
let firstTouchStateForUITouchPhase x self = msg_send ~self ~cmd:(selector "firstTouchStateForUITouchPhase:") ~typ:(llong @-> returning (id)) x
...
let initWithTouchUUID x ~withPathIndex self = msg_send ~self ~cmd:(selector "initWithTouchUUID:withPathIndex:") ~typ:(id @-> ullong @-> returning (id)) x withPathIndex
