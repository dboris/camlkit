...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidocumentpasswordview?language=objc}UIDocumentPasswordView} *)

let self = get_class "UIDocumentPasswordView"
