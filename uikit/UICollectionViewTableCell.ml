...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewtablecell?language=objc}UICollectionViewTableCell} *)

let self = get_class "UICollectionViewTableCell"
...
let separatorInset self = msg_send ~self ~cmd:(selector "separatorInset") ~typ:(returning UIEdgeInsets.t)
