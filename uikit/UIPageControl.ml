...
let indicatorImageForPage x self = msg_send ~self ~cmd:(selector "indicatorImageForPage:") ~typ:(llong @-> returning (id)) x
...
let setIndicatorImage x ~forPage self = msg_send ~self ~cmd:(selector "setIndicatorImage:forPage:") ~typ:(id @-> llong @-> returning (void)) x forPage
let setNumberOfPages x self = msg_send ~self ~cmd:(selector "setNumberOfPages:") ~typ:(llong @-> returning (void)) x
...
let setPreviousPage x self = msg_send ~self ~cmd:(selector "setPreviousPage:") ~typ:(llong @-> returning (void)) x
...
let sizeForNumberOfPages x self = msg_send_stret ~self ~cmd:(selector "sizeForNumberOfPages:") ~typ:(llong @-> returning (CGSize.t)) ~return_type:CGSize.t x
