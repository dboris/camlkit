...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewlistcell?language=objc}UICollectionViewListCell} *)

let self = get_class "UICollectionViewListCell"
