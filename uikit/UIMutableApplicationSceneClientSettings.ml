...
let _class_ = get_class "UIMutableApplicationSceneClientSettings"
...
let setCompatibilityMode x self = msg_send ~self ~cmd:(selector "setCompatibilityMode:") ~typ:(llong @-> returning (void)) x
...
let setControlCenterRevealMode x self = msg_send ~self ~cmd:(selector "setControlCenterRevealMode:") ~typ:(llong @-> returning (void)) x
...
let setDefaultStatusBarStyle x self = msg_send ~self ~cmd:(selector "setDefaultStatusBarStyle:") ~typ:(llong @-> returning (void)) x
...
let setNotificationCenterRevealMode x self = msg_send ~self ~cmd:(selector "setNotificationCenterRevealMode:") ~typ:(llong @-> returning (void)) x
let setPlaybackControlsState x self = msg_send ~self ~cmd:(selector "setPlaybackControlsState:") ~typ:(llong @-> returning (void)) x
let setPreferredPointerLockStatus x self = msg_send ~self ~cmd:(selector "setPreferredPointerLockStatus:") ~typ:(llong @-> returning (void)) x
let setProximityDetectionModes x self = msg_send ~self ~cmd:(selector "setProximityDetectionModes:") ~typ:(ullong @-> returning (void)) x
...
let setSceneActivationBias x self = msg_send ~self ~cmd:(selector "setSceneActivationBias:") ~typ:(llong @-> returning (void)) x
let setScreenEdgesDeferringSystemGestures x self = msg_send ~self ~cmd:(selector "setScreenEdgesDeferringSystemGestures:") ~typ:(ullong @-> returning (void)) x
...
let setStatusBarModernStyle x self = msg_send ~self ~cmd:(selector "setStatusBarModernStyle:") ~typ:(llong @-> returning (void)) x
...
let setVisibleMiniAlertCount x self = msg_send ~self ~cmd:(selector "setVisibleMiniAlertCount:") ~typ:(ullong @-> returning (void)) x
let setWantsExclusiveForeground x self = msg_send ~self ~cmd:(selector "setWantsExclusiveForeground:") ~typ:(bool @-> returning (void)) x
let setWhitePointAdaptivityStyle x self = msg_send ~self ~cmd:(selector "setWhitePointAdaptivityStyle:") ~typ:(llong @-> returning (void)) x
