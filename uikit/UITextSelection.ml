...
let _class_ = get_class "UITextSelection"
...
let alterSelection x ~granularity self = msg_send ~self ~cmd:(selector "alterSelection:granularity:") ~typ:(CGPoint.t @-> llong @-> returning (void)) x granularity
let alterSelectionGranularity x self = msg_send ~self ~cmd:(selector "alterSelectionGranularity:") ~typ:(llong @-> returning (void)) x
...
let caretRectAtBeginOfDocument self = msg_send_stret ~self ~cmd:(selector "caretRectAtBeginOfDocument") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
let caretRectAtEndOfDocument self = msg_send_stret ~self ~cmd:(selector "caretRectAtEndOfDocument") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
...
let closestCaretRectForPoint x ~inSelection self = msg_send_stret ~self ~cmd:(selector "closestCaretRectForPoint:inSelection:") ~typ:(CGPoint.t @-> bool @-> returning (CGRect.t)) ~return_type:CGRect.t x inSelection
...
let setGranularity x self = msg_send ~self ~cmd:(selector "setGranularity:") ~typ:(llong @-> returning (void)) x
