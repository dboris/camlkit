...
let addInputString' x ~withFlags self = msg_send ~self ~cmd:(selector "addInputString:withFlags:") ~typ:(id @-> ullong @-> returning (void)) x withFlags
...
let dragInteraction5 x ~session ~didEndWithOperation self = msg_send ~self ~cmd:(selector "dragInteraction:session:didEndWithOperation:") ~typ:(id @-> id @-> ullong @-> returning (void)) x session didEndWithOperation
...
let drawPage x ~withPaginationInfo self = msg_send ~self ~cmd:(selector "drawPage:withPaginationInfo:") ~typ:(ullong @-> id @-> returning (void)) x withPaginationInfo
...
let readDataFromPasteboard x ~withIndex self = msg_send ~self ~cmd:(selector "readDataFromPasteboard:withIndex:") ~typ:(id @-> llong @-> returning (id)) x withIndex
...
let sendOrientationEventForOrientation x self = msg_send ~self ~cmd:(selector "sendOrientationEventForOrientation:") ~typ:(llong @-> returning (void)) x
...
let setCurrentDragSourceAction x self = msg_send ~self ~cmd:(selector "setCurrentDragSourceAction:") ~typ:(ullong @-> returning (void)) x
...
let setRenderTreeSizeThresholdForReset x self = msg_send ~self ~cmd:(selector "setRenderTreeSizeThresholdForReset:") ~typ:(ullong @-> returning (void)) x
let setSelectedDOMRange x ~affinity self = msg_send ~self ~cmd:(selector "setSelectedDOMRange:affinity:") ~typ:(id @-> ullong @-> returning (void)) x affinity
