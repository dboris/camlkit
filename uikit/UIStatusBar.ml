...
let _class_ = get_class "UIStatusBar"

module Class = struct
  let defaultStyleForRequestedStyle x ~styleOverrides self = msg_send ~self ~cmd:(selector "defaultStyleForRequestedStyle:styleOverrides:") ~typ:(llong @-> ullong @-> returning (llong)) x styleOverrides
...
let currentStyleRequestForStyle x self = msg_send ~self ~cmd:(selector "currentStyleRequestForStyle:") ~typ:(llong @-> returning (id)) x
...
let frameForOrientation x self = msg_send ~self ~cmd:(selector "frameForOrientation:") ~typ:(llong @-> returning (CGRect.t)) x
...
let requestStyle x ~animation ~startTime ~duration ~curve self = msg_send ~self ~cmd:(selector "requestStyle:animation:startTime:duration:curve:") ~typ:(llong @-> int @-> double @-> double @-> llong @-> returning (void)) x animation startTime duration curve
...
let statusBarServer x ~didReceiveStyleOverrides self = msg_send ~self ~cmd:(selector "statusBarServer:didReceiveStyleOverrides:") ~typ:(id @-> ullong @-> returning (void)) x didReceiveStyleOverrides
let statusBarServer1 x ~didReceiveDoubleHeightStatusString ~forStyle self = msg_send ~self ~cmd:(selector "statusBarServer:didReceiveDoubleHeightStatusString:forStyle:") ~typ:(id @-> id @-> llong @-> returning (void)) x didReceiveDoubleHeightStatusString forStyle
let statusBarServer2 x ~didReceiveGlowAnimationState ~forStyle self = msg_send ~self ~cmd:(selector "statusBarServer:didReceiveGlowAnimationState:forStyle:") ~typ:(id @-> bool @-> llong @-> returning (void)) x didReceiveGlowAnimationState forStyle
let statusBarStateProvider x ~didChangeDoubleHeightStatusStringForStyle self = msg_send ~self ~cmd:(selector "statusBarStateProvider:didChangeDoubleHeightStatusStringForStyle:") ~typ:(id @-> llong @-> returning (void)) x didChangeDoubleHeightStatusStringForStyle
