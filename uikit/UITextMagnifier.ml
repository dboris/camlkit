...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextmagnifier?language=objc}UITextMagnifier} *)

let self = get_class "UITextMagnifier"
...
let animationPoint self = msg_send ~self ~cmd:(selector "animationPoint") ~typ:(returning CGPoint.t)
...
let magnificationPoint self = msg_send ~self ~cmd:(selector "magnificationPoint") ~typ:(returning CGPoint.t)
...
let terminalPoint self = msg_send ~self ~cmd:(selector "terminalPoint") ~typ:(returning CGPoint.t)
