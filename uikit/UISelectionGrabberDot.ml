...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiselectiongrabberdot?language=objc}UISelectionGrabberDot} *)

let self = get_class "UISelectionGrabberDot"
