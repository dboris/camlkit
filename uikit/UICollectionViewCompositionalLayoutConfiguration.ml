...
let initWithScrollDirection x ~interSectionSpacing ~boundarySupplememtaryItems ~contentInsetsReference self = msg_send ~self ~cmd:(selector "initWithScrollDirection:interSectionSpacing:boundarySupplememtaryItems:contentInsetsReference:") ~typ:(llong @-> double @-> id @-> llong @-> returning (id)) x interSectionSpacing boundarySupplememtaryItems contentInsetsReference
...
let setContentInsetsReference x self = msg_send ~self ~cmd:(selector "setContentInsetsReference:") ~typ:(llong @-> returning (void)) x
