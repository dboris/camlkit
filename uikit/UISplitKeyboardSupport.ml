...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uisplitkeyboardsupport?language=objc}UISplitKeyboardSupport} *)

let self = get_class "UISplitKeyboardSupport"
