...
let rawSize self = msg_send ~self ~cmd:(selector "rawSize") ~typ:(returning (CGSize.t))
...
let setBaselineAdjustment x self = msg_send ~self ~cmd:(selector "setBaselineAdjustment:") ~typ:(llong @-> returning (void)) x
...
let setLineSpacing x self = msg_send ~self ~cmd:(selector "setLineSpacing:") ~typ:(llong @-> returning (void)) x
...
let textRectForBounds' x ~limitedToNumberOfLines self = msg_send ~self ~cmd:(selector "textRectForBounds:limitedToNumberOfLines:") ~typ:(CGRect.t @-> llong @-> returning (CGRect.t)) x limitedToNumberOfLines
let textSize self = msg_send ~self ~cmd:(selector "textSize") ~typ:(returning (CGSize.t))
let textSizeForWidth x self = msg_send ~self ~cmd:(selector "textSizeForWidth:") ~typ:(double @-> returning (CGSize.t)) x
