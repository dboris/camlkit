...
let _class_ = get_class "UIPercentDrivenInteractiveTransition"
...
let setCompletionCurve x self = msg_send ~self ~cmd:(selector "setCompletionCurve:") ~typ:(llong @-> returning (void)) x
