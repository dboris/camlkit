...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebselectmultiplepicker?language=objc}UIWebSelectMultiplePicker} *)

let self = get_class "UIWebSelectMultiplePicker"
