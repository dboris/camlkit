...
let _class_ = get_class "UIDatePicker"
...
let setDatePickerMode x self = msg_send ~self ~cmd:(selector "setDatePickerMode:") ~typ:(llong @-> returning (void)) x
...
let setMinuteInterval x self = msg_send ~self ~cmd:(selector "setMinuteInterval:") ~typ:(llong @-> returning (void)) x
let setPreferredDatePickerStyle x self = msg_send ~self ~cmd:(selector "setPreferredDatePickerStyle:") ~typ:(llong @-> returning (void)) x
