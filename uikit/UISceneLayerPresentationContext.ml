...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiscenelayerpresentationcontext?language=objc}UISceneLayerPresentationContext} *)

let self = get_class "UISceneLayerPresentationContext"
