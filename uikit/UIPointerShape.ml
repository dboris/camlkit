...
let inherentConstrainedSlip self = msg_send ~self ~cmd:(selector "inherentConstrainedSlip") ~typ:(returning (CGPoint.t))
...
let pinnedPoint self = msg_send ~self ~cmd:(selector "pinnedPoint") ~typ:(returning (CGPoint.t))
