...
let setBadgePositionAdjustment x self = msg_send ~self ~cmd:(selector "setBadgePositionAdjustment:") ~typ:(ptr void @-> returning (void)) x
let setBadgeTextAttributes x self = msg_send ~self ~cmd:(selector "setBadgeTextAttributes:") ~typ:(id @-> returning (void)) x
let setBadgeTitlePositionAdjustment x self = msg_send ~self ~cmd:(selector "setBadgeTitlePositionAdjustment:") ~typ:(ptr void @-> returning (void)) x
