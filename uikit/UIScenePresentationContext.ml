...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiscenepresentationcontext?language=objc}UIScenePresentationContext} *)

let self = get_class "UIScenePresentationContext"
