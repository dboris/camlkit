...
let rectForFooterInSection x self = msg_send_stret ~self ~cmd:(selector "rectForFooterInSection:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let rectForHeaderInSection x self = msg_send_stret ~self ~cmd:(selector "rectForHeaderInSection:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
...
let rectForSection x self = msg_send_stret ~self ~cmd:(selector "rectForSection:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
