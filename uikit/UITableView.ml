...
let deleteRowsAtIndexPaths x ~withRowAnimation self = msg_send ~self ~cmd:(selector "deleteRowsAtIndexPaths:withRowAnimation:") ~typ:(id @-> llong @-> returning (void)) x withRowAnimation
let deleteSections x ~withRowAnimation self = msg_send ~self ~cmd:(selector "deleteSections:withRowAnimation:") ~typ:(id @-> llong @-> returning (void)) x withRowAnimation
...
let footerViewForSection x self = msg_send ~self ~cmd:(selector "footerViewForSection:") ~typ:(llong @-> returning (id)) x
...
let headerViewForSection x self = msg_send ~self ~cmd:(selector "headerViewForSection:") ~typ:(llong @-> returning (id)) x
...
let highlightRowAtIndexPath x ~animated ~scrollPosition self = msg_send ~self ~cmd:(selector "highlightRowAtIndexPath:animated:scrollPosition:") ~typ:(id @-> bool @-> llong @-> returning (bool)) x animated scrollPosition
...
let indexBarAccessoryView x ~contentOffsetForEntry ~atIndex self = msg_send ~self ~cmd:(selector "indexBarAccessoryView:contentOffsetForEntry:atIndex:") ~typ:(id @-> id @-> llong @-> returning (CGPoint.t)) x contentOffsetForEntry atIndex
let indexFrame self = msg_send ~self ~cmd:(selector "indexFrame") ~typ:(returning (CGRect.t))
...
let insertRowsAtIndexPaths x ~withRowAnimation self = msg_send ~self ~cmd:(selector "insertRowsAtIndexPaths:withRowAnimation:") ~typ:(id @-> llong @-> returning (void)) x withRowAnimation
let insertSections x ~withRowAnimation self = msg_send ~self ~cmd:(selector "insertSections:withRowAnimation:") ~typ:(id @-> llong @-> returning (void)) x withRowAnimation
...
let rectForFooterInSection x self = msg_send ~self ~cmd:(selector "rectForFooterInSection:") ~typ:(llong @-> returning (CGRect.t)) x
let rectForHeaderInSection x self = msg_send ~self ~cmd:(selector "rectForHeaderInSection:") ~typ:(llong @-> returning (CGRect.t)) x
let rectForRowAtIndexPath x self = msg_send ~self ~cmd:(selector "rectForRowAtIndexPath:") ~typ:(id @-> returning (CGRect.t)) x
...
let reloadRowsAtIndexPaths x ~withRowAnimation self = msg_send ~self ~cmd:(selector "reloadRowsAtIndexPaths:withRowAnimation:") ~typ:(id @-> llong @-> returning (void)) x withRowAnimation
let reloadSectionIndexTitles self = msg_send ~self ~cmd:(selector "reloadSectionIndexTitles") ~typ:(returning (void))
let reloadSections x ~withRowAnimation self = msg_send ~self ~cmd:(selector "reloadSections:withRowAnimation:") ~typ:(id @-> llong @-> returning (void)) x withRowAnimation
...
let scrollToNearestSelectedRowAtScrollPosition x ~animated self = msg_send ~self ~cmd:(selector "scrollToNearestSelectedRowAtScrollPosition:animated:") ~typ:(llong @-> bool @-> returning (void)) x animated
let scrollToRowAtIndexPath x ~atScrollPosition ~animated self = msg_send ~self ~cmd:(selector "scrollToRowAtIndexPath:atScrollPosition:animated:") ~typ:(id @-> llong @-> bool @-> returning (void)) x atScrollPosition animated
...
let setCountStringInsignificantRowCount x self = msg_send ~self ~cmd:(selector "setCountStringInsignificantRowCount:") ~typ:(ullong @-> returning (void)) x
...
let setSectionIndexMinimumDisplayRowCount x self = msg_send ~self ~cmd:(selector "setSectionIndexMinimumDisplayRowCount:") ~typ:(llong @-> returning (void)) x
...
let setSeparatorInsetReference x self = msg_send ~self ~cmd:(selector "setSeparatorInsetReference:") ~typ:(llong @-> returning (void)) x
...
let swipeActionController13 x ~swipeOccurrence ~didChangeStateFrom ~to_ self = msg_send ~self ~cmd:(selector "swipeActionController:swipeOccurrence:didChangeStateFrom:to:") ~typ:(id @-> id @-> llong @-> llong @-> returning (void)) x swipeOccurrence didChangeStateFrom to_
