...
let rectForFooterInSection x self = msg_send ~self ~cmd:(selector "rectForFooterInSection:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
let rectForHeaderInSection x self = msg_send ~self ~cmd:(selector "rectForHeaderInSection:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
...
let swipeActionController2 x ~extraInsetsForItemAtIndexPath self = msg_send ~self ~cmd:(selector "swipeActionController:extraInsetsForItemAtIndexPath:") ~typ:(id @-> id @-> returning UIEdgeInsets.t) x extraInsetsForItemAtIndexPath
