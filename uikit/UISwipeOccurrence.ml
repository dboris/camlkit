...
let performPrimaryActionWithSwipeInfo x self = msg_send ~self ~cmd:(selector "performPrimaryActionWithSwipeInfo:") ~typ:(ptr void @-> returning (void)) x
...
let setCurrentSwipeInfo x self = msg_send ~self ~cmd:(selector "setCurrentSwipeInfo:") ~typ:(ptr void @-> returning (void)) x
let setExtraInsets x self = msg_send ~self ~cmd:(selector "setExtraInsets:") ~typ:(ptr void @-> returning (void)) x
...
let updateOffsetWithSwipeInfo x ~isTracking ~completion self = msg_send ~self ~cmd:(selector "updateOffsetWithSwipeInfo:isTracking:completion:") ~typ:(ptr void @-> bool @-> ptr void @-> returning (void)) x isTracking completion
