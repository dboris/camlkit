...
let _class_ = get_class "UISystemInputViewController"
...
module Class = struct
  ...
  let setKeyboardInteractionModel x self = msg_send ~self ~cmd:(selector "setKeyboardInteractionModel:") ~typ:(ullong @-> returning (void)) x
...
let accessoryViewControllerForEdge x self = msg_send ~self ~cmd:(selector "accessoryViewControllerForEdge:") ~typ:(llong @-> returning (id)) x
let alignmentConstraintArrayForAxis x self = msg_send ~self ~cmd:(selector "alignmentConstraintArrayForAxis:") ~typ:(llong @-> returning (id)) x
let alignmentConstraintForAxis x self = msg_send ~self ~cmd:(selector "alignmentConstraintForAxis:") ~typ:(llong @-> returning (id)) x
...
let constraintFromView x ~attribute ~toView ~attribute_ self = msg_send ~self ~cmd:(selector "constraintFromView:attribute:toView:attribute:") ~typ:(id @-> llong @-> id @-> llong @-> returning (id)) x attribute toView attribute_
let constraintsForEdge x self = msg_send ~self ~cmd:(selector "constraintsForEdge:") ~typ:(llong @-> returning (id)) x
...
let setAccessoryViewController x ~forEdge self = msg_send ~self ~cmd:(selector "setAccessoryViewController:forEdge:") ~typ:(id @-> llong @-> returning (void)) x forEdge
let setAlignmentConstraint x ~forAxis self = msg_send ~self ~cmd:(selector "setAlignmentConstraint:forAxis:") ~typ:(id @-> llong @-> returning (void)) x forAxis
let setAlignmentConstraintArray x ~forAxis self = msg_send ~self ~cmd:(selector "setAlignmentConstraintArray:forAxis:") ~typ:(id @-> llong @-> returning (void)) x forAxis
let setBlurEffectStyle x self = msg_send ~self ~cmd:(selector "setBlurEffectStyle:") ~typ:(llong @-> returning (void)) x
let setCachedRecents x self = msg_send ~self ~cmd:(selector "setCachedRecents:") ~typ:(id @-> returning (void)) x
let setConstraints x ~forEdge self = msg_send ~self ~cmd:(selector "setConstraints:forEdge:") ~typ:(id @-> llong @-> returning (void)) x forEdge
...
let setResolvedKeyboardStyle x self = msg_send ~self ~cmd:(selector "setResolvedKeyboardStyle:") ~typ:(llong @-> returning (void)) x
