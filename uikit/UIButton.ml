...
let _class_ = get_class "UIButton"
...
module Class = struct
  ...
  let buttonWithType x self = msg_send ~self ~cmd:(selector "buttonWithType:") ~typ:(llong @-> returning (id)) x
  let buttonWithType' x ~primaryAction self = msg_send ~self ~cmd:(selector "buttonWithType:primaryAction:") ~typ:(llong @-> id @-> returning (id)) x primaryAction
...
let attributedTitleForState x self = msg_send ~self ~cmd:(selector "attributedTitleForState:") ~typ:(ullong @-> returning (id)) x
...
let crossfadeToImage x ~forState self = msg_send ~self ~cmd:(selector "crossfadeToImage:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
...
let imageForState x self = msg_send ~self ~cmd:(selector "imageForState:") ~typ:(ullong @-> returning (id)) x
...
let preferredSymbolConfigurationForImageInState x self = msg_send ~self ~cmd:(selector "preferredSymbolConfigurationForImageInState:") ~typ:(ullong @-> returning (id)) x
...
let setBackgroundImage' x ~forStates self = msg_send ~self ~cmd:(selector "setBackgroundImage:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
...
let setImage' x ~forStates self = msg_send ~self ~cmd:(selector "setImage:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
...
let setTitle1 x ~forState self = msg_send ~self ~cmd:(selector "setTitle:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
let setTitle2 x ~forStates self = msg_send ~self ~cmd:(selector "setTitle:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
let setTitleColor x ~forState self = msg_send ~self ~cmd:(selector "setTitleColor:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
let setTitleColor' x ~forStates self = msg_send ~self ~cmd:(selector "setTitleColor:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
let setTitleShadowColor x ~forState self = msg_send ~self ~cmd:(selector "setTitleShadowColor:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
let setTitleShadowColor' x ~forStates self = msg_send ~self ~cmd:(selector "setTitleShadowColor:forStates:") ~typ:(id @-> ullong @-> returning (void)) x forStates
...
let titleColorForState x self = msg_send ~self ~cmd:(selector "titleColorForState:") ~typ:(ullong @-> returning (id)) x
let titleForState x self = msg_send ~self ~cmd:(selector "titleForState:") ~typ:(ullong @-> returning (id)) x
...
let titleShadowColorForState x self = msg_send ~self ~cmd:(selector "titleShadowColorForState:") ~typ:(ullong @-> returning (id)) x
