...
let setContentEdgeInsets x self = msg_send ~self ~cmd:(selector "setContentEdgeInsets:") ~typ:(ptr void @-> returning (void)) x
...
let setImageEdgeInsets x self = msg_send ~self ~cmd:(selector "setImageEdgeInsets:") ~typ:(ptr void @-> returning (void)) x
...
let setTitleEdgeInsets x self = msg_send ~self ~cmd:(selector "setTitleEdgeInsets:") ~typ:(ptr void @-> returning (void)) x
