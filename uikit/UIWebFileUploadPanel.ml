...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebfileuploadpanel?language=objc}UIWebFileUploadPanel} *)

let self = get_class "UIWebFileUploadPanel"
