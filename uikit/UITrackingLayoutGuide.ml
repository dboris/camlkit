...
let _class_ = get_class "UITrackingLayoutGuide"
...
let constraintsActiveWhenAwayFromEdge x self = msg_send ~self ~cmd:(selector "constraintsActiveWhenAwayFromEdge:") ~typ:(ullong @-> returning (id)) x
let constraintsActiveWhenNearEdge x self = msg_send ~self ~cmd:(selector "constraintsActiveWhenNearEdge:") ~typ:(ullong @-> returning (id)) x
...
let pauseUpdatingConstraintsForEdges x self = msg_send ~self ~cmd:(selector "pauseUpdatingConstraintsForEdges:") ~typ:(ullong @-> returning (void)) x
...
let setAnimationOptions x self = msg_send ~self ~cmd:(selector "setAnimationOptions:") ~typ:(ullong @-> returning (void)) x
...
let setConstraints x ~activeWhenAwayFromEdge self = msg_send ~self ~cmd:(selector "setConstraints:activeWhenAwayFromEdge:") ~typ:(id @-> ullong @-> returning (void)) x activeWhenAwayFromEdge
let setConstraints' x ~activeWhenNearEdge self = msg_send ~self ~cmd:(selector "setConstraints:activeWhenNearEdge:") ~typ:(id @-> ullong @-> returning (void)) x activeWhenNearEdge
let setNearEdgeConstraintsByEdge x self = msg_send ~self ~cmd:(selector "setNearEdgeConstraintsByEdge:") ~typ:(id @-> returning (void)) x
let setOverlappingEdges x self = msg_send ~self ~cmd:(selector "setOverlappingEdges:") ~typ:(ullong @-> returning (void)) x
let setOwningViewInterfaceLayoutDirection x self = msg_send ~self ~cmd:(selector "setOwningViewInterfaceLayoutDirection:") ~typ:(llong @-> returning (void)) x
let setPausedEdges x self = msg_send ~self ~cmd:(selector "setPausedEdges:") ~typ:(ullong @-> returning (void)) x
let startUpdatingConstraintsForEdges x self = msg_send ~self ~cmd:(selector "startUpdatingConstraintsForEdges:") ~typ:(ullong @-> returning (void)) x
let stopTrackingConstraintsForEdge x self = msg_send ~self ~cmd:(selector "stopTrackingConstraintsForEdge:") ~typ:(ullong @-> returning (void)) x
...
let updateAnimationDuration x ~options self = msg_send ~self ~cmd:(selector "updateAnimationDuration:options:") ~typ:(double @-> ullong @-> returning (void)) x options
