...
let setEdgeThresholds x ~forOrientation self = msg_send ~self ~cmd:(selector "setEdgeThresholds:forOrientation:") ~typ:(ptr void @-> llong @-> returning (void)) x (LLong.of_int forOrientation)
...
let setProportionalEdgeThresholds x self = msg_send ~self ~cmd:(selector "setProportionalEdgeThresholds:") ~typ:(ptr void @-> returning (void)) x
let setTriggerInsetsForLandscape x self = msg_send ~self ~cmd:(selector "setTriggerInsetsForLandscape:") ~typ:(ptr void @-> returning (void)) x
let setTriggerInsetsForPortrait x self = msg_send ~self ~cmd:(selector "setTriggerInsetsForPortrait:") ~typ:(ptr void @-> returning (void)) x
let setTriggerProportions x self = msg_send ~self ~cmd:(selector "setTriggerProportions:") ~typ:(ptr void @-> returning (void)) x
