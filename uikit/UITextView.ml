...
let _class_ = get_class "UITextView"
...
let addSnapshotSeparation x ~withAffinity self = msg_send ~self ~cmd:(selector "addSnapshotSeparation:withAffinity:") ~typ:(double @-> llong @-> returning (void)) x withAffinity
...
let marginTop self = msg_send ~self ~cmd:(selector "marginTop") ~typ:(returning (ullong))
...
let rectInTextContainerForRect x self = msg_send ~self ~cmd:(selector "rectInTextContainerForRect:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
...
let selectedRangeForTextContainerView x self = msg_send ~self ~cmd:(selector "selectedRangeForTextContainerView:") ~typ:(id @-> returning (NSRange.t)) x
...
let setMarginTop x self = msg_send ~self ~cmd:(selector "setMarginTop:") ~typ:(ullong @-> returning (void)) x
...
let textContainerView' x ~linkTextAttributesForLink ~forCharacterAtIndex self = msg_send ~self ~cmd:(selector "textContainerView:linkTextAttributesForLink:forCharacterAtIndex:") ~typ:(id @-> id @-> ullong @-> returning (id)) x linkTextAttributesForLink forCharacterAtIndex
...
let visibleRectIgnoringKeyboard self = msg_send ~self ~cmd:(selector "visibleRectIgnoringKeyboard") ~typ:(returning (CGRect.t))
