...
let _class_ = get_class "UITableCellAccessoryLayout"
...
let endLayout self = msg_send ~self ~cmd:(selector "endLayout") ~typ:(returning (CGRect.t))
...
let finalFrameForAccessory x self = msg_send ~self ~cmd:(selector "finalFrameForAccessory:") ~typ:(id @-> returning (CGRect.t)) x
...
let initialFrameForAccessory x self = msg_send ~self ~cmd:(selector "initialFrameForAccessory:") ~typ:(id @-> returning (CGRect.t)) x
...
let totalFrame self = msg_send ~self ~cmd:(selector "totalFrame") ~typ:(returning (CGRect.t))