...
let _class_ = get_class "UITextSelectionInteraction"
...
let initWithMode x self = msg_send ~self ~cmd:(selector "initWithMode:") ~typ:(llong @-> returning (id)) x
let initWithMode' x ~indirect self = msg_send ~self ~cmd:(selector "initWithMode:indirect:") ~typ:(llong @-> bool @-> returning (id)) x indirect
...
let tappedToPositionCursorWithGesture x ~atPoint ~granularity ~completionHandler self = msg_send ~self ~cmd:(selector "tappedToPositionCursorWithGesture:atPoint:granularity:completionHandler:") ~typ:(id @-> CGPoint.t @-> llong @-> ptr void @-> returning (void)) x atPoint granularity completionHandler
let tappedToSelectTextWithGesture x ~atPoint ~granularity ~completionHandler self = msg_send ~self ~cmd:(selector "tappedToSelectTextWithGesture:atPoint:granularity:completionHandler:") ~typ:(id @-> CGPoint.t @-> llong @-> ptr void @-> returning (void)) x atPoint granularity completionHandler
let tappedToUpdateSelectionWithGesture x ~atPoint ~granularity ~completionHandler self = msg_send ~self ~cmd:(selector "tappedToUpdateSelectionWithGesture:atPoint:granularity:completionHandler:") ~typ:(id @-> CGPoint.t @-> llong @-> ptr void @-> returning (void)) x atPoint granularity completionHandler
