...
let appendName3 x ~integerValue self = msg_send ~self ~cmd:(selector "appendName:integerValue:") ~typ:(id @-> llong @-> returning (id)) x integerValue
...
let appendName7 x ~unsignedInteger self = msg_send ~self ~cmd:(selector "appendName:unsignedInteger:") ~typ:(id @-> ullong @-> returning (id)) x unsignedInteger
