...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardpreferencescontroller?language=objc}UIKeyboardPreferencesController} *)

let self = get_class "UIKeyboardPreferencesController"
