...
let badgeTextAttributesForState x self = msg_send ~self ~cmd:(selector "badgeTextAttributesForState:") ~typ:(ullong @-> returning (id)) x
...
let initWithTabBarSystemItem x ~tag self = msg_send ~self ~cmd:(selector "initWithTabBarSystemItem:tag:") ~typ:(llong @-> llong @-> returning (id)) x tag
...
let initWithTitle' x ~image ~tag self = msg_send ~self ~cmd:(selector "initWithTitle:image:tag:") ~typ:(id @-> id @-> llong @-> returning (id)) x image tag
...
let setBadgeTextAttributes x ~forState self = msg_send ~self ~cmd:(selector "setBadgeTextAttributes:forState:") ~typ:(id @-> ullong @-> returning (void)) x forState
