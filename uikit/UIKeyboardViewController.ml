...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardviewcontroller?language=objc}UIKeyboardViewController} *)

let self = get_class "UIKeyboardViewController"
...
let initWithServiceRole x self = msg_send ~self ~cmd:(selector "initWithServiceRole:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
