...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uimorelistcontroller?language=objc}UIMoreListController} *)

let self = get_class "UIMoreListController"
