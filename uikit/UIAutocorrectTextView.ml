...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiautocorrecttextview?language=objc}UIAutocorrectTextView} *)

let self = get_class "UIAutocorrectTextView"
