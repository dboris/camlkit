...
let setAccessibilityContrast x self = msg_send ~self ~cmd:(selector "setAccessibilityContrast:") ~typ:(llong @-> returning (void)) x
...
let setDeactivationReasons x self = msg_send ~self ~cmd:(selector "setDeactivationReasons:") ~typ:(ullong @-> returning (void)) x
let setDefaultStatusBarHeight x ~forOrientation self = msg_send ~self ~cmd:(selector "setDefaultStatusBarHeight:forOrientation:") ~typ:(double @-> llong @-> returning (void)) x forOrientation
let setDeviceOrientation x self = msg_send ~self ~cmd:(selector "setDeviceOrientation:") ~typ:(llong @-> returning (void)) x
...
let setInterfaceOrientationMode x self = msg_send ~self ~cmd:(selector "setInterfaceOrientationMode:") ~typ:(llong @-> returning (void)) x
let setPersistenceIdentifier x self = msg_send ~self ~cmd:(selector "setPersistenceIdentifier:") ~typ:(id @-> returning (void)) x
let setPointerLockStatus x self = msg_send ~self ~cmd:(selector "setPointerLockStatus:") ~typ:(llong @-> returning (void)) x
let setScenePresenterRenderIdentifierForSnapshotting x self = msg_send ~self ~cmd:(selector "setScenePresenterRenderIdentifierForSnapshotting:") ~typ:(ullong @-> returning (void)) x
...
let setStatusBarParts x self = msg_send ~self ~cmd:(selector "setStatusBarParts:") ~typ:(llong @-> returning (void)) x
let setStatusBarStyleOverridesToSuppress x self = msg_send ~self ~cmd:(selector "setStatusBarStyleOverridesToSuppress:") ~typ:(ullong @-> returning (void)) x
