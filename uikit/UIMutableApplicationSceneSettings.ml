...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uimutableapplicationscenesettings?language=objc}UIMutableApplicationSceneSettings} *)

let self = get_class "UIMutableApplicationSceneSettings"
...
let peripheryInsets self = msg_send ~self ~cmd:(selector "peripheryInsets") ~typ:(returning UIEdgeInsets.t)
...
let safeAreaInsetsLandscapeLeft self = msg_send ~self ~cmd:(selector "safeAreaInsetsLandscapeLeft") ~typ:(returning UIEdgeInsets.t)
let safeAreaInsetsLandscapeRight self = msg_send ~self ~cmd:(selector "safeAreaInsetsLandscapeRight") ~typ:(returning UIEdgeInsets.t)
let safeAreaInsetsPortrait self = msg_send ~self ~cmd:(selector "safeAreaInsetsPortrait") ~typ:(returning UIEdgeInsets.t)
let safeAreaInsetsPortraitUpsideDown self = msg_send ~self ~cmd:(selector "safeAreaInsetsPortraitUpsideDown") ~typ:(returning UIEdgeInsets.t)
...
let setPeripheryInsets x self = msg_send ~self ~cmd:(selector "setPeripheryInsets:") ~typ:(UIEdgeInsets.t @-> returning void) x
...
let setSafeAreaInsetsLandscapeLeft x self = msg_send ~self ~cmd:(selector "setSafeAreaInsetsLandscapeLeft:") ~typ:(UIEdgeInsets.t @-> returning void) x
let setSafeAreaInsetsLandscapeRight x self = msg_send ~self ~cmd:(selector "setSafeAreaInsetsLandscapeRight:") ~typ:(UIEdgeInsets.t @-> returning void) x
let setSafeAreaInsetsPortrait x self = msg_send ~self ~cmd:(selector "setSafeAreaInsetsPortrait:") ~typ:(UIEdgeInsets.t @-> returning void) x
let setSafeAreaInsetsPortraitUpsideDown x self = msg_send ~self ~cmd:(selector "setSafeAreaInsetsPortraitUpsideDown:") ~typ:(UIEdgeInsets.t @-> returning void) x
