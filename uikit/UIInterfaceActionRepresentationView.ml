...
let _class_ = get_class "UIInterfaceActionRepresentationView"
...
let setVisualCornerPosition x self = msg_send ~self ~cmd:(selector "setVisualCornerPosition:") ~typ:(ullong @-> returning (void)) x
