...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinputswitchersegmentcontrol?language=objc}UIInputSwitcherSegmentControl} *)

let self = get_class "UIInputSwitcherSegmentControl"
