...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uipopoverpresentationcontroller?language=objc}UIPopoverPresentationController} *)

let self = get_class "UIPopoverPresentationController"
...
let popoverLayoutMargins self = msg_send ~self ~cmd:(selector "popoverLayoutMargins") ~typ:(returning UIEdgeInsets.t)
