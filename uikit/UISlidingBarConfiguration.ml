...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uislidingbarconfiguration?language=objc}UISlidingBarConfiguration} *)

let self = get_class "UISlidingBarConfiguration"
