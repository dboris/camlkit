...
let pointForGestureState x ~point ~translation self = msg_send ~self ~cmd:(selector "pointForGestureState:point:translation:") ~typ:(llong @-> CGPoint.t @-> CGPoint.t @-> returning (CGPoint.t)) x point translation
