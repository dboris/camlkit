...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uislidingbarstaterequest?language=objc}UISlidingBarStateRequest} *)

let self = get_class "UISlidingBarStateRequest"
