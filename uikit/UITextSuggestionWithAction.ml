...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextsuggestionwithaction?language=objc}UITextSuggestionWithAction} *)

let self = get_class "UITextSuggestionWithAction"
