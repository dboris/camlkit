...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinterfaceactiongroupviewstate?language=objc}UIInterfaceActionGroupViewState} *)

let self = get_class "UIInterfaceActionGroupViewState"
