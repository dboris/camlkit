...
let _class_ = get_class "UIFlickingAssistantViewSupport"
...
let barOriginFromTouchPoint x self = msg_send_stret ~self ~cmd:(selector "barOriginFromTouchPoint:") ~typ:(CGPoint.t @-> returning (CGPoint.t)) ~return_type:CGPoint.t x
...
let keyboardOriginFromAssistantViewPosition x self = msg_send_stret ~self ~cmd:(selector "keyboardOriginFromAssistantViewPosition:") ~typ:(llong @-> returning (CGPoint.t)) ~return_type:CGPoint.t x
let panGestureHandler x self = msg_send ~self ~cmd:(selector "panGestureHandler:") ~typ:(id @-> returning (void)) x
let projectedLandingPointForGestureRecognizerEnd x self = msg_send_stret ~self ~cmd:(selector "projectedLandingPointForGestureRecognizerEnd:") ~typ:(id @-> returning (CGPoint.t)) ~return_type:CGPoint.t x
...
let setDraggingState x self = msg_send ~self ~cmd:(selector "setDraggingState:") ~typ:(llong @-> returning (void)) x
let setRemotePlacement x self = msg_send ~self ~cmd:(selector "setRemotePlacement:") ~typ:(id @-> returning (void)) x
let transitToDraggingVisualState x ~withTouchLocation self = msg_send ~self ~cmd:(selector "transitToDraggingVisualState:withTouchLocation:") ~typ:(llong @-> CGPoint.t @-> returning (void)) x withTouchLocation
