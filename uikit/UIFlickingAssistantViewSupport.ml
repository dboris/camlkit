...
let keyboardOriginFromAssistantViewPosition x self = msg_send_stret ~self ~cmd:(selector "keyboardOriginFromAssistantViewPosition:") ~typ:(llong @-> returning (CGPoint.t)) ~return_type:CGPoint.t (LLong.of_int x)
