...
let _class_ = get_class "UIHoverEvent"
...
let hoverTouchForContextId x ~pathIndex self = msg_send ~self ~cmd:(selector "hoverTouchForContextId:pathIndex:") ~typ:(uint @-> llong @-> returning (id)) x pathIndex
let removeHoverTouchForContextId x ~pathIndex self = msg_send ~self ~cmd:(selector "removeHoverTouchForContextId:pathIndex:") ~typ:(uint @-> llong @-> returning (void)) x pathIndex
...
let setHoverTouch x ~forContextId ~pathIndex self = msg_send ~self ~cmd:(selector "setHoverTouch:forContextId:pathIndex:") ~typ:(id @-> uint @-> llong @-> returning (void)) x forContextId pathIndex
