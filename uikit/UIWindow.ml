...
let _class_ = get_class "UIWindow"
...
module Class = struct
  ...
  let createIOSurfaceOnScreen x ~withContextIds ~count ~frame ~usePurpleGfx ~outTransform self = msg_send ~self ~cmd:(selector "createIOSurfaceOnScreen:withContextIds:count:frame:usePurpleGfx:outTransform:") ~typ:(id @-> ptr (uint) @-> ullong @-> CGRect.t @-> bool @-> ptr void @-> returning (ptr (void))) x withContextIds count frame usePurpleGfx outTransform
  let createIOSurfaceWithContextIds x ~count ~frame self = msg_send ~self ~cmd:(selector "createIOSurfaceWithContextIds:count:frame:") ~typ:(ptr (uint) @-> ullong @-> CGRect.t @-> returning (ptr (void))) x count frame
  let createIOSurfaceWithContextIds1 x ~count ~frame ~outTransform self = msg_send ~self ~cmd:(selector "createIOSurfaceWithContextIds:count:frame:outTransform:") ~typ:(ptr (uint) @-> ullong @-> CGRect.t @-> ptr void @-> returning (ptr (void))) x count frame outTransform
  let createIOSurfaceWithContextIds2 x ~count ~frame ~usePurpleGfx ~outTransform self = msg_send ~self ~cmd:(selector "createIOSurfaceWithContextIds:count:frame:usePurpleGfx:outTransform:") ~typ:(ptr (uint) @-> ullong @-> CGRect.t @-> bool @-> ptr void @-> returning (ptr (void))) x count frame usePurpleGfx outTransform
...
let setupForOrientation x self = msg_send ~self ~cmd:(selector "setupForOrientation:") ~typ:(llong @-> returning (void)) x
...
let updateKeyboardAnimationOptions x ~duration self = msg_send ~self ~cmd:(selector "updateKeyboardAnimationOptions:duration:") ~typ:(ullong @-> double @-> returning (void)) x duration
