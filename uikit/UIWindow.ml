...
module C = struct
  ...
  let createIOSurfaceOnScreen x ~withContextIds ~count ~frame ~baseTransform self = msg_send ~self ~cmd:(selector "createIOSurfaceOnScreen:withContextIds:count:frame:baseTransform:") ~typ:(id @-> ptr (uint) @-> ullong @-> CGRect.t @-> ptr void @-> returning (ptr (void))) x withContextIds (ULLong.of_int count) frame baseTransform
  let createIOSurfaceOnScreen' x ~withContextIds ~count ~frame ~usePurpleGfx ~outTransform self = msg_send ~self ~cmd:(selector "createIOSurfaceOnScreen:withContextIds:count:frame:usePurpleGfx:outTransform:") ~typ:(id @-> ptr (uint) @-> ullong @-> CGRect.t @-> bool @-> ptr void @-> returning (ptr (void))) x withContextIds (ULLong.of_int count) frame usePurpleGfx outTransform
  ...
  let createIOSurfaceWithContextIds1 x ~count ~frame ~outTransform self = msg_send ~self ~cmd:(selector "createIOSurfaceWithContextIds:count:frame:outTransform:") ~typ:(ptr (uint) @-> ullong @-> CGRect.t @-> ptr void @-> returning (ptr (void))) x (ULLong.of_int count) frame outTransform
  let createIOSurfaceWithContextIds2 x ~count ~frame ~usePurpleGfx ~outTransform self = msg_send ~self ~cmd:(selector "createIOSurfaceWithContextIds:count:frame:usePurpleGfx:outTransform:") ~typ:(ptr (uint) @-> ullong @-> CGRect.t @-> bool @-> ptr void @-> returning (ptr (void))) x (ULLong.of_int count) frame usePurpleGfx outTransform
...
let updateKeyboardOffset x self = msg_send ~self ~cmd:(selector "updateKeyboardOffset:") ~typ:(ptr void @-> returning (bool)) x
