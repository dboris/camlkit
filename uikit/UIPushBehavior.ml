...
let setPushDirection x self = msg_send ~self ~cmd:(selector "setPushDirection:") ~typ:(ptr void @-> returning (void)) x
let setTargetOffsetFromCenter x ~forItem self = msg_send ~self ~cmd:(selector "setTargetOffsetFromCenter:forItem:") ~typ:(ptr void @-> id @-> returning (void)) x forItem
