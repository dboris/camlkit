...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uisearchdisplaycontrollercontainerview?language=objc}UISearchDisplayControllerContainerView} *)

let self = get_class "UISearchDisplayControllerContainerView"
