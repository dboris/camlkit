...
let highlightBounds self = msg_send ~self ~cmd:(selector "highlightBounds") ~typ:(returning (CGRect.t))
...
let setDrawingStroke x ~forState self = msg_send ~self ~cmd:(selector "setDrawingStroke:forState:") ~typ:(double @-> ullong @-> returning (void)) x forState
let setEnabled x self = msg_send ~self ~cmd:(selector "setEnabled:") ~typ:(bool @-> returning (void)) x
let setExternalFlatEdge x self = msg_send ~self ~cmd:(selector "setExternalFlatEdge:") ~typ:(ullong @-> returning (void)) x
