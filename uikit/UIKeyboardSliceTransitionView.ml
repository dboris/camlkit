...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardslicetransitionview?language=objc}UIKeyboardSliceTransitionView} *)

let self = get_class "UIKeyboardSliceTransitionView"
...
let getKeyboardImageAsSplit x self = msg_send ~self ~cmd:(selector "getKeyboardImageAsSplit:") ~typ:(bool @-> returning (ptr CGImage.t)) x
