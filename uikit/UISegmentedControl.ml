...
let setContentPositionAdjustment x ~forSegmentType ~barMetrics self = msg_send ~self ~cmd:(selector "setContentPositionAdjustment:forSegmentType:barMetrics:") ~typ:(ptr void @-> llong @-> llong @-> returning (void)) x (LLong.of_int forSegmentType) (LLong.of_int barMetrics)
