...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwillpresentnotificationaction?language=objc}UIWillPresentNotificationAction} *)

let self = get_class "UIWillPresentNotificationAction"
