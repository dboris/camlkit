...
let numberOfMatchesInString x ~options ~range self = msg_send ~self ~cmd:(selector "numberOfMatchesInString:options:range:") ~typ:(id @-> ullong @-> NSRange.t @-> returning ullong) x (ULLong.of_int options) range
...
let rangeOfFirstMatchInString x ~options ~range self = msg_send ~self ~cmd:(selector "rangeOfFirstMatchInString:options:range:") ~typ:(id @-> ullong @-> NSRange.t @-> returning NSRange.t) x (ULLong.of_int options) range
let replaceMatchesInString x ~options ~range ~withTemplate self = msg_send ~self ~cmd:(selector "replaceMatchesInString:options:range:withTemplate:") ~typ:(id @-> ullong @-> NSRange.t @-> id @-> returning ullong) x (ULLong.of_int options) range withTemplate
