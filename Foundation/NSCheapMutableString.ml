...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nscheapmutablestring?language=objc}NSCheapMutableString} *)

let self = get_class "NSCheapMutableString"
