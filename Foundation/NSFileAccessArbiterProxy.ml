...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nsfileaccessarbiterproxy?language=objc}NSFileAccessArbiterProxy} *)

let self = get_class "NSFileAccessArbiterProxy"
