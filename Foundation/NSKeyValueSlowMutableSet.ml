...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nskeyvalueslowmutableset?language=objc}NSKeyValueSlowMutableSet} *)

let self = get_class "NSKeyValueSlowMutableSet"
