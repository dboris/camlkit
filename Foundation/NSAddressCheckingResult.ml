...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nsaddresscheckingresult?language=objc}NSAddressCheckingResult} *)

let self = get_class "NSAddressCheckingResult"
