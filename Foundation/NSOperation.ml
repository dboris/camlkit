...
let decreasePriority self = msg_send ~self ~cmd:(selector "decreasePriority") ~typ:(returning void)
let dependencies self = msg_send ~self ~cmd:(selector "dependencies") ~typ:(returning id)
let description self = msg_send ~self ~cmd:(selector "description") ~typ:(returning id)
let increasePriority self = msg_send ~self ~cmd:(selector "increasePriority") ~typ:(returning void)
