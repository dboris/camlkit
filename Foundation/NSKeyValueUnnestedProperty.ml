...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nskeyvalueunnestedproperty?language=objc}NSKeyValueUnnestedProperty} *)

let self = get_class "NSKeyValueUnnestedProperty"
