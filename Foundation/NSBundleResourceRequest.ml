...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nsbundleresourcerequest?language=objc}NSBundleResourceRequest} *)

let self = get_class "NSBundleResourceRequest"
