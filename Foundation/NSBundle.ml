...
let _URLForMaterialRecipe x self = msg_send ~self ~cmd:(selector "URLForMaterialRecipe:") ~typ:(id @-> returning id) x
let _URLForMaterialRecipeDescendant x self = msg_send ~self ~cmd:(selector "URLForMaterialRecipeDescendant:") ~typ:(id @-> returning id) x
...
let _URLForVisualStyleSet x self = msg_send ~self ~cmd:(selector "URLForVisualStyleSet:") ~typ:(id @-> returning id) x
let _URLForVisualStyleSetDescendant x self = msg_send ~self ~cmd:(selector "URLForVisualStyleSetDescendant:") ~typ:(id @-> returning id) x
let _URLsForImageResource x self = msg_send ~self ~cmd:(selector "URLsForImageResource:") ~typ:(id @-> returning id) x
let _URLsForMaterialRecipeDescendants self = msg_send ~self ~cmd:(selector "URLsForMaterialRecipeDescendants") ~typ:(returning id)
let _URLsForMaterialRecipes self = msg_send ~self ~cmd:(selector "URLsForMaterialRecipes") ~typ:(returning id)
...
let _URLsForVisualStyleSets self = msg_send ~self ~cmd:(selector "URLsForVisualStyleSets") ~typ:(returning id)
...
let dataForResourceName x self = msg_send ~self ~cmd:(selector "dataForResourceName:") ~typ:(id @-> returning id) x
...
let loadNibFile' x ~externalNameTable ~options ~withZone self = msg_send ~self ~cmd:(selector "loadNibFile:externalNameTable:options:withZone:") ~typ:(id @-> id @-> id @-> (ptr void) @-> returning bool) x externalNameTable options withZone
let loadNibNamed x ~owner ~options self = msg_send ~self ~cmd:(selector "loadNibNamed:owner:options:") ~typ:(id @-> id @-> id @-> returning id) x owner options
...
let normalizedLocalizations self = msg_send ~self ~cmd:(selector "normalizedLocalizations") ~typ:(returning id)
