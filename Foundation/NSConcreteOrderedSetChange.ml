...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nsconcreteorderedsetchange?language=objc}NSConcreteOrderedSetChange} *)

let self = get_class "NSConcreteOrderedSetChange"
