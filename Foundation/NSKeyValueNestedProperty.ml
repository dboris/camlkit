...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nskeyvaluenestedproperty?language=objc}NSKeyValueNestedProperty} *)

let self = get_class "NSKeyValueNestedProperty"
