...
let _XMLDataWithOptions x self = msg_send ~self ~cmd:(selector "XMLDataWithOptions:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
...
let initWithData' x ~options ~validExternalEntityURLs ~error self = msg_send ~self ~cmd:(selector "initWithData:options:validExternalEntityURLs:error:") ~typ:(id @-> ullong @-> id @-> (ptr id) @-> returning id) x (ULLong.of_int options) validExternalEntityURLs error
...
let initWithXMLString x ~options ~error self = msg_send ~self ~cmd:(selector "initWithXMLString:options:error:") ~typ:(id @-> ullong @-> (ptr id) @-> returning id) x (ULLong.of_int options) error
...
let setDocumentContentKind x self = msg_send ~self ~cmd:(selector "setDocumentContentKind:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
