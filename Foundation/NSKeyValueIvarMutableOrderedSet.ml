...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nskeyvalueivarmutableorderedset?language=objc}NSKeyValueIvarMutableOrderedSet} *)

let self = get_class "NSKeyValueIvarMutableOrderedSet"
