...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nsconcretesetchanges?language=objc}NSConcreteSetChanges} *)

let self = get_class "NSConcreteSetChanges"
