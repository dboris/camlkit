...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nskeyvaluenotifyingmutablearray?language=objc}NSKeyValueNotifyingMutableArray} *)

let self = get_class "NSKeyValueNotifyingMutableArray"
