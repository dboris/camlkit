...
(** Apple docs: {{:https://developer.apple.com/documentation/coredata/nssqlkeypathtriggerattributeextension?language=objc}NSSQLKeypathTriggerAttributeExtension} *)

let self = get_class "NSSQLKeypathTriggerAttributeExtension"
