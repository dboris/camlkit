...
(** Apple docs: {{:https://developer.apple.com/documentation/coredata/nsbinaryobjectstore?language=objc}NSBinaryObjectStore} *)

let self = get_class "NSBinaryObjectStore"
