...
(** Apple docs: {{:https://developer.apple.com/documentation/coredata/nsbatchupdateresult?language=objc}NSBatchUpdateResult} *)

let self = get_class "NSBatchUpdateResult"
