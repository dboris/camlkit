...
(** Apple docs: {{:https://developer.apple.com/documentation/coredata/nssqlforeignorderkey?language=objc}NSSQLForeignOrderKey} *)

let self = get_class "NSSQLForeignOrderKey"
