...
(** Apple docs: {{:https://developer.apple.com/documentation/coredata/nsbatchdeleteresult?language=objc}NSBatchDeleteResult} *)

let self = get_class "NSBatchDeleteResult"
