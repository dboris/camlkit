...
(** Apple docs: {{:https://developer.apple.com/documentation/coredata/nssqllocationattributertreeextension?language=objc}NSSQLLocationAttributeRTreeExtension} *)

let self = get_class "NSSQLLocationAttributeRTreeExtension"
