...
let allowsExtendedAttributes  self = msg_send ~self ~cmd:(selector "allowsExtendedAttributes") ~typ:(returning (char)) 
let appliesSourcePositionAttributes  self = msg_send ~self ~cmd:(selector "appliesSourcePositionAttributes") ~typ:(returning (char)) 
...
let setAllowsExtendedAttributes ~x self = msg_send ~self ~cmd:(selector "setAllowsExtendedAttributes:") ~typ:(char @-> returning (void)) x
let setAppliesSourcePositionAttributes ~x self = msg_send ~self ~cmd:(selector "setAppliesSourcePositionAttributes:") ~typ:(char @-> returning (void)) x
