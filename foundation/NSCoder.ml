...
let decodeCGPointForKey ~x self = msg_send ~self ~cmd:(selector "decodeCGPointForKey:") ~typ:(id @-> returning (CGPoint.t)) x
let decodeCGRectForKey ~x self = msg_send ~self ~cmd:(selector "decodeCGRectForKey:") ~typ:(id @-> returning (CGRect.t)) x
let decodeCGSizeForKey ~x self = msg_send ~self ~cmd:(selector "decodeCGSizeForKey:") ~typ:(id @-> returning (CGSize.t)) x
...
let encodeUInt64 ~x ~forKey self = msg_send ~self ~cmd:(selector "encodeUInt64:forKey:") ~typ:(ullong @-> id @-> returning (void)) x forKey
...
let validateAllowedClass ~x ~forKey self = msg_send ~self ~cmd:(selector "validateAllowedClass:forKey:") ~typ:(_Class @-> id @-> returning (char)) x forKey
let validateClassSupportsSecureCoding ~x self = msg_send ~self ~cmd:(selector "validateClassSupportsSecureCoding:") ~typ:(_Class @-> returning (char)) x
