...
module Class = struct
  ...
  let decimalNumberWithMantissa ~x ~exponent ~isNegative self = msg_send ~self ~cmd:(selector "decimalNumberWithMantissa:exponent:isNegative:") ~typ:(ullong @-> short @-> bool @-> returning (id)) x exponent isNegative
  ...
  let numberWithChar ~x self = msg_send ~self ~cmd:(selector "numberWithChar:") ~typ:(char @-> returning (id)) x
...
let decimalNumberByRaisingToPower ~x self = msg_send ~self ~cmd:(selector "decimalNumberByRaisingToPower:") ~typ:(ullong @-> returning (id)) x
let decimalNumberByRaisingToPower' ~x ~withBehavior self = msg_send ~self ~cmd:(selector "decimalNumberByRaisingToPower:withBehavior:") ~typ:(ullong @-> id @-> returning (id)) x withBehavior
