...
let _class_ = get_class "NSFileManager"
...
let _URLsForDirectory ~x ~inDomains self = msg_send ~self ~cmd:(selector "URLsForDirectory:inDomains:") ~typ:(ullong @-> ullong @-> returning (id)) x inDomains
...
let contentsOfDirectoryAtURL ~x ~includingPropertiesForKeys ~options ~error self = msg_send ~self ~cmd:(selector "contentsOfDirectoryAtURL:includingPropertiesForKeys:options:error:") ~typ:(id @-> id @-> ullong @-> ptr (id) @-> returning (id)) x includingPropertiesForKeys options error
...
let copyItemAtPath' ~x ~toPath ~options ~error self = msg_send ~self ~cmd:(selector "copyItemAtPath:toPath:options:error:") ~typ:(id @-> id @-> ullong @-> ptr (id) @-> returning (bool)) x toPath options error
...
let copyItemAtURL' ~x ~toURL ~options ~error self = msg_send ~self ~cmd:(selector "copyItemAtURL:toURL:options:error:") ~typ:(id @-> id @-> ullong @-> ptr (id) @-> returning (bool)) x toURL options error
...
let directoryContentsAtPath1 ~x ~matchingExtension ~options ~keepExtension self = msg_send ~self ~cmd:(selector "directoryContentsAtPath:matchingExtension:options:keepExtension:") ~typ:(id @-> id @-> llong @-> bool @-> returning (id)) x matchingExtension options keepExtension
let directoryContentsAtPath2 ~x ~matchingExtension ~options ~keepExtension ~error self = msg_send ~self ~cmd:(selector "directoryContentsAtPath:matchingExtension:options:keepExtension:error:") ~typ:(id @-> id @-> llong @-> bool @-> ptr (id) @-> returning (id)) x matchingExtension options keepExtension error
...
let enumeratorAtURL ~x ~includingPropertiesForKeys ~options ~errorHandler self = msg_send ~self ~cmd:(selector "enumeratorAtURL:includingPropertiesForKeys:options:errorHandler:") ~typ:(id @-> id @-> ullong @-> ptr void @-> returning (id)) x includingPropertiesForKeys options errorHandler
...
let getFileSystemRepresentation ~x ~maxLength ~withPath self = msg_send ~self ~cmd:(selector "getFileSystemRepresentation:maxLength:withPath:") ~typ:(string @-> ullong @-> id @-> returning (bool)) x maxLength withPath
...
let getRelationship' ~x ~ofDirectory ~inDomain ~toItemAtURL ~error self = msg_send ~self ~cmd:(selector "getRelationship:ofDirectory:inDomain:toItemAtURL:error:") ~typ:(ptr (llong) @-> ullong @-> ullong @-> id @-> ptr (id) @-> returning (bool)) x ofDirectory inDomain toItemAtURL error
...
let mountedVolumeURLsIncludingResourceValuesForKeys ~x ~options self = msg_send ~self ~cmd:(selector "mountedVolumeURLsIncludingResourceValuesForKeys:options:") ~typ:(id @-> ullong @-> returning (id)) x options
...
let moveItemAtURL' ~x ~toURL ~options ~error self = msg_send ~self ~cmd:(selector "moveItemAtURL:toURL:options:error:") ~typ:(id @-> id @-> ullong @-> ptr (id) @-> returning (bool)) x toURL options error
...
let stringWithFileSystemRepresentation ~x ~length self = msg_send ~self ~cmd:(selector "stringWithFileSystemRepresentation:length:") ~typ:(string @-> ullong @-> returning (id)) x length
...
let unmountVolumeAtURL ~x ~options ~completionHandler self = msg_send ~self ~cmd:(selector "unmountVolumeAtURL:options:completionHandler:") ~typ:(id @-> ullong @-> ptr void @-> returning (void)) x options completionHandler