...
let initWithBytesNoCopy' ~x ~length ~freeWhenDone self = msg_send ~self ~cmd:(selector "initWithBytesNoCopy:length:freeWhenDone:") ~typ:(ptr (void) @-> ullong @-> char @-> returning (id)) x length freeWhenDone
