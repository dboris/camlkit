...
let compressUsingAlgorithm ~x ~error self = msg_send ~self ~cmd:(selector "compressUsingAlgorithm:error:") ~typ:(llong @-> ptr (id) @-> returning (char)) x error
let decompressUsingAlgorithm ~x ~error self = msg_send ~self ~cmd:(selector "decompressUsingAlgorithm:error:") ~typ:(llong @-> ptr (id) @-> returning (char)) x error
