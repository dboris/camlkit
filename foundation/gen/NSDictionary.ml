...
let containsKey ~x self = msg_send ~self ~cmd:(selector "containsKey:") ~typ:(id @-> returning (char)) x
...
let entriesToStringWithIndent ~x ~debug self = msg_send ~self ~cmd:(selector "entriesToStringWithIndent:debug:") ~typ:(int @-> char @-> returning (id)) x debug
...
let isEqualToDictionary ~x self = msg_send ~self ~cmd:(selector "isEqualToDictionary:") ~typ:(id @-> returning (char)) x
let isEqualToDictionary' ~x ~forKeys self = msg_send ~self ~cmd:(selector "isEqualToDictionary:forKeys:") ~typ:(id @-> id @-> returning (char)) x forKeys
