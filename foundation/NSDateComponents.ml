...
let isSameDayAsComponents ~x self = msg_send ~self ~cmd:(selector "isSameDayAsComponents:") ~typ:(id @-> returning (char)) x
let isSameMonthAsComponents ~x self = msg_send ~self ~cmd:(selector "isSameMonthAsComponents:") ~typ:(id @-> returning (char)) x
let isSameYearAsComponents ~x self = msg_send ~self ~cmd:(selector "isSameYearAsComponents:") ~typ:(id @-> returning (char)) x
let isValidDate  self = msg_send ~self ~cmd:(selector "isValidDate") ~typ:(returning (char))
let isValidDateInCalendar ~x self = msg_send ~self ~cmd:(selector "isValidDateInCalendar:") ~typ:(id @-> returning (char)) x
...
let setLeapMonth ~x self = msg_send ~self ~cmd:(selector "setLeapMonth:") ~typ:(char @-> returning (void)) x
