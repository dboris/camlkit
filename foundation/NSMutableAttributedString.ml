...
let readFromData ~x ~options ~documentAttributes self = msg_send ~self ~cmd:(selector "readFromData:options:documentAttributes:") ~typ:(id @-> id @-> ptr (id) @-> returning (char)) x options documentAttributes
let readFromData' ~x ~options ~documentAttributes ~error self = msg_send ~self ~cmd:(selector "readFromData:options:documentAttributes:error:") ~typ:(id @-> id @-> ptr (id) @-> ptr (id) @-> returning (char)) x options documentAttributes error
let readFromFileURL ~x ~options ~documentAttributes ~error self = msg_send ~self ~cmd:(selector "readFromFileURL:options:documentAttributes:error:") ~typ:(id @-> id @-> ptr (id) @-> ptr (id) @-> returning (char)) x options documentAttributes error
let readFromURL ~x ~options ~documentAttributes self = msg_send ~self ~cmd:(selector "readFromURL:options:documentAttributes:") ~typ:(id @-> id @-> ptr (id) @-> returning (char)) x options documentAttributes
let readFromURL' ~x ~options ~documentAttributes ~error self = msg_send ~self ~cmd:(selector "readFromURL:options:documentAttributes:error:") ~typ:(id @-> id @-> ptr (id) @-> ptr (id) @-> returning (char)) x options documentAttributes error
