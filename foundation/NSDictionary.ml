...
module Class = struct
  ...
  let dictionaryWithObjects' ~x ~forKeys ~count self = msg_send ~self ~cmd:(selector "dictionaryWithObjects:forKeys:count:") ~typ:(ptr (id) @-> ptr (id) @-> ullong @-> returning (id)) x forKeys count
  let dictionaryWithObjectsAndKeys ~x self = msg_send ~self ~cmd:(selector "dictionaryWithObjectsAndKeys:") ~typ:(id @-> returning (id)) x
  let newDictionaryWithObjects ~x ~forKeys ~count self = msg_send ~self ~cmd:(selector "newDictionaryWithObjects:forKeys:count:") ~typ:(ptr (id) @-> ptr (id) @-> ullong @-> returning (id)) x forKeys count
...
let getObjects2 ~x ~andKeys ~count self = msg_send ~self ~cmd:(selector "getObjects:andKeys:count:") ~typ:(ptr (id) @-> ptr (id) @-> ullong @-> returning (void)) x andKeys count
...
let keysSortedByValueWithOptions ~x ~usingComparator self = msg_send ~self ~cmd:(selector "keysSortedByValueWithOptions:usingComparator:") ~typ:(ullong @-> ptr void @-> returning (id)) x usingComparator
