...
let addPublisher ~x ~forID ~withValues ~isOld self = msg_send ~self ~cmd:(selector "addPublisher:forID:withValues:isOld:") ~typ:(id @-> id @-> id @-> char @-> returning (void)) x forID withValues isOld
