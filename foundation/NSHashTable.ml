...
let intersectsHashTable ~x self = msg_send ~self ~cmd:(selector "intersectsHashTable:") ~typ:(id @-> returning (char)) x
let isEqualToHashTable ~x self = msg_send ~self ~cmd:(selector "isEqualToHashTable:") ~typ:(id @-> returning (char)) x
let isSubsetOfHashTable ~x self = msg_send ~self ~cmd:(selector "isSubsetOfHashTable:") ~typ:(id @-> returning (char)) x
