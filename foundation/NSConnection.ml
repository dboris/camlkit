...
let hasRunLoop ~x self = msg_send ~self ~cmd:(selector "hasRunLoop:") ~typ:(id @-> returning (char)) x
let independentConversationQueueing  self = msg_send ~self ~cmd:(selector "independentConversationQueueing") ~typ:(returning (char))
...
let multipleThreadsEnabled  self = msg_send ~self ~cmd:(selector "multipleThreadsEnabled") ~typ:(returning (char))
...
let registerName ~x self = msg_send ~self ~cmd:(selector "registerName:") ~typ:(id @-> returning (char)) x
let registerName' ~x ~withNameServer self = msg_send ~self ~cmd:(selector "registerName:withNameServer:") ~typ:(id @-> id @-> returning (char)) x withNameServer
...
let sendInvocation' ~x ~internal self = msg_send ~self ~cmd:(selector "sendInvocation:internal:") ~typ:(id @-> char @-> returning (void)) x internal
...
let sendWireCountForWireID ~x ~port self = msg_send ~self ~cmd:(selector "sendWireCountForWireID:port:") ~typ:(uint @-> id @-> returning (char)) x port
let setDelegate ~x self = msg_send ~self ~cmd:(selector "setDelegate:") ~typ:(id @-> returning (void)) x
let setIndependentConversationQueueing ~x self = msg_send ~self ~cmd:(selector "setIndependentConversationQueueing:") ~typ:(char @-> returning (void)) x
