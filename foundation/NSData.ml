...
module Class = struct
  ...
  let dataWithBytes x ~length self = msg_send ~self ~cmd:(selector "dataWithBytes:length:") ~typ:(ptr (void) @-> ullong @-> returning (id)) x length
  let dataWithBytesNoCopy x ~length self = msg_send ~self ~cmd:(selector "dataWithBytesNoCopy:length:") ~typ:(ptr (void) @-> ullong @-> returning (id)) x length
  let dataWithBytesNoCopy' x ~length ~freeWhenDone self = msg_send ~self ~cmd:(selector "dataWithBytesNoCopy:length:freeWhenDone:") ~typ:(ptr (void) @-> ullong @-> bool @-> returning (id)) x length freeWhenDone
  let dataWithContentsOfFile x self = msg_send ~self ~cmd:(selector "dataWithContentsOfFile:") ~typ:(id @-> returning (id)) x
  let dataWithContentsOfFile' x ~options ~error self = msg_send ~self ~cmd:(selector "dataWithContentsOfFile:options:error:") ~typ:(id @-> ullong @-> ptr (id) @-> returning (id)) x options error
  ...
  let dataWithContentsOfURL1 x ~options ~error self = msg_send ~self ~cmd:(selector "dataWithContentsOfURL:options:error:") ~typ:(id @-> ullong @-> ptr (id) @-> returning (id)) x options error
  let dataWithContentsOfURL2 x ~options ~maxLength ~error self = msg_send ~self ~cmd:(selector "dataWithContentsOfURL:options:maxLength:error:") ~typ:(id @-> ullong @-> ullong @-> ptr (id) @-> returning (id)) x options maxLength error
...
let initWithBytes1 x ~length ~copy ~deallocator self = msg_send ~self ~cmd:(selector "initWithBytes:length:copy:deallocator:") ~typ:(ptr (void) @-> ullong @-> bool @-> ptr void @-> returning (id)) x length copy deallocator
let initWithBytes2 x ~length ~copy ~freeWhenDone ~bytesAreVM self = msg_send ~self ~cmd:(selector "initWithBytes:length:copy:freeWhenDone:bytesAreVM:") ~typ:(ptr (void) @-> ullong @-> bool @-> bool @-> bool @-> returning (id)) x length copy freeWhenDone bytesAreVM
...
let initWithBytesNoCopy2 x ~length ~freeWhenDone self = msg_send ~self ~cmd:(selector "initWithBytesNoCopy:length:freeWhenDone:") ~typ:(ptr (void) @-> ullong @-> bool @-> returning (id)) x length freeWhenDone
...
let rangeOfData x ~options ~range self = msg_send_stret ~self ~cmd:(selector "rangeOfData:options:range:") ~typ:(id @-> ullong @-> NSRange.t @-> returning (NSRange.t)) ~return_type:NSRange.t x options range
...
let writeToFile2 x ~options ~error self = msg_send ~self ~cmd:(selector "writeToFile:options:error:") ~typ:(id @-> ullong @-> ptr (id) @-> returning (bool)) x options error
...
let writeToURL' x ~options ~error self = msg_send ~self ~cmd:(selector "writeToURL:options:error:") ~typ:(id @-> ullong @-> ptr (id) @-> returning (bool)) x options error