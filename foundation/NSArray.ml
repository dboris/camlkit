...
let containsObjectIdenticalTo ~x self = msg_send ~self ~cmd:(selector "containsObjectIdenticalTo:") ~typ:(id @-> returning (char)) x
let containsObjectIdenticalTo' ~x ~inRange self = msg_send ~self ~cmd:(selector "containsObjectIdenticalTo:inRange:") ~typ:(id @-> NSRange.t @-> returning (char)) x inRange
...
let isEqualToArray ~x self = msg_send ~self ~cmd:(selector "isEqualToArray:") ~typ:(id @-> returning (char)) x
...
let rangesContainLocation ~x self = msg_send ~self ~cmd:(selector "rangesContainLocation:") ~typ:(ullong @-> returning (char)) x
...
let sortedArrayUsingFunction2 ~x ~context self = msg_send ~self ~cmd:(selector "sortedArrayUsingFunction:context:") ~typ:(ptr (ptr void) @-> ptr (void) @-> returning (id)) x context
let sortedArrayUsingFunction3 ~x ~context ~hint self = msg_send ~self ~cmd:(selector "sortedArrayUsingFunction:context:hint:") ~typ:(ptr (ptr void) @-> ptr (void) @-> id @-> returning (id)) x context hint
let sortedArrayUsingSelector ~x self = msg_send ~self ~cmd:(selector "sortedArrayUsingSelector:") ~typ:(_SEL @-> returning (id)) x
let sortedArrayUsingSelector1 ~x ~hint self = msg_send ~self ~cmd:(selector "sortedArrayUsingSelector:hint:") ~typ:(_SEL @-> id @-> returning (id)) x hint
...
let writeToURL' ~x ~error self = msg_send ~self ~cmd:(selector "writeToURL:error:") ~typ:(id @-> ptr (id) @-> returning (char)) x error