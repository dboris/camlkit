...
let allowsFloats  self = msg_send ~self ~cmd:(selector "allowsFloats") ~typ:(returning (char))
let alwaysShowsDecimalSeparator  self = msg_send ~self ~cmd:(selector "alwaysShowsDecimalSeparator") ~typ:(returning (char))
...
let checkLocaleChange  self = msg_send ~self ~cmd:(selector "checkLocaleChange") ~typ:(returning (char))
let checkModify  self = msg_send ~self ~cmd:(selector "checkModify") ~typ:(returning (char))
...
let generatesDecimalNumbers  self = msg_send ~self ~cmd:(selector "generatesDecimalNumbers") ~typ:(returning (char))
...
let hasThousandSeparators  self = msg_send ~self ~cmd:(selector "hasThousandSeparators") ~typ:(returning (char))
...
let isPartialStringValidationEnabled  self = msg_send ~self ~cmd:(selector "isPartialStringValidationEnabled") ~typ:(returning (char))
let locale  self = msg_send ~self ~cmd:(selector "locale") ~typ:(returning (id))
let localizesFormat  self = msg_send ~self ~cmd:(selector "localizesFormat") ~typ:(returning (char))
...
let setAllowsFloats ~x self = msg_send ~self ~cmd:(selector "setAllowsFloats:") ~typ:(char @-> returning (void)) x
let setAlwaysShowsDecimalSeparator ~x self = msg_send ~self ~cmd:(selector "setAlwaysShowsDecimalSeparator:") ~typ:(char @-> returning (void)) x
...
let setGeneratesDecimalNumbers ~x self = msg_send ~self ~cmd:(selector "setGeneratesDecimalNumbers:") ~typ:(char @-> returning (void)) x
...
let setHasThousandSeparators ~x self = msg_send ~self ~cmd:(selector "setHasThousandSeparators:") ~typ:(char @-> returning (void)) x
...
let setLocalizesFormat ~x self = msg_send ~self ~cmd:(selector "setLocalizesFormat:") ~typ:(char @-> returning (void)) x
...
let setPartialStringValidationEnabled ~x self = msg_send ~self ~cmd:(selector "setPartialStringValidationEnabled:") ~typ:(char @-> returning (void)) x
...
let setUsesGroupingSeparator ~x self = msg_send ~self ~cmd:(selector "setUsesGroupingSeparator:") ~typ:(char @-> returning (void)) x
let setUsesSignificantDigits ~x self = msg_send ~self ~cmd:(selector "setUsesSignificantDigits:") ~typ:(char @-> returning (void)) x
...
let usesGroupingSeparator  self = msg_send ~self ~cmd:(selector "usesGroupingSeparator") ~typ:(returning (char))
let usesSignificantDigits  self = msg_send ~self ~cmd:(selector "usesSignificantDigits") ~typ:(returning (char))
