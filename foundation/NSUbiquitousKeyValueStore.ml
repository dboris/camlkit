...
let initWithBundleIdentifier2 ~x ~storeIdentifier ~additionalStore self = msg_send ~self ~cmd:(selector "initWithBundleIdentifier:storeIdentifier:additionalStore:") ~typ:(id @-> id @-> char @-> returning (id)) x storeIdentifier additionalStore
let initWithBundleIdentifier3 ~x ~storeIdentifier ~additionalStore ~storeType self = msg_send ~self ~cmd:(selector "initWithBundleIdentifier:storeIdentifier:additionalStore:storeType:") ~typ:(id @-> id @-> char @-> llong @-> returning (id)) x storeIdentifier additionalStore storeType
...
let synchronizeWithSourceForced ~x self = msg_send ~self ~cmd:(selector "synchronizeWithSourceForced:") ~typ:(char @-> returning (char)) x