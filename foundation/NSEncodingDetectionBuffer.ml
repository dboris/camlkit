...
let appendByte1' ~x ~byte2 ~byte3 self = msg_send ~self ~cmd:(selector "appendByte1:byte2:byte3:") ~typ:(bool @-> bool @-> bool @-> returning (void)) x byte2 byte3
let appendByte1'' ~x ~byte2 ~byte3 ~byte4 self = msg_send ~self ~cmd:(selector "appendByte1:byte2:byte3:byte4:") ~typ:(bool @-> bool @-> bool @-> bool @-> returning (void)) x byte2 byte3 byte4
