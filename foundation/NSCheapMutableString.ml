...
let setContentsNoCopy x ~length ~freeWhenDone ~isUnicode self = msg_send ~self ~cmd:(selector "setContentsNoCopy:length:freeWhenDone:isUnicode:") ~typ:(ptr (void) @-> ullong @-> bool @-> bool @-> returning (void)) x length freeWhenDone isUnicode