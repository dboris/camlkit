...
let isGathering  self = msg_send ~self ~cmd:(selector "isGathering") ~typ:(returning (char)) 
let isStarted  self = msg_send ~self ~cmd:(selector "isStarted") ~typ:(returning (char)) 
let isStopped  self = msg_send ~self ~cmd:(selector "isStopped") ~typ:(returning (char)) 
...
let startQuery  self = msg_send ~self ~cmd:(selector "startQuery") ~typ:(returning (char)) 
