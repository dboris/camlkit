...
let isForPersonHeightUse  self = msg_send ~self ~cmd:(selector "isForPersonHeightUse") ~typ:(returning (char)) 
...
let setForPersonHeightUse ~x self = msg_send ~self ~cmd:(selector "setForPersonHeightUse:") ~typ:(char @-> returning (void)) x
