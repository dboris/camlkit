...
let containerIsObjectBeingTested  self = msg_send ~self ~cmd:(selector "containerIsObjectBeingTested") ~typ:(returning (char)) 
let containerIsRangeContainerObject  self = msg_send ~self ~cmd:(selector "containerIsRangeContainerObject") ~typ:(returning (char)) 
...
let setContainerIsObjectBeingTested ~x self = msg_send ~self ~cmd:(selector "setContainerIsObjectBeingTested:") ~typ:(char @-> returning (void)) x
let setContainerIsRangeContainerObject ~x self = msg_send ~self ~cmd:(selector "setContainerIsRangeContainerObject:") ~typ:(char @-> returning (void)) x
