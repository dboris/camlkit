...
let replaceObjects' x ~forKeys ~count self = msg_send ~self ~cmd:(selector "replaceObjects:forKeys:count:") ~typ:(ptr (id) @-> ptr (id) @-> ullong @-> returning (void)) x forKeys count
...
let setObjects' x ~forKeys ~count self = msg_send ~self ~cmd:(selector "setObjects:forKeys:count:") ~typ:(ptr (id) @-> ptr (id) @-> ullong @-> returning (void)) x forKeys count
