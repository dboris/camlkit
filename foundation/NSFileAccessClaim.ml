...
let cameFromSuperarbiter  self = msg_send ~self ~cmd:(selector "cameFromSuperarbiter") ~typ:(returning (char))
let canAccessLocations ~x ~forReading ~error self = msg_send ~self ~cmd:(selector "canAccessLocations:forReading:error:") ~typ:(id @-> char @-> ptr (id) @-> returning (char)) x forReading error
let cancelled  self = msg_send ~self ~cmd:(selector "cancelled") ~typ:(returning (void))
let checkIfSymbolicLinkAtURL ~x ~withResolutionCount ~andIfSoThenReevaluateSelf self = msg_send ~self ~cmd:(selector "checkIfSymbolicLinkAtURL:withResolutionCount:andIfSoThenReevaluateSelf:") ~typ:(id @-> ptr (llong) @-> ptr void @-> returning (char)) x withResolutionCount andIfSoThenReevaluateSelf
...
let claimerInvokingIsBlockedByReactorWithID ~x self = msg_send ~self ~cmd:(selector "claimerInvokingIsBlockedByReactorWithID:") ~typ:(id @-> returning (char)) x
...
let didWait  self = msg_send ~self ~cmd:(selector "didWait") ~typ:(returning (char))
...
let isBlockedByClaimWithPurposeID ~x self = msg_send ~self ~cmd:(selector "isBlockedByClaimWithPurposeID:") ~typ:(id @-> returning (char)) x
...
let isGranted  self = msg_send ~self ~cmd:(selector "isGranted") ~typ:(returning (char))
let isRevoked  self = msg_send ~self ~cmd:(selector "isRevoked") ~typ:(returning (char))
...
let makePresentersOfItemAtLocation ~x ~orContainedItem ~relinquishUsingProcedureGetter self = msg_send ~self ~cmd:(selector "makePresentersOfItemAtLocation:orContainedItem:relinquishUsingProcedureGetter:") ~typ:(id @-> char @-> ptr void @-> returning (void)) x orContainedItem relinquishUsingProcedureGetter
let makeProviderOfItemAtLocation ~x ~provideIfNecessaryWithOptions ~thenContinue self = msg_send ~self ~cmd:(selector "makeProviderOfItemAtLocation:provideIfNecessaryWithOptions:thenContinue:") ~typ:(id @-> ullong @-> ptr void @-> returning (void)) x provideIfNecessaryWithOptions thenContinue
let makeProviderOfItemAtLocation1 ~x ~provideOrAttachPhysicalURLIfNecessaryForPurposeID ~readingOptions ~thenContinue self = msg_send ~self ~cmd:(selector "makeProviderOfItemAtLocation:provideOrAttachPhysicalURLIfNecessaryForPurposeID:readingOptions:thenContinue:") ~typ:(id @-> id @-> ullong @-> ptr void @-> returning (void)) x provideOrAttachPhysicalURLIfNecessaryForPurposeID readingOptions thenContinue
...
let makeProviderOfItemAtLocation3 ~x ~providePhysicalURLThenContinue self = msg_send ~self ~cmd:(selector "makeProviderOfItemAtLocation:providePhysicalURLThenContinue:") ~typ:(id @-> ptr void @-> returning (void)) x providePhysicalURLThenContinue
...
let setShouldEnableMaterializationDuringAccessorBlock ~x self = msg_send ~self ~cmd:(selector "setShouldEnableMaterializationDuringAccessorBlock:") ~typ:(char @-> returning (void)) x
...
let shouldEnableMaterializationDuringAccessorBlock  self = msg_send ~self ~cmd:(selector "shouldEnableMaterializationDuringAccessorBlock") ~typ:(returning (char))
let shouldInformProvidersAboutEndOfWriteWithOptions ~x self = msg_send ~self ~cmd:(selector "shouldInformProvidersAboutEndOfWriteWithOptions:") ~typ:(ullong @-> returning (char)) x
let shouldMakeProviderProvideItemAtLocation ~x ~withOptions self = msg_send ~self ~cmd:(selector "shouldMakeProviderProvideItemAtLocation:withOptions:") ~typ:(id @-> ullong @-> returning (char)) x withOptions
let shouldReadingWithOptions ~x ~causePresenterToRelinquish self = msg_send ~self ~cmd:(selector "shouldReadingWithOptions:causePresenterToRelinquish:") ~typ:(ullong @-> id @-> returning (char)) x causePresenterToRelinquish
let shouldWritingWithOptions ~x ~causePresenterToRelinquish self = msg_send ~self ~cmd:(selector "shouldWritingWithOptions:causePresenterToRelinquish:") ~typ:(ullong @-> id @-> returning (char)) x causePresenterToRelinquish
