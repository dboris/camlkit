...
let canLoadObjectOfClass ~x self = msg_send ~self ~cmd:(selector "canLoadObjectOfClass:") ~typ:(_Class @-> returning (char)) x
...
let hasItemConformingToTypeIdentifier ~x self = msg_send ~self ~cmd:(selector "hasItemConformingToTypeIdentifier:") ~typ:(id @-> returning (char)) x
let hasRepresentationConformingToTypeIdentifier ~x ~fileOptions self = msg_send ~self ~cmd:(selector "hasRepresentationConformingToTypeIdentifier:fileOptions:") ~typ:(id @-> llong @-> returning (char)) x fileOptions
