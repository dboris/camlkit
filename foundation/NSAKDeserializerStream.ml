...
let initFromMemoryNoCopy ~x ~length ~freeWhenDone self = msg_send ~self ~cmd:(selector "initFromMemoryNoCopy:length:freeWhenDone:") ~typ:(ptr (void) @-> ullong @-> char @-> returning (id)) x length freeWhenDone
