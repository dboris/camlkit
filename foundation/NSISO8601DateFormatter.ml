...
module Class = struct
  let stringFromDate x ~timeZone ~formatOptions self = msg_send ~self ~cmd:(selector "stringFromDate:timeZone:formatOptions:") ~typ:(id @-> id @-> ullong @-> returning (id)) x timeZone formatOptions
