...
let descendantAtPath ~x ~componentRange ~create self = msg_send ~self ~cmd:(selector "descendantAtPath:componentRange:create:") ~typ:(id @-> NSRange.t @-> char @-> returning (id)) x componentRange create
let descendantAtPath' ~x ~componentRange ~forAddingLeafNode ~create self = msg_send ~self ~cmd:(selector "descendantAtPath:componentRange:forAddingLeafNode:create:") ~typ:(id @-> NSRange.t @-> id @-> char @-> returning (id)) x componentRange forAddingLeafNode create
let descendantForFileURL ~x self = msg_send ~self ~cmd:(selector "descendantForFileURL:") ~typ:(id @-> returning (id)) x
let description  self = msg_send ~self ~cmd:(selector "description") ~typ:(returning (id))
let descriptionWithIndenting ~x ~excludingExcessNodes ~excludingReactors self = msg_send ~self ~cmd:(selector "descriptionWithIndenting:excludingExcessNodes:excludingReactors:") ~typ:(id @-> char @-> char @-> returning (id)) x excludingExcessNodes excludingReactors
...
let itemIsFilePackage  self = msg_send ~self ~cmd:(selector "itemIsFilePackage") ~typ:(returning (char))
let itemIsInItemAtLocation ~x self = msg_send ~self ~cmd:(selector "itemIsInItemAtLocation:") ~typ:(id @-> returning (char)) x
let itemIsItemAtLocation ~x self = msg_send ~self ~cmd:(selector "itemIsItemAtLocation:") ~typ:(id @-> returning (char)) x
let itemIsSubarbitrable  self = msg_send ~self ~cmd:(selector "itemIsSubarbitrable") ~typ:(returning (char))
...
let setProvider ~x self = msg_send ~self ~cmd:(selector "setProvider:") ~typ:(id @-> returning (char)) x
