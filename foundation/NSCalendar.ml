...
let maximumRangeOfUnit x self = msg_send_stret ~self ~cmd:(selector "maximumRangeOfUnit:") ~typ:(ullong @-> returning (NSRange.t)) ~return_type:NSRange.t x
let minimumDaysInFirstWeek self = msg_send ~self ~cmd:(selector "minimumDaysInFirstWeek") ~typ:(returning (ullong))
let minimumRangeOfUnit x self = msg_send_stret ~self ~cmd:(selector "minimumRangeOfUnit:") ~typ:(ullong @-> returning (NSRange.t)) ~return_type:NSRange.t x
...
let rangeOfUnit x ~inUnit ~forDate self = msg_send_stret ~self ~cmd:(selector "rangeOfUnit:inUnit:forDate:") ~typ:(ullong @-> ullong @-> id @-> returning (NSRange.t)) ~return_type:NSRange.t x inUnit forDate
