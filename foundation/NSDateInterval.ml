...
let containsDate ~x self = msg_send ~self ~cmd:(selector "containsDate:") ~typ:(id @-> returning (char)) x
...
let intersectsDateInterval ~x self = msg_send ~self ~cmd:(selector "intersectsDateInterval:") ~typ:(id @-> returning (char)) x
let isEqual ~x self = msg_send ~self ~cmd:(selector "isEqual:") ~typ:(id @-> returning (char)) x
let isEqualToDateInterval ~x self = msg_send ~self ~cmd:(selector "isEqualToDateInterval:") ~typ:(id @-> returning (char)) x
