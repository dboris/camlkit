...
let initWithString ~x ~syllableCount ~lastSyllableIsPartial ~score ~replacementCount ~transpositionCount ~insertionCount ~deletionCount ~indexOfFirstModification ~rangeCount ~ranges self = msg_send ~self ~cmd:(selector "initWithString:syllableCount:lastSyllableIsPartial:score:replacementCount:transpositionCount:insertionCount:deletionCount:indexOfFirstModification:rangeCount:ranges:") ~typ:(id @-> ullong @-> char @-> ullong @-> ullong @-> ullong @-> ullong @-> ullong @-> ullong @-> ullong @-> ptr (NSRange.t) @-> returning (id)) x syllableCount lastSyllableIsPartial score replacementCount transpositionCount insertionCount deletionCount indexOfFirstModification rangeCount ranges
let initWithString' ~x ~syllableCount ~lastSyllableIsPartial ~score ~replacementCount ~transpositionCount ~insertionCount ~deletionCount ~rangeCount ~ranges self = msg_send ~self ~cmd:(selector "initWithString:syllableCount:lastSyllableIsPartial:score:replacementCount:transpositionCount:insertionCount:deletionCount:rangeCount:ranges:") ~typ:(id @-> ullong @-> char @-> ullong @-> ullong @-> ullong @-> ullong @-> ullong @-> ullong @-> ptr (NSRange.t) @-> returning (id)) x syllableCount lastSyllableIsPartial score replacementCount transpositionCount insertionCount deletionCount rangeCount ranges
let isEqual ~x self = msg_send ~self ~cmd:(selector "isEqual:") ~typ:(id @-> returning (char)) x
let lastSyllableIsPartial  self = msg_send ~self ~cmd:(selector "lastSyllableIsPartial") ~typ:(returning (char))
