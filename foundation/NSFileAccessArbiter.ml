...
let getDebugInformationIncludingEverything ~x ~withString ~fromPid ~thenContinue self = msg_send ~self ~cmd:(selector "getDebugInformationIncludingEverything:withString:fromPid:thenContinue:") ~typ:(char @-> id @-> int @-> ptr void @-> returning (void)) x withString fromPid thenContinue
...
let initWithQueue ~x ~isSubarbiter ~listener self = msg_send ~self ~cmd:(selector "initWithQueue:isSubarbiter:listener:") ~typ:(id @-> char @-> id @-> returning (id)) x isSubarbiter listener
...
let provideSubarbiterDebugInfoIncludingEverything ~x ~completionHandler self = msg_send ~self ~cmd:(selector "provideSubarbiterDebugInfoIncludingEverything:completionHandler:") ~typ:(char @-> ptr void @-> returning (void)) x completionHandler
...
let writerWithPurposeID2 ~x ~didChangeUbiquityAttributes ~ofItemAtURL self = msg_send ~self ~cmd:(selector "writerWithPurposeID:didChangeUbiquityAttributes:ofItemAtURL:") ~typ:(id @-> id @-> id @-> returning (void)) x didChangeUbiquityAttributes ofItemAtURL
let writerWithPurposeID3 ~x ~didChangeUbiquityOfItemAtURL self = msg_send ~self ~cmd:(selector "writerWithPurposeID:didChangeUbiquityOfItemAtURL:") ~typ:(id @-> id @-> returning (void)) x didChangeUbiquityOfItemAtURL
let writerWithPurposeID4 ~x ~didDisconnectItemAtURL self = msg_send ~self ~cmd:(selector "writerWithPurposeID:didDisconnectItemAtURL:") ~typ:(id @-> id @-> returning (void)) x didDisconnectItemAtURL
let writerWithPurposeID5 ~x ~didMakeItemDisappearAtURL self = msg_send ~self ~cmd:(selector "writerWithPurposeID:didMakeItemDisappearAtURL:") ~typ:(id @-> id @-> returning (void)) x didMakeItemDisappearAtURL
let writerWithPurposeID6 ~x ~didMoveItemAtURL ~toURL self = msg_send ~self ~cmd:(selector "writerWithPurposeID:didMoveItemAtURL:toURL:") ~typ:(id @-> id @-> id @-> returning (void)) x didMoveItemAtURL toURL
let writerWithPurposeID7 ~x ~didReconnectItemAtURL self = msg_send ~self ~cmd:(selector "writerWithPurposeID:didReconnectItemAtURL:") ~typ:(id @-> id @-> returning (void)) x didReconnectItemAtURL
