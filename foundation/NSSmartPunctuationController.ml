...
let setSmartDashesEnabled ~x self = msg_send ~self ~cmd:(selector "setSmartDashesEnabled:") ~typ:(char @-> returning (void)) x
let setSmartQuoteOptions ~x self = msg_send ~self ~cmd:(selector "setSmartQuoteOptions:") ~typ:(id @-> returning (void)) x
let setSmartQuotesEnabled ~x self = msg_send ~self ~cmd:(selector "setSmartQuotesEnabled:") ~typ:(char @-> returning (void)) x
let smartDashesEnabled  self = msg_send ~self ~cmd:(selector "smartDashesEnabled") ~typ:(returning (char)) 
let smartQuoteOptions  self = msg_send ~self ~cmd:(selector "smartQuoteOptions") ~typ:(returning (id)) 
let smartQuotesEnabled  self = msg_send ~self ~cmd:(selector "smartQuotesEnabled") ~typ:(returning (char)) 