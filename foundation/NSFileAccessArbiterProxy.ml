...
let grantAccessClaim ~x ~synchronouslyIfPossible self = msg_send ~self ~cmd:(selector "grantAccessClaim:synchronouslyIfPossible:") ~typ:(id @-> char @-> returning (id)) x synchronouslyIfPossible
...
let itemHasPresentersAtURL ~x self = msg_send ~self ~cmd:(selector "itemHasPresentersAtURL:") ~typ:(id @-> returning (char)) x
...
let setAutomaticFileProviderReregistrationDisabled ~x self = msg_send ~self ~cmd:(selector "setAutomaticFileProviderReregistrationDisabled:") ~typ:(char @-> returning (void)) x
