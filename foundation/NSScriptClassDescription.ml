...
let hasOrderedToManyRelationshipForKey ~x self = msg_send ~self ~cmd:(selector "hasOrderedToManyRelationshipForKey:") ~typ:(id @-> returning (char)) x
let hasPropertyForKey ~x self = msg_send ~self ~cmd:(selector "hasPropertyForKey:") ~typ:(id @-> returning (char)) x
let hasReadablePropertyForKey ~x self = msg_send ~self ~cmd:(selector "hasReadablePropertyForKey:") ~typ:(id @-> returning (char)) x
let hasWritablePropertyForKey ~x self = msg_send ~self ~cmd:(selector "hasWritablePropertyForKey:") ~typ:(id @-> returning (char)) x
...
let isLocationRequiredToCreateForKey ~x self = msg_send ~self ~cmd:(selector "isLocationRequiredToCreateForKey:") ~typ:(id @-> returning (char)) x
let isReadOnlyKey ~x self = msg_send ~self ~cmd:(selector "isReadOnlyKey:") ~typ:(id @-> returning (char)) x
...
let supportsCommand ~x self = msg_send ~self ~cmd:(selector "supportsCommand:") ~typ:(id @-> returning (char)) x
