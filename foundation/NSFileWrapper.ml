...
let isDirectory  self = msg_send ~self ~cmd:(selector "isDirectory") ~typ:(returning (char)) 
let isRegularFile  self = msg_send ~self ~cmd:(selector "isRegularFile") ~typ:(returning (char)) 
let isSymbolicLink  self = msg_send ~self ~cmd:(selector "isSymbolicLink") ~typ:(returning (char)) 
let keyForFileWrapper ~x self = msg_send ~self ~cmd:(selector "keyForFileWrapper:") ~typ:(id @-> returning (id)) x
let matchesContentsOfURL ~x self = msg_send ~self ~cmd:(selector "matchesContentsOfURL:") ~typ:(id @-> returning (char)) x
let needsToBeUpdatedFromPath ~x self = msg_send ~self ~cmd:(selector "needsToBeUpdatedFromPath:") ~typ:(id @-> returning (char)) x
let preferredFilename  self = msg_send ~self ~cmd:(selector "preferredFilename") ~typ:(returning (id)) 
let readFromURL ~x ~options ~error self = msg_send ~self ~cmd:(selector "readFromURL:options:error:") ~typ:(id @-> ullong @-> ptr (id) @-> returning (char)) x options error
...
let updateFromPath ~x self = msg_send ~self ~cmd:(selector "updateFromPath:") ~typ:(id @-> returning (char)) x
let writeToFile ~x ~atomically ~updateFilenames self = msg_send ~self ~cmd:(selector "writeToFile:atomically:updateFilenames:") ~typ:(id @-> char @-> char @-> returning (char)) x atomically updateFilenames
let writeToURL ~x ~options ~originalContentsURL ~error self = msg_send ~self ~cmd:(selector "writeToURL:options:originalContentsURL:error:") ~typ:(id @-> ullong @-> id @-> ptr (id) @-> returning (char)) x options originalContentsURL error