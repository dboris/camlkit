...
let performOperationUsingObject ~x ~andObject self = msg_send ~self ~cmd:(selector "performOperationUsingObject:andObject:") ~typ:(id @-> id @-> returning (char)) x andObject
