...
module Class = struct
  let operatorWithCustomSelector ~x ~modifier self = msg_send ~self ~cmd:(selector "operatorWithCustomSelector:modifier:") ~typ:(_SEL @-> ullong @-> returning (id)) x modifier
  let operatorWithType ~x ~modifier ~options self = msg_send ~self ~cmd:(selector "operatorWithType:modifier:options:") ~typ:(ullong @-> ullong @-> ullong @-> returning (id)) x modifier options
...
let initWithOperatorType ~x self = msg_send ~self ~cmd:(selector "initWithOperatorType:") ~typ:(ullong @-> returning (id)) x
let initWithOperatorType1 ~x ~modifier self = msg_send ~self ~cmd:(selector "initWithOperatorType:modifier:") ~typ:(ullong @-> ullong @-> returning (id)) x modifier
let initWithOperatorType2 ~x ~modifier ~options self = msg_send ~self ~cmd:(selector "initWithOperatorType:modifier:options:") ~typ:(ullong @-> ullong @-> ullong @-> returning (id)) x modifier options
