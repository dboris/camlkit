...
let isLoaded  self = msg_send ~self ~cmd:(selector "isLoaded") ~typ:(returning (char))
let load  self = msg_send ~self ~cmd:(selector "load") ~typ:(returning (char))
let loadAndReturnError ~x self = msg_send ~self ~cmd:(selector "loadAndReturnError:") ~typ:(ptr (id) @-> returning (char)) x
let loadNibFile ~x ~externalNameTable ~options ~withZone self = msg_send ~self ~cmd:(selector "loadNibFile:externalNameTable:options:withZone:") ~typ:(id @-> id @-> id @-> id @-> returning (char)) x externalNameTable options withZone
let loadNibFile' ~x ~externalNameTable ~withZone self = msg_send ~self ~cmd:(selector "loadNibFile:externalNameTable:withZone:") ~typ:(id @-> id @-> id @-> returning (char)) x externalNameTable withZone
let loadNibNamed ~x ~owner ~topLevelObjects self = msg_send ~self ~cmd:(selector "loadNibNamed:owner:topLevelObjects:") ~typ:(id @-> id @-> ptr (id) @-> returning (char)) x owner topLevelObjects
...
let preflightAndReturnError ~x self = msg_send ~self ~cmd:(selector "preflightAndReturnError:") ~typ:(ptr (id) @-> returning (char)) x
...
let unload  self = msg_send ~self ~cmd:(selector "unload") ~typ:(returning (char))
