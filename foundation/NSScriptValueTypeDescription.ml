...
let initWithName' ~x ~appleEventCode ~objcClassName ~isHidden self = msg_send ~self ~cmd:(selector "initWithName:appleEventCode:objcClassName:isHidden:") ~typ:(id @-> uint @-> id @-> char @-> returning (id)) x appleEventCode objcClassName isHidden
