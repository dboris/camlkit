...
let isPreregistered  self = msg_send ~self ~cmd:(selector "isPreregistered") ~typ:(returning (char)) 
let qualityOfService  self = msg_send ~self ~cmd:(selector "qualityOfService") ~typ:(returning (llong)) 
let repeats  self = msg_send ~self ~cmd:(selector "repeats") ~typ:(returning (char)) 
...
let setPreregistered ~x self = msg_send ~self ~cmd:(selector "setPreregistered:") ~typ:(char @-> returning (void)) x
let setQualityOfService ~x self = msg_send ~self ~cmd:(selector "setQualityOfService:") ~typ:(llong @-> returning (void)) x
let setRepeats ~x self = msg_send ~self ~cmd:(selector "setRepeats:") ~typ:(char @-> returning (void)) x
let setTolerance ~x self = msg_send ~self ~cmd:(selector "setTolerance:") ~typ:(double @-> returning (void)) x
let shouldDefer  self = msg_send ~self ~cmd:(selector "shouldDefer") ~typ:(returning (char)) 
