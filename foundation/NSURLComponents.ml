...
let initWithURL x ~resolvingAgainstBaseURL self = msg_send ~self ~cmd:(selector "initWithURL:resolvingAgainstBaseURL:") ~typ:(id @-> bool @-> returning (id)) x resolvingAgainstBaseURL
...
let rangeOfFragment self = msg_send_stret ~self ~cmd:(selector "rangeOfFragment") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
let rangeOfHost self = msg_send_stret ~self ~cmd:(selector "rangeOfHost") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
let rangeOfPassword self = msg_send_stret ~self ~cmd:(selector "rangeOfPassword") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
let rangeOfPath self = msg_send_stret ~self ~cmd:(selector "rangeOfPath") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
let rangeOfPort self = msg_send_stret ~self ~cmd:(selector "rangeOfPort") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
let rangeOfQuery self = msg_send_stret ~self ~cmd:(selector "rangeOfQuery") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
let rangeOfScheme self = msg_send_stret ~self ~cmd:(selector "rangeOfScheme") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
let rangeOfUser self = msg_send_stret ~self ~cmd:(selector "rangeOfUser") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
