...
let containsIndex ~x self = msg_send ~self ~cmd:(selector "containsIndex:") ~typ:(ullong @-> returning (char)) x
let containsIndexes ~x self = msg_send ~self ~cmd:(selector "containsIndexes:") ~typ:(id @-> returning (char)) x
let containsIndexesInRange ~x self = msg_send ~self ~cmd:(selector "containsIndexesInRange:") ~typ:(NSRange.t @-> returning (char)) x
...
let intersectsIndexesInRange ~x self = msg_send ~self ~cmd:(selector "intersectsIndexesInRange:") ~typ:(NSRange.t @-> returning (char)) x
let isEqual ~x self = msg_send ~self ~cmd:(selector "isEqual:") ~typ:(id @-> returning (char)) x
let isEqualToIndexSet ~x self = msg_send ~self ~cmd:(selector "isEqualToIndexSet:") ~typ:(id @-> returning (char)) x
