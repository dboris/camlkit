...
let encodeObject ~x ~isBycopy ~isByref self = msg_send ~self ~cmd:(selector "encodeObject:isBycopy:isByref:") ~typ:(id @-> char @-> char @-> returning (void)) x isBycopy isByref
