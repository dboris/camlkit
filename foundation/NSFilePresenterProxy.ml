...
let observePresenterChange ~x ~atSubitemURL self = msg_send ~self ~cmd:(selector "observePresenterChange:atSubitemURL:") ~typ:(char @-> id @-> returning (void)) x atSubitemURL
...
let setInSubarbiter ~x self = msg_send ~self ~cmd:(selector "setInSubarbiter:") ~typ:(char @-> returning (void)) x
...
let setUsesMainThreadDuringReliquishing ~x self = msg_send ~self ~cmd:(selector "setUsesMainThreadDuringReliquishing:") ~typ:(char @-> returning (void)) x
let shouldSendObservationMessageWithPurposeID ~x self = msg_send ~self ~cmd:(selector "shouldSendObservationMessageWithPurposeID:") ~typ:(id @-> returning (char)) x
...
let usesMainThreadDuringReliquishing  self = msg_send ~self ~cmd:(selector "usesMainThreadDuringReliquishing") ~typ:(returning (char)) 