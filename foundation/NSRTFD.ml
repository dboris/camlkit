...
let getDirInfo ~x self = msg_send ~self ~cmd:(selector "getDirInfo:") ~typ:(char @-> returning (id)) x
...
let initWithDictionary' ~x ~copyItems self = msg_send ~self ~cmd:(selector "initWithDictionary:copyItems:") ~typ:(id @-> char @-> returning (id)) x copyItems
...
let internalSaveTo ~x ~removeBackup ~errorHandler self = msg_send ~self ~cmd:(selector "internalSaveTo:removeBackup:errorHandler:") ~typ:(id @-> char @-> id @-> returning (ullong)) x removeBackup errorHandler
let internalSaveTo' ~x ~removeBackup ~errorHandler ~temp ~backup self = msg_send ~self ~cmd:(selector "internalSaveTo:removeBackup:errorHandler:temp:backup:") ~typ:(id @-> char @-> id @-> id @-> id @-> returning (ullong)) x removeBackup errorHandler temp backup
let internalWritePath ~x ~errorHandler ~remapContents ~hardLinkPath self = msg_send ~self ~cmd:(selector "internalWritePath:errorHandler:remapContents:hardLinkPath:") ~typ:(id @-> id @-> char @-> id @-> returning (ullong)) x errorHandler remapContents hardLinkPath
let isPackage  self = msg_send ~self ~cmd:(selector "isPackage") ~typ:(returning (char))
...
let saveToDocument ~x ~removeBackup ~errorHandler self = msg_send ~self ~cmd:(selector "saveToDocument:removeBackup:errorHandler:") ~typ:(id @-> char @-> id @-> returning (ullong)) x removeBackup errorHandler
...
let setPackage ~x self = msg_send ~self ~cmd:(selector "setPackage:") ~typ:(char @-> returning (id)) x
...
let writePath' ~x ~docInfo ~errorHandler ~remapContents ~markBusy ~hardLinkPath self = msg_send ~self ~cmd:(selector "writePath:docInfo:errorHandler:remapContents:markBusy:hardLinkPath:") ~typ:(id @-> id @-> id @-> char @-> char @-> id @-> returning (ullong)) x docInfo errorHandler remapContents markBusy hardLinkPath