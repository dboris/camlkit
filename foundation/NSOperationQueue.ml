...
let addOperations ~x ~waitUntilFinished self = msg_send ~self ~cmd:(selector "addOperations:waitUntilFinished:") ~typ:(id @-> char @-> returning (void)) x waitUntilFinished
...
let isSuspended  self = msg_send ~self ~cmd:(selector "isSuspended") ~typ:(returning (char)) 
...
let overcommitsOperations  self = msg_send ~self ~cmd:(selector "overcommitsOperations") ~typ:(returning (char)) 
...
let setMaxConcurrentOperationCount ~x self = msg_send ~self ~cmd:(selector "setMaxConcurrentOperationCount:") ~typ:(llong @-> returning (void)) x
let setName ~x self = msg_send ~self ~cmd:(selector "setName:") ~typ:(id @-> returning (void)) x
let setOvercommitsOperations ~x self = msg_send ~self ~cmd:(selector "setOvercommitsOperations:") ~typ:(char @-> returning (void)) x
let setQualityOfService ~x self = msg_send ~self ~cmd:(selector "setQualityOfService:") ~typ:(llong @-> returning (void)) x
let setSuspended ~x self = msg_send ~self ~cmd:(selector "setSuspended:") ~typ:(char @-> returning (void)) x
