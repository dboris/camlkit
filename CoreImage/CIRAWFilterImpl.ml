...
let getOrientationTransform x self = msg_send ~self ~cmd:(selector "getOrientationTransform:") ~typ:(id @-> returning CGAffineTransform.t) x
let getScaleTransform x self = msg_send ~self ~cmd:(selector "getScaleTransform:") ~typ:(id @-> returning CGAffineTransform.t) x
