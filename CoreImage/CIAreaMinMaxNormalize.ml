...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciareaminmaxnormalize?language=objc}CIAreaMinMaxNormalize} *)

let self = get_class "CIAreaMinMaxNormalize"
