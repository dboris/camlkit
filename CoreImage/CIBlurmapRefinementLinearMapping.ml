...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciblurmaprefinementlinearmapping?language=objc}CIBlurmapRefinementLinearMapping} *)

let self = get_class "CIBlurmapRefinementLinearMapping"
