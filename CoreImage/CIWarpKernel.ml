...
let autogenerateROI x ~args ~arguments ~extent self = msg_send_stret ~self ~cmd:(selector "autogenerateROI:args:arguments:extent:") ~typ:((ptr void) @-> (ptr void) @-> id @-> CGRect.t @-> returning CGRect.t) ~return_type:CGRect.t x args arguments extent
