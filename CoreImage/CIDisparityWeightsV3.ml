...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cidisparityweightsv3?language=objc}CIDisparityWeightsV3} *)

let self = get_class "CIDisparityWeightsV3"
