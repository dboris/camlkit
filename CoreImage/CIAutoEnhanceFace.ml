...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciautoenhanceface?language=objc}CIAutoEnhanceFace} *)

let self = get_class "CIAutoEnhanceFace"
...
let faceRect self = msg_send ~self ~cmd:(selector "faceRect") ~typ:(returning CGRect.t)
