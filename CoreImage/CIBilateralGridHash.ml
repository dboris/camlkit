...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cibilateralgridhash?language=objc}CIBilateralGridHash} *)

let self = get_class "CIBilateralGridHash"
