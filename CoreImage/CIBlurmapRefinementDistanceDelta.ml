...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciblurmaprefinementdistancedelta?language=objc}CIBlurmapRefinementDistanceDelta} *)

let self = get_class "CIBlurmapRefinementDistanceDelta"
