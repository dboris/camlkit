...
let supportRectangleWithFaceArray x ~options self = msg_send_stret ~self ~cmd:(selector "supportRectangleWithFaceArray:options:") ~typ:(id @-> id @-> returning CGRect.t) ~return_type:CGRect.t x options
