...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cibicubicscaletransform?language=objc}CIBicubicScaleTransform} *)

let self = get_class "CIBicubicScaleTransform"
