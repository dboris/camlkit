...
let nativeSize self = msg_send ~self ~cmd:(selector "nativeSize") ~typ:(returning CGSize.t)
let neutralChromaticity self = msg_send ~self ~cmd:(selector "neutralChromaticity") ~typ:(returning CGPoint.t)
let neutralLocation self = msg_send ~self ~cmd:(selector "neutralLocation") ~typ:(returning CGPoint.t)
