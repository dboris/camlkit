...
let bitmapPointWithDictionaryPoint x self = msg_send_stret ~self ~cmd:(selector "bitmapPointWithDictionaryPoint:") ~typ:(CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t x
let bitmapPointWithDictionaryPointArray x self = msg_send_stret ~self ~cmd:(selector "bitmapPointWithDictionaryPointArray:") ~typ:(id @-> returning CGPoint.t) ~return_type:CGPoint.t x
...
let centroidWithConvexHull x self = msg_send_stret ~self ~cmd:(selector "centroidWithConvexHull:") ~typ:((ptr void) @-> returning CGPoint.t) ~return_type:CGPoint.t x
...
let dictionaryPointWithBitmapPoint x self = msg_send_stret ~self ~cmd:(selector "dictionaryPointWithBitmapPoint:") ~typ:(CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t x
let dictionaryPointWithGlobalBitmapPoint x self = msg_send_stret ~self ~cmd:(selector "dictionaryPointWithGlobalBitmapPoint:") ~typ:(CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t x
...
let globalBitmapPointWithDictionaryPoint x self = msg_send_stret ~self ~cmd:(selector "globalBitmapPointWithDictionaryPoint:") ~typ:(CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t x
let globalBitmapPointWithDictionaryPointArray x self = msg_send_stret ~self ~cmd:(selector "globalBitmapPointWithDictionaryPointArray:") ~typ:(id @-> returning CGPoint.t) ~return_type:CGPoint.t x
...
let leftHandedTransform x ~ofPoint self = msg_send_stret ~self ~cmd:(selector "leftHandedTransform:ofPoint:") ~typ:(CGAffineTransform.t @-> CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t x ofPoint
...
let threadCentroid x self = msg_send_stret ~self ~cmd:(selector "threadCentroid:") ~typ:((ptr void) @-> returning CGPoint.t) ~return_type:CGPoint.t x
