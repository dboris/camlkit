...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cifacefeature?language=objc}CIFaceFeature} *)

let self = get_class "CIFaceFeature"
...
let leftEyePosition self = msg_send ~self ~cmd:(selector "leftEyePosition") ~typ:(returning CGPoint.t)
let mouthPosition self = msg_send ~self ~cmd:(selector "mouthPosition") ~typ:(returning CGPoint.t)
let rightEyeClosed self = msg_send ~self ~cmd:(selector "rightEyeClosed") ~typ:(returning bool)
let rightEyePosition self = msg_send ~self ~cmd:(selector "rightEyePosition") ~typ:(returning CGPoint.t)
