...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cismoothlineargradient?language=objc}CISmoothLinearGradient} *)

let self = get_class "CISmoothLinearGradient"
