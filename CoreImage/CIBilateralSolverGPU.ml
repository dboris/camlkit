...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cibilateralsolvergpu?language=objc}CIBilateralSolverGPU} *)

let self = get_class "CIBilateralSolverGPU"
