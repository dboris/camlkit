...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cihighlightrecovery?language=objc}CIHighlightRecovery} *)

let self = get_class "CIHighlightRecovery"
