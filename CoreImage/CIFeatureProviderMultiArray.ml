...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cifeatureprovidermultiarray?language=objc}CIFeatureProviderMultiArray} *)

let self = get_class "CIFeatureProviderMultiArray"
