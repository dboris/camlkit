...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cicopymachinetransition?language=objc}CICopyMachineTransition} *)

let self = get_class "CICopyMachineTransition"
