...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciblurmaprefinementthreshold?language=objc}CIBlurmapRefinementThreshold} *)

let self = get_class "CIBlurmapRefinementThreshold"
