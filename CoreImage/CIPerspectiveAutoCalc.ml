...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciperspectiveautocalc?language=objc}CIPerspectiveAutoCalc} *)

let self = get_class "CIPerspectiveAutoCalc"
