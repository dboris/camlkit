...
let calcIntersection x ~slope1 ~pt2 ~slope2 self = msg_send ~self ~cmd:(selector "calcIntersection:slope1:pt2:slope2:") ~typ:(CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> returning CGPoint.t) x slope1 pt2 slope2
...
let imageTransformForCGOrientation x self = msg_send ~self ~cmd:(selector "imageTransformForCGOrientation:") ~typ:(uint @-> returning CGAffineTransform.t) x
let imageTransformForOrientation x self = msg_send ~self ~cmd:(selector "imageTransformForOrientation:") ~typ:(int @-> returning CGAffineTransform.t) x
...
let pointWithDictionary x ~name ~index ~transformedBy self = msg_send ~self ~cmd:(selector "pointWithDictionary:name:index:transformedBy:") ~typ:(id @-> id @-> int @-> CGAffineTransform.t @-> returning CGPoint.t) x name index transformedBy
...
let regionOfInterestForImage x ~inRect self = msg_send ~self ~cmd:(selector "regionOfInterestForImage:inRect:") ~typ:(id @-> CGRect.t @-> returning CGRect.t) x inRect
