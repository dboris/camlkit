...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cifiltergenerator?language=objc}CIFilterGenerator} *)

let self = get_class "CIFilterGenerator"
...
let immutableCopyWithZone x self = msg_send ~self ~cmd:(selector "immutableCopyWithZone:") ~typ:((ptr void) @-> returning id) x
