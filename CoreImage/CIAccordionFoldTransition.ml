...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciaccordionfoldtransition?language=objc}CIAccordionFoldTransition} *)

let self = get_class "CIAccordionFoldTransition"
