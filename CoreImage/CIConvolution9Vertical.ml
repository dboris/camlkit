...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciconvolution9vertical?language=objc}CIConvolution9Vertical} *)

let self = get_class "CIConvolution9Vertical"
