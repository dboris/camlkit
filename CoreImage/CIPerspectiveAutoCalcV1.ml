...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciperspectiveautocalcv1?language=objc}CIPerspectiveAutoCalcV1} *)

let self = get_class "CIPerspectiveAutoCalcV1"
