...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cifacemaskcalculator?language=objc}CIFaceMaskCalculator} *)

let self = get_class "CIFaceMaskCalculator"
