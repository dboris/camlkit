...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/cibumpdistortionlinear?language=objc}CIBumpDistortionLinear} *)

let self = get_class "CIBumpDistortionLinear"
