...
(** Apple docs: {{:https://developer.apple.com/documentation/coreimage/ciconvolution9horizontal?language=objc}CIConvolution9Horizontal} *)

let self = get_class "CIConvolution9Horizontal"
