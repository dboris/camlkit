...
let rangeOfData x ~options ~range self = msg_send ~self ~cmd:(selector "rangeOfData:options:range:") ~typ:(id @-> ullong @-> NSRange.t @-> returning NSRange.t) x (ULLong.of_int options) range
