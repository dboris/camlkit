...
let countLimit self = msg_send ~self ~cmd:(selector "countLimit") ~typ:(returning ullong) |> ULLong.to_int
...
let minimumObjectCount self = msg_send ~self ~cmd:(selector "minimumObjectCount") ~typ:(returning ullong) |> ULLong.to_int
...
let totalCostLimit self = msg_send ~self ~cmd:(selector "totalCostLimit") ~typ:(returning ullong) |> ULLong.to_int