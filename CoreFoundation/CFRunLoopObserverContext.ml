...
let t : [`CFRunLoopObserverContext] structure typ = structure "_CFRunLoopObserverContext"
(** Apple docs: {{:https://developer.apple.com/documentation/corefoundation/_cfrunloopobservercontext?language=objc}_CFRunLoopObserverContext} *)
