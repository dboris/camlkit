...
let keySetCount self = msg_send ~self ~cmd:(selector "keySetCount") ~typ:(returning ullong) |> ULLong.to_int
let keys self = msg_send ~self ~cmd:(selector "keys") ~typ:(returning (ptr id))
let maximumIndex self = msg_send ~self ~cmd:(selector "maximumIndex") ~typ:(returning ullong) |> ULLong.to_int
...
let select self = msg_send ~self ~cmd:(selector "select") ~typ:(returning uchar)
...
let setSelect x self = msg_send ~self ~cmd:(selector "setSelect:") ~typ:(uchar @-> returning void) x
