...
let t : [`CFFileDescriptorContext] structure typ = structure "_CFFileDescriptorContext"
(** Apple docs: {{:https://developer.apple.com/documentation/corefoundation/_cffiledescriptorcontext?language=objc}_CFFileDescriptorContext} *)
