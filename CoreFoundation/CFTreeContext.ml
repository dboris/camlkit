...
let t : [`CFTreeContext] structure typ = structure "_CFTreeContext"
(** Apple docs: {{:https://developer.apple.com/documentation/corefoundation/_cftreecontext?language=objc}_CFTreeContext} *)
