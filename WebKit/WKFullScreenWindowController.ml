...
let finalFrame self = msg_send ~self ~cmd:(selector "finalFrame") ~typ:(returning CGRect.t)
...
let initialFrame self = msg_send ~self ~cmd:(selector "initialFrame") ~typ:(returning CGRect.t)
