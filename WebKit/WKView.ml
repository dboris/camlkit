...
let minimumSizeForAutoLayout self = msg_send ~self ~cmd:(selector "minimumSizeForAutoLayout") ~typ:(returning CGSize.t)
...
let sizeToContentAutoSizeMaximumSize self = msg_send ~self ~cmd:(selector "sizeToContentAutoSizeMaximumSize") ~typ:(returning CGSize.t)
