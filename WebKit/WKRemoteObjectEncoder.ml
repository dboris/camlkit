...
(** Apple docs: {{:https://developer.apple.com/documentation/webkit/wkremoteobjectencoder?language=objc}WKRemoteObjectEncoder} *)

let self = get_class "WKRemoteObjectEncoder"
