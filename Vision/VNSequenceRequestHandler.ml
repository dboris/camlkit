...
(** Apple docs: {{:https://developer.apple.com/documentation/vision/vnsequencerequesthandler?language=objc}VNSequenceRequestHandler} *)

let init self = msg_send ~self ~cmd:(selector "init") ~typ:(returning id)
let initWithSession x self = msg_send ~self ~cmd:(selector "initWithSession:") ~typ:(id @-> returning id) x
let performRequests x ~onCGImage ~error self = msg_send ~self ~cmd:(selector "performRequests:onCGImage:error:") ~typ:(id @-> (ptr CGImage.t) @-> (ptr id) @-> returning bool) x onCGImage error
...
let performRequests3 x ~onCVPixelBuffer ~error self = msg_send ~self ~cmd:(selector "performRequests:onCVPixelBuffer:error:") ~typ:(id @-> (ptr CVBuffer.t) @-> (ptr id) @-> returning bool) x onCVPixelBuffer error
...
let performRequests6 x ~onCGImage ~gatheredForensics ~error self = msg_send ~self ~cmd:(selector "performRequests:onCGImage:gatheredForensics:error:") ~typ:(id @-> (ptr CGImage.t) @-> (ptr id) @-> (ptr id) @-> returning bool) x onCGImage gatheredForensics error
let performRequests7 x ~onCGImage ~orientation ~error self = msg_send ~self ~cmd:(selector "performRequests:onCGImage:orientation:error:") ~typ:(id @-> (ptr CGImage.t) @-> uint @-> (ptr id) @-> returning bool) x onCGImage orientation error
...
let performRequests12 x ~onCVPixelBuffer ~gatheredForensics ~error self = msg_send ~self ~cmd:(selector "performRequests:onCVPixelBuffer:gatheredForensics:error:") ~typ:(id @-> (ptr CVBuffer.t) @-> (ptr id) @-> (ptr id) @-> returning bool) x onCVPixelBuffer gatheredForensics error
let performRequests13 x ~onCVPixelBuffer ~orientation ~error self = msg_send ~self ~cmd:(selector "performRequests:onCVPixelBuffer:orientation:error:") ~typ:(id @-> (ptr CVBuffer.t) @-> uint @-> (ptr id) @-> returning bool) x onCVPixelBuffer orientation error
...
let performRequests18 x ~onCGImage ~orientation ~gatheredForensics ~error self = msg_send ~self ~cmd:(selector "performRequests:onCGImage:orientation:gatheredForensics:error:") ~typ:(id @-> (ptr CGImage.t) @-> uint @-> (ptr id) @-> (ptr id) @-> returning bool) x onCGImage orientation gatheredForensics error
...
let performRequests21 x ~onCVPixelBuffer ~orientation ~gatheredForensics ~error self = msg_send ~self ~cmd:(selector "performRequests:onCVPixelBuffer:orientation:gatheredForensics:error:") ~typ:(id @-> (ptr CVBuffer.t) @-> uint @-> (ptr id) @-> (ptr id) @-> returning bool) x onCVPixelBuffer orientation gatheredForensics error
