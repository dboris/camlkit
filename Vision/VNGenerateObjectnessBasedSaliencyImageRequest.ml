...
(** Apple docs: {{:https://developer.apple.com/documentation/vision/vngenerateobjectnessbasedsaliencyimagerequest?language=objc}VNGenerateObjectnessBasedSaliencyImageRequest} *)

let self = get_class "VNGenerateObjectnessBasedSaliencyImageRequest"
