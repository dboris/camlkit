...
let _VNImageProcessingSessionRegionOfInterest self = msg_send_stret ~self ~cmd:(selector "VNImageProcessingSessionRegionOfInterest") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
...
let regionOfInterestNonIntegralPixelRectForWidth x ~height self = msg_send_stret ~self ~cmd:(selector "regionOfInterestNonIntegralPixelRectForWidth:height:") ~typ:(ullong @-> ullong @-> returning (CGRect.t)) ~return_type:CGRect.t (ULLong.of_int x) (ULLong.of_int height)
let regionOfInterestPixelRectForWidth x ~height self = msg_send_stret ~self ~cmd:(selector "regionOfInterestPixelRectForWidth:height:") ~typ:(ullong @-> ullong @-> returning (CGRect.t)) ~return_type:CGRect.t (ULLong.of_int x) (ULLong.of_int height)
