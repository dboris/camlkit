...
(** Apple docs: {{:https://developer.apple.com/documentation/vision/vnfacesegmentgenerator?language=objc}VNFaceSegmentGenerator} *)

let self = get_class "VNFaceSegmentGenerator"
