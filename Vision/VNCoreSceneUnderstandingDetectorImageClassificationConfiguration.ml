...
let setMaximumHierarchicalClassifications x self = msg_send ~self ~cmd:(selector "setMaximumHierarchicalClassifications:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
let setMaximumLeafClassifications x self = msg_send ~self ~cmd:(selector "setMaximumLeafClassifications:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
