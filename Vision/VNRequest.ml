...
module C = struct
  ...
  let supportsAnyRevision x self = msg_send ~self ~cmd:(selector "supportsAnyRevision:") ~typ:(ullong @-> returning (bool)) (ULLong.of_int x)
...
let applicableDetectorAndOptions x ~forRevision ~loadedInSession ~error self = msg_send ~self ~cmd:(selector "applicableDetectorAndOptions:forRevision:loadedInSession:error:") ~typ:(ptr (id) @-> ullong @-> id @-> ptr (id) @-> returning (id)) x (ULLong.of_int forRevision) loadedInSession error
let applicableDetectorClassAndOptions x ~forRevision ~error self = msg_send ~self ~cmd:(selector "applicableDetectorClassAndOptions:forRevision:error:") ~typ:(ptr (id) @-> ullong @-> ptr (id) @-> returning (_Class)) x (ULLong.of_int forRevision) error
...
let setIoSurfaceMemoryPoolId x self = msg_send ~self ~cmd:(selector "setIoSurfaceMemoryPoolId:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
