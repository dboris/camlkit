...
(** Apple docs: {{:https://developer.apple.com/documentation/vision/vnsceneclassificationrequestconfiguration?language=objc}VNSceneClassificationRequestConfiguration} *)

let self = get_class "VNSceneClassificationRequestConfiguration"
