...
let self = get_class "VNTorsoprint"
...
let emptyTorsoprintDataForRevision x self = msg_send ~self ~cmd:(selector "emptyTorsoprintDataForRevision:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
