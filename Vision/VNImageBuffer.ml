...
let createBufferWithMaxSideLengthOf x ~andPixelFormat ~andOptions ~error self = msg_send ~self ~cmd:(selector "createBufferWithMaxSideLengthOf:andPixelFormat:andOptions:error:") ~typ:(ullong @-> uint @-> id @-> (ptr id) @-> returning (ptr void)) (ULLong.of_int x) andPixelFormat andOptions error
let createCroppedBufferWithMaxSideLengthOf x ~andCropBounds ~andPixelFormat ~andOptions ~error self = msg_send ~self ~cmd:(selector "createCroppedBufferWithMaxSideLengthOf:andCropBounds:andPixelFormat:andOptions:error:") ~typ:(ullong @-> CGRect.t @-> uint @-> id @-> (ptr id) @-> returning (ptr void)) (ULLong.of_int x) andCropBounds andPixelFormat andOptions error
...
let initWithCVPixelBuffer' x ~orientation ~options self = msg_send ~self ~cmd:(selector "initWithCVPixelBuffer:orientation:options:") ~typ:((ptr void) @-> uint @-> id @-> returning id) x orientation options
