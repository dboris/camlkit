...
(** Apple docs: {{:https://developer.apple.com/documentation/vision/vnfacequalitygenerator?language=objc}VNFaceQualityGenerator} *)

let self = get_class "VNFaceQualityGenerator"
