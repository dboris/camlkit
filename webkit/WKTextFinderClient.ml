...
let initWithPage x ~view ~usePlatformFindUI self = msg_send ~self ~cmd:(selector "initWithPage:view:usePlatformFindUI:") ~typ:(ptr void @-> id @-> bool @-> returning (id)) x view usePlatformFindUI
