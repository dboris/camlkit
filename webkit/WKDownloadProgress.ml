...
let initWithDownloadTask x ~download ~_URL ~sandboxExtension self = msg_send ~self ~cmd:(selector "initWithDownloadTask:download:URL:sandboxExtension:") ~typ:(id @-> ptr (void) @-> id @-> ptr void @-> returning (id)) x download _URL sandboxExtension
