...
let initWithFrame3 x ~contextRef ~pageGroupRef ~relatedToPage self = msg_send ~self ~cmd:(selector "initWithFrame:contextRef:pageGroupRef:relatedToPage:") ~typ:(CGRect.t @-> ptr void @-> ptr void @-> ptr void @-> returning (id)) x contextRef pageGroupRef relatedToPage
let initWithFrame4 x ~processGroup ~browsingContextGroup ~relatedToView self = msg_send ~self ~cmd:(selector "initWithFrame:processGroup:browsingContextGroup:relatedToView:") ~typ:(CGRect.t @-> id @-> id @-> id @-> returning (id)) x processGroup browsingContextGroup relatedToView
