...
let initWithFrame3 x ~processPool ~configuration self = msg_send ~self ~cmd:(selector "initWithFrame:processPool:configuration:") ~typ:(CGRect.t @-> ptr void @-> ptr (void) @-> returning (id)) x processPool configuration
