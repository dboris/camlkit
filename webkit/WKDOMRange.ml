...
let rangeByExpandingToWordBoundaryByCharacters x ~inDirection self = msg_send ~self ~cmd:(selector "rangeByExpandingToWordBoundaryByCharacters:inDirection:") ~typ:(ullong @-> llong @-> returning (id)) x inDirection
