...
let _class_ = get_class "WKTextTouchBarItemController"
...
let setCurrentTextAlignment x self = msg_send ~self ~cmd:(selector "setCurrentTextAlignment:") ~typ:(llong @-> returning (void)) x
