...
let contentViewInsetsForContentSize x self = msg_send ~self ~cmd:(selector "contentViewInsetsForContentSize:") ~typ:(CGSize.t @-> returning NSEdgeInsets.t) x
...
let scrollPointAligningItemAtIndex x ~toAlignment self = msg_send ~self ~cmd:(selector "scrollPointAligningItemAtIndex:toAlignment:") ~typ:(llong @-> llong @-> returning CGPoint.t) (LLong.of_int x) (LLong.of_int toAlignment)
let scrollPointAligningItemAtIndex1 x ~toAlignment ~forState self = msg_send ~self ~cmd:(selector "scrollPointAligningItemAtIndex:toAlignment:forState:") ~typ:(llong @-> llong @-> void @-> returning CGPoint.t) (LLong.of_int x) (LLong.of_int toAlignment) forState
let scrollPointAligningItemAtIndex2 x ~toAlignment ~forSelectedIndex ~approximatedScrollPoint self = msg_send ~self ~cmd:(selector "scrollPointAligningItemAtIndex:toAlignment:forSelectedIndex:approximatedScrollPoint:") ~typ:(llong @-> llong @-> llong @-> CGPoint.t @-> returning CGPoint.t) (LLong.of_int x) (LLong.of_int toAlignment) (LLong.of_int forSelectedIndex) approximatedScrollPoint
...
let visibleContentRectForPinningConfiguration x self = msg_send ~self ~cmd:(selector "visibleContentRectForPinningConfiguration:") ~typ:(void @-> returning CGRect.t) x