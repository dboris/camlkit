...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentdragbutton?language=objc}NSDocumentDragButton} *)

let self = get_class "NSDocumentDragButton"
