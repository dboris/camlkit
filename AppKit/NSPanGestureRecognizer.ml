...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspangesturerecognizer?language=objc}NSPanGestureRecognizer} *)

let self = get_class "NSPanGestureRecognizer"
