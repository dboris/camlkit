...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentrevisionswindow?language=objc}NSDocumentRevisionsWindow} *)

let self = get_class "NSDocumentRevisionsWindow"
