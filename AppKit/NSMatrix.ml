...
let cellFrameAtRow x ~column self = msg_send ~self ~cmd:(selector "cellFrameAtRow:column:") ~typ:(llong @-> llong @-> returning CGRect.t) (LLong.of_int x) (LLong.of_int column)
