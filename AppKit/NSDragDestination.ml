...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdragdestination?language=objc}NSDragDestination} *)

let self = get_class "NSDragDestination"
...
let draggedImageLocation self = msg_send ~self ~cmd:(selector "draggedImageLocation") ~typ:(returning CGPoint.t)
