...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspageabletableview?language=objc}NSPageableTableView} *)

let self = get_class "NSPageableTableView"
...
let setDisplayedRowCount x self = msg_send ~self ~cmd:(selector "setDisplayedRowCount:") ~typ:(llong @-> returning void) (LLong.of_int x)
