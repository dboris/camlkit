...
let self = get_class "NSTextField"
...
let boundsOutsetsForTextLayer x self = msg_send ~self ~cmd:(selector "boundsOutsetsForTextLayer:") ~typ:(id @-> returning NSEdgeInsets.t) x
...
let setTextAlignmentPolicy x self = msg_send ~self ~cmd:(selector "setTextAlignmentPolicy:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let textView2 x ~shouldSelectCandidateAtIndex self = msg_send ~self ~cmd:(selector "textView:shouldSelectCandidateAtIndex:") ~typ:(id @-> ullong @-> returning bool) x (ULLong.of_int shouldSelectCandidateAtIndex)
...
let textView6 x ~prepareMenu ~forCharacterAtIndex ~withEvent self = msg_send ~self ~cmd:(selector "textView:prepareMenu:forCharacterAtIndex:withEvent:") ~typ:(id @-> id @-> ullong @-> id @-> returning void) x prepareMenu (ULLong.of_int forCharacterAtIndex) withEvent
