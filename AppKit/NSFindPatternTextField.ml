...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsfindpatterntextfield?language=objc}NSFindPatternTextField} *)

let self = get_class "NSFindPatternTextField"
