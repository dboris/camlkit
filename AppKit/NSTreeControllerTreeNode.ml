...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstreecontrollertreenode?language=objc}NSTreeControllerTreeNode} *)

let self = get_class "NSTreeControllerTreeNode"
