...
let rectOfColumn x self = msg_send ~self ~cmd:(selector "rectOfColumn:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
let rectOfRow x self = msg_send ~self ~cmd:(selector "rectOfRow:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
