...
let self = get_class "NSTableView"
...
let columnAutoresizingStyle self = msg_send ~self ~cmd:(selector "columnAutoresizingStyle") ~typ:(returning ullong) |> ULLong.to_int
let columnForView x self = msg_send ~self ~cmd:(selector "columnForView:") ~typ:(id @-> returning llong) x |> LLong.to_int
let columnIndexesInRect x self = msg_send ~self ~cmd:(selector "columnIndexesInRect:") ~typ:(CGRect.t @-> returning id) x
let columnWithIdentifier x self = msg_send ~self ~cmd:(selector "columnWithIdentifier:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let draggingSession1 x ~sourceOperationMaskForDraggingContext self = msg_send ~self ~cmd:(selector "draggingSession:sourceOperationMaskForDraggingContext:") ~typ:(id @-> llong @-> returning ullong) x (LLong.of_int sourceOperationMaskForDraggingContext) |> ULLong.to_int
...
let editedColumn self = msg_send ~self ~cmd:(selector "editedColumn") ~typ:(returning llong) |> LLong.to_int
let editedRow self = msg_send ~self ~cmd:(selector "editedRow") ~typ:(returning llong) |> LLong.to_int
let effectiveRowSizeStyle self = msg_send ~self ~cmd:(selector "effectiveRowSizeStyle") ~typ:(returning llong) |> LLong.to_int
let effectiveStyle self = msg_send ~self ~cmd:(selector "effectiveStyle") ~typ:(returning llong) |> LLong.to_int
...
let focusedColumn self = msg_send ~self ~cmd:(selector "focusedColumn") ~typ:(returning llong) |> LLong.to_int
...
let groupRowStyle self = msg_send ~self ~cmd:(selector "groupRowStyle") ~typ:(returning llong) |> LLong.to_int
...
let lastSelectedRow self = msg_send ~self ~cmd:(selector "lastSelectedRow") ~typ:(returning llong) |> LLong.to_int
...
let numberOfSelectedColumns self = msg_send ~self ~cmd:(selector "numberOfSelectedColumns") ~typ:(returning llong) |> LLong.to_int
let numberOfSelectedRows self = msg_send ~self ~cmd:(selector "numberOfSelectedRows") ~typ:(returning llong) |> LLong.to_int
...
let rowAtPoint x self = msg_send ~self ~cmd:(selector "rowAtPoint:") ~typ:(CGPoint.t @-> returning llong) x |> LLong.to_int
let rowData self = msg_send ~self ~cmd:(selector "rowData") ~typ:(returning id)
let rowForView x self = msg_send ~self ~cmd:(selector "rowForView:") ~typ:(id @-> returning llong) x |> LLong.to_int
