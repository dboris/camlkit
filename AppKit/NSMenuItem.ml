...
let applicationShortcutItem self = msg_send ~self ~cmd:(selector "applicationShortcutItem") ~typ:(returning id)
...
let keyEquivalentSharingMode self = msg_send ~self ~cmd:(selector "keyEquivalentSharingMode") ~typ:(returning llong) |> LLong.to_int
...
let setKeyEquivalentSharingMode x self = msg_send ~self ~cmd:(selector "setKeyEquivalentSharingMode:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let userKeyEquivalentModifierMask self = msg_send ~self ~cmd:(selector "userKeyEquivalentModifierMask") ~typ:(returning ullong) |> ULLong.to_int
