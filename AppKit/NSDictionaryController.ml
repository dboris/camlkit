...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdictionarycontroller?language=objc}NSDictionaryController} *)

let self = get_class "NSDictionaryController"
