...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorpickersliders?language=objc}NSColorPickerSliders} *)

let self = get_class "NSColorPickerSliders"
