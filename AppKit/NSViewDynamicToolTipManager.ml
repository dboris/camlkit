...
let self = get_class "NSViewDynamicToolTipManager"
...
let view2 x ~customToolTip ~frameForToolTipWithDisplayInfo self = msg_send ~self ~cmd:(selector "view:customToolTip:frameForToolTipWithDisplayInfo:") ~typ:(id @-> llong @-> id @-> returning CGRect.t) x (LLong.of_int customToolTip) frameForToolTipWithDisplayInfo
