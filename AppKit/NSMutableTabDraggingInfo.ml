...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsmutabletabdragginginfo?language=objc}NSMutableTabDraggingInfo} *)

let self = get_class "NSMutableTabDraggingInfo"
