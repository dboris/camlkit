...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nslocalwindowsharingwindow?language=objc}NSLocalWindowSharingWindow} *)

let self = get_class "NSLocalWindowSharingWindow"
