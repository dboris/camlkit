...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscustomtooltipdrawview?language=objc}NSCustomToolTipDrawView} *)

let self = get_class "NSCustomToolTipDrawView"
...
let margin self = msg_send ~self ~cmd:(selector "margin") ~typ:(returning CGSize.t)
