...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsthemeautosavebuttoncell?language=objc}NSThemeAutosaveButtonCell} *)

let self = get_class "NSThemeAutosaveButtonCell"
