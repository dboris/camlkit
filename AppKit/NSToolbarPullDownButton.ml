...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstoolbarpulldownbutton?language=objc}NSToolbarPullDownButton} *)

let self = get_class "NSToolbarPullDownButton"
