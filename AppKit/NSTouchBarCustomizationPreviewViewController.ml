...
let closeButtonFrameForCollectionView x ~layout self = msg_send_stret ~self ~cmd:(selector "closeButtonFrameForCollectionView:layout:") ~typ:(id @-> id @-> returning CGRect.t) ~return_type:CGRect.t x layout
...
let collectionView2 x ~layout ~containmentFrameForSection self = msg_send_stret ~self ~cmd:(selector "collectionView:layout:containmentFrameForSection:") ~typ:(id @-> id @-> llong @-> returning CGRect.t) ~return_type:CGRect.t x layout (LLong.of_int containmentFrameForSection)
let collectionView3 x ~layout ~paddingForSection self = msg_send_stret ~self ~cmd:(selector "collectionView:layout:paddingForSection:") ~typ:(id @-> id @-> llong @-> returning NSEdgeInsets.t) ~return_type:NSEdgeInsets.t x layout (LLong.of_int paddingForSection)
...
let containmentRectForSection x self = msg_send_stret ~self ~cmd:(selector "containmentRectForSection:") ~typ:(llong @-> returning CGRect.t) ~return_type:CGRect.t (LLong.of_int x)
let containmentRectForSectionLayout x self = msg_send_stret ~self ~cmd:(selector "containmentRectForSectionLayout:") ~typ:(id @-> returning CGRect.t) ~return_type:CGRect.t x
...
let cursorEnterAtPoint x ~mouseIsDown ~withItem self = msg_send_stret ~self ~cmd:(selector "cursorEnterAtPoint:mouseIsDown:withItem:") ~typ:(CGPoint.t @-> bool @-> id @-> returning CGPoint.t) ~return_type:CGPoint.t x mouseIsDown withItem
let cursorEnterAtPoint' x ~mouseIsDown ~withPreset self = msg_send_stret ~self ~cmd:(selector "cursorEnterAtPoint:mouseIsDown:withPreset:") ~typ:(CGPoint.t @-> bool @-> id @-> returning CGPoint.t) ~return_type:CGPoint.t x mouseIsDown withPreset
...
let cursorMouseUpAtPoint x self = msg_send_stret ~self ~cmd:(selector "cursorMouseUpAtPoint:") ~typ:(CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t x
let cursorMovedToPoint x ~withDelta ~mouseIsDown self = msg_send_stret ~self ~cmd:(selector "cursorMovedToPoint:withDelta:mouseIsDown:") ~typ:(CGPoint.t @-> CGSize.t @-> bool @-> returning CGPoint.t) ~return_type:CGPoint.t x withDelta mouseIsDown
let cursorPoint self = msg_send_stret ~self ~cmd:(selector "cursorPoint") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
...
let escKeyRect self = msg_send_stret ~self ~cmd:(selector "escKeyRect") ~typ:(returning CGRect.t) ~return_type:CGRect.t
let escapeKeyFrameForCollectionView x ~layout self = msg_send_stret ~self ~cmd:(selector "escapeKeyFrameForCollectionView:layout:") ~typ:(id @-> id @-> returning CGRect.t) ~return_type:CGRect.t x layout
...
let paddingForSection x self = msg_send_stret ~self ~cmd:(selector "paddingForSection:") ~typ:(llong @-> returning NSEdgeInsets.t) ~return_type:NSEdgeInsets.t (LLong.of_int x)
let paddingForSectionLayout x self = msg_send_stret ~self ~cmd:(selector "paddingForSectionLayout:") ~typ:(id @-> returning NSEdgeInsets.t) ~return_type:NSEdgeInsets.t x
