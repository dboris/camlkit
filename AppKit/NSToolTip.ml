...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstooltip?language=objc}NSToolTip} *)

let self = get_class "NSToolTip"
...
let setTrackingNum x self = msg_send ~self ~cmd:(selector "setTrackingNum:") ~typ:(llong @-> returning void) (LLong.of_int x)
