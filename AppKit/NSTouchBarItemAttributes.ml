...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbaritemattributes?language=objc}NSTouchBarItemAttributes} *)

let self = get_class "NSTouchBarItemAttributes"
