...
let self = get_class "NSViewController"
...
let preferredMaximumSize self = msg_send ~self ~cmd:(selector "preferredMaximumSize") ~typ:(returning CGSize.t)
let preferredMinimumSize self = msg_send ~self ~cmd:(selector "preferredMinimumSize") ~typ:(returning CGSize.t)
let preferredScreenOrigin self = msg_send ~self ~cmd:(selector "preferredScreenOrigin") ~typ:(returning CGPoint.t)
