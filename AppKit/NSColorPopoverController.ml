...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorpopovercontroller?language=objc}NSColorPopoverController} *)

let self = get_class "NSColorPopoverController"
