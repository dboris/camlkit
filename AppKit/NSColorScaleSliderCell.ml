...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorscaleslidercell?language=objc}NSColorScaleSliderCell} *)

let self = get_class "NSColorScaleSliderCell"
