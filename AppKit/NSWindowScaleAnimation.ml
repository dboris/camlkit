...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nswindowscaleanimation?language=objc}NSWindowScaleAnimation} *)

let self = get_class "NSWindowScaleAnimation"
