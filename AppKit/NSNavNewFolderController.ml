...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsnavnewfoldercontroller?language=objc}NSNavNewFolderController} *)

let self = get_class "NSNavNewFolderController"
