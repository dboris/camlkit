...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstoolbaritemgrouppickerview?language=objc}NSToolbarItemGroupPickerView} *)

let self = get_class "NSToolbarItemGroupPickerView"
