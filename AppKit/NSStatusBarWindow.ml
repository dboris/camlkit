...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsstatusbarwindow?language=objc}NSStatusBarWindow} *)

let self = get_class "NSStatusBarWindow"
...
let convertBaseToScreen x self = msg_send ~self ~cmd:(selector "convertBaseToScreen:") ~typ:(CGPoint.t @-> returning CGPoint.t) x
