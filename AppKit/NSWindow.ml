...
let accessibilityWindowNumber self = msg_send ~self ~cmd:(selector "accessibilityWindowNumber") ~typ:(returning llong) |> LLong.to_int
...
let anchorAttributeForOrientation x self = msg_send ~self ~cmd:(selector "anchorAttributeForOrientation:") ~typ:(llong @-> returning llong) (LLong.of_int x) |> LLong.to_int
...
let animationBehavior self = msg_send ~self ~cmd:(selector "animationBehavior") ~typ:(returning llong) |> LLong.to_int
...
let backingLocation self = msg_send ~self ~cmd:(selector "backingLocation") ~typ:(returning ullong) |> ULLong.to_int
let backingScaleFactor self = msg_send ~self ~cmd:(selector "backingScaleFactor") ~typ:(returning double)
let backingType self = msg_send ~self ~cmd:(selector "backingType") ~typ:(returning ullong) |> ULLong.to_int
...
let beginServiceSheet x ~completionHandler ~isCritical self = msg_send ~self ~cmd:(selector "beginServiceSheet:completionHandler:isCritical:") ~typ:(id @-> (ptr void) @-> bool @-> returning void) x completionHandler isCritical
...
let collectionBehavior self = msg_send ~self ~cmd:(selector "collectionBehavior") ~typ:(returning ullong) |> ULLong.to_int
...
let contentTitlebarSeparatorStyle self = msg_send ~self ~cmd:(selector "contentTitlebarSeparatorStyle") ~typ:(returning llong) |> LLong.to_int
...
let endHostSheet x self = msg_send ~self ~cmd:(selector "endHostSheet:") ~typ:(id @-> returning void) x
...
let gState self = msg_send ~self ~cmd:(selector "gState") ~typ:(returning llong) |> LLong.to_int
...
let keyViewSelectionDirection self = msg_send ~self ~cmd:(selector "keyViewSelectionDirection") ~typ:(returning ullong) |> ULLong.to_int
let layoutIfNeeded self = msg_send ~self ~cmd:(selector "layoutIfNeeded") ~typ:(returning void)
let level self = msg_send ~self ~cmd:(selector "level") ~typ:(returning llong) |> LLong.to_int
let liveResizeEdges self = msg_send ~self ~cmd:(selector "liveResizeEdges") ~typ:(returning ullong) |> ULLong.to_int
...
let orderedIndex self = msg_send ~self ~cmd:(selector "orderedIndex") ~typ:(returning llong) |> LLong.to_int
...
let preferredBackingLocation self = msg_send ~self ~cmd:(selector "preferredBackingLocation") ~typ:(returning ullong) |> ULLong.to_int
...
let resizeFlags self = msg_send ~self ~cmd:(selector "resizeFlags") ~typ:(returning ullong) |> ULLong.to_int
...
let setViewBridgeBecomingChild x self = msg_send ~self ~cmd:(selector "setViewBridgeBecomingChild:") ~typ:(bool @-> returning void) x
let setViewBridgeHostApp x self = msg_send ~self ~cmd:(selector "setViewBridgeHostApp:") ~typ:(id @-> returning void) x
...
let shadowOptions self = msg_send ~self ~cmd:(selector "shadowOptions") ~typ:(returning ullong) |> ULLong.to_int
let shadowOptionsForActiveAppearance x self = msg_send ~self ~cmd:(selector "shadowOptionsForActiveAppearance:") ~typ:(bool @-> returning ullong) x |> ULLong.to_int
let shadowParameters self = msg_send ~self ~cmd:(selector "shadowParameters") ~typ:(returning id)
let shadowStyle self = msg_send ~self ~cmd:(selector "shadowStyle") ~typ:(returning ullong) |> ULLong.to_int
let sharingIndicator self = msg_send ~self ~cmd:(selector "sharingIndicator") ~typ:(returning id)
let sharingType self = msg_send ~self ~cmd:(selector "sharingType") ~typ:(returning ullong) |> ULLong.to_int
let sheetBehavior self = msg_send ~self ~cmd:(selector "sheetBehavior") ~typ:(returning ullong) |> ULLong.to_int
...
let styleMask self = msg_send ~self ~cmd:(selector "styleMask") ~typ:(returning ullong) |> ULLong.to_int
...
let swizzledAddChildWindow x ~ordered self = msg_send ~self ~cmd:(selector "swizzledAddChildWindow:ordered:") ~typ:(id @-> llong @-> returning void) x (LLong.of_int ordered)
let swizzledBackgroundColor self = msg_send ~self ~cmd:(selector "swizzledBackgroundColor") ~typ:(returning id)
let swizzledBackingScaleFactor self = msg_send ~self ~cmd:(selector "swizzledBackingScaleFactor") ~typ:(returning double)
let swizzledBecomeKeyWindow self = msg_send ~self ~cmd:(selector "swizzledBecomeKeyWindow") ~typ:(returning void)
let swizzledBeginCriticalSheet x ~completionHandler self = msg_send ~self ~cmd:(selector "swizzledBeginCriticalSheet:completionHandler:") ~typ:(id @-> (ptr void) @-> returning void) x completionHandler
let swizzledBeginSheet x ~completionHandler self = msg_send ~self ~cmd:(selector "swizzledBeginSheet:completionHandler:") ~typ:(id @-> (ptr void) @-> returning void) x completionHandler
let swizzledCanBecomeKeyWindow self = msg_send ~self ~cmd:(selector "swizzledCanBecomeKeyWindow") ~typ:(returning bool)
let swizzledCanBecomeMainWindow self = msg_send ~self ~cmd:(selector "swizzledCanBecomeMainWindow") ~typ:(returning bool)
let swizzledConstrainFrameRect x ~toScreen self = msg_send_stret ~self ~cmd:(selector "swizzledConstrainFrameRect:toScreen:") ~typ:(CGRect.t @-> id @-> returning CGRect.t) ~return_type:CGRect.t x toScreen
let swizzledDoOrderWindow x ~relativeTo ~findKey ~forCounter ~force ~isModal self = msg_send ~self ~cmd:(selector "swizzledDoOrderWindow:relativeTo:findKey:forCounter:force:isModal:") ~typ:(llong @-> llong @-> bool @-> bool @-> bool @-> bool @-> returning void) (LLong.of_int x) (LLong.of_int relativeTo) findKey forCounter force isModal
let swizzledDragWindowRelativeToMouseDown x self = msg_send ~self ~cmd:(selector "swizzledDragWindowRelativeToMouseDown:") ~typ:(CGPoint.t @-> returning void) x
let swizzledEndSheet x self = msg_send ~self ~cmd:(selector "swizzledEndSheet:") ~typ:(id @-> returning void) x
let swizzledEndSheet' x ~returnCode self = msg_send ~self ~cmd:(selector "swizzledEndSheet:returnCode:") ~typ:(id @-> llong @-> returning void) x (LLong.of_int returnCode)
let swizzledHierarchyDidChangeInView x self = msg_send ~self ~cmd:(selector "swizzledHierarchyDidChangeInView:") ~typ:(id @-> returning void) x
let swizzledHostWindowIsKey self = msg_send ~self ~cmd:(selector "swizzledHostWindowIsKey") ~typ:(returning bool)
let swizzledIsEffectivelyVisible self = msg_send ~self ~cmd:(selector "swizzledIsEffectivelyVisible") ~typ:(returning bool)
let swizzledIsKeyWindow self = msg_send ~self ~cmd:(selector "swizzledIsKeyWindow") ~typ:(returning bool)
let swizzledIsRunningADocModalAttachedSheet self = msg_send ~self ~cmd:(selector "swizzledIsRunningADocModalAttachedSheet") ~typ:(returning bool)
let swizzledMakeFirstResponder x self = msg_send ~self ~cmd:(selector "swizzledMakeFirstResponder:") ~typ:(id @-> returning bool) x
let swizzledOrderFrontRelativeToWindow x self = msg_send ~self ~cmd:(selector "swizzledOrderFrontRelativeToWindow:") ~typ:(id @-> returning void) x
let swizzledOrderedDrawerAndWindowKeyLoopGroupingViews self = msg_send ~self ~cmd:(selector "swizzledOrderedDrawerAndWindowKeyLoopGroupingViews") ~typ:(returning id)
let swizzledRegionForOpaqueViewsBlockingDraggableFrame x self = msg_send ~self ~cmd:(selector "swizzledRegionForOpaqueViewsBlockingDraggableFrame:") ~typ:(CGRect.t @-> returning (ptr void)) x
let swizzledRemoveChildWindow x self = msg_send ~self ~cmd:(selector "swizzledRemoveChildWindow:") ~typ:(id @-> returning void) x
let swizzledResignKeyWindow self = msg_send ~self ~cmd:(selector "swizzledResignKeyWindow") ~typ:(returning void)
let swizzledSelectKeyViewFollowingView x self = msg_send ~self ~cmd:(selector "swizzledSelectKeyViewFollowingView:") ~typ:(id @-> returning void) x
let swizzledSelectKeyViewPrecedingView x self = msg_send ~self ~cmd:(selector "swizzledSelectKeyViewPrecedingView:") ~typ:(id @-> returning void) x
let swizzledSendEvent x self = msg_send ~self ~cmd:(selector "swizzledSendEvent:") ~typ:(id @-> returning void) x
let swizzledSetBackgroundColor x self = msg_send ~self ~cmd:(selector "swizzledSetBackgroundColor:") ~typ:(id @-> returning void) x
let swizzledSetCursorForMouseLocation x self = msg_send ~self ~cmd:(selector "swizzledSetCursorForMouseLocation:") ~typ:(CGPoint.t @-> returning void) x
let swizzledSetEventMask x self = msg_send ~self ~cmd:(selector "swizzledSetEventMask:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let swizzledSetFrameCommon x ~display ~stashSize self = msg_send ~self ~cmd:(selector "swizzledSetFrameCommon:display:stashSize:") ~typ:(CGRect.t @-> bool @-> bool @-> returning void) x display stashSize
let swizzledSetHidesOnDeactivate x self = msg_send ~self ~cmd:(selector "swizzledSetHidesOnDeactivate:") ~typ:(bool @-> returning void) x
let swizzledSetMouseMovedEventsEnabled x self = msg_send ~self ~cmd:(selector "swizzledSetMouseMovedEventsEnabled:") ~typ:(bool @-> returning void) x
let swizzledSetStyleMask x self = msg_send ~self ~cmd:(selector "swizzledSetStyleMask:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let swizzledShake self = msg_send ~self ~cmd:(selector "swizzledShake") ~typ:(returning void)
let swizzledStyleMask self = msg_send ~self ~cmd:(selector "swizzledStyleMask") ~typ:(returning ullong) |> ULLong.to_int
let swizzledUpdateConstraintsIfNeeded self = msg_send ~self ~cmd:(selector "swizzledUpdateConstraintsIfNeeded") ~typ:(returning void)
let swizzledWindowForSheetMovementAndOrderingGroups self = msg_send ~self ~cmd:(selector "swizzledWindowForSheetMovementAndOrderingGroups") ~typ:(returning id)
...
let tabbingMode self = msg_send ~self ~cmd:(selector "tabbingMode") ~typ:(returning llong) |> LLong.to_int
...
let titleMode self = msg_send ~self ~cmd:(selector "titleMode") ~typ:(returning llong) |> LLong.to_int
let titlePosition self = msg_send ~self ~cmd:(selector "titlePosition") ~typ:(returning llong) |> LLong.to_int
let titleVisibility self = msg_send ~self ~cmd:(selector "titleVisibility") ~typ:(returning llong) |> LLong.to_int
...
let titlebarBlendingMode self = msg_send ~self ~cmd:(selector "titlebarBlendingMode") ~typ:(returning llong) |> LLong.to_int
...
let toolbarStyle self = msg_send ~self ~cmd:(selector "toolbarStyle") ~typ:(returning llong) |> LLong.to_int
...
let uniqueID self = msg_send ~self ~cmd:(selector "uniqueID") ~typ:(returning llong) |> LLong.to_int
...
let viewBridgeBecomingChild self = msg_send ~self ~cmd:(selector "viewBridgeBecomingChild") ~typ:(returning bool)
let viewBridgeHostApp self = msg_send ~self ~cmd:(selector "viewBridgeHostApp") ~typ:(returning id)
...
let windowTitlebarLayoutDirection self = msg_send ~self ~cmd:(selector "windowTitlebarLayoutDirection") ~typ:(returning llong) |> LLong.to_int
