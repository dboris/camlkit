...
let self = get_class "NSAccessibilityElement"
...
let accessibilityAddChildElement x self = msg_send ~self ~cmd:(selector "accessibilityAddChildElement:") ~typ:(id @-> returning void) x
