...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscollectionviewitem?language=objc}NSCollectionViewItem} *)

let self = get_class "NSCollectionViewItem"
...
let setHighlightState x self = msg_send ~self ~cmd:(selector "setHighlightState:") ~typ:(llong @-> returning void) (LLong.of_int x)
