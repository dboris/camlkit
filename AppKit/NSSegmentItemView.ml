...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nssegmentitemview?language=objc}NSSegmentItemView} *)

let self = get_class "NSSegmentItemView"
...
let imageRect self = msg_send ~self ~cmd:(selector "imageRect") ~typ:(returning CGRect.t)
...
let labelRect self = msg_send ~self ~cmd:(selector "labelRect") ~typ:(returning CGRect.t)
...
let setLeadingSegmentHighlightState x self = msg_send ~self ~cmd:(selector "setLeadingSegmentHighlightState:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let setTrailingSegmentHighlightState x self = msg_send ~self ~cmd:(selector "setTrailingSegmentHighlightState:") ~typ:(llong @-> returning void) (LLong.of_int x)
