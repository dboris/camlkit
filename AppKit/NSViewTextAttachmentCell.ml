...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsviewtextattachmentcell?language=objc}NSViewTextAttachmentCell} *)

let self = get_class "NSViewTextAttachmentCell"
