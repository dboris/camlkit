...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsslidertouchbaritem?language=objc}NSSliderTouchBarItem} *)

let self = get_class "NSSliderTouchBarItem"
