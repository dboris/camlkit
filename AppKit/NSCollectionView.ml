...
let frameForItemAtIndex x self = msg_send ~self ~cmd:(selector "frameForItemAtIndex:") ~typ:(ullong @-> returning CGRect.t) (ULLong.of_int x)
let frameForItemAtIndex' x ~withNumberOfItems self = msg_send ~self ~cmd:(selector "frameForItemAtIndex:withNumberOfItems:") ~typ:(ullong @-> ullong @-> returning CGRect.t) (ULLong.of_int x) (ULLong.of_int withNumberOfItems)
