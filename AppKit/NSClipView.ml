...
let constrainBoundsRect x self = msg_send_stret ~self ~cmd:(selector "constrainBoundsRect:") ~typ:(CGRect.t @-> returning CGRect.t) ~return_type:CGRect.t x
let constrainScrollPoint x self = msg_send_stret ~self ~cmd:(selector "constrainScrollPoint:") ~typ:(CGPoint.t @-> returning CGPoint.t) ~return_type:CGPoint.t x
...
let scrollVelocity self = msg_send_stret ~self ~cmd:(selector "scrollVelocity") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
