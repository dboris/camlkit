...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdynamicmodifiedcolor?language=objc}NSDynamicModifiedColor} *)

let self = get_class "NSDynamicModifiedColor"
