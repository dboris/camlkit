...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstableviewcellproxy?language=objc}NSTableViewCellProxy} *)

let self = get_class "NSTableViewCellProxy"
