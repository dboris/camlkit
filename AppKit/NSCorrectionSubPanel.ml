...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscorrectionsubpanel?language=objc}NSCorrectionSubPanel} *)

let self = get_class "NSCorrectionSubPanel"
