...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarview?language=objc}NSTouchBarView} *)

let self = get_class "NSTouchBarView"
...
let rectForItem x self = msg_send_stret ~self ~cmd:(selector "rectForItem:") ~typ:(id @-> returning CGRect.t) ~return_type:CGRect.t x
