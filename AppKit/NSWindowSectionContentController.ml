...
let self = get_class "NSWindowSectionContentController"
...
let dividerExtentRect self = msg_send_stret ~self ~cmd:(selector "dividerExtentRect") ~typ:(returning CGRect.t) ~return_type:CGRect.t
