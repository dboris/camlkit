...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nslocalwindowsharingwindowcontroller?language=objc}NSLocalWindowSharingWindowController} *)

let self = get_class "NSLocalWindowSharingWindowController"
