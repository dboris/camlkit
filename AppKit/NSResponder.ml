...
let self = get_class "NSResponder"
...
let additionalQuickActionItemSource self = msg_send ~self ~cmd:(selector "additionalQuickActionItemSource") ~typ:(returning id)
...
let changeModeWithEvent x self = msg_send ~self ~cmd:(selector "changeModeWithEvent:") ~typ:(id @-> returning void) x
...
let dependencyInfo self = msg_send ~self ~cmd:(selector "dependencyInfo") ~typ:(returning id)
...
let interfaceStyle self = msg_send ~self ~cmd:(selector "interfaceStyle") ~typ:(returning ullong) |> ULLong.to_int
let interpretKeyEvents x self = msg_send ~self ~cmd:(selector "interpretKeyEvents:") ~typ:(id @-> returning void) x
let invalidateRequestor self = msg_send ~self ~cmd:(selector "invalidateRequestor") ~typ:(returning void)
...
let navigateWithEvent x self = msg_send ~self ~cmd:(selector "navigateWithEvent:") ~typ:(id @-> returning void) x
...
let quickAction x ~sourceWindowForRequestor self = msg_send ~self ~cmd:(selector "quickAction:sourceWindowForRequestor:") ~typ:(id @-> id @-> returning id) x sourceWindowForRequestor
let quickAction1 x ~didFailWithRequestor ~error self = msg_send ~self ~cmd:(selector "quickAction:didFailWithRequestor:error:") ~typ:(id @-> id @-> id @-> returning void) x didFailWithRequestor error
let quickAction2 x ~anchoringViewForRequestor ~showRelativeToRect ~preferredEdge self = msg_send ~self ~cmd:(selector "quickAction:anchoringViewForRequestor:showRelativeToRect:preferredEdge:") ~typ:(id @-> id @-> (ptr CGRect.t) @-> (ptr ullong) @-> returning id) x anchoringViewForRequestor showRelativeToRect preferredEdge
...
let servicesRequestor self = msg_send ~self ~cmd:(selector "servicesRequestor") ~typ:(returning id)
...
let setDependencyInfo x self = msg_send ~self ~cmd:(selector "setDependencyInfo:") ~typ:(id @-> returning void) x
...
let showContextHelp x self = msg_send ~self ~cmd:(selector "showContextHelp:") ~typ:(id @-> returning void) x
...
let tabletProximity x self = msg_send ~self ~cmd:(selector "tabletProximity:") ~typ:(id @-> returning void) x
...
let wantsForwardedScrollEvents self = msg_send ~self ~cmd:(selector "wantsForwardedScrollEvents") ~typ:(returning bool)
let wantsForwardedScrollEventsForAxis x self = msg_send ~self ~cmd:(selector "wantsForwardedScrollEventsForAxis:") ~typ:(llong @-> returning bool) (LLong.of_int x)
