...
let self = get_class "NSButtonCell"
...
let setGradientType x self = msg_send ~self ~cmd:(selector "setGradientType:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let setShowsStateBy x self = msg_send ~self ~cmd:(selector "setShowsStateBy:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
