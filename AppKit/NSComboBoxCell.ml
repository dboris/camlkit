...
let self = get_class "NSComboBoxCell"
...
let boundsForButtonCell x self = msg_send ~self ~cmd:(selector "boundsForButtonCell:") ~typ:(CGRect.t @-> returning CGRect.t) x
let boundsForTextCell x self = msg_send ~self ~cmd:(selector "boundsForTextCell:") ~typ:(CGRect.t @-> returning CGRect.t) x
...
let frameForPopUpWithOldFrame x ~cellFrame ~controlView self = msg_send ~self ~cmd:(selector "frameForPopUpWithOldFrame:cellFrame:controlView:") ~typ:(CGRect.t @-> CGRect.t @-> id @-> returning CGRect.t) x cellFrame controlView
