...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsviewlayerhostingcontext?language=objc}NSViewLayerHostingContext} *)

let self = get_class "NSViewLayerHostingContext"
