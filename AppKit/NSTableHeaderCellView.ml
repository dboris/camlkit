...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstableheadercellview?language=objc}NSTableHeaderCellView} *)

let self = get_class "NSTableHeaderCellView"
