...
let accessibilityCharacterRangeForLineNumber x self = msg_send ~self ~cmd:(selector "accessibilityCharacterRangeForLineNumber:") ~typ:(ullong @-> returning NSRange.t) (ULLong.of_int x)
...
let accessibilityStyleRangeForCharacterIndex x self = msg_send ~self ~cmd:(selector "accessibilityStyleRangeForCharacterIndex:") ~typ:(ullong @-> returning NSRange.t) (ULLong.of_int x)
