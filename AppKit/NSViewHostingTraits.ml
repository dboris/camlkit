...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsviewhostingtraits?language=objc}NSViewHostingTraits} *)

let self = get_class "NSViewHostingTraits"
...
let hostingBounds self = msg_send ~self ~cmd:(selector "hostingBounds") ~typ:(returning CGRect.t)
