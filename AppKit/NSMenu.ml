...
let addItemWithTitle x ~action ~keyEquivalent self = msg_send ~self ~cmd:(selector "addItemWithTitle:action:keyEquivalent:") ~typ:(id @-> _SEL @-> id @-> returning id) x action keyEquivalent
let allowsContextMenuPlugIns self = msg_send ~self ~cmd:(selector "allowsContextMenuPlugIns") ~typ:(returning bool)
...
let attachedMenu self = msg_send ~self ~cmd:(selector "attachedMenu") ~typ:(returning id)
let autoenablesItems self = msg_send ~self ~cmd:(selector "autoenablesItems") ~typ:(returning bool)
let cancelTracking self = msg_send ~self ~cmd:(selector "cancelTracking") ~typ:(returning void)
let cancelTrackingWithoutAnimation self = msg_send ~self ~cmd:(selector "cancelTrackingWithoutAnimation") ~typ:(returning void)
let contextMenuRepresentation self = msg_send ~self ~cmd:(selector "contextMenuRepresentation") ~typ:(returning id)
...
let highlightItem x self = msg_send ~self ~cmd:(selector "highlightItem:") ~typ:(id @-> returning void) x
let highlightedItem self = msg_send ~self ~cmd:(selector "highlightedItem") ~typ:(returning id)
...
let indexOfItemWithSubmenu x self = msg_send ~self ~cmd:(selector "indexOfItemWithSubmenu:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let insertItem x ~atIndex self = msg_send ~self ~cmd:(selector "insertItem:atIndex:") ~typ:(id @-> llong @-> returning void) x (LLong.of_int atIndex)
let insertItemWithTitle x ~action ~keyEquivalent ~atIndex self = msg_send ~self ~cmd:(selector "insertItemWithTitle:action:keyEquivalent:atIndex:") ~typ:(id @-> _SEL @-> id @-> llong @-> returning id) x action keyEquivalent (LLong.of_int atIndex)
...
let isTornOff self = msg_send ~self ~cmd:(selector "isTornOff") ~typ:(returning bool)
...
let itemChanged x self = msg_send ~self ~cmd:(selector "itemChanged:") ~typ:(id @-> returning void) x
let itemWithTag x self = msg_send ~self ~cmd:(selector "itemWithTag:") ~typ:(llong @-> returning id) (LLong.of_int x)
let itemWithTitle x self = msg_send ~self ~cmd:(selector "itemWithTitle:") ~typ:(id @-> returning id) x
let locationForSubmenu x self = msg_send_stret ~self ~cmd:(selector "locationForSubmenu:") ~typ:(id @-> returning CGPoint.t) ~return_type:CGPoint.t x
let menuBarHeight self = msg_send ~self ~cmd:(selector "menuBarHeight") ~typ:(returning double)
let menuChangedMessagesEnabled self = msg_send ~self ~cmd:(selector "menuChangedMessagesEnabled") ~typ:(returning bool)
let menuRepresentation self = msg_send ~self ~cmd:(selector "menuRepresentation") ~typ:(returning id)
...
let popUpMenuPositioningItem x ~atLocation ~inView self = msg_send ~self ~cmd:(selector "popUpMenuPositioningItem:atLocation:inView:") ~typ:(id @-> CGPoint.t @-> id @-> returning bool) x atLocation inView
let popUpMenuPositioningItem' x ~atLocation ~inView ~appearance self = msg_send ~self ~cmd:(selector "popUpMenuPositioningItem:atLocation:inView:appearance:") ~typ:(id @-> CGPoint.t @-> id @-> id @-> returning bool) x atLocation inView appearance
let presentControllerAsModalWindow x self = msg_send ~self ~cmd:(selector "presentControllerAsModalWindow:") ~typ:(id @-> returning void) x
let propertiesToUpdate self = msg_send ~self ~cmd:(selector "propertiesToUpdate") ~typ:(returning ullong) |> ULLong.to_int
let recordKeyboardShortcutEvent x ~withKeyEquivalent ~modifierMask ~title self = msg_send ~self ~cmd:(selector "recordKeyboardShortcutEvent:withKeyEquivalent:modifierMask:title:") ~typ:(id @-> id @-> ullong @-> id @-> returning void) x withKeyEquivalent (ULLong.of_int modifierMask) title
...
let setAllowsContextMenuPlugIns x self = msg_send ~self ~cmd:(selector "setAllowsContextMenuPlugIns:") ~typ:(bool @-> returning void) x
...
let setContextMenuRepresentation x self = msg_send ~self ~cmd:(selector "setContextMenuRepresentation:") ~typ:(id @-> returning void) x
...
let setItemArray x self = msg_send ~self ~cmd:(selector "setItemArray:") ~typ:(id @-> returning void) x
let setMenuChangedMessagesEnabled x self = msg_send ~self ~cmd:(selector "setMenuChangedMessagesEnabled:") ~typ:(bool @-> returning void) x
let setMenuRepresentation x self = msg_send ~self ~cmd:(selector "setMenuRepresentation:") ~typ:(id @-> returning void) x
...
let setShowsStateColumn x self = msg_send ~self ~cmd:(selector "setShowsStateColumn:") ~typ:(bool @-> returning void) x
let setSubmenu x ~forItem self = msg_send ~self ~cmd:(selector "setSubmenu:forItem:") ~typ:(id @-> id @-> returning void) x forItem
let setSupermenu x self = msg_send ~self ~cmd:(selector "setSupermenu:") ~typ:(id @-> returning void) x
let setTearOffMenuRepresentation x self = msg_send ~self ~cmd:(selector "setTearOffMenuRepresentation:") ~typ:(id @-> returning void) x
...
let showsStateColumn self = msg_send ~self ~cmd:(selector "showsStateColumn") ~typ:(returning bool)
...
let tearOffMenuRepresentation self = msg_send ~self ~cmd:(selector "tearOffMenuRepresentation") ~typ:(returning id)
