...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsscrubberflowlayout?language=objc}NSScrubberFlowLayout} *)

let self = get_class "NSScrubberFlowLayout"
