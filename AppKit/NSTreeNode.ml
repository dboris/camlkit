...
let insertObject x ~inSubNodesAtIndex self = msg_send ~self ~cmd:(selector "insertObject:inSubNodesAtIndex:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int inSubNodesAtIndex)
...
let objectInSubNodesAtIndex x self = msg_send ~self ~cmd:(selector "objectInSubNodesAtIndex:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
...
let removeObjectFromSubNodesAtIndex x self = msg_send ~self ~cmd:(selector "removeObjectFromSubNodesAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let subnodeAtIndex x self = msg_send ~self ~cmd:(selector "subnodeAtIndex:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
