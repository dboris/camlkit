...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorpickerpencils?language=objc}NSColorPickerPencils} *)

let self = get_class "NSColorPickerPencils"
