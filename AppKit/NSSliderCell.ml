...
let self = get_class "NSSliderCell"
...
let knobValueRangeRect x self = msg_send_stret ~self ~cmd:(selector "knobValueRangeRect:") ~typ:(bool @-> returning CGRect.t) ~return_type:CGRect.t x
