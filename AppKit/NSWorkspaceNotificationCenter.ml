...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsworkspacenotificationcenter?language=objc}NSWorkspaceNotificationCenter} *)

let self = get_class "NSWorkspaceNotificationCenter"
