...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nskeyvaluedependencyinfo?language=objc}NSKeyValueDependencyInfo} *)

let self = get_class "NSKeyValueDependencyInfo"
