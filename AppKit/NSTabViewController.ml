...
let self = get_class "NSTabViewController"
...
let moveTabViewItem x ~toIndex self = msg_send ~self ~cmd:(selector "moveTabViewItem:toIndex:") ~typ:(id @-> llong @-> returning void) x (LLong.of_int toIndex)
...
let setTabStyle x self = msg_send ~self ~cmd:(selector "setTabStyle:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let setTransitionOptions x self = msg_send ~self ~cmd:(selector "setTransitionOptions:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
