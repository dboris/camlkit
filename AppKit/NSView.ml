...
let addToolTipRect x ~owner ~userData self = msg_send ~self ~cmd:(selector "addToolTipRect:owner:userData:") ~typ:(CGRect.t @-> id @-> (ptr void) @-> returning llong) x owner userData |> LLong.to_int
let addTrackingArea x self = msg_send ~self ~cmd:(selector "addTrackingArea:") ~typ:(id @-> returning void) x
let addTrackingRect x ~owner ~userData ~assumeInside self = msg_send ~self ~cmd:(selector "addTrackingRect:owner:userData:assumeInside:") ~typ:(CGRect.t @-> id @-> (ptr void) @-> bool @-> returning llong) x owner userData assumeInside |> LLong.to_int
...
let compareGeometry x self = msg_send ~self ~cmd:(selector "compareGeometry:") ~typ:(id @-> returning llong) x |> LLong.to_int
...
let layerContentsPlacement self = msg_send ~self ~cmd:(selector "layerContentsPlacement") ~typ:(returning llong) |> LLong.to_int
...
let quickLookFrame self = msg_send_stret ~self ~cmd:(selector "quickLookFrame") ~typ:(returning CGRect.t) ~return_type:CGRect.t
let quickLookLayer self = msg_send ~self ~cmd:(selector "quickLookLayer") ~typ:(returning id)
let quickLookView self = msg_send ~self ~cmd:(selector "quickLookView") ~typ:(returning id)
let quickLookViewController self = msg_send ~self ~cmd:(selector "quickLookViewController") ~typ:(returning id)
...
let setQuickLookFrame x self = msg_send ~self ~cmd:(selector "setQuickLookFrame:") ~typ:(CGRect.t @-> returning void) x
...
let swizzledAccessibilityAttributeValue x self = msg_send ~self ~cmd:(selector "swizzledAccessibilityAttributeValue:") ~typ:(id @-> returning id) x
let swizzledviewDidChangeEffectiveAppearance self = msg_send ~self ~cmd:(selector "swizzledviewDidChangeEffectiveAppearance") ~typ:(returning void)
