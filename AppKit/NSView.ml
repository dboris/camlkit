...
let computedSafeAreaInsets self = msg_send ~self ~cmd:(selector "computedSafeAreaInsets") ~typ:(returning NSEdgeInsets.t)
...
let frameTransform self = msg_send ~self ~cmd:(selector "frameTransform") ~typ:(returning CGAffineTransform.t)
...
let view1 x ~customToolTip ~frameForToolTipWithDisplayInfo self = msg_send ~self ~cmd:(selector "view:customToolTip:frameForToolTipWithDisplayInfo:") ~typ:(id @-> llong @-> id @-> returning CGRect.t) x (LLong.of_int customToolTip) frameForToolTipWithDisplayInfo
