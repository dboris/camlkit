...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsapplicationextensionsession?language=objc}NSApplicationExtensionSession} *)

let self = get_class "NSApplicationExtensionSession"
