...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsprintthumbnailview?language=objc}NSPrintThumbnailView} *)

let self = get_class "NSPrintThumbnailView"
...
let setBasePageNumber x self = msg_send ~self ~cmd:(selector "setBasePageNumber:") ~typ:(llong @-> returning void) (LLong.of_int x)
