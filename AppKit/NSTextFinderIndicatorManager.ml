...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstextfinderindicatormanager?language=objc}NSTextFinderIndicatorManager} *)

let self = get_class "NSTextFinderIndicatorManager"
