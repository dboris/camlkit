...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentcontrolleropening?language=objc}NSDocumentControllerOpening} *)

let self = get_class "NSDocumentControllerOpening"
