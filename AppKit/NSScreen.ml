...
let backingAlignedRect x ~options self = msg_send ~self ~cmd:(selector "backingAlignedRect:options:") ~typ:(CGRect.t @-> ullong @-> returning CGRect.t) x (ULLong.of_int options)
