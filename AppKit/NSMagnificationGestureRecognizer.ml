...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsmagnificationgesturerecognizer?language=objc}NSMagnificationGestureRecognizer} *)

let self = get_class "NSMagnificationGestureRecognizer"
