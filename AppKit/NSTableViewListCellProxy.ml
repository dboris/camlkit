...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstableviewlistcellproxy?language=objc}NSTableViewListCellProxy} *)

let self = get_class "NSTableViewListCellProxy"
