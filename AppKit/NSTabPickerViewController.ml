...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstabpickerviewcontroller?language=objc}NSTabPickerViewController} *)

let self = get_class "NSTabPickerViewController"
...
let frameForVisualTabPickerController x self = msg_send ~self ~cmd:(selector "frameForVisualTabPickerController:") ~typ:(id @-> returning CGRect.t) x
let frameForWindowContentAnimation self = msg_send ~self ~cmd:(selector "frameForWindowContentAnimation") ~typ:(returning CGRect.t)
