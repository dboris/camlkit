...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsthemeframebackgrounddelegate?language=objc}NSThemeFrameBackgroundDelegate} *)

let self = get_class "NSThemeFrameBackgroundDelegate"
