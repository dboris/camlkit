...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstextfinderbarsearchfieldcell?language=objc}NSTextFinderBarSearchFieldCell} *)

let self = get_class "NSTextFinderBarSearchFieldCell"
