...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstableviewchildcellproxy?language=objc}NSTableViewChildCellProxy} *)

let self = get_class "NSTableViewChildCellProxy"
