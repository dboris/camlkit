...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentconflictpanelcontroller?language=objc}NSDocumentConflictPanelController} *)

let self = get_class "NSDocumentConflictPanelController"
...
let previewPanel3 x ~sourceFrameOnScreenForPreviewItem self = msg_send ~self ~cmd:(selector "previewPanel:sourceFrameOnScreenForPreviewItem:") ~typ:(id @-> id @-> returning CGRect.t) x sourceFrameOnScreenForPreviewItem
