...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorpickerpencilview?language=objc}NSColorPickerPencilView} *)

let self = get_class "NSColorPickerPencilView"
