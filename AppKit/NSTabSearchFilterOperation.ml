...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstabsearchfilteroperation?language=objc}NSTabSearchFilterOperation} *)

let self = get_class "NSTabSearchFilterOperation"
