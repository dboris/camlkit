...
let self = get_class "NSSplitView"
...
let cursorRectForDividerAtIndex x self = msg_send ~self ~cmd:(selector "cursorRectForDividerAtIndex:") ~typ:(llong @-> returning CGRect.t) (LLong.of_int x)
