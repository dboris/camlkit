...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsconcurrenteventmonitor?language=objc}NSConcurrentEventMonitor} *)

let self = get_class "NSConcurrentEventMonitor"
