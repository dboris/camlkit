...
let splitView1 x ~additionalEffectiveRectOfDividerAtIndex self = msg_send ~self ~cmd:(selector "splitView:additionalEffectiveRectOfDividerAtIndex:") ~typ:(id @-> llong @-> returning CGRect.t) x (LLong.of_int additionalEffectiveRectOfDividerAtIndex)
...
let splitView6 x ~effectiveRect ~forDrawnRect ~ofDividerAtIndex self = msg_send ~self ~cmd:(selector "splitView:effectiveRect:forDrawnRect:ofDividerAtIndex:") ~typ:(id @-> CGRect.t @-> CGRect.t @-> llong @-> returning CGRect.t) x effectiveRect forDrawnRect (LLong.of_int ofDividerAtIndex)
