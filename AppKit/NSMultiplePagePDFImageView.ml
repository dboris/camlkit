...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsmultiplepagepdfimageview?language=objc}NSMultiplePagePDFImageView} *)

let self = get_class "NSMultiplePagePDFImageView"
