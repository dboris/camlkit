...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsprintcopyinggraphicscontext?language=objc}NSPrintCopyingGraphicsContext} *)

let self = get_class "NSPrintCopyingGraphicsContext"
