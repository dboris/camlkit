...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsstatusitemnavigationcontroller?language=objc}NSStatusItemNavigationController} *)

let self = get_class "NSStatusItemNavigationController"
