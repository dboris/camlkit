...
let characterIndexForInsertionAtPoint x self = msg_send ~self ~cmd:(selector "characterIndexForInsertionAtPoint:") ~typ:(CGPoint.t @-> returning ullong) x |> ULLong.to_int
...
let characterRangeForRect x self = msg_send_stret ~self ~cmd:(selector "characterRangeForRect:") ~typ:(CGRect.t @-> returning NSRange.t) ~return_type:NSRange.t x
...
let dragOperationForDraggingInfo x ~type_ self = msg_send ~self ~cmd:(selector "dragOperationForDraggingInfo:type:") ~typ:(id @-> id @-> returning ullong) x type_ |> ULLong.to_int
...
let draggingSession x ~sourceOperationMaskForDraggingContext self = msg_send ~self ~cmd:(selector "draggingSession:sourceOperationMaskForDraggingContext:") ~typ:(id @-> llong @-> returning ullong) x (LLong.of_int sourceOperationMaskForDraggingContext) |> ULLong.to_int
...
let firstSelectedRange self = msg_send_stret ~self ~cmd:(selector "firstSelectedRange") ~typ:(returning NSRange.t) ~return_type:NSRange.t
...
let highlightBoundingRectForCharacterRange x ~highlightStyle self = msg_send_stret ~self ~cmd:(selector "highlightBoundingRectForCharacterRange:highlightStyle:") ~typ:(NSRange.t @-> ullong @-> returning CGRect.t) ~return_type:CGRect.t x (ULLong.of_int highlightStyle)
...
let numberOfPreviewItemsInPreviewPanel x self = msg_send ~self ~cmd:(selector "numberOfPreviewItemsInPreviewPanel:") ~typ:(id @-> returning ullong) x |> ULLong.to_int
...
let previewPanel1 x ~sourceFrameOnScreenForPreviewItem self = msg_send_stret ~self ~cmd:(selector "previewPanel:sourceFrameOnScreenForPreviewItem:") ~typ:(id @-> id @-> returning CGRect.t) ~return_type:CGRect.t x sourceFrameOnScreenForPreviewItem
...
let rangeForUserCharacterAttributeChange self = msg_send_stret ~self ~cmd:(selector "rangeForUserCharacterAttributeChange") ~typ:(returning NSRange.t) ~return_type:NSRange.t
...
let rangeForUserParagraphAttributeChange self = msg_send_stret ~self ~cmd:(selector "rangeForUserParagraphAttributeChange") ~typ:(returning NSRange.t) ~return_type:NSRange.t
let rangeForUserTextChange self = msg_send_stret ~self ~cmd:(selector "rangeForUserTextChange") ~typ:(returning NSRange.t) ~return_type:NSRange.t
...
let rulerView5 x ~pointForLocation self = msg_send_stret ~self ~cmd:(selector "rulerView:pointForLocation:") ~typ:(id @-> double @-> returning CGPoint.t) ~return_type:CGPoint.t x pointForLocation
...
let selectionAffinity self = msg_send ~self ~cmd:(selector "selectionAffinity") ~typ:(returning ullong) |> ULLong.to_int
let selectionGranularity self = msg_send ~self ~cmd:(selector "selectionGranularity") ~typ:(returning ullong) |> ULLong.to_int
let selectionItems self = msg_send ~self ~cmd:(selector "selectionItems") ~typ:(returning id)
let selectionRangeForProposedRange x ~granularity self = msg_send_stret ~self ~cmd:(selector "selectionRangeForProposedRange:granularity:") ~typ:(NSRange.t @-> ullong @-> returning NSRange.t) ~return_type:NSRange.t x (ULLong.of_int granularity)
...
let smartDeleteRangeForProposedRange x self = msg_send_stret ~self ~cmd:(selector "smartDeleteRangeForProposedRange:") ~typ:(NSRange.t @-> returning NSRange.t) ~return_type:NSRange.t x
...
let textContainerInset self = msg_send_stret ~self ~cmd:(selector "textContainerInset") ~typ:(returning CGSize.t) ~return_type:CGSize.t
let textContainerInsets self = msg_send_stret ~self ~cmd:(selector "textContainerInsets") ~typ:(returning NSEdgeInsets.t) ~return_type:NSEdgeInsets.t
...
let viewportAnchor self = msg_send_stret ~self ~cmd:(selector "viewportAnchor") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let viewportBounds self = msg_send_stret ~self ~cmd:(selector "viewportBounds") ~typ:(returning CGRect.t) ~return_type:CGRect.t
let viewportBoundsForTextViewportLayoutController x self = msg_send_stret ~self ~cmd:(selector "viewportBoundsForTextViewportLayoutController:") ~typ:(id @-> returning CGRect.t) ~return_type:CGRect.t x
