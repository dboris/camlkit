...
let self = get_class "NSTouchBarCustomizationController"
...
let controller1 x ~didSelectSection self = msg_send ~self ~cmd:(selector "controller:didSelectSection:") ~typ:(id @-> llong @-> returning void) x (LLong.of_int didSelectSection)
...
let cursorManager1 x ~didMouseUpInTouchBarAtPoint self = msg_send ~self ~cmd:(selector "cursorManager:didMouseUpInTouchBarAtPoint:") ~typ:(id @-> CGPoint.t @-> returning CGPoint.t) x didMouseUpInTouchBarAtPoint
let cursorManager2 x ~didEnterTouchBarAtPoint ~mouseIsDown self = msg_send ~self ~cmd:(selector "cursorManager:didEnterTouchBarAtPoint:mouseIsDown:") ~typ:(id @-> CGPoint.t @-> bool @-> returning CGPoint.t) x didEnterTouchBarAtPoint mouseIsDown
...
let cursorManager4 x ~didMoveTouchBarCursorToPoint ~withDelta ~mouseIsDown self = msg_send ~self ~cmd:(selector "cursorManager:didMoveTouchBarCursorToPoint:withDelta:mouseIsDown:") ~typ:(id @-> CGPoint.t @-> CGSize.t @-> bool @-> returning CGPoint.t) x didMoveTouchBarCursorToPoint withDelta mouseIsDown
