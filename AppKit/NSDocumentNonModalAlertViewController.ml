...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentnonmodalalertviewcontroller?language=objc}NSDocumentNonModalAlertViewController} *)

let self = get_class "NSDocumentNonModalAlertViewController"
