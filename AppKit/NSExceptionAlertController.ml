...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsexceptionalertcontroller?language=objc}NSExceptionAlertController} *)

let self = get_class "NSExceptionAlertController"
