...
let self = get_class "NSDocumentRevisionsController"
...
let endVisualizationWithOutcome x ~thenContinueAfterAnimation self = msg_send ~self ~cmd:(selector "endVisualizationWithOutcome:thenContinueAfterAnimation:") ~typ:(llong @-> (ptr void) @-> returning void) (LLong.of_int x) thenContinueAfterAnimation
let endVisualizationWithOutcome' x ~thenContinueAfterAnimation ~thenContinueWhenExited self = msg_send ~self ~cmd:(selector "endVisualizationWithOutcome:thenContinueAfterAnimation:thenContinueWhenExited:") ~typ:(llong @-> (ptr void) @-> (ptr void) @-> returning void) (LLong.of_int x) thenContinueAfterAnimation thenContinueWhenExited
...
let goToStackItemAtIndex x self = msg_send ~self ~cmd:(selector "goToStackItemAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let setCurrentStackItemIndex x self = msg_send ~self ~cmd:(selector "setCurrentStackItemIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let startVisualizationWithDocument x ~options ~thenContinue self = msg_send ~self ~cmd:(selector "startVisualizationWithDocument:options:thenContinue:") ~typ:(id @-> ullong @-> (ptr void) @-> returning void) x (ULLong.of_int options) thenContinue
