...
let blackpointAdaptation self = msg_send ~self ~cmd:(selector "blackpointAdaptation") ~typ:(returning CGColorTRC.t)
...
let convertPoint x ~fromContextId self = msg_send ~self ~cmd:(selector "convertPoint:fromContextId:") ~typ:(CGPoint.t @-> uint @-> returning CGPoint.t) x fromContextId
let convertPoint' x ~toContextId self = msg_send ~self ~cmd:(selector "convertPoint:toContextId:") ~typ:(CGPoint.t @-> uint @-> returning CGPoint.t) x toContextId
...
let cursorPosition self = msg_send ~self ~cmd:(selector "cursorPosition") ~typ:(returning CGPoint.t)
...
let detachingRect self = msg_send ~self ~cmd:(selector "detachingRect") ~typ:(returning CGRect.t)
...
let maximumCursorSize self = msg_send ~self ~cmd:(selector "maximumCursorSize") ~typ:(returning CGSize.t)
...
let minimumVisibleCursorSize self = msg_send ~self ~cmd:(selector "minimumVisibleCursorSize") ~typ:(returning CGSize.t)
...
let panelPhysicalSize self = msg_send ~self ~cmd:(selector "panelPhysicalSize") ~typ:(returning CGSize.t)
...
let scales self = msg_send ~self ~cmd:(selector "scales") ~typ:(returning CGSize.t)
...
let systemGamma self = msg_send ~self ~cmd:(selector "systemGamma") ~typ:(returning CGColorTRC.t)
...
let transformFromLayerId x ~inContextId self = msg_send ~self ~cmd:(selector "transformFromLayerId:inContextId:") ~typ:(ullong @-> uint @-> returning CATransform3D.t) (ULLong.of_int x) inContextId
