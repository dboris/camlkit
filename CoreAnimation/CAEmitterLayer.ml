...
let cullRect self = msg_send_stret ~self ~cmd:(selector "cullRect") ~typ:(returning CGRect.t) ~return_type:CGRect.t
...
let emitterPosition self = msg_send_stret ~self ~cmd:(selector "emitterPosition") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
...
let emitterSize self = msg_send_stret ~self ~cmd:(selector "emitterSize") ~typ:(returning CGSize.t) ~return_type:CGSize.t
