...
let dayOfCommonEra self = msg_send ~self ~cmd:(selector "dayOfCommonEra") ~typ:(returning llong) |> LLong.to_int
let dayOfMonth self = msg_send ~self ~cmd:(selector "dayOfMonth") ~typ:(returning llong) |> LLong.to_int
let dayOfWeek self = msg_send ~self ~cmd:(selector "dayOfWeek") ~typ:(returning llong) |> LLong.to_int
let dayOfYear self = msg_send ~self ~cmd:(selector "dayOfYear") ~typ:(returning llong) |> LLong.to_int
...
let hourOfDay self = msg_send ~self ~cmd:(selector "hourOfDay") ~typ:(returning llong) |> LLong.to_int
...
let microsecondOfSecond self = msg_send ~self ~cmd:(selector "microsecondOfSecond") ~typ:(returning llong) |> LLong.to_int
let minuteOfHour self = msg_send ~self ~cmd:(selector "minuteOfHour") ~typ:(returning llong) |> LLong.to_int
let monthOfYear self = msg_send ~self ~cmd:(selector "monthOfYear") ~typ:(returning llong) |> LLong.to_int
let release self = msg_send ~self ~cmd:(selector "release") ~typ:(returning void)
let replacementObjectForPortCoder x self = msg_send ~self ~cmd:(selector "replacementObjectForPortCoder:") ~typ:(id @-> returning id) x
let secondOfMinute self = msg_send ~self ~cmd:(selector "secondOfMinute") ~typ:(returning llong) |> LLong.to_int
...
let yearOfCommonEra self = msg_send ~self ~cmd:(selector "yearOfCommonEra") ~typ:(returning llong) |> LLong.to_int
