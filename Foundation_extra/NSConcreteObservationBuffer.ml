...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nsconcreteobservationbuffer?language=objc}NSConcreteObservationBuffer} *)

let self = get_class "NSConcreteObservationBuffer"
