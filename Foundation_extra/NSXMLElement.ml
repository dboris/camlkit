...
(** Apple docs: {{:https://developer.apple.com/documentation/foundation/nsxmlelement?language=objc}NSXMLElement} *)

let self = get_class "NSXMLElement"
...
let countOfAttributes self = msg_send ~self ~cmd:(selector "countOfAttributes") ~typ:(returning ullong) |> ULLong.to_int
let countOfChildren self = msg_send ~self ~cmd:(selector "countOfChildren") ~typ:(returning ullong) |> ULLong.to_int
let countOfNamespaces self = msg_send ~self ~cmd:(selector "countOfNamespaces") ~typ:(returning ullong) |> ULLong.to_int
...
let insertObject x ~inAttributesAtIndex self = msg_send ~self ~cmd:(selector "insertObject:inAttributesAtIndex:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int inAttributesAtIndex)
let insertObject1 x ~inChildrenAtIndex self = msg_send ~self ~cmd:(selector "insertObject:inChildrenAtIndex:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int inChildrenAtIndex)
let insertObject2 x ~inNamespacesAtIndex self = msg_send ~self ~cmd:(selector "insertObject:inNamespacesAtIndex:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int inNamespacesAtIndex)
...
let objectInAttributesAtIndex x self = msg_send ~self ~cmd:(selector "objectInAttributesAtIndex:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
...
let objectInNamespacesAtIndex x self = msg_send ~self ~cmd:(selector "objectInNamespacesAtIndex:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
...
let removeObjectFromAttributesAtIndex x self = msg_send ~self ~cmd:(selector "removeObjectFromAttributesAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let removeObjectFromNamespacesAtIndex x self = msg_send ~self ~cmd:(selector "removeObjectFromNamespacesAtIndex:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
