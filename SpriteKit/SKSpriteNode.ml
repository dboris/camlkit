...
let centerRect self = msg_send ~self ~cmd:(selector "centerRect") ~typ:(returning CGRect.t)
...
let repeatTextureSize self = msg_send ~self ~cmd:(selector "repeatTextureSize") ~typ:(returning CGSize.t)
