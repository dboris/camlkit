...
let calculateAccumulatedFrame self = msg_send_stret ~self ~cmd:(selector "calculateAccumulatedFrame") ~typ:(returning CGRect.t) ~return_type:CGRect.t
...
let convertPoint x ~fromNode self = msg_send_stret ~self ~cmd:(selector "convertPoint:fromNode:") ~typ:(CGPoint.t @-> id @-> returning CGPoint.t) ~return_type:CGPoint.t x fromNode
let convertPoint' x ~toNode self = msg_send_stret ~self ~cmd:(selector "convertPoint:toNode:") ~typ:(CGPoint.t @-> id @-> returning CGPoint.t) ~return_type:CGPoint.t x toNode
