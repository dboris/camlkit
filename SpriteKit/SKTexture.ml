...
let alphaMapSize self = msg_send_stret ~self ~cmd:(selector "alphaMapSize") ~typ:(returning CGSize.t) ~return_type:CGSize.t
let commonInit self = msg_send ~self ~cmd:(selector "commonInit") ~typ:(returning void)
let copyWithZone x self = msg_send ~self ~cmd:(selector "copyWithZone:") ~typ:((ptr void) @-> returning id) x
let cropOffset self = msg_send_stret ~self ~cmd:(selector "cropOffset") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let cropScale self = msg_send_stret ~self ~cmd:(selector "cropScale") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
...
let textureRect self = msg_send_stret ~self ~cmd:(selector "textureRect") ~typ:(returning CGRect.t) ~return_type:CGRect.t
