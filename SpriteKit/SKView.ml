...
let convertPoint x ~fromScene self = msg_send ~self ~cmd:(selector "convertPoint:fromScene:") ~typ:(CGPoint.t @-> id @-> returning CGPoint.t) x fromScene
let convertPoint' x ~toScene self = msg_send ~self ~cmd:(selector "convertPoint:toScene:") ~typ:(CGPoint.t @-> id @-> returning CGPoint.t) x toScene
