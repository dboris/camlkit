...
let convertPointFromView x self = msg_send ~self ~cmd:(selector "convertPointFromView:") ~typ:(CGPoint.t @-> returning CGPoint.t) x
let convertPointToParent x self = msg_send ~self ~cmd:(selector "convertPointToParent:") ~typ:(CGPoint.t @-> returning CGPoint.t) x
let convertPointToView x self = msg_send ~self ~cmd:(selector "convertPointToView:") ~typ:(CGPoint.t @-> returning CGPoint.t) x
...
let visibleRectCenter self = msg_send ~self ~cmd:(selector "visibleRectCenter") ~typ:(returning CGPoint.t)
let visibleRectSize self = msg_send ~self ~cmd:(selector "visibleRectSize") ~typ:(returning CGSize.t)
