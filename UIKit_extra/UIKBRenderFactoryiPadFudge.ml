...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipadfudge?language=objc}UIKBRenderFactoryiPadFudge} *)

let self = get_class "UIKBRenderFactoryiPadFudge"
...
let deleteKeyOffset x self = msg_send_stret ~self ~cmd:(selector "deleteKeyOffset:") ~typ:(ullong @-> returning CGPoint.t) ~return_type:CGPoint.t (ULLong.of_int x)
...
let dualStringKeyBottomTextOffset x self = msg_send_stret ~self ~cmd:(selector "dualStringKeyBottomTextOffset:") ~typ:(ullong @-> returning CGPoint.t) ~return_type:CGPoint.t (ULLong.of_int x)
...
let dualStringKeyTopTextOffset x self = msg_send_stret ~self ~cmd:(selector "dualStringKeyTopTextOffset:") ~typ:(ullong @-> returning CGPoint.t) ~return_type:CGPoint.t (ULLong.of_int x)
...
let stringKeyOffset x self = msg_send_stret ~self ~cmd:(selector "stringKeyOffset:") ~typ:(ullong @-> returning CGPoint.t) ~return_type:CGPoint.t (ULLong.of_int x)
