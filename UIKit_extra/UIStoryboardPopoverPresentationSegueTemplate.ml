...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistoryboardpopoverpresentationseguetemplate?language=objc}UIStoryboardPopoverPresentationSegueTemplate} *)

let self = get_class "UIStoryboardPopoverPresentationSegueTemplate"
