...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistoryboardpushseguetemplate?language=objc}UIStoryboardPushSegueTemplate} *)

let self = get_class "UIStoryboardPushSegueTemplate"
