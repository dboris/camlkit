...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uihbdowngesturerecognizer?language=objc}UIHBDownGestureRecognizer} *)

let self = get_class "UIHBDownGestureRecognizer"
