...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbautofilltesttaggerview?language=objc}UIKBAutoFillTestTaggerView} *)

let self = get_class "UIKBAutoFillTestTaggerView"
