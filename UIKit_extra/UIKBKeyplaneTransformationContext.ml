...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbkeyplanetransformationcontext?language=objc}UIKBKeyplaneTransformationContext} *)

let self = get_class "UIKBKeyplaneTransformationContext"
