...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactorynumberpad?language=objc}UIKBRenderFactoryNumberPad} *)

let self = get_class "UIKBRenderFactoryNumberPad"
