...
let popoverRectPlaceholder self = msg_send_stret ~self ~cmd:(selector "popoverRectPlaceholder") ~typ:(returning CGRect.t) ~return_type:CGRect.t
...
let scaledPopoverTransform self = msg_send_stret ~self ~cmd:(selector "scaledPopoverTransform") ~typ:(returning CGAffineTransform.t) ~return_type:CGAffineTransform.t
