...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewcelllayoutmanagervalue1?language=objc}UITableViewCellLayoutManagerValue1} *)

let self = get_class "UITableViewCellLayoutManagerValue1"
