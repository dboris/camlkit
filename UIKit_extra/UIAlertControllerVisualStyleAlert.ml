...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uialertcontrollervisualstylealert?language=objc}UIAlertControllerVisualStyleAlert} *)

let self = get_class "UIAlertControllerVisualStyleAlert"
