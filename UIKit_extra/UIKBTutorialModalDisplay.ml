...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbtutorialmodaldisplay?language=objc}UIKBTutorialModalDisplay} *)

let self = get_class "UIKBTutorialModalDisplay"
...
let sizeForTutorialPageView self = msg_send_stret ~self ~cmd:(selector "sizeForTutorialPageView") ~typ:(returning CGSize.t) ~return_type:CGSize.t
