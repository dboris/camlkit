...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewindex?language=objc}UITableViewIndex} *)

let self = get_class "UITableViewIndex"
...
let drawingInsets self = msg_send_stret ~self ~cmd:(selector "drawingInsets") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
...
let setDrawingInsets x self = msg_send ~self ~cmd:(selector "setDrawingInsets:") ~typ:(UIEdgeInsets.t @-> returning void) x
