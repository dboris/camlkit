...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbviewforresponderforwarding?language=objc}UIKBViewForResponderForwarding} *)

let self = get_class "UIKBViewForResponderForwarding"
