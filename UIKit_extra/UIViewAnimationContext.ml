...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiviewanimationcontext?language=objc}UIViewAnimationContext} *)

let self = get_class "UIViewAnimationContext"
