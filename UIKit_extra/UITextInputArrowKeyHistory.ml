...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextinputarrowkeyhistory?language=objc}UITextInputArrowKeyHistory} *)

let self = get_class "UITextInputArrowKeyHistory"
