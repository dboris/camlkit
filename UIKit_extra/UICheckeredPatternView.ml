...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicheckeredpatternview?language=objc}UICheckeredPatternView} *)

let self = get_class "UICheckeredPatternView"
