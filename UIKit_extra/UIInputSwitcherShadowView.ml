...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinputswitchershadowview?language=objc}UIInputSwitcherShadowView} *)

let self = get_class "UIInputSwitcherShadowView"
