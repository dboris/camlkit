...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiscrollviewdirectionalpressgesturerecognizer?language=objc}UIScrollViewDirectionalPressGestureRecognizer} *)

let self = get_class "UIScrollViewDirectionalPressGestureRecognizer"
