...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebtiledview?language=objc}UIWebTiledView} *)

let self = get_class "UIWebTiledView"
...
let drawImageIntoTiles x self = msg_send ~self ~cmd:(selector "drawImageIntoTiles:") ~typ:((ptr CGImage.t) @-> returning void) x
