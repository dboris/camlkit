...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiexternalscenepairingobserver?language=objc}UIExternalScenePairingObserver} *)

let self = get_class "UIExternalScenePairingObserver"
