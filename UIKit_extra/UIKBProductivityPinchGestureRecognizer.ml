...
let self = get_class "UIKBProductivityPinchGestureRecognizer"
...
let beginCentroid self = msg_send_stret ~self ~cmd:(selector "beginCentroid") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
