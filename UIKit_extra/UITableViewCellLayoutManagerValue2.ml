...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewcelllayoutmanagervalue2?language=objc}UITableViewCellLayoutManagerValue2} *)

let self = get_class "UITableViewCellLayoutManagerValue2"
