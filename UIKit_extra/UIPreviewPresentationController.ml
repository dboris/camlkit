...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uipreviewpresentationcontroller?language=objc}UIPreviewPresentationController} *)

let self = get_class "UIPreviewPresentationController"
