...
let self = get_class "UIKBRenderer"
...
let context self = msg_send ~self ~cmd:(selector "context") ~typ:(returning (ptr CGContext.t))
...
let drawPath x ~weight ~transform ~color ~fill self = msg_send ~self ~cmd:(selector "drawPath:weight:transform:color:fill:") ~typ:((ptr CGPath.t) @-> double @-> CGAffineTransform.t @-> (ptr CGColor.t) @-> bool @-> returning void) x weight transform color fill
let drawShiftPath x ~weight ~transform ~color self = msg_send ~self ~cmd:(selector "drawShiftPath:weight:transform:color:") ~typ:(bool @-> double @-> CGAffineTransform.t @-> (ptr CGColor.t) @-> returning void) x weight transform color
...
let initWithContext x ~withSize ~withScale ~opaque ~renderFlags ~assetIdiom self = msg_send ~self ~cmd:(selector "initWithContext:withSize:withScale:opaque:renderFlags:assetIdiom:") ~typ:((ptr CGContext.t) @-> CGSize.t @-> double @-> bool @-> llong @-> llong @-> returning id) x withSize withScale opaque (LLong.of_int renderFlags) (LLong.of_int assetIdiom)
