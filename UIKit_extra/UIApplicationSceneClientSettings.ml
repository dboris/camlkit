...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiapplicationsceneclientsettings?language=objc}UIApplicationSceneClientSettings} *)

let self = get_class "UIApplicationSceneClientSettings"
...
let primaryWindowOverlayInsets self = msg_send ~self ~cmd:(selector "primaryWindowOverlayInsets") ~typ:(returning UIEdgeInsets.t)
