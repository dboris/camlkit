...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uihblongclickgesturerecognizer?language=objc}UIHBLongClickGestureRecognizer} *)

let self = get_class "UIHBLongClickGestureRecognizer"
