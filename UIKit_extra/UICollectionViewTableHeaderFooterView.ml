...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewtableheaderfooterview?language=objc}UICollectionViewTableHeaderFooterView} *)

let self = get_class "UICollectionViewTableHeaderFooterView"
