...
let self = get_class "UIInterpolatedColorMatrix"
...
let initWithColorMatrix x self = msg_send ~self ~cmd:(selector "initWithColorMatrix:") ~typ:(CAColorMatrix.t @-> returning id) x
let initWithColorMatrix' x ~epsilon self = msg_send ~self ~cmd:(selector "initWithColorMatrix:epsilon:") ~typ:(CAColorMatrix.t @-> double @-> returning id) x epsilon
