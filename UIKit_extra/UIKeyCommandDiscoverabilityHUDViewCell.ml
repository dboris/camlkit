...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeycommanddiscoverabilityhudviewcell?language=objc}UIKeyCommandDiscoverabilityHUDViewCell} *)

let self = get_class "UIKeyCommandDiscoverabilityHUDViewCell"
