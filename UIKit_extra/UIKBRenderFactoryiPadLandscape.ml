...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipadlandscape?language=objc}UIKBRenderFactoryiPadLandscape} *)

let self = get_class "UIKBRenderFactoryiPadLandscape"
