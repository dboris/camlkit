...
let self = get_class "UIKBTextStyle"
...
let etchOffset self = msg_send ~self ~cmd:(selector "etchOffset") ~typ:(returning CGPoint.t)
...
let textOffset self = msg_send ~self ~cmd:(selector "textOffset") ~typ:(returning CGPoint.t)
