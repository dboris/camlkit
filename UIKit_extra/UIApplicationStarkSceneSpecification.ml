...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiapplicationstarkscenespecification?language=objc}UIApplicationStarkSceneSpecification} *)

let self = get_class "UIApplicationStarkSceneSpecification"
