...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiassistantbarroundedbuttonviewbutton?language=objc}UIAssistantBarRoundedButtonViewButton} *)

let self = get_class "UIAssistantBarRoundedButtonViewButton"
