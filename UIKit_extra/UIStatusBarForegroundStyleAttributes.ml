...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarforegroundstyleattributes?language=objc}UIStatusBarForegroundStyleAttributes} *)

let self = get_class "UIStatusBarForegroundStyleAttributes"
...
let baselineOffsetForStyle x self = msg_send ~self ~cmd:(selector "baselineOffsetForStyle:") ~typ:(llong @-> returning double) (LLong.of_int x)
let batteryAccessoryMargin self = msg_send ~self ~cmd:(selector "batteryAccessoryMargin") ~typ:(returning double)
let batteryColorForCapacity x ~style ~usingTintColor self = msg_send ~self ~cmd:(selector "batteryColorForCapacity:style:usingTintColor:") ~typ:(int @-> ullong @-> bool @-> returning id) x (ULLong.of_int style) usingTintColor
...
let cachedImageWithText x ~forWidth ~lineBreakMode ~letterSpacing ~textAlignment ~style ~itemType self = msg_send ~self ~cmd:(selector "cachedImageWithText:forWidth:lineBreakMode:letterSpacing:textAlignment:style:itemType:") ~typ:(id @-> double @-> llong @-> double @-> llong @-> llong @-> int @-> returning id) x forWidth (LLong.of_int lineBreakMode) letterSpacing (LLong.of_int textAlignment) (LLong.of_int style) itemType
let canShowBreadcrumbs self = msg_send ~self ~cmd:(selector "canShowBreadcrumbs") ~typ:(returning bool)
let copyWithZone x self = msg_send ~self ~cmd:(selector "copyWithZone:") ~typ:((ptr void) @-> returning id) x
let drawBatteryInsidesWithSize x ~capacity ~style self = msg_send ~self ~cmd:(selector "drawBatteryInsidesWithSize:capacity:style:") ~typ:(CGSize.t @-> int @-> ullong @-> returning void) x capacity (ULLong.of_int style)
let drawBatteryInsidesWithSize' x ~capacity ~style ~usingTintColor self = msg_send ~self ~cmd:(selector "drawBatteryInsidesWithSize:capacity:style:usingTintColor:") ~typ:(CGSize.t @-> int @-> ullong @-> bool @-> returning void) x capacity (ULLong.of_int style) usingTintColor
...
let imageIdWithText x ~forWidth ~lineBreakMode ~letterSpacing ~style self = msg_send ~self ~cmd:(selector "imageIdWithText:forWidth:lineBreakMode:letterSpacing:style:") ~typ:(id @-> double @-> llong @-> double @-> llong @-> returning id) x forWidth (LLong.of_int lineBreakMode) letterSpacing (LLong.of_int style)
let imageNamed x self = msg_send ~self ~cmd:(selector "imageNamed:") ~typ:(id @-> returning id) x
let imageNamed' x ~withLegibilityStyle ~legibilityStrength self = msg_send ~self ~cmd:(selector "imageNamed:withLegibilityStyle:legibilityStrength:") ~typ:(id @-> llong @-> double @-> returning id) x (LLong.of_int withLegibilityStyle) legibilityStrength
let imageWithText x ~ofItemType ~forWidth ~lineBreakMode ~letterSpacing ~textAlignment ~style ~withLegibilityStyle ~legibilityStrength self = msg_send ~self ~cmd:(selector "imageWithText:ofItemType:forWidth:lineBreakMode:letterSpacing:textAlignment:style:withLegibilityStyle:legibilityStrength:") ~typ:(id @-> int @-> double @-> llong @-> double @-> llong @-> llong @-> llong @-> double @-> returning id) x ofItemType forWidth (LLong.of_int lineBreakMode) letterSpacing (LLong.of_int textAlignment) (LLong.of_int style) (LLong.of_int withLegibilityStyle) legibilityStrength
let imageWithText' x ~ofItemType ~forWidth ~lineBreakMode ~letterSpacing ~textAlignment ~style ~withLegibilityStyle ~legibilityStrength ~shouldCache self = msg_send ~self ~cmd:(selector "imageWithText:ofItemType:forWidth:lineBreakMode:letterSpacing:textAlignment:style:withLegibilityStyle:legibilityStrength:shouldCache:") ~typ:(id @-> int @-> double @-> llong @-> double @-> llong @-> llong @-> llong @-> double @-> bool @-> returning id) x ofItemType forWidth (LLong.of_int lineBreakMode) letterSpacing (LLong.of_int textAlignment) (LLong.of_int style) (LLong.of_int withLegibilityStyle) legibilityStrength shouldCache
let initWithHeight x ~legibilityStyle ~tintColor ~hasBusyBackground self = msg_send ~self ~cmd:(selector "initWithHeight:legibilityStyle:tintColor:hasBusyBackground:") ~typ:(double @-> llong @-> id @-> bool @-> returning id) x (LLong.of_int legibilityStyle) tintColor hasBusyBackground
let initWithHeight' x ~legibilityStyle ~tintColor ~hasBusyBackground ~idiom self = msg_send ~self ~cmd:(selector "initWithHeight:legibilityStyle:tintColor:hasBusyBackground:idiom:") ~typ:(double @-> llong @-> id @-> bool @-> llong @-> returning id) x (LLong.of_int legibilityStyle) tintColor hasBusyBackground (LLong.of_int idiom)
...
let shadowImageForImage x ~withIdentifier ~forStyle ~withStrength self = msg_send ~self ~cmd:(selector "shadowImageForImage:withIdentifier:forStyle:withStrength:") ~typ:(id @-> id @-> llong @-> double @-> returning id) x withIdentifier (LLong.of_int forStyle) withStrength
let shadowImageForImage1 x ~withIdentifier ~forStyle ~withStrength ~inTempGroup self = msg_send ~self ~cmd:(selector "shadowImageForImage:withIdentifier:forStyle:withStrength:inTempGroup:") ~typ:(id @-> id @-> llong @-> double @-> id @-> returning id) x withIdentifier (LLong.of_int forStyle) withStrength inTempGroup
let shadowImageForImage2 x ~withIdentifier ~forStyle ~withStrength ~inTempGroup ~shouldCache self = msg_send ~self ~cmd:(selector "shadowImageForImage:withIdentifier:forStyle:withStrength:inTempGroup:shouldCache:") ~typ:(id @-> id @-> llong @-> double @-> id @-> bool @-> returning id) x withIdentifier (LLong.of_int forStyle) withStrength inTempGroup shouldCache
...
let textColorForStyle x self = msg_send ~self ~cmd:(selector "textColorForStyle:") ~typ:(llong @-> returning id) (LLong.of_int x)
let textFontForStyle x self = msg_send ~self ~cmd:(selector "textFontForStyle:") ~typ:(llong @-> returning id) (LLong.of_int x)
