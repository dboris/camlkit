...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbar_placeholder?language=objc}UIStatusBar_Placeholder} *)

let self = get_class "UIStatusBar_Placeholder"
