...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardpinchgesturerecognizer?language=objc}UIKeyboardPinchGestureRecognizer} *)

let self = get_class "UIKeyboardPinchGestureRecognizer"
