...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactory10key?language=objc}UIKBRenderFactory10Key} *)

let self = get_class "UIKBRenderFactory10Key"
...
let topEdgeAdjustmentInsets self = msg_send ~self ~cmd:(selector "topEdgeAdjustmentInsets") ~typ:(returning UIEdgeInsets.t)
