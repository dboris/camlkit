...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeycommanddiscoverabilityhudvisualstyleregular?language=objc}UIKeyCommandDiscoverabilityHUDVisualStyleRegular} *)
