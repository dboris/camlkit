...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwebplaybacktargetpicker?language=objc}UIWebPlaybackTargetPicker} *)

let self = get_class "UIWebPlaybackTargetPicker"
