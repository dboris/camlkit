...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarbatterypercentitemview?language=objc}UIStatusBarBatteryPercentItemView} *)

let self = get_class "UIStatusBarBatteryPercentItemView"
