...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiindexbaraccessoryview?language=objc}UIIndexBarAccessoryView} *)

let self = get_class "UIIndexBarAccessoryView"
