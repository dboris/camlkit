...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipad?language=objc}UIKBRenderFactoryiPad} *)

let self = get_class "UIKBRenderFactoryiPad"
...
let insetFrame x ~forKey self = msg_send ~self ~cmd:(selector "insetFrame:forKey:") ~typ:(CGRect.t @-> id @-> returning CGRect.t) x forKey
