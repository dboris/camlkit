...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrecentinputsview?language=objc}UIKBRecentInputsView} *)

let self = get_class "UIKBRecentInputsView"
...
let collectionView3 x ~layout ~sizeForItemAtIndexPath self = msg_send ~self ~cmd:(selector "collectionView:layout:sizeForItemAtIndexPath:") ~typ:(id @-> id @-> id @-> returning CGSize.t) x layout sizeForItemAtIndexPath
