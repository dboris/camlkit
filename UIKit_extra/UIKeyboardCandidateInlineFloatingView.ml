...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardcandidateinlinefloatingview?language=objc}UIKeyboardCandidateInlineFloatingView} *)
...
let adjustedFrameFromDesiredFrame x ~textHeight self = msg_send ~self ~cmd:(selector "adjustedFrameFromDesiredFrame:textHeight:") ~typ:(CGRect.t @-> double @-> returning CGRect.t) x textHeight
let adjustedFrameFromDesiredFrame' x ~textWidth self = msg_send ~self ~cmd:(selector "adjustedFrameFromDesiredFrame:textWidth:") ~typ:(CGRect.t @-> double @-> returning CGRect.t) x textWidth
let adjustedInlineRectFromInlineText x ~inlineRect self = msg_send ~self ~cmd:(selector "adjustedInlineRectFromInlineText:inlineRect:") ~typ:(id @-> CGRect.t @-> returning CGRect.t) x inlineRect
let cellPadding self = msg_send ~self ~cmd:(selector "cellPadding") ~typ:(returning UIEdgeInsets.t)
...
let inlineRect self = msg_send ~self ~cmd:(selector "inlineRect") ~typ:(returning CGRect.t)
...
let previousCollapsedFrame self = msg_send ~self ~cmd:(selector "previousCollapsedFrame") ~typ:(returning CGRect.t)
let setAdjustMode x self = msg_send ~self ~cmd:(selector "setAdjustMode:") ~typ:(int @-> returning void) x
let setCellPadding x self = msg_send ~self ~cmd:(selector "setCellPadding:") ~typ:(UIEdgeInsets.t @-> returning void) x
