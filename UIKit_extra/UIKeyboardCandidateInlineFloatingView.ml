...
let cellPadding self = msg_send_stret ~self ~cmd:(selector "cellPadding") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
let extendedStateAdditionalHeight self = msg_send ~self ~cmd:(selector "extendedStateAdditionalHeight") ~typ:(returning double)
let extraInsets self = msg_send_stret ~self ~cmd:(selector "extraInsets") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
