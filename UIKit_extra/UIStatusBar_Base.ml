...
let offsetForPartWithIdentifier x self = msg_send_stret ~self ~cmd:(selector "offsetForPartWithIdentifier:") ~typ:(id @-> returning UIOffset.t) ~return_type:UIOffset.t x
