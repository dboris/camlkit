...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicoversheetbutton?language=objc}UICoverSheetButton} *)

let self = get_class "UICoverSheetButton"
...
let edgeInsets self = msg_send_stret ~self ~cmd:(selector "edgeInsets") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
