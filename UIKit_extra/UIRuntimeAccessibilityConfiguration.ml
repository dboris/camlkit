...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiruntimeaccessibilityconfiguration?language=objc}UIRuntimeAccessibilityConfiguration} *)

let self = get_class "UIRuntimeAccessibilityConfiguration"
