...
let defaultUndockedOffsetForFloating x self = msg_send ~self ~cmd:(selector "defaultUndockedOffsetForFloating:") ~typ:(bool @-> returning CGPoint.t) x
let deviceSpecificPaddingForInterfaceOrientation x ~inputMode self = msg_send ~self ~cmd:(selector "deviceSpecificPaddingForInterfaceOrientation:inputMode:") ~typ:(llong @-> id @-> returning UIEdgeInsets.t) (LLong.of_int x) inputMode
let deviceSpecificStaticHitBufferForInterfaceOrientation x ~inputMode self = msg_send ~self ~cmd:(selector "deviceSpecificStaticHitBufferForInterfaceOrientation:inputMode:") ~typ:(llong @-> id @-> returning UIEdgeInsets.t) (LLong.of_int x) inputMode
...
let floatingNormalizedPersistentOffset self = msg_send ~self ~cmd:(selector "floatingNormalizedPersistentOffset") ~typ:(returning CGPoint.t)
let floatingPersistentOffset self = msg_send ~self ~cmd:(selector "floatingPersistentOffset") ~typ:(returning CGPoint.t)
...
let normalizedPersistentOffset self = msg_send ~self ~cmd:(selector "normalizedPersistentOffset") ~typ:(returning CGPoint.t)
let normalizedPersistentOffsetIgnoringState self = msg_send ~self ~cmd:(selector "normalizedPersistentOffsetIgnoringState") ~typ:(returning CGPoint.t)
...
let persistentOffset self = msg_send ~self ~cmd:(selector "persistentOffset") ~typ:(returning CGPoint.t)
...
let requestedFloatingInsets self = msg_send ~self ~cmd:(selector "requestedFloatingInsets") ~typ:(returning UIEdgeInsets.t)
