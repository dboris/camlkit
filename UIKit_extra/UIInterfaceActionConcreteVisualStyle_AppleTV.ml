...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiinterfaceactionconcretevisualstyle_appletv?language=objc}UIInterfaceActionConcreteVisualStyle_AppleTV} *)

let self = get_class "UIInterfaceActionConcreteVisualStyle_AppleTV"
