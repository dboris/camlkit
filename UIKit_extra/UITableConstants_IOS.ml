...
let defaultInsetGroupedHeaderLayoutMarginsForExtraProminentStyle x self = msg_send_stret ~self ~cmd:(selector "defaultInsetGroupedHeaderLayoutMarginsForExtraProminentStyle:") ~typ:(bool @-> returning NSDirectionalEdgeInsets.t) ~return_type:NSDirectionalEdgeInsets.t x
...
let defaultSidebarLayoutMarginsForElementsInsideSection self = msg_send_stret ~self ~cmd:(selector "defaultSidebarLayoutMarginsForElementsInsideSection") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
