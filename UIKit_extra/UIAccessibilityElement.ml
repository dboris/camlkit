...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiaccessibilityelement?language=objc}UIAccessibilityElement} *)

let self = get_class "UIAccessibilityElement"
