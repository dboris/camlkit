...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uimutablescenepresentationcontext?language=objc}UIMutableScenePresentationContext} *)

let self = get_class "UIMutableScenePresentationContext"
...
let setAppearanceStyle x self = msg_send ~self ~cmd:(selector "setAppearanceStyle:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
...
let setPresentedLayerTypes x self = msg_send ~self ~cmd:(selector "setPresentedLayerTypes:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
