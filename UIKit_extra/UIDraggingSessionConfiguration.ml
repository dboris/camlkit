...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidraggingsessionconfiguration?language=objc}UIDraggingSessionConfiguration} *)

let self = get_class "UIDraggingSessionConfiguration"
...
let initialCentroid self = msg_send_stret ~self ~cmd:(selector "initialCentroid") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
