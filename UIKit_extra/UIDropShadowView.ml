...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidropshadowview?language=objc}UIDropShadowView} *)

let self = get_class "UIDropShadowView"
...
let contentTouchInsets self = msg_send_stret ~self ~cmd:(selector "contentTouchInsets") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
...
let initWithFrame x ~independentCorners ~supportsShadow ~stylesSheetsAsCards self = msg_send ~self ~cmd:(selector "initWithFrame:independentCorners:supportsShadow:stylesSheetsAsCards:") ~typ:(CGRect.t @-> llong @-> bool @-> bool @-> returning id) x (LLong.of_int independentCorners) supportsShadow stylesSheetsAsCards
...
let setContentTouchInsets x self = msg_send ~self ~cmd:(selector "setContentTouchInsets:") ~typ:(UIEdgeInsets.t @-> returning void) x
let setContentView x self = msg_send ~self ~cmd:(selector "setContentView:") ~typ:(id @-> returning void) x
let setEnvironmentMatchingCornerRadii x self = msg_send ~self ~cmd:(selector "setEnvironmentMatchingCornerRadii:") ~typ:(ptr void @-> returning void) x
