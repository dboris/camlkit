...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicollectionviewreordereditem?language=objc}UICollectionViewReorderedItem} *)

let self = get_class "UICollectionViewReorderedItem"
...
let pinnedPreviousContentOffset self = msg_send_stret ~self ~cmd:(selector "pinnedPreviousContentOffset") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
