...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardemojicollectionview?language=objc}UIKeyboardEmojiCollectionView} *)

let self = get_class "UIKeyboardEmojiCollectionView"
