...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiscrollviewdelayedtouchesbegangesturerecognizer?language=objc}UIScrollViewDelayedTouchesBeganGestureRecognizer} *)

let self = get_class "UIScrollViewDelayedTouchesBeganGestureRecognizer"
