...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardscheduledtask?language=objc}UIKeyboardScheduledTask} *)

let self = get_class "UIKeyboardScheduledTask"
