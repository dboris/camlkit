...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarbatteryitemview?language=objc}UIStatusBarBatteryItemView} *)

let self = get_class "UIStatusBarBatteryItemView"
...
let setCachedAXHUDStyle x self = msg_send ~self ~cmd:(selector "setCachedAXHUDStyle:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let setCachedBatteryStyle x self = msg_send ~self ~cmd:(selector "setCachedBatteryStyle:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
