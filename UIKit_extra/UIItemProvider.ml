...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiitemprovider?language=objc}UIItemProvider} *)

let self = get_class "UIItemProvider"
...
let registerFileRepresentationForTypeIdentifier x ~fileOptions ~loadHandler self = msg_send ~self ~cmd:(selector "registerFileRepresentationForTypeIdentifier:fileOptions:loadHandler:") ~typ:(id @-> llong @-> (ptr void) @-> returning void) x (LLong.of_int fileOptions) loadHandler
let registerFileRepresentationForTypeIdentifier' x ~fileOptions ~options ~loadHandler self = msg_send ~self ~cmd:(selector "registerFileRepresentationForTypeIdentifier:fileOptions:options:loadHandler:") ~typ:(id @-> llong @-> id @-> (ptr void) @-> returning void) x (LLong.of_int fileOptions) options loadHandler
