...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarpersonnameitemview?language=objc}UIStatusBarPersonNameItemView} *)

let self = get_class "UIStatusBarPersonNameItemView"
