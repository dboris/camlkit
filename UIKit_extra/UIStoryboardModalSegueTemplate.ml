...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistoryboardmodalseguetemplate?language=objc}UIStoryboardModalSegueTemplate} *)

let self = get_class "UIStoryboardModalSegueTemplate"
