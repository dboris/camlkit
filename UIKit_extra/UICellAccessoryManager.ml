...
let containerBounds self = msg_send ~self ~cmd:(selector "containerBounds") ~typ:(returning CGRect.t)
let containerSize self = msg_send ~self ~cmd:(selector "containerSize") ~typ:(returning CGSize.t)
...
let contentInset self = msg_send ~self ~cmd:(selector "contentInset") ~typ:(returning UIEdgeInsets.t)
...
let previousContainerSize self = msg_send ~self ~cmd:(selector "previousContainerSize") ~typ:(returning CGSize.t)
