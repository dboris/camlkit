...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardemojisplit?language=objc}UIKeyboardEmojiSplit} *)

let self = get_class "UIKeyboardEmojiSplit"
