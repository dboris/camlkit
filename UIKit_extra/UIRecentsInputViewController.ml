...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uirecentsinputviewcontroller?language=objc}UIRecentsInputViewController} *)

let self = get_class "UIRecentsInputViewController"
