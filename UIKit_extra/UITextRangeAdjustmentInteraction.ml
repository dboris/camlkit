...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextrangeadjustmentinteraction?language=objc}UITextRangeAdjustmentInteraction} *)
...
let initialBasePoint self = msg_send ~self ~cmd:(selector "initialBasePoint") ~typ:(returning CGPoint.t)
...
let touchOffset self = msg_send ~self ~cmd:(selector "touchOffset") ~typ:(returning CGPoint.t)
