...
let headerFooterOffsetFromContentInsetForTableView x self = msg_send_stret ~self ~cmd:(selector "headerFooterOffsetFromContentInsetForTableView:") ~typ:(id @-> returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t x
