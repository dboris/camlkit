...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidefaultkeyboardinput?language=objc}UIDefaultKeyboardInput} *)

let self = get_class "UIDefaultKeyboardInput"
