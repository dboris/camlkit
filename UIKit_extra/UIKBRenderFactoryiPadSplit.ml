...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipadsplit?language=objc}UIKBRenderFactoryiPadSplit} *)

let self = get_class "UIKBRenderFactoryiPadSplit"
