...
let displayInsets self = msg_send ~self ~cmd:(selector "displayInsets") ~typ:(returning UIEdgeInsets.t)
...
let paddedInsets self = msg_send ~self ~cmd:(selector "paddedInsets") ~typ:(returning UIEdgeInsets.t)
