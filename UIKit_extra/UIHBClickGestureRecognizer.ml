...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uihbclickgesturerecognizer?language=objc}UIHBClickGestureRecognizer} *)

let self = get_class "UIHBClickGestureRecognizer"
