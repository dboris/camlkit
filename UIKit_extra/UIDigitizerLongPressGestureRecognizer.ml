...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidigitizerlongpressgesturerecognizer?language=objc}UIDigitizerLongPressGestureRecognizer} *)

let self = get_class "UIDigitizerLongPressGestureRecognizer"
