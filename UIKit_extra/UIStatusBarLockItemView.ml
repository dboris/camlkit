...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarlockitemview?language=objc}UIStatusBarLockItemView} *)

let self = get_class "UIStatusBarLockItemView"
