...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipadfudgepasscode?language=objc}UIKBRenderFactoryiPadFudgePasscode} *)

let self = get_class "UIKBRenderFactoryiPadFudgePasscode"
