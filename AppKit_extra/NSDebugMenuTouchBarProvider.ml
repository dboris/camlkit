...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugmenutouchbarprovider?language=objc}NSDebugMenuTouchBarProvider} *)

let self = get_class "NSDebugMenuTouchBarProvider"
