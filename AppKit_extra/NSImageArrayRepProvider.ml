...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsimagearrayrepprovider?language=objc}NSImageArrayRepProvider} *)

let self = get_class "NSImageArrayRepProvider"
