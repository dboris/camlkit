...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdraggingdestinationview?language=objc}NSDraggingDestinationView} *)

let self = get_class "NSDraggingDestinationView"
...
let setDraggingDestinationStyle x self = msg_send ~self ~cmd:(selector "setDraggingDestinationStyle:") ~typ:(llong @-> returning void) (LLong.of_int x)
let setFeedbackStyle x self = msg_send ~self ~cmd:(selector "setFeedbackStyle:") ~typ:(llong @-> returning void) (LLong.of_int x)
