...
let self = get_class "NSWindowStackController"
...
let insertWindow x ~atIndex self = msg_send ~self ~cmd:(selector "insertWindow:atIndex:") ~typ:(id @-> llong @-> returning void) x (LLong.of_int atIndex)
...
let moveWindow x ~toWindowStackController ~atIndex self = msg_send ~self ~cmd:(selector "moveWindow:toWindowStackController:atIndex:") ~typ:(id @-> id @-> llong @-> returning void) x toWindowStackController (LLong.of_int atIndex)
...
let setTALTabIndex x ~forWindow self = msg_send ~self ~cmd:(selector "setTALTabIndex:forWindow:") ~typ:(llong @-> id @-> returning void) (LLong.of_int x) forWindow
...
let tabBar5 x ~droppedWindowTabShouldMoveToSpace self = msg_send ~self ~cmd:(selector "tabBar:droppedWindowTabShouldMoveToSpace:") ~typ:(id @-> llong @-> returning bool) x (LLong.of_int droppedWindowTabShouldMoveToSpace)
let tabBar6 x ~hideWindowForDraggingItemAtIndex self = msg_send ~self ~cmd:(selector "tabBar:hideWindowForDraggingItemAtIndex:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int hideWindowForDraggingItemAtIndex)
...
let tabBar8 x ~showWindowForDraggingItemAtIndex self = msg_send ~self ~cmd:(selector "tabBar:showWindowForDraggingItemAtIndex:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int showWindowForDraggingItemAtIndex)
...
let tabBar11 x ~acceptDrop ~index self = msg_send ~self ~cmd:(selector "tabBar:acceptDrop:index:") ~typ:(id @-> id @-> ullong @-> returning bool) x acceptDrop (ULLong.of_int index)
let tabBar12 x ~acceptTabDrop ~index self = msg_send ~self ~cmd:(selector "tabBar:acceptTabDrop:index:") ~typ:(id @-> id @-> ullong @-> returning bool) x acceptTabDrop (ULLong.of_int index)
...
let tabPickerFrameForWindowContentAnimation x self = msg_send_stret ~self ~cmd:(selector "tabPickerFrameForWindowContentAnimation:") ~typ:(id @-> returning CGRect.t) ~return_type:CGRect.t x
...
let tabRectForWindow x self = msg_send_stret ~self ~cmd:(selector "tabRectForWindow:") ~typ:(id @-> returning CGRect.t) ~return_type:CGRect.t x
