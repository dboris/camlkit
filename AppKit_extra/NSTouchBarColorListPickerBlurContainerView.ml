...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcolorlistpickerblurcontainerview?language=objc}NSTouchBarColorListPickerBlurContainerView} *)

let self = get_class "NSTouchBarColorListPickerBlurContainerView"
