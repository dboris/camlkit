...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nswindowcontrollermoreivars?language=objc}NSWindowControllerMoreIVars} *)

let self = get_class "NSWindowControllerMoreIVars"
