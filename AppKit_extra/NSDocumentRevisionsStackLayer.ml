...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentrevisionsstacklayer?language=objc}NSDocumentRevisionsStackLayer} *)

let self = get_class "NSDocumentRevisionsStackLayer"
