...
let thumbnailContainerFrameForThumbnailAtIndex x self = msg_send ~self ~cmd:(selector "thumbnailContainerFrameForThumbnailAtIndex:") ~typ:(ullong @-> returning CGRect.t) (ULLong.of_int x)
