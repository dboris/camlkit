...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstableoverlappingcolumncliphelper?language=objc}NSTableOverlappingColumnClipHelper} *)

let self = get_class "NSTableOverlappingColumnClipHelper"
