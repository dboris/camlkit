...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsnavsharedservercontroller?language=objc}NSNavSharedServerController} *)

let self = get_class "NSNavSharedServerController"
