...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarsliderpopovertransposer?language=objc}NSTouchBarSliderPopoverTransposer} *)

let self = get_class "NSTouchBarSliderPopoverTransposer"
...
let setContinuationBehavior x self = msg_send ~self ~cmd:(selector "setContinuationBehavior:") ~typ:(llong @-> returning void) (LLong.of_int x)
