...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nswindowtitlecontroller?language=objc}NSWindowTitleController} *)

let self = get_class "NSWindowTitleController"
...
let setDocumentEditingState x self = msg_send ~self ~cmd:(selector "setDocumentEditingState:") ~typ:(llong @-> returning void) (LLong.of_int x)
