...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsvisualtabpickernewtabview?language=objc}NSVisualTabPickerNewTabView} *)

let self = get_class "NSVisualTabPickerNewTabView"
