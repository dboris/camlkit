...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsfindpatterncombobox?language=objc}NSFindPatternComboBox} *)

let self = get_class "NSFindPatternComboBox"
