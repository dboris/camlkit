...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nslegacyfilepromiseprovider?language=objc}NSLegacyFilePromiseProvider} *)

let self = get_class "NSLegacyFilePromiseProvider"
