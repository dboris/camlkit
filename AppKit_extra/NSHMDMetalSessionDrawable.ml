...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nshmdmetalsessiondrawable?language=objc}NSHMDMetalSessionDrawable} *)

let self = get_class "NSHMDMetalSessionDrawable"
