...
let self = get_class "NSDocumentRevisionsWindowTransformAnimation"
...
let frameForProgress x self = msg_send ~self ~cmd:(selector "frameForProgress:") ~typ:(double @-> returning CGRect.t) x
...
let scaleForProgress x self = msg_send ~self ~cmd:(selector "scaleForProgress:") ~typ:(double @-> returning CGSize.t) x
...
let sizeForProgress x self = msg_send ~self ~cmd:(selector "sizeForProgress:") ~typ:(double @-> returning CGSize.t) x
let startAnimation self = msg_send ~self ~cmd:(selector "startAnimation") ~typ:(returning void)
let translationForProgress x self = msg_send ~self ~cmd:(selector "translationForProgress:") ~typ:(double @-> returning CGPoint.t) x
