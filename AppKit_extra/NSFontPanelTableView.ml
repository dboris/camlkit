...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsfontpaneltableview?language=objc}NSFontPanelTableView} *)

let self = get_class "NSFontPanelTableView"
