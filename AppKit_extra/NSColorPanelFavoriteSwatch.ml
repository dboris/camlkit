...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorpanelfavoriteswatch?language=objc}NSColorPanelFavoriteSwatch} *)

let self = get_class "NSColorPanelFavoriteSwatch"
