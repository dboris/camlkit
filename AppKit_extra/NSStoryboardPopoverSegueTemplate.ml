...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsstoryboardpopoverseguetemplate?language=objc}NSStoryboardPopoverSegueTemplate} *)

let self = get_class "NSStoryboardPopoverSegueTemplate"
