...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcolorpickersliderbrightnessartworkprovider?language=objc}NSTouchBarColorPickerSliderBrightnessArtworkProvider} *)

let self = get_class "NSTouchBarColorPickerSliderBrightnessArtworkProvider"
...
let initWithDisplayHue x ~displaySaturation self = msg_send ~self ~cmd:(selector "initWithDisplayHue:displaySaturation:") ~typ:(double @-> double @-> returning id) x displaySaturation
