...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsautoreleaseidentifier?language=objc}NSAutoreleaseIdentifier} *)

let self = get_class "NSAutoreleaseIdentifier"
