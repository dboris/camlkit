...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuiwindowinfo?language=objc}NSPersistentUIWindowInfo} *)

let self = get_class "NSPersistentUIWindowInfo"
