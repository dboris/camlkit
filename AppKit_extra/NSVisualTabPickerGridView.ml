...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsvisualtabpickergridview?language=objc}NSVisualTabPickerGridView} *)

let self = get_class "NSVisualTabPickerGridView"
