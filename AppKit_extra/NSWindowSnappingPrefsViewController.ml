...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nswindowsnappingprefsviewcontroller?language=objc}NSWindowSnappingPrefsViewController} *)

let self = get_class "NSWindowSnappingPrefsViewController"
