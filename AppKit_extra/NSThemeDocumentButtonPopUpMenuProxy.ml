...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsthemedocumentbuttonpopupmenuproxy?language=objc}NSThemeDocumentButtonPopUpMenuProxy} *)

let self = get_class "NSThemeDocumentButtonPopUpMenuProxy"
