...
let activationRect self = msg_send_stret ~self ~cmd:(selector "activationRect") ~typ:(returning CGRect.t) ~return_type:CGRect.t
...
let leftButtonGroupFrameInTitlebarView self = msg_send_stret ~self ~cmd:(selector "leftButtonGroupFrameInTitlebarView") ~typ:(returning CGRect.t) ~return_type:CGRect.t
...
let sizeOfTitlebarToolbarButton self = msg_send_stret ~self ~cmd:(selector "sizeOfTitlebarToolbarButton") ~typ:(returning CGSize.t) ~return_type:CGSize.t
let startingYLocationForSheets self = msg_send ~self ~cmd:(selector "startingYLocationForSheets") ~typ:(returning double)
let stoplightOffset self = msg_send_stret ~self ~cmd:(selector "stoplightOffset") ~typ:(returning CGSize.t) ~return_type:CGSize.t
