...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentautosavebutton?language=objc}NSDocumentAutosaveButton} *)

let self = get_class "NSDocumentAutosaveButton"
