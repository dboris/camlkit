...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcolorpickersliderhueartworkprovider?language=objc}NSTouchBarColorPickerSliderHueArtworkProvider} *)

let self = get_class "NSTouchBarColorPickerSliderHueArtworkProvider"
