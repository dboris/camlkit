...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuiaggregateunarchiver?language=objc}NSPersistentUIAggregateUnarchiver} *)

let self = get_class "NSPersistentUIAggregateUnarchiver"
