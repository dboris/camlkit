...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsglobalpreferencetransitionoverlay?language=objc}NSGlobalPreferenceTransitionOverlay} *)

let self = get_class "NSGlobalPreferenceTransitionOverlay"
