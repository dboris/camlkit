...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsviewcontrollerpresentationanimatorobject?language=objc}NSViewControllerPresentationAnimatorObject} *)

let self = get_class "NSViewControllerPresentationAnimatorObject"
