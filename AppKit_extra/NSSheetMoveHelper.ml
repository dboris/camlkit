...
let self = get_class "NSSheetMoveHelper"
...
let sheetSizeToFitScreenFromSize x ~inPositioningRect ~parent self = msg_send_stret ~self ~cmd:(selector "sheetSizeToFitScreenFromSize:inPositioningRect:parent:") ~typ:(CGSize.t @-> CGRect.t @-> id @-> returning CGSize.t) ~return_type:CGSize.t x inPositioningRect parent
