...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nswindowsharingsessionhostbuttoncell?language=objc}NSWindowSharingSessionHostButtonCell} *)

let self = get_class "NSWindowSharingSessionHostButtonCell"
