...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcolorpickerslidersaturationartworkprovider?language=objc}NSTouchBarColorPickerSliderSaturationArtworkProvider} *)

let self = get_class "NSTouchBarColorPickerSliderSaturationArtworkProvider"
