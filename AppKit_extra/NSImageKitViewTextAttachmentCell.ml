...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsimagekitviewtextattachmentcell?language=objc}NSImageKitViewTextAttachmentCell} *)

let self = get_class "NSImageKitViewTextAttachmentCell"
