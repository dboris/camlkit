...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsscrollanimationhelper?language=objc}NSScrollAnimationHelper} *)

let self = get_class "NSScrollAnimationHelper"
