...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorpickerpageablenamelistscrollview?language=objc}NSColorPickerPageableNameListScrollView} *)

let self = get_class "NSColorPickerPageableNameListScrollView"
...
let pageClicked x ~inSpectrumView self = msg_send ~self ~cmd:(selector "pageClicked:inSpectrumView:") ~typ:(llong @-> id @-> returning void) (LLong.of_int x) inSpectrumView
