...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsseparatortoolbaritemview?language=objc}NSSeparatorToolbarItemView} *)

let self = get_class "NSSeparatorToolbarItemView"
