...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuipreservedstatedirectory?language=objc}NSPersistentUIPreservedStateDirectory} *)

let self = get_class "NSPersistentUIPreservedStateDirectory"
