...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nssavepanelalertstylecontentview?language=objc}NSSavePanelAlertStyleContentView} *)

let self = get_class "NSSavePanelAlertStyleContentView"
