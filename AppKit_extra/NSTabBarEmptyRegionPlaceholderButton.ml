...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstabbaremptyregionplaceholderbutton?language=objc}NSTabBarEmptyRegionPlaceholderButton} *)

let self = get_class "NSTabBarEmptyRegionPlaceholderButton"
