...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscacheddevicewhitecolor?language=objc}NSCachedDeviceWhiteColor} *)

let self = get_class "NSCachedDeviceWhiteColor"
