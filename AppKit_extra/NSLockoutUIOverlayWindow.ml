...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nslockoutuioverlaywindow?language=objc}NSLockoutUIOverlayWindow} *)

let self = get_class "NSLockoutUIOverlayWindow"
