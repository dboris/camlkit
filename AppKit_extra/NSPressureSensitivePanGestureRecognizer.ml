...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspressuresensitivepangesturerecognizer?language=objc}NSPressureSensitivePanGestureRecognizer} *)

let self = get_class "NSPressureSensitivePanGestureRecognizer"
