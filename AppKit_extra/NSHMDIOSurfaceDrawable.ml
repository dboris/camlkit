...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nshmdiosurfacedrawable?language=objc}NSHMDIOSurfaceDrawable} *)

let self = get_class "NSHMDIOSurfaceDrawable"
