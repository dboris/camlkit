...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscacheddevicergbcolor?language=objc}NSCachedDeviceRGBColor} *)

let self = get_class "NSCachedDeviceRGBColor"
