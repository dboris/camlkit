...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstablecolumndraginfo?language=objc}NSTableColumnDragInfo} *)

let self = get_class "NSTableColumnDragInfo"
