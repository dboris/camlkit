...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugmenudumplayerprovider?language=objc}NSDebugMenuDumpLayerProvider} *)

let self = get_class "NSDebugMenuDumpLayerProvider"
