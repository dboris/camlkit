...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsaccessibilitymockstatusbaritem?language=objc}NSAccessibilityMockStatusBarItem} *)

let self = get_class "NSAccessibilityMockStatusBarItem"
