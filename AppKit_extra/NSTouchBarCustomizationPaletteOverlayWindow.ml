...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcustomizationpaletteoverlaywindow?language=objc}NSTouchBarCustomizationPaletteOverlayWindow} *)

let self = get_class "NSTouchBarCustomizationPaletteOverlayWindow"
...
let dragLocation self = msg_send_stret ~self ~cmd:(selector "dragLocation") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let dragSize self = msg_send_stret ~self ~cmd:(selector "dragSize") ~typ:(returning CGSize.t) ~return_type:CGSize.t
