...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsattachmenttextstorage?language=objc}NSAttachmentTextStorage} *)

let self = get_class "NSAttachmentTextStorage"
