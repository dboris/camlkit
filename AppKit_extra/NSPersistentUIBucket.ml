...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuibucket?language=objc}NSPersistentUIBucket} *)

let self = get_class "NSPersistentUIBucket"
