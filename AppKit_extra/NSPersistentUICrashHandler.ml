...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuicrashhandler?language=objc}NSPersistentUICrashHandler} *)

let self = get_class "NSPersistentUICrashHandler"
