...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsextendedspellcheckingresult?language=objc}NSExtendedSpellCheckingResult} *)

let self = get_class "NSExtendedSpellCheckingResult"
