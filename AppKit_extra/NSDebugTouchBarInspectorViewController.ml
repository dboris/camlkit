...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugtouchbarinspectorviewcontroller?language=objc}NSDebugTouchBarInspectorViewController} *)

let self = get_class "NSDebugTouchBarInspectorViewController"
