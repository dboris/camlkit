...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsoutlinemockdisclosuretriangle?language=objc}NSOutlineMockDisclosureTriangle} *)

let self = get_class "NSOutlineMockDisclosureTriangle"
