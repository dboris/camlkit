...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nssimplepreferencesmodule?language=objc}NSSimplePreferencesModule} *)

let self = get_class "NSSimplePreferencesModule"
...
let setApplicationGroupContainerIdentifier x self = msg_send ~self ~cmd:(selector "setApplicationGroupContainerIdentifier:") ~typ:(id @-> returning void) x
