...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcolorpickersliderartworkprovider?language=objc}NSTouchBarColorPickerSliderArtworkProvider} *)

let self = get_class "NSTouchBarColorPickerSliderArtworkProvider"
