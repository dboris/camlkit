...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsprintpreviewgraphicscontext?language=objc}NSPrintPreviewGraphicsContext} *)

let self = get_class "NSPrintPreviewGraphicsContext"
