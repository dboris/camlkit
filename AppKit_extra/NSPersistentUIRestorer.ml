...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuirestorer?language=objc}NSPersistentUIRestorer} *)

let self = get_class "NSPersistentUIRestorer"
