...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscollectionviewsupplementaryviewconcreteviewaccessibility?language=objc}NSCollectionViewSupplementaryViewConcreteViewAccessibility} *)

let self = get_class "NSCollectionViewSupplementaryViewConcreteViewAccessibility"
