...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscollectionviewsectionaccessibility?language=objc}NSCollectionViewSectionAccessibility} *)

let self = get_class "NSCollectionViewSectionAccessibility"
...
let setIndexInCollectionView x self = msg_send ~self ~cmd:(selector "setIndexInCollectionView:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let visibleItemsInSection x self = msg_send ~self ~cmd:(selector "visibleItemsInSection:") ~typ:(llong @-> returning id) (LLong.of_int x)
let visibleSupplementaryViewsInSection x self = msg_send ~self ~cmd:(selector "visibleSupplementaryViewsInSection:") ~typ:(llong @-> returning id) (LLong.of_int x)