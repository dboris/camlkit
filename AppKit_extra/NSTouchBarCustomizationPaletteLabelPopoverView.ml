...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcustomizationpalettelabelpopoverview?language=objc}NSTouchBarCustomizationPaletteLabelPopoverView} *)

let self = get_class "NSTouchBarCustomizationPaletteLabelPopoverView"
