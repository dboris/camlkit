...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsaccessibilityimagemockuielement?language=objc}NSAccessibilityImageMockUIElement} *)

let self = get_class "NSAccessibilityImageMockUIElement"
