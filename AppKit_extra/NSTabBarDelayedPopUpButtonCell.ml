...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstabbardelayedpopupbuttoncell?language=objc}NSTabBarDelayedPopUpButtonCell} *)

let self = get_class "NSTabBarDelayedPopUpButtonCell"
