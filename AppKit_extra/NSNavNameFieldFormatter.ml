...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsnavnamefieldformatter?language=objc}NSNavNameFieldFormatter} *)

let self = get_class "NSNavNameFieldFormatter"
