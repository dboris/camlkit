...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstitlebarviewcontroller?language=objc}NSTitlebarViewController} *)

let self = get_class "NSTitlebarViewController"
