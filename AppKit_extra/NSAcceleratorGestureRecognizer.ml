...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsacceleratorgesturerecognizer?language=objc}NSAcceleratorGestureRecognizer} *)

let self = get_class "NSAcceleratorGestureRecognizer"
