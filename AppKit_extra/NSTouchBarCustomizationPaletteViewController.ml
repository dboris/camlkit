...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcustomizationpaletteviewcontroller?language=objc}NSTouchBarCustomizationPaletteViewController} *)

let self = get_class "NSTouchBarCustomizationPaletteViewController"
...
let collectionView3 x ~layout ~maxSizeForItemAtIndexPath self = msg_send ~self ~cmd:(selector "collectionView:layout:maxSizeForItemAtIndexPath:") ~typ:(id @-> id @-> id @-> returning CGSize.t) x layout maxSizeForItemAtIndexPath
let collectionView4 x ~layout ~minSizeForItemAtIndexPath self = msg_send ~self ~cmd:(selector "collectionView:layout:minSizeForItemAtIndexPath:") ~typ:(id @-> id @-> id @-> returning CGSize.t) x layout minSizeForItemAtIndexPath
...
let collectionView7 x ~draggingSession ~endedAtPoint ~dragOperation self = msg_send ~self ~cmd:(selector "collectionView:draggingSession:endedAtPoint:dragOperation:") ~typ:(id @-> id @-> CGPoint.t @-> ullong @-> returning void) x draggingSession endedAtPoint (ULLong.of_int dragOperation)
...
let presetSize self = msg_send ~self ~cmd:(selector "presetSize") ~typ:(returning CGSize.t)
