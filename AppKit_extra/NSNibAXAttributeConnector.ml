...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsnibaxattributeconnector?language=objc}NSNibAXAttributeConnector} *)

let self = get_class "NSNibAXAttributeConnector"
