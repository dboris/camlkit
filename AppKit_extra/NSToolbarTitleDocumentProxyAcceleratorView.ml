...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstoolbartitledocumentproxyacceleratorview?language=objc}NSToolbarTitleDocumentProxyAcceleratorView} *)

let self = get_class "NSToolbarTitleDocumentProxyAcceleratorView"
