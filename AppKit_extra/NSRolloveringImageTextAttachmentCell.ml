...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsrolloveringimagetextattachmentcell?language=objc}NSRolloveringImageTextAttachmentCell} *)

let self = get_class "NSRolloveringImageTextAttachmentCell"
