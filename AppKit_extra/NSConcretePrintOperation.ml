...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsconcreteprintoperation?language=objc}NSConcretePrintOperation} *)

let self = get_class "NSConcretePrintOperation"
