...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcustomizationcursormanager?language=objc}NSTouchBarCustomizationCursorManager} *)

let self = get_class "NSTouchBarCustomizationCursorManager"
