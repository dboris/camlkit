...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsalphathresholdcolormodifier?language=objc}NSAlphaThresholdColorModifier} *)

let self = get_class "NSAlphaThresholdColorModifier"
