...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsaccessibilitymenuextrasmenubar?language=objc}NSAccessibilityMenuExtrasMenuBar} *)

let self = get_class "NSAccessibilityMenuExtrasMenuBar"
