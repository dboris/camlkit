...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugmenuactionrecorderprovider?language=objc}NSDebugMenuActionRecorderProvider} *)

let self = get_class "NSDebugMenuActionRecorderProvider"
