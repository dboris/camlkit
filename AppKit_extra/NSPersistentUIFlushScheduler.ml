...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuiflushscheduler?language=objc}NSPersistentUIFlushScheduler} *)

let self = get_class "NSPersistentUIFlushScheduler"
