...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugmenuresponderchainprovider?language=objc}NSDebugMenuResponderChainProvider} *)

let self = get_class "NSDebugMenuResponderChainProvider"
...
let updateForCFMZ x self = msg_send ~self ~cmd:(selector "updateForCFMZ:") ~typ:(id @-> returning void) x
let updateResponderChainFromWindow x self = msg_send ~self ~cmd:(selector "updateResponderChainFromWindow:") ~typ:(id @-> returning void) x