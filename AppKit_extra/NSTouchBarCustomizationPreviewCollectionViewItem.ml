...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcustomizationpreviewcollectionviewitem?language=objc}NSTouchBarCustomizationPreviewCollectionViewItem} *)

let self = get_class "NSTouchBarCustomizationPreviewCollectionViewItem"
