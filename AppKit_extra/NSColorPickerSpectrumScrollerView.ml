...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscolorpickerspectrumscrollerview?language=objc}NSColorPickerSpectrumScrollerView} *)

let self = get_class "NSColorPickerSpectrumScrollerView"
