...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugtouchbarviewcontroller?language=objc}NSDebugTouchBarViewController} *)

let self = get_class "NSDebugTouchBarViewController"
