...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscollectionviewflowlayoutsectionaccessibility?language=objc}NSCollectionViewFlowLayoutSectionAccessibility} *)

let self = get_class "NSCollectionViewFlowLayoutSectionAccessibility"
