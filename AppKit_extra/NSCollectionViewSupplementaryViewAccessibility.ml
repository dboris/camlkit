...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscollectionviewsupplementaryviewaccessibility?language=objc}NSCollectionViewSupplementaryViewAccessibility} *)

let self = get_class "NSCollectionViewSupplementaryViewAccessibility"
