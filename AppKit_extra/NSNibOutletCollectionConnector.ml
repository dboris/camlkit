...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsniboutletcollectionconnector?language=objc}NSNibOutletCollectionConnector} *)

let self = get_class "NSNibOutletCollectionConnector"
