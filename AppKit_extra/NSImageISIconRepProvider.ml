...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsimageisiconrepprovider?language=objc}NSImageISIconRepProvider} *)

let self = get_class "NSImageISIconRepProvider"
