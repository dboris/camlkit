...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchdevicetouchmap?language=objc}NSTouchDeviceTouchMap} *)

let self = get_class "NSTouchDeviceTouchMap"
