...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsavaudioplayersoundengine?language=objc}NSAVAudioPlayerSoundEngine} *)

let self = get_class "NSAVAudioPlayerSoundEngine"

let audioPlayerDidFinishPlaying x ~successfully self = msg_send ~self ~cmd:(selector "audioPlayerDidFinishPlaying:successfully:") ~typ:(id @-> bool @-> returning void) x successfully
