...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nssheeteffectdimmingview?language=objc}NSSheetEffectDimmingView} *)

let self = get_class "NSSheetEffectDimmingView"
