...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nswindowbatchordering?language=objc}NSWindowBatchOrdering} *)

let self = get_class "NSWindowBatchOrdering"
