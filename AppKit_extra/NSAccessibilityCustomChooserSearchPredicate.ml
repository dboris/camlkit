...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsaccessibilitycustomchoosersearchpredicate?language=objc}NSAccessibilityCustomChooserSearchPredicate} *)

let self = get_class "NSAccessibilityCustomChooserSearchPredicate"
