...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcolorpickerswitcher?language=objc}NSTouchBarColorPickerSwitcher} *)

let self = get_class "NSTouchBarColorPickerSwitcher"
