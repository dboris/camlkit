...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsthemedocumentbuttoncell?language=objc}NSThemeDocumentButtonCell} *)

let self = get_class "NSThemeDocumentButtonCell"
