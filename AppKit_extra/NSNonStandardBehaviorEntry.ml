...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsnonstandardbehaviorentry?language=objc}NSNonStandardBehaviorEntry} *)

let self = get_class "NSNonStandardBehaviorEntry"
...
let setReason x self = msg_send ~self ~cmd:(selector "setReason:") ~typ:(llong @-> returning void) (LLong.of_int x)
