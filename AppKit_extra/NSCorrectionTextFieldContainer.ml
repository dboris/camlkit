...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscorrectiontextfieldcontainer?language=objc}NSCorrectionTextFieldContainer} *)

let self = get_class "NSCorrectionTextFieldContainer"
