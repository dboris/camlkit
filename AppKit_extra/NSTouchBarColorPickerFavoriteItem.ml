...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcolorpickerfavoriteitem?language=objc}NSTouchBarColorPickerFavoriteItem} *)

let self = get_class "NSTouchBarColorPickerFavoriteItem"
