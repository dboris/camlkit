...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscustomdynamiccolor?language=objc}NSCustomDynamicColor} *)

let self = get_class "NSCustomDynamicColor"
