...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscollectionviewaccessibilityhelper?language=objc}NSCollectionViewAccessibilityHelper} *)

let self = get_class "NSCollectionViewAccessibilityHelper"
