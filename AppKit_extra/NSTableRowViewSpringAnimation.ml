...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstablerowviewspringanimation?language=objc}NSTableRowViewSpringAnimation} *)

let self = get_class "NSTableRowViewSpringAnimation"
