...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugtouchbarmodel?language=objc}NSDebugTouchBarModel} *)

let self = get_class "NSDebugTouchBarModel"
