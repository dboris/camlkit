...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsworkspaceapplicationkvohelper?language=objc}NSWorkspaceApplicationKVOHelper} *)

let self = get_class "NSWorkspaceApplicationKVOHelper"
...
let initWithKVOHelperIndex x self = msg_send ~self ~cmd:(selector "initWithKVOHelperIndex:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
