...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscorrectiontextview?language=objc}NSCorrectionTextView} *)

let self = get_class "NSCorrectionTextView"
