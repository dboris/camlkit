...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugmenunonstandardbehaviorprovider?language=objc}NSDebugMenuNonStandardBehaviorProvider} *)

let self = get_class "NSDebugMenuNonStandardBehaviorProvider"
