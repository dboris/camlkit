...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstabviewcontrollertoolbaruiprovider?language=objc}NSTabViewControllerToolbarUIProvider} *)

let self = get_class "NSTabViewControllerToolbarUIProvider"
