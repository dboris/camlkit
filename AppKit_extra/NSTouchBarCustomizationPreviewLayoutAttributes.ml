...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcustomizationpreviewlayoutattributes?language=objc}NSTouchBarCustomizationPreviewLayoutAttributes} *)

let self = get_class "NSTouchBarCustomizationPreviewLayoutAttributes"
