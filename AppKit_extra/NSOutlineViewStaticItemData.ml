...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsoutlineviewstaticitemdata?language=objc}NSOutlineViewStaticItemData} *)

let self = get_class "NSOutlineViewStaticItemData"
