...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdebugmenuappearanceoverrideprovider?language=objc}NSDebugMenuAppearanceOverrideProvider} *)

let self = get_class "NSDebugMenuAppearanceOverrideProvider"
