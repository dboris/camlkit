...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstableviewdropfeedbackdata?language=objc}NSTableViewDropFeedbackData} *)

let self = get_class "NSTableViewDropFeedbackData"
