...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nspersistentuikeyedunarchiver?language=objc}NSPersistentUIKeyedUnarchiver} *)

let self = get_class "NSPersistentUIKeyedUnarchiver"
