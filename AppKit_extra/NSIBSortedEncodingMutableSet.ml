...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsibsortedencodingmutableset?language=objc}NSIBSortedEncodingMutableSet} *)

let self = get_class "NSIBSortedEncodingMutableSet"
