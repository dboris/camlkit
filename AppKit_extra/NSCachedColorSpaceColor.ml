...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nscachedcolorspacecolor?language=objc}NSCachedColorSpaceColor} *)

let self = get_class "NSCachedColorSpaceColor"
