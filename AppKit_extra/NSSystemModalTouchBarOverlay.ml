...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nssystemmodaltouchbaroverlay?language=objc}NSSystemModalTouchBarOverlay} *)

let self = get_class "NSSystemModalTouchBarOverlay"
