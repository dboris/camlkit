...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstextviewattachmenteditcompletionanimation?language=objc}NSTextViewAttachmentEditCompletionAnimation} *)

let self = get_class "NSTextViewAttachmentEditCompletionAnimation"
