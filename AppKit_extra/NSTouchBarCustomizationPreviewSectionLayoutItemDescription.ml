...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nstouchbarcustomizationpreviewsectionlayoutitemdescription?language=objc}NSTouchBarCustomizationPreviewSectionLayoutItemDescription} *)
