...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsapplicationsubtest?language=objc}NSApplicationSubTest} *)

let self = get_class "NSApplicationSubTest"
