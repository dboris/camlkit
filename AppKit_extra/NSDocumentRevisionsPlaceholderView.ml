...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentrevisionsplaceholderview?language=objc}NSDocumentRevisionsPlaceholderView} *)

let self = get_class "NSDocumentRevisionsPlaceholderView"
