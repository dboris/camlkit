...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsbrowsercolumnviewcontroller?language=objc}NSBrowserColumnViewController} *)

let self = get_class "NSBrowserColumnViewController"
...
let childItemAtIndex x self = msg_send ~self ~cmd:(selector "childItemAtIndex:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let didEndResizingColumn x self = msg_send ~self ~cmd:(selector "didEndResizingColumn:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let editRow x ~withEvent ~select self = msg_send ~self ~cmd:(selector "editRow:withEvent:select:") ~typ:(llong @-> id @-> bool @-> returning void) (LLong.of_int x) withEvent select
let firstValidRowIndex self = msg_send ~self ~cmd:(selector "firstValidRowIndex") ~typ:(returning llong)
let frameOfRow x self = msg_send_stret ~self ~cmd:(selector "frameOfRow:") ~typ:(llong @-> returning CGRect.t) ~return_type:CGRect.t (LLong.of_int x)
let headerViewController self = msg_send ~self ~cmd:(selector "headerViewController") ~typ:(returning id)
let isExpandableRow x self = msg_send ~self ~cmd:(selector "isExpandableRow:") ~typ:(llong @-> returning bool) (LLong.of_int x)
let isLeafItem x self = msg_send ~self ~cmd:(selector "isLeafItem:") ~typ:(id @-> returning bool) x
let isLeafRow x self = msg_send ~self ~cmd:(selector "isLeafRow:") ~typ:(llong @-> returning bool) (LLong.of_int x)
let menu self = msg_send ~self ~cmd:(selector "menu") ~typ:(returning id)
let nextValidRowIndexAfterIndex x self = msg_send ~self ~cmd:(selector "nextValidRowIndexAfterIndex:") ~typ:(llong @-> returning llong) (LLong.of_int x)
...
let preparedCellAtRow x self = msg_send ~self ~cmd:(selector "preparedCellAtRow:") ~typ:(llong @-> returning id) (LLong.of_int x)
...
let scrollRowToCenter x self = msg_send ~self ~cmd:(selector "scrollRowToCenter:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let setColumnIndex x self = msg_send ~self ~cmd:(selector "setColumnIndex:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let setNeedsDisplayInRow x self = msg_send ~self ~cmd:(selector "setNeedsDisplayInRow:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let willBeginResizingColumn x self = msg_send ~self ~cmd:(selector "willBeginResizingColumn:") ~typ:(llong @-> returning void) (LLong.of_int x)