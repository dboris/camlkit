...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsdocumentrevisionsview?language=objc}NSDocumentRevisionsView} *)

let self = get_class "NSDocumentRevisionsView"
...
let focusedOriginalFrame self = msg_send_stret ~self ~cmd:(selector "focusedOriginalFrame") ~typ:(returning CGRect.t) ~return_type:CGRect.t
let focusedRevisionFrame self = msg_send_stret ~self ~cmd:(selector "focusedRevisionFrame") ~typ:(returning CGRect.t) ~return_type:CGRect.t
let fullTwoUpLayout self = msg_send ~self ~cmd:(selector "fullTwoUpLayout") ~typ:(returning bool)
let goToStackItemAtIndex x ~thenContinue self = msg_send ~self ~cmd:(selector "goToStackItemAtIndex:thenContinue:") ~typ:(ullong @-> (ptr void) @-> returning void) (ULLong.of_int x) thenContinue
...
let prepareForFinishAnimationWithOutcome x self = msg_send ~self ~cmd:(selector "prepareForFinishAnimationWithOutcome:") ~typ:(llong @-> returning void) (LLong.of_int x)
...
let revisionFrame self = msg_send_stret ~self ~cmd:(selector "revisionFrame") ~typ:(returning CGRect.t) ~return_type:CGRect.t
