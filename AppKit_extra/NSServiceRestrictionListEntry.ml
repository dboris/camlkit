...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsservicerestrictionlistentry?language=objc}NSServiceRestrictionListEntry} *)

let self = get_class "NSServiceRestrictionListEntry"
