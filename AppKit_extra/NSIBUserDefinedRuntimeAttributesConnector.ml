...
(** Apple docs: {{:https://developer.apple.com/documentation/appkit/nsibuserdefinedruntimeattributesconnector?language=objc}NSIBUserDefinedRuntimeAttributesConnector} *)

let self = get_class "NSIBUserDefinedRuntimeAttributesConnector"
