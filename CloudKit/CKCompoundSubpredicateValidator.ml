...
(** Apple docs: {{:https://developer.apple.com/documentation/cloudkit/ckcompoundsubpredicatevalidator?language=objc}CKCompoundSubpredicateValidator} *)

let self = get_class "CKCompoundSubpredicateValidator"
