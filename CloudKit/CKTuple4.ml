...
(** Apple docs: {{:https://developer.apple.com/documentation/cloudkit/cktuple4?language=objc}CKTuple4} *)

let self = get_class "CKTuple4"

let hash self = msg_send ~self ~cmd:(selector "hash") ~typ:(returning ullong) |> ULLong.to_int
let initWithObject1 x ~object2 ~object3 ~object4 self = msg_send ~self ~cmd:(selector "initWithObject1:object2:object3:object4:") ~typ:(id @-> id @-> id @-> id @-> returning id) x object2 object3 object4
