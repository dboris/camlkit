...
(** Apple docs: {{:https://developer.apple.com/documentation/cloudkit/ckflipfloppredicatevalidator?language=objc}CKFlipFlopPredicateValidator} *)

let self = get_class "CKFlipFlopPredicateValidator"
