...
(** Apple docs: {{:https://developer.apple.com/documentation/cloudkit/ckconstantvalueexpressionvalidator?language=objc}CKConstantValueExpressionValidator} *)

let self = get_class "CKConstantValueExpressionValidator"
