...
(** Apple docs: {{:https://developer.apple.com/documentation/cloudkit/ckkeypathexpressionvalidator?language=objc}CKKeyPathExpressionValidator} *)

let self = get_class "CKKeyPathExpressionValidator"
