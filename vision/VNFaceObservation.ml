...
module C = struct
  let computeYawPitchRollFromPoseMatrix x ~outputYaw ~outputPitch ~outputRoll self = msg_send ~self ~cmd:(selector "computeYawPitchRollFromPoseMatrix:outputYaw:outputPitch:outputRoll:") ~typ:(ptr void @-> ptr (float) @-> ptr (float) @-> ptr (float) @-> returning (bool)) x outputYaw outputPitch outputRoll
...
let alignedBoundingBoxAsCGRect self = msg_send_stret ~self ~cmd:(selector "alignedBoundingBoxAsCGRect") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
...
let getComputedRectifyingTransform x self = msg_send ~self ~cmd:(selector "getComputedRectifyingTransform:") ~typ:(ptr void @-> returning (bool)) x
...
let unalignedBoundingBox self = msg_send_stret ~self ~cmd:(selector "unalignedBoundingBox") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
