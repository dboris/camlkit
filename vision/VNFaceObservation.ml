...
let _class_ = get_class "VNFaceObservation"
...
module Class = struct
  ...
  let faceObservationWithRequestRevision x ~boundingBox ~andAlignedBoundingBox self = msg_send ~self ~cmd:(selector "faceObservationWithRequestRevision:boundingBox:andAlignedBoundingBox:") ~typ:(ullong @-> CGRect.t @-> CGRect.t @-> returning (id)) x boundingBox andAlignedBoundingBox
  let faceObservationWithRequestRevision1 x ~boundingBox ~faceprint self = msg_send ~self ~cmd:(selector "faceObservationWithRequestRevision:boundingBox:faceprint:") ~typ:(ullong @-> CGRect.t @-> id @-> returning (id)) x boundingBox faceprint
  let faceObservationWithRequestRevision2 x ~unalignedBoundingBox ~alignedBoundingBox self = msg_send ~self ~cmd:(selector "faceObservationWithRequestRevision:unalignedBoundingBox:alignedBoundingBox:") ~typ:(ullong @-> CGRect.t @-> CGRect.t @-> returning (id)) x unalignedBoundingBox alignedBoundingBox
  let faceObservationWithRequestRevision3 x ~boundingBox ~roll ~yaw self = msg_send ~self ~cmd:(selector "faceObservationWithRequestRevision:boundingBox:roll:yaw:") ~typ:(ullong @-> CGRect.t @-> id @-> id @-> returning (id)) x boundingBox roll yaw
  let faceObservationWithRequestRevision4 x ~boundingBox ~alignedBoundingBox ~roll ~yaw self = msg_send ~self ~cmd:(selector "faceObservationWithRequestRevision:boundingBox:alignedBoundingBox:roll:yaw:") ~typ:(ullong @-> CGRect.t @-> CGRect.t @-> id @-> id @-> returning (id)) x boundingBox alignedBoundingBox roll yaw
  let faceObservationWithRequestRevision5 x ~boundingBox ~roll ~yaw ~pitch self = msg_send ~self ~cmd:(selector "faceObservationWithRequestRevision:boundingBox:roll:yaw:pitch:") ~typ:(ullong @-> CGRect.t @-> id @-> id @-> id @-> returning (id)) x boundingBox roll yaw pitch
  let faceObservationWithRequestRevision6 x ~boundingBox ~alignedBoundingBox ~roll ~yaw ~pitch self = msg_send ~self ~cmd:(selector "faceObservationWithRequestRevision:boundingBox:alignedBoundingBox:roll:yaw:pitch:") ~typ:(ullong @-> CGRect.t @-> CGRect.t @-> id @-> id @-> id @-> returning (id)) x boundingBox alignedBoundingBox roll yaw pitch
...
let _VNPersonsModelFaceprintWithRequestRevision x ~error self = msg_send ~self ~cmd:(selector "VNPersonsModelFaceprintWithRequestRevision:error:") ~typ:(ullong @-> ptr (id) @-> returning (id)) x error
...
let faceCaptureQualityOriginatingRequestSpecifier self = msg_send ~self ~cmd:(selector "faceCaptureQualityOriginatingRequestSpecifier") ~typ:(returning (id))
...
let isBoundingBoxAligned self = msg_send ~self ~cmd:(selector "isBoundingBoxAligned") ~typ:(returning (bool))
let isEqual x self = msg_send ~self ~cmd:(selector "isEqual:") ~typ:(id @-> returning (bool)) x
let isRevision1DetectedRectanglesCompatible self = msg_send ~self ~cmd:(selector "isRevision1DetectedRectanglesCompatible") ~typ:(returning (bool))
...
let poseOriginatingRequestSpecifier self = msg_send ~self ~cmd:(selector "poseOriginatingRequestSpecifier") ~typ:(returning (id))
...
let setBoundingBoxAligned x self = msg_send ~self ~cmd:(selector "setBoundingBoxAligned:") ~typ:(bool @-> returning (void)) x
...
let setFaceCaptureQuality x ~originatingRequestSpecifier self = msg_send ~self ~cmd:(selector "setFaceCaptureQuality:originatingRequestSpecifier:") ~typ:(float @-> id @-> returning (void)) x originatingRequestSpecifier
let setFaceId x self = msg_send ~self ~cmd:(selector "setFaceId:") ~typ:(ullong @-> returning (void)) x
...
let setLandmarksConstellation x self = msg_send ~self ~cmd:(selector "setLandmarksConstellation:") ~typ:(ullong @-> returning (void)) x
...
let setPoseData x ~originatingRequestSpecifier self = msg_send ~self ~cmd:(selector "setPoseData:originatingRequestSpecifier:") ~typ:(id @-> id @-> returning (void)) x originatingRequestSpecifier
...
let updateFaceCaptureQuality x self = msg_send ~self ~cmd:(selector "updateFaceCaptureQuality:") ~typ:(id @-> returning (void)) x
