...
module Class = struct
  ...
  let specifierForRequestClass x ~revision ~error self = msg_send ~self ~cmd:(selector "specifierForRequestClass:revision:error:") ~typ:(_Class @-> ullong @-> ptr (id) @-> returning (id)) x revision error
  let specifierForRequestClassCode x ~revision ~error self = msg_send ~self ~cmd:(selector "specifierForRequestClassCode:revision:error:") ~typ:(ptr (uint) @-> ullong @-> ptr (id) @-> returning (id)) x revision error
  let specifierForRequestClassName x ~revision ~error self = msg_send ~self ~cmd:(selector "specifierForRequestClassName:revision:error:") ~typ:(id @-> ullong @-> ptr (id) @-> returning (id)) x revision error
...
let initWithRequestClass x ~name ~code ~revision self = msg_send ~self ~cmd:(selector "initWithRequestClass:name:code:revision:") ~typ:(_Class @-> id @-> uint @-> ullong @-> returning (id)) x name code revision
...
let specifiesRequestClass1 x ~revision self = msg_send ~self ~cmd:(selector "specifiesRequestClass:revision:") ~typ:(_Class @-> ullong @-> returning (bool)) x revision
let specifiesRequestClass2 x ~withAnyRevision self = msg_send ~self ~cmd:(selector "specifiesRequestClass:withAnyRevision:") ~typ:(_Class @-> ullong @-> returning (bool)) x withAnyRevision
let specifiesRequestClassName x self = msg_send ~self ~cmd:(selector "specifiesRequestClassName:") ~typ:(id @-> returning (bool)) x
let specifiesRequestClassName1 x ~revision self = msg_send ~self ~cmd:(selector "specifiesRequestClassName:revision:") ~typ:(id @-> ullong @-> returning (bool)) x revision
let specifiesRequestClassName2 x ~withAnyRevision self = msg_send ~self ~cmd:(selector "specifiesRequestClassName:withAnyRevision:") ~typ:(id @-> ullong @-> returning (bool)) x withAnyRevision