...
let faceCenter self = msg_send_stret ~self ~cmd:(selector "faceCenter") ~typ:(returning (CGPoint.t)) ~return_type:CGPoint.t
...
let leftEye self = msg_send_stret ~self ~cmd:(selector "leftEye") ~typ:(returning (CGPoint.t)) ~return_type:CGPoint.t
let mouth self = msg_send_stret ~self ~cmd:(selector "mouth") ~typ:(returning (CGPoint.t)) ~return_type:CGPoint.t
...
let rightEye self = msg_send_stret ~self ~cmd:(selector "rightEye") ~typ:(returning (CGPoint.t)) ~return_type:CGPoint.t
