...
module Class = struct
  ...
  let rectangleObservationWithRequestRevision x ~topLeft ~bottomLeft ~bottomRight ~topRight self = msg_send ~self ~cmd:(selector "rectangleObservationWithRequestRevision:topLeft:bottomLeft:bottomRight:topRight:") ~typ:(ullong @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> returning (id)) x topLeft bottomLeft bottomRight topRight
  let rectangleObservationWithRequestRevision' x ~topLeft ~topRight ~bottomRight ~bottomLeft self = msg_send ~self ~cmd:(selector "rectangleObservationWithRequestRevision:topLeft:topRight:bottomRight:bottomLeft:") ~typ:(ullong @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> returning (id)) x topLeft topRight bottomRight bottomLeft
...
let initWithRequestRevision1 x ~topLeft ~bottomLeft ~bottomRight ~topRight self = msg_send ~self ~cmd:(selector "initWithRequestRevision:topLeft:bottomLeft:bottomRight:topRight:") ~typ:(ullong @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> returning (id)) x topLeft bottomLeft bottomRight topRight
let initWithRequestRevision2 x ~topLeft ~topRight ~bottomRight ~bottomLeft self = msg_send ~self ~cmd:(selector "initWithRequestRevision:topLeft:topRight:bottomRight:bottomLeft:") ~typ:(ullong @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> CGPoint.t @-> returning (id)) x topLeft topRight bottomRight bottomLeft
...
let vkQuad self = msg_send ~self ~cmd:(selector "vkQuad") ~typ:(returning (id))