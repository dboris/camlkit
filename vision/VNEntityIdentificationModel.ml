...
module Class = struct
  ...
  let modelConfigurationForVersion x ~modelObjects ~error self = msg_send ~self ~cmd:(selector "modelConfigurationForVersion:modelObjects:error:") ~typ:(ullong @-> id @-> ptr (id) @-> returning (id)) x modelObjects error
...
let entityPredictionsForObservation x ~limit ~canceller ~error self = msg_send ~self ~cmd:(selector "entityPredictionsForObservation:limit:canceller:error:") ~typ:(id @-> ullong @-> id @-> ptr (id) @-> returning (id)) x limit canceller error
...
let uniqueIdentifierForEntityAtIndex x self = msg_send ~self ~cmd:(selector "uniqueIdentifierForEntityAtIndex:") ~typ:(ullong @-> returning (id)) x
