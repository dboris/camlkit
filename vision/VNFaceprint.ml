...
let _class_ = get_class "VNFaceprint"
...
module C = struct
  ...
  let emptyFaceprintDataForRevision x self = msg_send ~self ~cmd:(selector "emptyFaceprintDataForRevision:") ~typ:(ullong @-> returning (id)) (ULLong.of_int x)
...
let initWithRawData x ~confidence ~requestRevision self = msg_send ~self ~cmd:(selector "initWithRawData:confidence:requestRevision:") ~typ:(ptr (void) @-> float @-> ullong @-> returning (id)) x confidence (ULLong.of_int requestRevision)
let initWithRawData' x ~elementCount ~elementType ~lengthInBytes ~confidence ~requestRevision self = msg_send ~self ~cmd:(selector "initWithRawData:elementCount:elementType:lengthInBytes:confidence:requestRevision:") ~typ:(ptr (void) @-> ullong @-> ullong @-> ullong @-> float @-> ullong @-> returning (id)) x (ULLong.of_int elementCount) (ULLong.of_int elementType) (ULLong.of_int lengthInBytes) confidence (ULLong.of_int requestRevision)
