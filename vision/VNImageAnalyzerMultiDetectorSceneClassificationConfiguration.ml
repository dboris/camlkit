...
let setMaximumHierarchicalLabels x self = msg_send ~self ~cmd:(selector "setMaximumHierarchicalLabels:") ~typ:(ullong @-> returning (void)) x
let setMaximumLeafLabels x self = msg_send ~self ~cmd:(selector "setMaximumLeafLabels:") ~typ:(ullong @-> returning (void)) x
