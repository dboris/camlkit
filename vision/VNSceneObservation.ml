...
let initWithRequestRevision x ~sceneprints self = msg_send ~self ~cmd:(selector "initWithRequestRevision:sceneprints:") ~typ:(ullong @-> id @-> returning (id)) x sceneprints
