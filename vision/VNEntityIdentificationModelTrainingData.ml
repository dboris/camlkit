...
let _class_ = get_class "VNEntityIdentificationModelTrainingData"
...
let observationAtIndex x ~forEntityAtIndex self = msg_send ~self ~cmd:(selector "observationAtIndex:forEntityAtIndex:") ~typ:(ullong @-> ullong @-> returning (id)) x forEntityAtIndex
let observationCountForEntityAtIndex x self = msg_send ~self ~cmd:(selector "observationCountForEntityAtIndex:") ~typ:(ullong @-> returning (ullong)) x
...
let trainedModelNumberOfObservationsForEntityAtIndex x self = msg_send ~self ~cmd:(selector "trainedModelNumberOfObservationsForEntityAtIndex:") ~typ:(ullong @-> returning (ullong)) x
let trainedModelObservationAtIndex x ~forEntityAtIndex self = msg_send ~self ~cmd:(selector "trainedModelObservationAtIndex:forEntityAtIndex:") ~typ:(ullong @-> ullong @-> returning (id)) x forEntityAtIndex
let trainedModelUniqueIdentifierOfEntityAtIndex x self = msg_send ~self ~cmd:(selector "trainedModelUniqueIdentifierOfEntityAtIndex:") ~typ:(ullong @-> returning (id)) x
