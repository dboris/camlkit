...
let _class_ = get_class "VNEntityIdentificationModelTrainedModelVIPv3"
...
let initWithFaceIDModel x ~entityPrintOriginatingRequestSpecifier ~entityUniqueIdentifiers ~entityPrintCounts self = msg_send ~self ~cmd:(selector "initWithFaceIDModel:entityPrintOriginatingRequestSpecifier:entityUniqueIdentifiers:entityPrintCounts:") ~typ:(ptr void @-> id @-> id @-> id @-> returning (id)) x entityPrintOriginatingRequestSpecifier entityUniqueIdentifiers entityPrintCounts
