...
let rangeOfTextBlock x self = msg_send_stret ~self ~cmd:(selector "rangeOfTextBlock:") ~typ:(id @-> returning (NSRange.t)) ~return_type:NSRange.t x
let rangeOfTextBlockObservation x self = msg_send_stret ~self ~cmd:(selector "rangeOfTextBlockObservation:") ~typ:(id @-> returning (NSRange.t)) ~return_type:NSRange.t x
