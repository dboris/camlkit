...
let faceModelFaceObservationAtIndex x ~forPersonAtIndex self = msg_send ~self ~cmd:(selector "faceModelFaceObservationAtIndex:forPersonAtIndex:") ~typ:(ullong @-> ullong @-> returning (id)) x forPersonAtIndex
...
let faceModelNumberOfFaceObservationsForPersonAtIndex x self = msg_send ~self ~cmd:(selector "faceModelNumberOfFaceObservationsForPersonAtIndex:") ~typ:(ullong @-> returning (ullong)) x
let faceModelPersonsCount self = msg_send ~self ~cmd:(selector "faceModelPersonsCount") ~typ:(returning (ullong))
let faceModelUniqueIdentifierOfPersonAtIndex x self = msg_send ~self ~cmd:(selector "faceModelUniqueIdentifierOfPersonAtIndex:") ~typ:(ullong @-> returning (id)) x
