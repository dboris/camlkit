...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phlivephotoexportsession?language=objc}PHLivePhotoExportSession} *)

let self = get_class "PHLivePhotoExportSession"
