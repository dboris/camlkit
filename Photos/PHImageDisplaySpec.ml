...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phimagedisplayspec?language=objc}PHImageDisplaySpec} *)

let self = get_class "PHImageDisplaySpec"
...
let requestSizeFromFullSizedWidth x ~height self = msg_send ~self ~cmd:(selector "requestSizeFromFullSizedWidth:height:") ~typ:(llong @-> llong @-> returning CGSize.t) (LLong.of_int x) (LLong.of_int height)
let requestSizeFromFullSizedWidth' x ~height ~resizeMode self = msg_send ~self ~cmd:(selector "requestSizeFromFullSizedWidth:height:resizeMode:") ~typ:(llong @-> llong @-> llong @-> returning CGSize.t) (LLong.of_int x) (LLong.of_int height) (LLong.of_int resizeMode)
