...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phmemorygenerationoptions?language=objc}PHMemoryGenerationOptions} *)

let self = get_class "PHMemoryGenerationOptions"
