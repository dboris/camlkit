...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phsuggestionmessagematchingresult?language=objc}PHSuggestionMessageMatchingResult} *)

let self = get_class "PHSuggestionMessageMatchingResult"
