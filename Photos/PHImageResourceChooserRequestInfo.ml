...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phimageresourcechooserrequestinfo?language=objc}PHImageResourceChooserRequestInfo} *)

let self = get_class "PHImageResourceChooserRequestInfo"
...
let desiredSize self = msg_send ~self ~cmd:(selector "desiredSize") ~typ:(returning CGSize.t)
