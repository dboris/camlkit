...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetresourcewriterequest?language=objc}PHAssetResourceWriteRequest} *)

let self = get_class "PHAssetResourceWriteRequest"
