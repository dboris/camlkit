...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phimportassetfilepresenter?language=objc}PHImportAssetFilePresenter} *)

let self = get_class "PHImportAssetFilePresenter"
