...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phuserfeedbackdatacache?language=objc}PHUserFeedbackDataCache} *)

let self = get_class "PHUserFeedbackDataCache"
