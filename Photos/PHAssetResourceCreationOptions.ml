...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetresourcecreationoptions?language=objc}PHAssetResourceCreationOptions} *)

let self = get_class "PHAssetResourceCreationOptions"
