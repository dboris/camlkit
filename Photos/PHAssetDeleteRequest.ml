...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetdeleterequest?language=objc}PHAssetDeleteRequest} *)

let self = get_class "PHAssetDeleteRequest"
