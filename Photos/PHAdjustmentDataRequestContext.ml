...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phadjustmentdatarequestcontext?language=objc}PHAdjustmentDataRequestContext} *)

let self = get_class "PHAdjustmentDataRequestContext"
