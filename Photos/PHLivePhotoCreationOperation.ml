...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phlivephotocreationoperation?language=objc}PHLivePhotoCreationOperation} *)

let self = get_class "PHLivePhotoCreationOperation"
