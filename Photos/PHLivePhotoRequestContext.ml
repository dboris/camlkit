...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phlivephotorequestcontext?language=objc}PHLivePhotoRequestContext} *)

let self = get_class "PHLivePhotoRequestContext"
