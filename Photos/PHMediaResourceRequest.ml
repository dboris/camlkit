...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phmediaresourcerequest?language=objc}PHMediaResourceRequest} *)

let self = get_class "PHMediaResourceRequest"
