...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phcontenteditinginput?language=objc}PHContentEditingInput} *)

let self = get_class "PHContentEditingInput"
