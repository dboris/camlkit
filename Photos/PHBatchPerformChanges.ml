...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phbatchperformchanges?language=objc}PHBatchPerformChanges} *)

let self = get_class "PHBatchPerformChanges"
