...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetaestheticproperties?language=objc}PHAssetAestheticProperties} *)

let self = get_class "PHAssetAestheticProperties"
