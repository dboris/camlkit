...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phpersondeleterequest?language=objc}PHPersonDeleteRequest} *)

let self = get_class "PHPersonDeleteRequest"
