...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phmediaresourceresult?language=objc}PHMediaResourceResult} *)

let self = get_class "PHMediaResourceResult"
