...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phimagerequestcontext?language=objc}PHImageRequestContext} *)

let self = get_class "PHImageRequestContext"
