...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phsuggestionmessagecontext?language=objc}PHSuggestionMessageContext} *)

let self = get_class "PHSuggestionMessageContext"
