...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phrelatedfetchoptions?language=objc}PHRelatedFetchOptions} *)

let self = get_class "PHRelatedFetchOptions"
