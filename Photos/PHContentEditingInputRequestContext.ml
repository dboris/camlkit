...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phcontenteditinginputrequestcontext?language=objc}PHContentEditingInputRequestContext} *)

let self = get_class "PHContentEditingInputRequestContext"
