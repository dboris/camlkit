...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phimportexceptionrecorder?language=objc}PHImportExceptionRecorder} *)

let self = get_class "PHImportExceptionRecorder"
