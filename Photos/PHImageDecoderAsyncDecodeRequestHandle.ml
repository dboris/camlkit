...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phimagedecoderasyncdecoderequesthandle?language=objc}PHImageDecoderAsyncDecodeRequestHandle} *)

let self = get_class "PHImageDecoderAsyncDecodeRequestHandle"
