...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phmomentsharepreview?language=objc}PHMomentSharePreview} *)

let self = get_class "PHMomentSharePreview"

let cropRect self = msg_send ~self ~cmd:(selector "cropRect") ~typ:(returning CGRect.t)
