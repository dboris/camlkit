...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetresourcerequestoptions?language=objc}PHAssetResourceRequestOptions} *)

let self = get_class "PHAssetResourceRequestOptions"
