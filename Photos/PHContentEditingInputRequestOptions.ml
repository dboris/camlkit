...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phcontenteditinginputrequestoptions?language=objc}PHContentEditingInputRequestOptions} *)

let self = get_class "PHContentEditingInputRequestOptions"
