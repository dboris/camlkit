...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetresourcevalidatedcontext?language=objc}PHAssetResourceValidatedContext} *)

let self = get_class "PHAssetResourceValidatedContext"
