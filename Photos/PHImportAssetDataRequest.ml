...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phimportassetdatarequest?language=objc}PHImportAssetDataRequest} *)

let self = get_class "PHImportAssetDataRequest"
