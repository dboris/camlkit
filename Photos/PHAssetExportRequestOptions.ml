...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetexportrequestoptions?language=objc}PHAssetExportRequestOptions} *)

let self = get_class "PHAssetExportRequestOptions"
