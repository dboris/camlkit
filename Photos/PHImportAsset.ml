...
let self = get_class "PHImportAsset"
...
let avThumbnailOfSize x ~canceler ~error self = msg_send ~self ~cmd:(selector "avThumbnailOfSize:canceler:error:") ~typ:(ullong @-> id @-> (ptr id) @-> returning (ptr CGImage.t)) (ULLong.of_int x) canceler error
...
let cgImageSize self = msg_send ~self ~cmd:(selector "cgImageSize") ~typ:(returning CGSize.t)
let checkForSidecarWithExtension x self = msg_send ~self ~cmd:(selector "checkForSidecarWithExtension:") ~typ:(id @-> returning id) x
let checkForSidecarWithName x self = msg_send ~self ~cmd:(selector "checkForSidecarWithName:") ~typ:(id @-> returning id) x
...
let configureWithContentType x ~supportedMediaType self = msg_send ~self ~cmd:(selector "configureWithContentType:supportedMediaType:") ~typ:(id @-> uchar @-> returning bool) x supportedMediaType
...
let cropEXIFThumbSize x ~originalSize self = msg_send ~self ~cmd:(selector "cropEXIFThumbSize:originalSize:") ~typ:(CGSize.t @-> CGSize.t @-> returning CGSize.t) x originalSize
...
let duplicateStateConfidence self = msg_send ~self ~cmd:(selector "duplicateStateConfidence") ~typ:(returning uchar)
...
let fileLocation self = msg_send ~self ~cmd:(selector "fileLocation") ~typ:(returning uchar)
...
let imageThumbnailOfSize x ~canceler ~error self = msg_send ~self ~cmd:(selector "imageThumbnailOfSize:canceler:error:") ~typ:(ullong @-> id @-> (ptr id) @-> returning (ptr CGImage.t)) (ULLong.of_int x) canceler error
...
let removeBlackBarsFromExifThumbnail x ~fullSize self = msg_send ~self ~cmd:(selector "removeBlackBarsFromExifThumbnail:fullSize:") ~typ:((ptr CGImage.t) @-> CGSize.t @-> returning (ptr CGImage.t)) x fullSize
...
let setDuplicateStateConfidence x self = msg_send ~self ~cmd:(selector "setDuplicateStateConfidence:") ~typ:(uchar @-> returning void) x
...
let setFileLocation x self = msg_send ~self ~cmd:(selector "setFileLocation:") ~typ:(uchar @-> returning void) x
...
let thumbnailForSize' x ~priority ~atEnd self = msg_send ~self ~cmd:(selector "thumbnailForSize:priority:atEnd:") ~typ:(ullong @-> uchar @-> (ptr void) @-> returning id) (ULLong.of_int x) priority atEnd
let thumbnailRender self = msg_send ~self ~cmd:(selector "thumbnailRender") ~typ:(returning id)
let thumbnailSize self = msg_send ~self ~cmd:(selector "thumbnailSize") ~typ:(returning CGSize.t)
