...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phvideorequestoptions?language=objc}PHVideoRequestOptions} *)

let self = get_class "PHVideoRequestOptions"
