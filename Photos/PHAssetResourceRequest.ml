...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetresourcerequest?language=objc}PHAssetResourceRequest} *)

let self = get_class "PHAssetResourceRequest"
