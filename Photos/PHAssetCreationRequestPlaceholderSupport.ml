...
(** Apple docs: {{:https://developer.apple.com/documentation/photos/phassetcreationrequestplaceholdersupport?language=objc}PHAssetCreationRequestPlaceholderSupport} *)

let self = get_class "PHAssetCreationRequestPlaceholderSupport"
