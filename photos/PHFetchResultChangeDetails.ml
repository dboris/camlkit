...
let _class_ = get_class "PHFetchResultChangeDetails"
...
let initWithFetchResult' x ~currentFetchResult ~sortedChangedIdentifiers ~unknownMergeEvent self = msg_send ~self ~cmd:(selector "initWithFetchResult:currentFetchResult:sortedChangedIdentifiers:unknownMergeEvent:") ~typ:(id @-> id @-> id @-> bool @-> returning (id)) x currentFetchResult sortedChangedIdentifiers unknownMergeEvent
...
let movedFromIndexes self = msg_send ~self ~cmd:(selector "movedFromIndexes") ~typ:(returning (ptr void))
...
let sortedChangedIdentifiers self = msg_send ~self ~cmd:(selector "sortedChangedIdentifiers") ~typ:(returning (id))