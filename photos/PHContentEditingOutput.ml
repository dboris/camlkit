...
let _class_ = get_class "PHContentEditingOutput"

module C = struct
  let defaultExtensionForUniformTypeIdentifierType x self = msg_send ~self ~cmd:(selector "defaultExtensionForUniformTypeIdentifierType:") ~typ:(id @-> returning (id)) x
  let imageRenderURLUsingHEICFormat x ~appropriateForURL self = msg_send ~self ~cmd:(selector "imageRenderURLUsingHEICFormat:appropriateForURL:") ~typ:(bool @-> id @-> returning (id)) x appropriateForURL
...
let defaultRenderedContentType self = msg_send ~self ~cmd:(selector "defaultRenderedContentType") ~typ:(returning (id))
...
let initWithAdjustmentBaseVersion x ~mediaType ~appropriateForURL self = msg_send ~self ~cmd:(selector "initWithAdjustmentBaseVersion:mediaType:appropriateForURL:") ~typ:(llong @-> llong @-> id @-> returning (id)) (LLong.of_int x) (LLong.of_int mediaType) appropriateForURL
...
let renderedContentURLForType x ~error self = msg_send ~self ~cmd:(selector "renderedContentURLForType:error:") ~typ:(id @-> ptr (id) @-> returning (id)) x error
...
let shouldPreferHEICForRenderedImages self = msg_send ~self ~cmd:(selector "shouldPreferHEICForRenderedImages") ~typ:(returning (bool))
let supportedRenderedContentTypes self = msg_send ~self ~cmd:(selector "supportedRenderedContentTypes") ~typ:(returning (id))
