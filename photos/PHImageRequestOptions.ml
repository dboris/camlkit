...
let _class_ = get_class "PHImageRequestOptions"

let allowPlaceholder self = msg_send ~self ~cmd:(selector "allowPlaceholder") ~typ:(returning (bool))
let allowSecondaryDegradedImage self = msg_send ~self ~cmd:(selector "allowSecondaryDegradedImage") ~typ:(returning (bool))
...
let ignoreProcessWideRepairLimits self = msg_send ~self ~cmd:(selector "ignoreProcessWideRepairLimits") ~typ:(returning (bool))
...
let preferHDR self = msg_send ~self ~cmd:(selector "preferHDR") ~typ:(returning (bool))
...
let setAllowSecondaryDegradedImage x self = msg_send ~self ~cmd:(selector "setAllowSecondaryDegradedImage:") ~typ:(bool @-> returning (void)) x
...
let setIgnoreProcessWideRepairLimits x self = msg_send ~self ~cmd:(selector "setIgnoreProcessWideRepairLimits:") ~typ:(bool @-> returning (void)) x
...
let setPreferHDR x self = msg_send ~self ~cmd:(selector "setPreferHDR:") ~typ:(bool @-> returning (void)) x
...
let setVideoFrameTime x self = msg_send ~self ~cmd:(selector "setVideoFrameTime:") ~typ:(ptr void @-> returning (void)) x
