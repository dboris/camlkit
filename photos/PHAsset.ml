...
module C = struct
  ...
  let fetchAssetsContainingAllPersons x ~options self = msg_send ~self ~cmd:(selector "fetchAssetsContainingAllPersons:options:") ~typ:(id @-> id @-> returning (id)) x options
  ...
  let fetchAssetsForPerson' x ~faceCount ~options self = msg_send ~self ~cmd:(selector "fetchAssetsForPerson:faceCount:options:") ~typ:(id @-> ullong @-> id @-> returning (id)) x (ULLong.of_int faceCount) options
  ...
  let fetchAssetsForSearchLookupIdentifier x ~options self = msg_send ~self ~cmd:(selector "fetchAssetsForSearchLookupIdentifier:options:") ~typ:(id @-> id @-> returning (id)) x options
  ...
  let fetchAssetsInLibraryScope x ~fromAssets self = msg_send ~self ~cmd:(selector "fetchAssetsInLibraryScope:fromAssets:") ~typ:(id @-> id @-> returning (id)) x fromAssets
  let fetchAssetsInLibraryScope' x ~options self = msg_send ~self ~cmd:(selector "fetchAssetsInLibraryScope:options:") ~typ:(id @-> id @-> returning (id)) x options
  let fetchAssetsInPreviewStateInLibraryScope x ~options self = msg_send ~self ~cmd:(selector "fetchAssetsInPreviewStateInLibraryScope:options:") ~typ:(id @-> id @-> returning (id)) x options
  let fetchAssetsInPreviewStateWithPhotosOrPhotosDeferredSuggestedByClientTypeWithOptions x self = msg_send ~self ~cmd:(selector "fetchAssetsInPreviewStateWithPhotosOrPhotosDeferredSuggestedByClientTypeWithOptions:") ~typ:(id @-> returning (id)) x
  let fetchAssetsInPreviewStateWithSuggestedByClientType x ~options self = msg_send ~self ~cmd:(selector "fetchAssetsInPreviewStateWithSuggestedByClientType:options:") ~typ:(short @-> id @-> returning (id)) x options
  ...
  let fetchAssetsWithCurrentUserAsLibraryScopeContributor x ~inLibraryScope ~options self = msg_send ~self ~cmd:(selector "fetchAssetsWithCurrentUserAsLibraryScopeContributor:inLibraryScope:options:") ~typ:(bool @-> id @-> id @-> returning (id)) x inLibraryScope options
  ...
  let fetchCustomUserAssetsInMemory x ~options self = msg_send ~self ~cmd:(selector "fetchCustomUserAssetsInMemory:options:") ~typ:(id @-> id @-> returning (id)) x options
  ...
  let fetchKeyAssetForSceneIdentifier x ~aboveConfidenceThreshold ~minimumSceneAnalysisVersion ~options self = msg_send ~self ~cmd:(selector "fetchKeyAssetForSceneIdentifier:aboveConfidenceThreshold:minimumSceneAnalysisVersion:options:") ~typ:(uint @-> double @-> short @-> id @-> returning (id)) x aboveConfidenceThreshold minimumSceneAnalysisVersion options
  ...
  let fetchPreviewAssetsForMomentShareCreationWithAssets x ~options self = msg_send ~self ~cmd:(selector "fetchPreviewAssetsForMomentShareCreationWithAssets:options:") ~typ:(id @-> id @-> returning (id)) x options
  ...
  let fetchSummaryCurationForHighlight x ~fetchOptions ~allowsOnDemand ~error self = msg_send ~self ~cmd:(selector "fetchSummaryCurationForHighlight:fetchOptions:allowsOnDemand:error:") ~typ:(id @-> id @-> bool @-> ptr (id) @-> returning (id)) x fetchOptions allowsOnDemand error
...
let allSceneClassifications self = msg_send ~self ~cmd:(selector "allSceneClassifications") ~typ:(returning (id))
...
let descriptionForPhotoAnanlysisWallpaperProeprtiesWithManagedAsset x self = msg_send ~self ~cmd:(selector "descriptionForPhotoAnanlysisWallpaperProeprtiesWithManagedAsset:") ~typ:(id @-> returning (id)) x
...
let hasEditableDepth self = msg_send ~self ~cmd:(selector "hasEditableDepth") ~typ:(returning (bool))
...
let iconicScoreProperties self = msg_send ~self ~cmd:(selector "iconicScoreProperties") ~typ:(returning (id))
...
let isIncompleteLivePhotoMissingVideoComplement self = msg_send ~self ~cmd:(selector "isIncompleteLivePhotoMissingVideoComplement") ~typ:(returning (bool))
...
let isLocatedAtCoordinates x self = msg_send ~self ~cmd:(selector "isLocatedAtCoordinates:") ~typ:(ptr void @-> returning (bool)) x
...
let isSpatialMedia self = msg_send ~self ~cmd:(selector "isSpatialMedia") ~typ:(returning (bool))
...
let libraryScopeProperties self = msg_send ~self ~cmd:(selector "libraryScopeProperties") ~typ:(returning (id))
...
let locationDataProperties self = msg_send ~self ~cmd:(selector "locationDataProperties") ~typ:(returning (id))
...
let normalizedFaceAreaRect self = msg_send_stret ~self ~cmd:(selector "normalizedFaceAreaRect") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
...
let originalCreationDateWithTimeZone x self = msg_send ~self ~cmd:(selector "originalCreationDateWithTimeZone:") ~typ:(ptr (id) @-> returning (id)) x
let originalFaceAreaRect self = msg_send_stret ~self ~cmd:(selector "originalFaceAreaRect") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
let originalFaceAreaRectValue self = msg_send ~self ~cmd:(selector "originalFaceAreaRectValue") ~typ:(returning (id))
...
let participatesInLibraryScope self = msg_send ~self ~cmd:(selector "participatesInLibraryScope") ~typ:(returning (bool))
...
let photoAnalysisWallpaperProperties self = msg_send ~self ~cmd:(selector "photoAnalysisWallpaperProperties") ~typ:(returning (id))
...
let sceneClassificationsOfTypes x self = msg_send ~self ~cmd:(selector "sceneClassificationsOfTypes:") ~typ:(id @-> returning (id)) x
...
let spatialMediaProperties self = msg_send ~self ~cmd:(selector "spatialMediaProperties") ~typ:(returning (id))
let suggestedCropForTargetSize x self = msg_send_stret ~self ~cmd:(selector "suggestedCropForTargetSize:") ~typ:(CGSize.t @-> returning (CGRect.t)) ~return_type:CGRect.t x
let suggestedCropForTargetSize1 x ~withFocusRegion self = msg_send_stret ~self ~cmd:(selector "suggestedCropForTargetSize:withFocusRegion:") ~typ:(CGSize.t @-> CGRect.t @-> returning (CGRect.t)) ~return_type:CGRect.t x withFocusRegion
let suggestedCropForTargetSize2 x ~withFocusRegion ~andOutputCropScore self = msg_send_stret ~self ~cmd:(selector "suggestedCropForTargetSize:withFocusRegion:andOutputCropScore:") ~typ:(CGSize.t @-> CGRect.t @-> ptr (double) @-> returning (CGRect.t)) ~return_type:CGRect.t x withFocusRegion andOutputCropScore
let suggestedCropForTargetSize3 x ~withOcclusionRegion ~andOutputCropScore self = msg_send_stret ~self ~cmd:(selector "suggestedCropForTargetSize:withOcclusionRegion:andOutputCropScore:") ~typ:(CGSize.t @-> CGRect.t @-> ptr (double) @-> returning (CGRect.t)) ~return_type:CGRect.t x withOcclusionRegion andOutputCropScore
...
let temporalSceneClassifications self = msg_send ~self ~cmd:(selector "temporalSceneClassifications") ~typ:(returning (id))
...
let wallpaperCroppingDebugKeyValuePairs self = msg_send ~self ~cmd:(selector "wallpaperCroppingDebugKeyValuePairs") ~typ:(returning (id))