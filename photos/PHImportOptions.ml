...
let _class_ = get_class "PHImportOptions"
...
let fileOperation self = msg_send ~self ~cmd:(selector "fileOperation") ~typ:(returning (bool))
...
let libraryScope self = msg_send ~self ~cmd:(selector "libraryScope") ~typ:(returning (id))
let metadataAddMode self = msg_send ~self ~cmd:(selector "metadataAddMode") ~typ:(returning (bool))
...
let setFileOperation x self = msg_send ~self ~cmd:(selector "setFileOperation:") ~typ:(bool @-> returning (void)) x
...
let setLibraryScope x self = msg_send ~self ~cmd:(selector "setLibraryScope:") ~typ:(id @-> returning (void)) x
let setMetadataAddMode x self = msg_send ~self ~cmd:(selector "setMetadataAddMode:") ~typ:(bool @-> returning (void)) x
