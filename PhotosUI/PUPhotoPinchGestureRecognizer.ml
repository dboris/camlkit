...
let adjustedInitialCenterInView x self = msg_send_stret ~self ~cmd:(selector "adjustedInitialCenterInView:") ~typ:(id @-> returning CGPoint.t) ~return_type:CGPoint.t x
...
let adjustedTranslationInView x self = msg_send_stret ~self ~cmd:(selector "adjustedTranslationInView:") ~typ:(id @-> returning CGPoint.t) ~return_type:CGPoint.t x
let adjustedTranslationVelocityInView x self = msg_send_stret ~self ~cmd:(selector "adjustedTranslationVelocityInView:") ~typ:(id @-> returning CGPoint.t) ~return_type:CGPoint.t x
let initWithTarget x ~action self = msg_send ~self ~cmd:(selector "initWithTarget:action:") ~typ:(id @-> _SEL @-> returning id) x action
let initialPinchRect self = msg_send_stret ~self ~cmd:(selector "initialPinchRect") ~typ:(returning CGRect.t) ~return_type:CGRect.t
