...
let normalizedTranslation self = msg_send_stret ~self ~cmd:(selector "normalizedTranslation") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let overscroll self = msg_send_stret ~self ~cmd:(selector "overscroll") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
