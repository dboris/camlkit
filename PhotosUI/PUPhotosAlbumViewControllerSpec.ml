...
let fullMomentsLevelSectionHeaderHighlightInset self = msg_send_stret ~self ~cmd:(selector "fullMomentsLevelSectionHeaderHighlightInset") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
