...
let self = get_class "PUVideoPlayerView"
...
let placeholderImageContentsRect self = msg_send_stret ~self ~cmd:(selector "placeholderImageContentsRect") ~typ:(returning CGRect.t) ~return_type:CGRect.t
