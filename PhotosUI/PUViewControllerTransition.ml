...
let finalFromViewFrame self = msg_send ~self ~cmd:(selector "finalFromViewFrame") ~typ:(returning CGRect.t)
let finalToViewFrame self = msg_send ~self ~cmd:(selector "finalToViewFrame") ~typ:(returning CGRect.t)
...
let initialFromViewFrame self = msg_send ~self ~cmd:(selector "initialFromViewFrame") ~typ:(returning CGRect.t)
let initialToViewFrame self = msg_send ~self ~cmd:(selector "initialToViewFrame") ~typ:(returning CGRect.t)
