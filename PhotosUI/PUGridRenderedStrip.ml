...
let self = get_class "PUGridRenderedStrip"
...
let visualItemRange self = msg_send_stret ~self ~cmd:(selector "visualItemRange") ~typ:(returning NSRange.t) ~return_type:NSRange.t
