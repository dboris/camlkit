...
let rectForStackItemAtIndex x ~inCoordinateSpace self = msg_send ~self ~cmd:(selector "rectForStackItemAtIndex:inCoordinateSpace:") ~typ:(llong @-> id @-> returning CGRect.t) (LLong.of_int x) inCoordinateSpace
