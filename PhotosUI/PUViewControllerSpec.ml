...
let layoutReferenceSize self = msg_send ~self ~cmd:(selector "layoutReferenceSize") ~typ:(returning CGSize.t)
...
let secondScreenSize self = msg_send ~self ~cmd:(selector "secondScreenSize") ~typ:(returning CGSize.t)
