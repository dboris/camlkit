...
let stackPerspectiveFactor self = msg_send ~self ~cmd:(selector "stackPerspectiveFactor") ~typ:(returning CGPoint.t)
...
let topLeftCornerOfFrontStackItem self = msg_send ~self ~cmd:(selector "topLeftCornerOfFrontStackItem") ~typ:(returning CGPoint.t)
