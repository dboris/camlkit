...
let overridingContentOffset self = msg_send_stret ~self ~cmd:(selector "overridingContentOffset") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let preferredContentOffset self = msg_send_stret ~self ~cmd:(selector "preferredContentOffset") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
