...
let trackedBounds self = msg_send_stret ~self ~cmd:(selector "trackedBounds") ~typ:(returning CGRect.t) ~return_type:CGRect.t
let trackedCenter self = msg_send_stret ~self ~cmd:(selector "trackedCenter") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
let trackedTransform self = msg_send_stret ~self ~cmd:(selector "trackedTransform") ~typ:(returning CGAffineTransform.t) ~return_type:CGAffineTransform.t