...
let anchorShiftOffset self = msg_send ~self ~cmd:(selector "anchorShiftOffset") ~typ:(returning PUGridCoordinates.t)
...
let setAnchorShiftOffset x self = msg_send ~self ~cmd:(selector "setAnchorShiftOffset:") ~typ:(PUGridCoordinates.t @-> returning void) x
