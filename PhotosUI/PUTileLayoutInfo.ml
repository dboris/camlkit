...
let cropInsets self = msg_send_stret ~self ~cmd:(selector "cropInsets") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
...
let hitTestOutset self = msg_send_stret ~self ~cmd:(selector "hitTestOutset") ~typ:(returning UIEdgeInsets.t) ~return_type:UIEdgeInsets.t
...
let parallaxOffset self = msg_send_stret ~self ~cmd:(selector "parallaxOffset") ~typ:(returning CGPoint.t) ~return_type:CGPoint.t
