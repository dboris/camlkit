...
let extendPowerOffBy x self = msg_send ~self ~cmd:(selector "extendPowerOffBy:") ~typ:(llong @-> returning (llong)) x
...
let launchApplicationAtURL x ~options ~configuration ~error self = msg_send ~self ~cmd:(selector "launchApplicationAtURL:options:configuration:error:") ~typ:(id @-> ullong @-> id @-> ptr (id) @-> returning (id)) x options configuration error
...
let openURL2 x ~options ~configuration ~error self = msg_send ~self ~cmd:(selector "openURL:options:configuration:error:") ~typ:(id @-> ullong @-> id @-> ptr (id) @-> returning (id)) x options configuration error
...
let openURLs1 x ~withAppBundleIdentifier ~options ~additionalEventParamDescriptor ~launchIdentifiers self = msg_send ~self ~cmd:(selector "openURLs:withAppBundleIdentifier:options:additionalEventParamDescriptor:launchIdentifiers:") ~typ:(id @-> id @-> ullong @-> id @-> ptr (id) @-> returning (bool)) x withAppBundleIdentifier options additionalEventParamDescriptor launchIdentifiers
let openURLs2 x ~withApplicationAtURL ~options ~configuration ~error self = msg_send ~self ~cmd:(selector "openURLs:withApplicationAtURL:options:configuration:error:") ~typ:(id @-> id @-> ullong @-> id @-> ptr (id) @-> returning (id)) x withApplicationAtURL options configuration error
...
let requestAuthorizationOfType x ~completionHandler self = msg_send ~self ~cmd:(selector "requestAuthorizationOfType:completionHandler:") ~typ:(llong @-> ptr void @-> returning (void)) x completionHandler
...
let setIcon x ~forFile ~options self = msg_send ~self ~cmd:(selector "setIcon:forFile:options:") ~typ:(id @-> id @-> ullong @-> returning (bool)) x forFile options
