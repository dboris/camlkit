...
let frameForItemAtIndex x self = msg_send_stret ~self ~cmd:(selector "frameForItemAtIndex:") ~typ:(ullong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let frameForItemAtIndex' x ~withNumberOfItems self = msg_send_stret ~self ~cmd:(selector "frameForItemAtIndex:withNumberOfItems:") ~typ:(ullong @-> ullong @-> returning (CGRect.t)) ~return_type:CGRect.t x withNumberOfItems
