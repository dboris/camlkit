...
let tokenFieldCell9 x ~characterAtIndex ~shouldTerminateString self = msg_send ~self ~cmd:(selector "tokenFieldCell:characterAtIndex:shouldTerminateString:") ~typ:(id @-> ullong @-> id @-> returning (bool)) x characterAtIndex shouldTerminateString
...
let tokenFieldCell11 x ~shouldAddObjects ~atIndex self = msg_send ~self ~cmd:(selector "tokenFieldCell:shouldAddObjects:atIndex:") ~typ:(id @-> id @-> ullong @-> returning (id)) x shouldAddObjects atIndex
...
let tokenFieldCell14 x ~completionsForSubstring ~indexOfToken ~indexOfSelectedItem self = msg_send ~self ~cmd:(selector "tokenFieldCell:completionsForSubstring:indexOfToken:indexOfSelectedItem:") ~typ:(id @-> id @-> llong @-> ptr (llong) @-> returning (id)) x completionsForSubstring indexOfToken indexOfSelectedItem
