...
let cancelButtonRectForBounds x self = msg_send ~self ~cmd:(selector "cancelButtonRectForBounds:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
...
let searchButtonRectForBounds x self = msg_send ~self ~cmd:(selector "searchButtonRectForBounds:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
let searchButtonRectForBounds' x ~focused self = msg_send ~self ~cmd:(selector "searchButtonRectForBounds:focused:") ~typ:(CGRect.t @-> bool @-> returning (CGRect.t)) x focused
...
let searchTextRectForBounds' x ~focused self = msg_send ~self ~cmd:(selector "searchTextRectForBounds:focused:") ~typ:(CGRect.t @-> bool @-> returning (CGRect.t)) x focused
