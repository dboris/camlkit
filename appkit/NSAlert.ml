...
let buildAlertStyle x ~title ~formattedMessage ~first ~second ~third ~oldStyle self = msg_send ~self ~cmd:(selector "buildAlertStyle:title:formattedMessage:first:second:third:oldStyle:") ~typ:(ullong @-> id @-> id @-> id @-> id @-> id @-> bool @-> returning (id)) x title formattedMessage first second third oldStyle
let buildAlertStyle' x ~title ~message ~first ~second ~third ~oldStyle ~args self = msg_send ~self ~cmd:(selector "buildAlertStyle:title:message:first:second:third:oldStyle:args:") ~typ:(ullong @-> id @-> id @-> id @-> id @-> id @-> bool @-> ptr void @-> returning (id)) x title message first second third oldStyle args
...
let didEndAlert x ~returnCode ~contextInfo self = msg_send ~self ~cmd:(selector "didEndAlert:returnCode:contextInfo:") ~typ:(id @-> llong @-> ptr (void) @-> returning (void)) x returnCode contextInfo
...
let placeButtons x ~firstWidth ~secondWidth ~thirdWidth self = msg_send ~self ~cmd:(selector "placeButtons:firstWidth:secondWidth:thirdWidth:") ~typ:(llong @-> double @-> double @-> double @-> returning (void)) x firstWidth secondWidth thirdWidth
...
let setAlertStyle x self = msg_send ~self ~cmd:(selector "setAlertStyle:") ~typ:(ullong @-> returning (void)) x
