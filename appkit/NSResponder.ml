...
let _class_ = get_class "NSResponder"
...
let wantsForwardedScrollEventsForAxis x self = msg_send ~self ~cmd:(selector "wantsForwardedScrollEventsForAxis:") ~typ:(llong @-> returning (bool)) x
