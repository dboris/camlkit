...
let _class_ = get_class "NSImageTextFieldCell"
...
let outlineCellFrame self = msg_send_stret ~self ~cmd:(selector "outlineCellFrame") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
