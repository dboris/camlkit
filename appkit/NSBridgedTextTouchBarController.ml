...
let _class_ = get_class "NSBridgedTextTouchBarController"
...
let candidateListTouchBarItem' x ~endSelectingCandidateAtIndex self = msg_send ~self ~cmd:(selector "candidateListTouchBarItem:endSelectingCandidateAtIndex:") ~typ:(id @-> llong @-> returning (void)) x endSelectingCandidateAtIndex
...
let setCandidateSequenceNumber x self = msg_send ~self ~cmd:(selector "setCandidateSequenceNumber:") ~typ:(ullong @-> returning (void)) x
...
let updateTextCheckingTypes x ~forInputTraits self = msg_send ~self ~cmd:(selector "updateTextCheckingTypes:forInputTraits:") ~typ:(ullong @-> id @-> returning (ullong)) x forInputTraits