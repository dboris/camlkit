...
let cursorRectForDividerAtIndex x self = msg_send_stret ~self ~cmd:(selector "cursorRectForDividerAtIndex:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
...
let holdingPriorityForSubviewAtIndex x self = msg_send ~self ~cmd:(selector "holdingPriorityForSubviewAtIndex:") ~typ:(llong @-> returning (float)) x
...
let maxPossiblePositionOfDividerAtIndex x self = msg_send ~self ~cmd:(selector "maxPossiblePositionOfDividerAtIndex:") ~typ:(llong @-> returning (double)) x
let minPossiblePositionOfDividerAtIndex x self = msg_send ~self ~cmd:(selector "minPossiblePositionOfDividerAtIndex:") ~typ:(llong @-> returning (double)) x
...
let positionOfDividerAtIndex x self = msg_send ~self ~cmd:(selector "positionOfDividerAtIndex:") ~typ:(llong @-> returning (double)) x
...
let setHoldingPriority x ~forSubviewAtIndex self = msg_send ~self ~cmd:(selector "setHoldingPriority:forSubviewAtIndex:") ~typ:(float @-> llong @-> returning (void)) x forSubviewAtIndex
...
let setPosition x ~ofDividerAtIndex self = msg_send ~self ~cmd:(selector "setPosition:ofDividerAtIndex:") ~typ:(double @-> llong @-> returning (void)) x ofDividerAtIndex
let setSpringLoaded x self = msg_send ~self ~cmd:(selector "setSpringLoaded:") ~typ:(bool @-> returning (void)) x
let setStayPutPriority x ~forSubviewAtIndex self = msg_send ~self ~cmd:(selector "setStayPutPriority:forSubviewAtIndex:") ~typ:(float @-> llong @-> returning (void)) x forSubviewAtIndex
...
let stayPutPriorityForSubviewAtIndex x self = msg_send ~self ~cmd:(selector "stayPutPriorityForSubviewAtIndex:") ~typ:(llong @-> returning (float)) x
