...
let copyColorAtIndex x ~toIndex ~saveList self = msg_send ~self ~cmd:(selector "copyColorAtIndex:toIndex:saveList:") ~typ:(llong @-> llong @-> bool @-> returning (void)) x toIndex saveList
...
let insertNewColor x ~atIndex ~andShowInWell self = msg_send ~self ~cmd:(selector "insertNewColor:atIndex:andShowInWell:") ~typ:(id @-> llong @-> bool @-> returning (void)) x atIndex andShowInWell
...
let insertPopItemWithTitle' x ~andObject ~atIndex self = msg_send ~self ~cmd:(selector "insertPopItemWithTitle:andObject:atIndex:") ~typ:(id @-> id @-> llong @-> returning (void)) x andObject atIndex
...
let moveColorAtIndex x ~toIndex ~saveList self = msg_send ~self ~cmd:(selector "moveColorAtIndex:toIndex:saveList:") ~typ:(llong @-> llong @-> bool @-> returning (void)) x toIndex saveList
