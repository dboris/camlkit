...
let _class_ = get_class "NSPDFPanelAccessoryViewController"
...
let initWithOptions x ~customAccessoryViewController self = msg_send ~self ~cmd:(selector "initWithOptions:customAccessoryViewController:") ~typ:(llong @-> id @-> returning (id)) x customAccessoryViewController
