...
let drawFromCenter x ~radius ~toCenter ~radius_ ~options self = msg_send ~self ~cmd:(selector "drawFromCenter:radius:toCenter:radius:options:") ~typ:(CGPoint.t @-> double @-> CGPoint.t @-> double @-> ullong @-> returning (void)) x radius toCenter radius_ options
let drawFromPoint x ~toPoint ~options self = msg_send ~self ~cmd:(selector "drawFromPoint:toPoint:options:") ~typ:(CGPoint.t @-> CGPoint.t @-> ullong @-> returning (void)) x toPoint options
...
let getColor x ~location ~atIndex self = msg_send ~self ~cmd:(selector "getColor:location:atIndex:") ~typ:(ptr (id) @-> ptr (double) @-> llong @-> returning (void)) x location atIndex
