...
let coreUIDrawOptions self = msg_send ~self ~cmd:(selector "coreUIDrawOptions") ~typ:(returning (ptr void))
...
let initWithCoreUIDrawOptions x ~size self = msg_send ~self ~cmd:(selector "initWithCoreUIDrawOptions:size:") ~typ:(ptr void @-> CGSize.t @-> returning (id)) x size
