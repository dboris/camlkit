...
module Class = struct
  ...
  let setPickerMask x self = msg_send ~self ~cmd:(selector "setPickerMask:") ~typ:(ullong @-> returning (void)) x
  let setPickerMode x self = msg_send ~self ~cmd:(selector "setPickerMode:") ~typ:(llong @-> returning (void)) x
...
let setColorMask x self = msg_send ~self ~cmd:(selector "setColorMask:") ~typ:(llong @-> returning (id)) x
