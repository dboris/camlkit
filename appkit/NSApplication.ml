...
let beginModalSessionForWindow x self = msg_send ~self ~cmd:(selector "beginModalSessionForWindow:") ~typ:(id @-> returning (ptr void)) x
let beginModalSessionForWindow' x ~relativeToWindow self = msg_send ~self ~cmd:(selector "beginModalSessionForWindow:relativeToWindow:") ~typ:(id @-> id @-> returning (ptr void)) x relativeToWindow
...
let endModalSession x self = msg_send ~self ~cmd:(selector "endModalSession:") ~typ:(ptr void @-> returning (void)) x
...
let runModalSession x self = msg_send ~self ~cmd:(selector "runModalSession:") ~typ:(ptr void @-> returning (llong)) x
...
let setValue1 x ~forSafeApertureCompatibilityConnectionProperty self = msg_send ~self ~cmd:(selector "setValue:forSafeApertureCompatibilityConnectionProperty:") ~typ:(ptr (void) @-> ptr void @-> returning (void)) x forSafeApertureCompatibilityConnectionProperty
