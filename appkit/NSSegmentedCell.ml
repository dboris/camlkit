...
let rectForSegment x ~inFrame self = msg_send_stret ~self ~cmd:(selector "rectForSegment:inFrame:") ~typ:(llong @-> CGRect.t @-> returning (CGRect.t)) ~return_type:CGRect.t x inFrame
