...
let cellFrameAtRow x ~column self = msg_send_stret ~self ~cmd:(selector "cellFrameAtRow:column:") ~typ:(llong @-> llong @-> returning (CGRect.t)) ~return_type:CGRect.t x column
