...
module Class = struct
  let gridViewWithNumberOfColumns x ~rows self = msg_send ~self ~cmd:(selector "gridViewWithNumberOfColumns:rows:") ~typ:(llong @-> llong @-> returning (id)) x rows
...
let cellAtColumnIndex x ~rowIndex self = msg_send ~self ~cmd:(selector "cellAtColumnIndex:rowIndex:") ~typ:(llong @-> llong @-> returning (id)) x rowIndex
let cellForView x self = msg_send ~self ~cmd:(selector "cellForView:") ~typ:(id @-> returning (id)) x
let columnAtIndex x self = msg_send ~self ~cmd:(selector "columnAtIndex:") ~typ:(llong @-> returning (id)) x
...
let insertColumnAtIndex x ~withViews self = msg_send ~self ~cmd:(selector "insertColumnAtIndex:withViews:") ~typ:(llong @-> id @-> returning (id)) x withViews
let insertRowAtIndex x ~withViews self = msg_send ~self ~cmd:(selector "insertRowAtIndex:withViews:") ~typ:(llong @-> id @-> returning (id)) x withViews
...
let moveColumnAtIndex x ~toIndex self = msg_send ~self ~cmd:(selector "moveColumnAtIndex:toIndex:") ~typ:(llong @-> llong @-> returning (void)) x toIndex
...
let rowAtIndex x self = msg_send ~self ~cmd:(selector "rowAtIndex:") ~typ:(llong @-> returning (id)) x
