...
include NSDocumentDragButton

let _class_ = get_class "NSThemeDocumentButton"
...
let menuLocationForLayoutDirection x self = msg_send ~self ~cmd:(selector "menuLocationForLayoutDirection:") ~typ:(bool @-> returning (CGPoint.t)) x
