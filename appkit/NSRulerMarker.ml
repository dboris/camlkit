...
let imageOrigin self = msg_send ~self ~cmd:(selector "imageOrigin") ~typ:(returning (CGPoint.t))
let imageRectInRuler self = msg_send ~self ~cmd:(selector "imageRectInRuler") ~typ:(returning (CGRect.t))
