...
let view1 x ~customToolTip ~frameForToolTipWithDisplayInfo self = msg_send_stret ~self ~cmd:(selector "view:customToolTip:frameForToolTipWithDisplayInfo:") ~typ:(id @-> llong @-> id @-> returning (CGRect.t)) ~return_type:CGRect.t x customToolTip frameForToolTipWithDisplayInfo
