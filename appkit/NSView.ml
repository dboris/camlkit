...
let accessibilityFocusRingMaskBounds self = msg_send ~self ~cmd:(selector "accessibilityFocusRingMaskBounds") ~typ:(returning (CGRect.t))
...
let activeDrawingRect self = msg_send ~self ~cmd:(selector "activeDrawingRect") ~typ:(returning (CGRect.t))
...
let adjustScroll x self = msg_send ~self ~cmd:(selector "adjustScroll:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
...
let beginPage x ~label ~bBox ~fonts self = msg_send ~self ~cmd:(selector "beginPage:label:bBox:fonts:") ~typ:(llong @-> id @-> CGRect.t @-> id @-> returning (void)) x label bBox fonts
...
let beginPrologueBBox x ~creationDate ~createdBy ~fonts ~forWhom ~pages ~title self = msg_send ~self ~cmd:(selector "beginPrologueBBox:creationDate:createdBy:fonts:forWhom:pages:title:") ~typ:(CGRect.t @-> id @-> id @-> id @-> id @-> llong @-> id @-> returning (void)) x creationDate createdBy fonts forWhom pages title
...
let boundsOrigin self = msg_send ~self ~cmd:(selector "boundsOrigin") ~typ:(returning (CGPoint.t))
...
let centerScanRect x self = msg_send ~self ~cmd:(selector "centerScanRect:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
...
let computedSafeAreaRect self = msg_send ~self ~cmd:(selector "computedSafeAreaRect") ~typ:(returning (CGRect.t))
...
let constraintsAffectingLayoutForOrientation' x ~ofItem self = msg_send ~self ~cmd:(selector "constraintsAffectingLayoutForOrientation:ofItem:") ~typ:(llong @-> id @-> returning (id)) x ofItem
let constraintsDidChangeInEngine x self = msg_send ~self ~cmd:(selector "constraintsDidChangeInEngine:") ~typ:(id @-> returning (void)) x
let contentCompressionResistancePriorityForOrientation x self = msg_send ~self ~cmd:(selector "contentCompressionResistancePriorityForOrientation:") ~typ:(llong @-> returning (float)) x
let contentFilters self = msg_send ~self ~cmd:(selector "contentFilters") ~typ:(returning (id))
let contentHuggingPriorityForOrientation x self = msg_send ~self ~cmd:(selector "contentHuggingPriorityForOrientation:") ~typ:(llong @-> returning (float)) x
...
let convertPointFromBase x self = msg_send ~self ~cmd:(selector "convertPointFromBase:") ~typ:(CGPoint.t @-> returning (CGPoint.t)) x
let convertPointFromLayer x self = msg_send ~self ~cmd:(selector "convertPointFromLayer:") ~typ:(CGPoint.t @-> returning (CGPoint.t)) x
let convertPointToBacking x self = msg_send ~self ~cmd:(selector "convertPointToBacking:") ~typ:(CGPoint.t @-> returning (CGPoint.t)) x
let convertPointToBase x self = msg_send ~self ~cmd:(selector "convertPointToBase:") ~typ:(CGPoint.t @-> returning (CGPoint.t)) x
let convertPointToLayer x self = msg_send ~self ~cmd:(selector "convertPointToLayer:") ~typ:(CGPoint.t @-> returning (CGPoint.t)) x
...
let convertRectFromBase x self = msg_send ~self ~cmd:(selector "convertRectFromBase:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
let convertRectFromLayer x self = msg_send ~self ~cmd:(selector "convertRectFromLayer:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
let convertRectToBacking x self = msg_send ~self ~cmd:(selector "convertRectToBacking:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
let convertRectToBase x self = msg_send ~self ~cmd:(selector "convertRectToBase:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
...
let convertSizeFromBacking x self = msg_send ~self ~cmd:(selector "convertSizeFromBacking:") ~typ:(CGSize.t @-> returning (CGSize.t)) x
let convertSizeFromBase x self = msg_send ~self ~cmd:(selector "convertSizeFromBase:") ~typ:(CGSize.t @-> returning (CGSize.t)) x
let convertSizeFromLayer x self = msg_send ~self ~cmd:(selector "convertSizeFromLayer:") ~typ:(CGSize.t @-> returning (CGSize.t)) x
let convertSizeToBacking x self = msg_send ~self ~cmd:(selector "convertSizeToBacking:") ~typ:(CGSize.t @-> returning (CGSize.t)) x
let convertSizeToBase x self = msg_send ~self ~cmd:(selector "convertSizeToBase:") ~typ:(CGSize.t @-> returning (CGSize.t)) x
let convertSizeToLayer x self = msg_send ~self ~cmd:(selector "convertSizeToLayer:") ~typ:(CGSize.t @-> returning (CGSize.t)) x
...
let fittingSize self = msg_send ~self ~cmd:(selector "fittingSize") ~typ:(returning (CGSize.t))
...
let frameSize self = msg_send ~self ~cmd:(selector "frameSize") ~typ:(returning (CGSize.t))
...
let preparedContentRect self = msg_send ~self ~cmd:(selector "preparedContentRect") ~typ:(returning (CGRect.t))
...
let rectPreservedDuringLiveResize self = msg_send ~self ~cmd:(selector "rectPreservedDuringLiveResize") ~typ:(returning (CGRect.t))
...
let removeToolTip x self = msg_send ~self ~cmd:(selector "removeToolTip:") ~typ:(llong @-> returning (void)) x
...
let replaceSubview' x ~with_ ~options ~completionHandler self = msg_send ~self ~cmd:(selector "replaceSubview:with:options:completionHandler:") ~typ:(id @-> id @-> ullong @-> ptr void @-> returning (void)) x with_ options completionHandler
...
let setContentHuggingPriority x ~forOrientation self = msg_send ~self ~cmd:(selector "setContentHuggingPriority:forOrientation:") ~typ:(float @-> llong @-> returning (void)) x forOrientation
...
let setLayerContentsPlacement x self = msg_send ~self ~cmd:(selector "setLayerContentsPlacement:") ~typ:(llong @-> returning (void)) x
let setLayerContentsRedrawPolicy x self = msg_send ~self ~cmd:(selector "setLayerContentsRedrawPolicy:") ~typ:(llong @-> returning (void)) x
...
let view x ~customToolTip ~fadeOutAllowedForToolTipWithDisplayInfo self = msg_send ~self ~cmd:(selector "view:customToolTip:fadeOutAllowedForToolTipWithDisplayInfo:") ~typ:(id @-> llong @-> id @-> returning (bool)) x customToolTip fadeOutAllowedForToolTipWithDisplayInfo
let view1 x ~customToolTip ~frameForToolTipWithDisplayInfo self = msg_send ~self ~cmd:(selector "view:customToolTip:frameForToolTipWithDisplayInfo:") ~typ:(id @-> llong @-> id @-> returning (CGRect.t)) x customToolTip frameForToolTipWithDisplayInfo
let view2 x ~customToolTip ~drawInView ~displayInfo self = msg_send ~self ~cmd:(selector "view:customToolTip:drawInView:displayInfo:") ~typ:(id @-> llong @-> id @-> id @-> returning (void)) x customToolTip drawInView displayInfo
