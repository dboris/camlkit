...
let checkGrammarOfString x ~startingAt ~language ~wrap ~inSpellDocumentWithTag ~details self = msg_send ~self ~cmd:(selector "checkGrammarOfString:startingAt:language:wrap:inSpellDocumentWithTag:details:") ~typ:(id @-> llong @-> id @-> bool @-> llong @-> ptr (id) @-> returning (NSRange.t)) x startingAt language wrap inSpellDocumentWithTag details
let checkGrammarOfString' x ~startingAt ~language ~wrap ~inSpellDocumentWithTag ~details ~reconnectOnError self = msg_send ~self ~cmd:(selector "checkGrammarOfString:startingAt:language:wrap:inSpellDocumentWithTag:details:reconnectOnError:") ~typ:(id @-> llong @-> id @-> bool @-> llong @-> ptr (id) @-> bool @-> returning (NSRange.t)) x startingAt language wrap inSpellDocumentWithTag details reconnectOnError
let checkSpellingOfString x ~startingAt self = msg_send ~self ~cmd:(selector "checkSpellingOfString:startingAt:") ~typ:(id @-> llong @-> returning (NSRange.t)) x startingAt
let checkSpellingOfString1 x ~startingAt ~language ~wrap ~inSpellDocumentWithTag ~wordCount self = msg_send ~self ~cmd:(selector "checkSpellingOfString:startingAt:language:wrap:inSpellDocumentWithTag:wordCount:") ~typ:(id @-> llong @-> id @-> bool @-> llong @-> ptr (llong) @-> returning (NSRange.t)) x startingAt language wrap inSpellDocumentWithTag wordCount
let checkSpellingOfString2 x ~startingAt ~language ~wrap ~inSpellDocumentWithTag ~wordCount ~reconnectOnError self = msg_send ~self ~cmd:(selector "checkSpellingOfString:startingAt:language:wrap:inSpellDocumentWithTag:wordCount:reconnectOnError:") ~typ:(id @-> llong @-> id @-> bool @-> llong @-> ptr (llong) @-> bool @-> returning (NSRange.t)) x startingAt language wrap inSpellDocumentWithTag wordCount reconnectOnError
