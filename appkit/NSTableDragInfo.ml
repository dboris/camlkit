...
let _class_ = get_class "NSTableDragInfo"
...
let lastOffscreenDropIndicatorFrame self = msg_send_stret ~self ~cmd:(selector "lastOffscreenDropIndicatorFrame") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
let setDragOperation x self = msg_send ~self ~cmd:(selector "setDragOperation:") ~typ:(ullong @-> returning (void)) x
let setDraggedRowIndexes x self = msg_send ~self ~cmd:(selector "setDraggedRowIndexes:") ~typ:(id @-> returning (void)) x
let setDropCandidateChildIndex x self = msg_send ~self ~cmd:(selector "setDropCandidateChildIndex:") ~typ:(llong @-> returning (void)) x
let setDropCandidateItem x self = msg_send ~self ~cmd:(selector "setDropCandidateItem:") ~typ:(id @-> returning (void)) x
let setDropCandidateParentRow x self = msg_send ~self ~cmd:(selector "setDropCandidateParentRow:") ~typ:(llong @-> returning (void)) x
let setDropCandidateRow x self = msg_send ~self ~cmd:(selector "setDropCandidateRow:") ~typ:(llong @-> returning (void)) x
let setLastDropHoverRow x self = msg_send ~self ~cmd:(selector "setLastDropHoverRow:") ~typ:(llong @-> returning (void)) x
let setLastDropHoverSourceMask x self = msg_send ~self ~cmd:(selector "setLastDropHoverSourceMask:") ~typ:(ullong @-> returning (void)) x
...
let setTableViewDropOperation x self = msg_send ~self ~cmd:(selector "setTableViewDropOperation:") ~typ:(ullong @-> returning (void)) x
