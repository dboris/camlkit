...
let setFullScreenSidebarToolbarMaterial x self = msg_send ~self ~cmd:(selector "setFullScreenSidebarToolbarMaterial:") ~typ:(llong @-> returning (void)) x
let setLastAppliedCollectionBehavior x self = msg_send ~self ~cmd:(selector "setLastAppliedCollectionBehavior:") ~typ:(ullong @-> returning (void)) x
