...
let part x ~boundsWithFrame self = msg_send_stret ~self ~cmd:(selector "part:boundsWithFrame:") ~typ:(llong @-> CGRect.t @-> returning (CGRect.t)) ~return_type:CGRect.t x boundsWithFrame
...
let setDiskLabelValues x self = msg_send ~self ~cmd:(selector "setDiskLabelValues:") ~typ:(llong @-> returning (void)) x
let setFocusedPart x self = msg_send ~self ~cmd:(selector "setFocusedPart:") ~typ:(llong @-> returning (void)) x
let setHoveredPart x self = msg_send ~self ~cmd:(selector "setHoveredPart:") ~typ:(llong @-> returning (void)) x
