...
let _class_ = get_class "NSScrubber"
...
let insertItemAtIndex x self = msg_send ~self ~cmd:(selector "insertItemAtIndex:") ~typ:(llong @-> returning (void)) x
...
let itemViewForItemAtIndex x self = msg_send ~self ~cmd:(selector "itemViewForItemAtIndex:") ~typ:(llong @-> returning (id)) x
...
let reloadItemAtIndex x self = msg_send ~self ~cmd:(selector "reloadItemAtIndex:") ~typ:(llong @-> returning (void)) x
...
let scrollItemAtIndex' x ~toAlignment ~animated self = msg_send ~self ~cmd:(selector "scrollItemAtIndex:toAlignment:animated:") ~typ:(llong @-> llong @-> bool @-> returning (void)) x toAlignment animated
...
let setSelectedIndex' x ~animated self = msg_send ~self ~cmd:(selector "setSelectedIndex:animated:") ~typ:(llong @-> bool @-> returning (void)) x animated
let setSelectionBackgroundStyle x self = msg_send ~self ~cmd:(selector "setSelectionBackgroundStyle:") ~typ:(id @-> returning (void)) x
let setSelectionIndex x self = msg_send ~self ~cmd:(selector "setSelectionIndex:") ~typ:(llong @-> returning (void)) x
