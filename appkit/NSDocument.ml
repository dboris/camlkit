...
module Class = struct
  ...
  let titleForEditingState x ~autosavingError self = msg_send ~self ~cmd:(selector "titleForEditingState:autosavingError:") ~typ:(llong @-> id @-> returning (id)) x autosavingError
...
let canAsynchronouslyWriteToURL x ~ofType ~forSaveOperation self = msg_send ~self ~cmd:(selector "canAsynchronouslyWriteToURL:ofType:forSaveOperation:") ~typ:(id @-> id @-> ullong @-> returning (bool)) x ofType forSaveOperation
...
let changeCountTokenForSaveOperation x self = msg_send ~self ~cmd:(selector "changeCountTokenForSaveOperation:") ~typ:(ullong @-> returning (id)) x
...
let fileAttributesToWriteToFile x ~ofType ~saveOperation self = msg_send ~self ~cmd:(selector "fileAttributesToWriteToFile:ofType:saveOperation:") ~typ:(id @-> id @-> ullong @-> returning (id)) x ofType saveOperation
let fileAttributesToWriteToURL x ~ofType ~forSaveOperation ~originalContentsURL ~error self = msg_send ~self ~cmd:(selector "fileAttributesToWriteToURL:ofType:forSaveOperation:originalContentsURL:error:") ~typ:(id @-> id @-> ullong @-> id @-> ptr (id) @-> returning (id)) x ofType forSaveOperation originalContentsURL error
...
let fileNameExtensionForType x ~saveOperation self = msg_send ~self ~cmd:(selector "fileNameExtensionForType:saveOperation:") ~typ:(id @-> ullong @-> returning (id)) x saveOperation
...
let fileNameFromRunningSavePanelForSaveOperation x self = msg_send ~self ~cmd:(selector "fileNameFromRunningSavePanelForSaveOperation:") ~typ:(ullong @-> returning (id)) x
...
let runModalSavePanelForSaveOperation x ~delegate ~didSaveSelector ~contextInfo self = msg_send ~self ~cmd:(selector "runModalSavePanelForSaveOperation:delegate:didSaveSelector:contextInfo:") ~typ:(ullong @-> id @-> _SEL @-> ptr (void) @-> returning (void)) x delegate didSaveSelector contextInfo
...
let saveToFile x ~saveOperation ~delegate ~didSaveSelector ~contextInfo self = msg_send ~self ~cmd:(selector "saveToFile:saveOperation:delegate:didSaveSelector:contextInfo:") ~typ:(id @-> ullong @-> id @-> _SEL @-> ptr (void) @-> returning (void)) x saveOperation delegate didSaveSelector contextInfo
let saveToURL x ~ofType ~forSaveOperation ~completionHandler self = msg_send ~self ~cmd:(selector "saveToURL:ofType:forSaveOperation:completionHandler:") ~typ:(id @-> id @-> ullong @-> ptr void @-> returning (void)) x ofType forSaveOperation completionHandler
let saveToURL1 x ~ofType ~forSaveOperation ~error self = msg_send ~self ~cmd:(selector "saveToURL:ofType:forSaveOperation:error:") ~typ:(id @-> id @-> ullong @-> ptr (id) @-> returning (bool)) x ofType forSaveOperation error
let saveToURL2 x ~ofType ~forSaveOperation ~delegate ~didSaveSelector ~contextInfo self = msg_send ~self ~cmd:(selector "saveToURL:ofType:forSaveOperation:delegate:didSaveSelector:contextInfo:") ~typ:(id @-> id @-> ullong @-> id @-> _SEL @-> ptr (void) @-> returning (void)) x ofType forSaveOperation delegate didSaveSelector contextInfo
...
let updateChangeCount x self = msg_send ~self ~cmd:(selector "updateChangeCount:") ~typ:(ullong @-> returning (void)) x
let updateChangeCountWithToken x ~forSaveOperation self = msg_send ~self ~cmd:(selector "updateChangeCountWithToken:forSaveOperation:") ~typ:(id @-> ullong @-> returning (void)) x forSaveOperation
...
let writableTypesForSaveOperation x self = msg_send ~self ~cmd:(selector "writableTypesForSaveOperation:") ~typ:(ullong @-> returning (id)) x
...
let writeToFile' x ~ofType ~originalFile ~saveOperation self = msg_send ~self ~cmd:(selector "writeToFile:ofType:originalFile:saveOperation:") ~typ:(id @-> id @-> id @-> ullong @-> returning (bool)) x ofType originalFile saveOperation
...
let writeToURL2 x ~ofType ~forSaveOperation ~originalContentsURL ~error self = msg_send ~self ~cmd:(selector "writeToURL:ofType:forSaveOperation:originalContentsURL:error:") ~typ:(id @-> id @-> ullong @-> id @-> ptr (id) @-> returning (bool)) x ofType forSaveOperation originalContentsURL error
let writeWithBackupToFile x ~ofType ~saveOperation self = msg_send ~self ~cmd:(selector "writeWithBackupToFile:ofType:saveOperation:") ~typ:(id @-> id @-> ullong @-> returning (bool)) x ofType saveOperation