...
let initWithBytes x ~length ~releaseBytesBlock self = msg_send ~self ~cmd:(selector "initWithBytes:length:releaseBytesBlock:") ~typ:(ptr (void) @-> ullong @-> ptr void @-> returning (id)) x length releaseBytesBlock
