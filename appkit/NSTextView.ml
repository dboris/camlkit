...
let highlightBoundingRectForCharacterRange x ~highlightStyle self = msg_send_stret ~self ~cmd:(selector "highlightBoundingRectForCharacterRange:highlightStyle:") ~typ:(NSRange.t @-> ullong @-> returning (CGRect.t)) ~return_type:CGRect.t x highlightStyle
...
let selectionRangeForProposedRange x ~granularity self = msg_send_stret ~self ~cmd:(selector "selectionRangeForProposedRange:granularity:") ~typ:(NSRange.t @-> ullong @-> returning (NSRange.t)) ~return_type:NSRange.t x granularity
