...
let rectOfColumn x self = msg_send_stret ~self ~cmd:(selector "rectOfColumn:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let rectOfRow x self = msg_send_stret ~self ~cmd:(selector "rectOfRow:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
