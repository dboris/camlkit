...
let editableStateAtIndex x self = msg_send ~self ~cmd:(selector "editableStateAtIndex:") ~typ:(ullong @-> returning (bool)) x
...
let enabledStateAtIndex x self = msg_send ~self ~cmd:(selector "enabledStateAtIndex:") ~typ:(ullong @-> returning (bool)) x
...
let hiddenStateAtIndex x self = msg_send ~self ~cmd:(selector "hiddenStateAtIndex:") ~typ:(ullong @-> returning (bool)) x
