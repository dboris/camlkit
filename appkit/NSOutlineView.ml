...
let child x ~ofItem self = msg_send ~self ~cmd:(selector "child:ofItem:") ~typ:(llong @-> id @-> returning (id)) x ofItem
...
let frameOfCellAtColumn x ~row self = msg_send_stret ~self ~cmd:(selector "frameOfCellAtColumn:row:") ~typ:(llong @-> llong @-> returning (CGRect.t)) ~return_type:CGRect.t x row
let frameOfOutlineCellAtRow x self = msg_send_stret ~self ~cmd:(selector "frameOfOutlineCellAtRow:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let identifierForRow x self = msg_send ~self ~cmd:(selector "identifierForRow:") ~typ:(llong @-> returning (id)) x
...
let insertItemsAtIndexes x ~inParent ~withAnimation self = msg_send ~self ~cmd:(selector "insertItemsAtIndexes:inParent:withAnimation:") ~typ:(id @-> id @-> ullong @-> returning (void)) x inParent withAnimation
...
let itemAtRow x self = msg_send ~self ~cmd:(selector "itemAtRow:") ~typ:(llong @-> returning (id)) x
...
let levelForRow x self = msg_send ~self ~cmd:(selector "levelForRow:") ~typ:(llong @-> returning (llong)) x
...
let moveItemAtIndex x ~inParent ~toIndex ~inParent_ self = msg_send ~self ~cmd:(selector "moveItemAtIndex:inParent:toIndex:inParent:") ~typ:(llong @-> id @-> llong @-> id @-> returning (void)) x inParent toIndex inParent_
...
let reloadItem2 x ~reloadChildren ~withInsertAnimation ~removeAnimation self = msg_send ~self ~cmd:(selector "reloadItem:reloadChildren:withInsertAnimation:removeAnimation:") ~typ:(id @-> bool @-> ullong @-> ullong @-> returning (void)) x reloadChildren withInsertAnimation removeAnimation
let removeFromSuperview self = msg_send ~self ~cmd:(selector "removeFromSuperview") ~typ:(returning (void))
let removeItemsAtIndexes x ~inParent ~withAnimation self = msg_send ~self ~cmd:(selector "removeItemsAtIndexes:inParent:withAnimation:") ~typ:(id @-> id @-> ullong @-> returning (void)) x inParent withAnimation
...
let setDropItem x ~dropChildIndex self = msg_send ~self ~cmd:(selector "setDropItem:dropChildIndex:") ~typ:(id @-> llong @-> returning (void)) x dropChildIndex
...
let shouldShowOutlineCellInlineForRow x self = msg_send ~self ~cmd:(selector "shouldShowOutlineCellInlineForRow:") ~typ:(llong @-> returning (bool)) x
