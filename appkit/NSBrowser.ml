...
let _class_ = get_class "NSBrowser"
...
let canDragRowsWithIndexes x ~inColumn ~withEvent self = msg_send ~self ~cmd:(selector "canDragRowsWithIndexes:inColumn:withEvent:") ~typ:(id @-> llong @-> id @-> returning (bool)) x inColumn withEvent
...
let displayColumn x self = msg_send ~self ~cmd:(selector "displayColumn:") ~typ:(llong @-> returning (void)) x
...
let draggingImageForRowsWithIndexes x ~inColumn ~withEvent ~offset self = msg_send ~self ~cmd:(selector "draggingImageForRowsWithIndexes:inColumn:withEvent:offset:") ~typ:(id @-> llong @-> id @-> ptr (CGPoint.t) @-> returning (id)) x inColumn withEvent offset
...
let drawTitleOfColumn x ~inRect self = msg_send ~self ~cmd:(selector "drawTitleOfColumn:inRect:") ~typ:(llong @-> CGRect.t @-> returning (void)) x inRect
...
let frameOfColumn x self = msg_send_stret ~self ~cmd:(selector "frameOfColumn:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let frameOfInsideOfColumn x self = msg_send_stret ~self ~cmd:(selector "frameOfInsideOfColumn:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let frameOfRow x ~inColumn self = msg_send_stret ~self ~cmd:(selector "frameOfRow:inColumn:") ~typ:(llong @-> llong @-> returning (CGRect.t)) ~return_type:CGRect.t x inColumn
...
let indexPathForColumn x self = msg_send ~self ~cmd:(selector "indexPathForColumn:") ~typ:(llong @-> returning (id)) x
...
let itemAtRow x ~column self = msg_send ~self ~cmd:(selector "itemAtRow:column:") ~typ:(llong @-> llong @-> returning (id)) x column
let itemAtRow' x ~inColumn self = msg_send ~self ~cmd:(selector "itemAtRow:inColumn:") ~typ:(llong @-> llong @-> returning (id)) x inColumn
...
let loadedCellAtRow x ~column self = msg_send ~self ~cmd:(selector "loadedCellAtRow:column:") ~typ:(llong @-> llong @-> returning (id)) x column
let matrixClass self = msg_send ~self ~cmd:(selector "matrixClass") ~typ:(returning (_Class))
let matrixInColumn x self = msg_send ~self ~cmd:(selector "matrixInColumn:") ~typ:(llong @-> returning (id)) x
...
let noteHeightOfRowsWithIndexesChanged x ~inColumn self = msg_send ~self ~cmd:(selector "noteHeightOfRowsWithIndexesChanged:inColumn:") ~typ:(id @-> llong @-> returning (void)) x inColumn
...
let parentForItemsInColumn x self = msg_send ~self ~cmd:(selector "parentForItemsInColumn:") ~typ:(llong @-> returning (id)) x
...
let pathToColumn x self = msg_send ~self ~cmd:(selector "pathToColumn:") ~typ:(llong @-> returning (id)) x
...
let reloadColumn x self = msg_send ~self ~cmd:(selector "reloadColumn:") ~typ:(llong @-> returning (void)) x
let reloadDataForRowIndexes x ~inColumn self = msg_send ~self ~cmd:(selector "reloadDataForRowIndexes:inColumn:") ~typ:(id @-> llong @-> returning (void)) x inColumn
...
let scrollColumnsLeftBy x self = msg_send ~self ~cmd:(selector "scrollColumnsLeftBy:") ~typ:(llong @-> returning (void)) x
let scrollColumnsRightBy x self = msg_send ~self ~cmd:(selector "scrollColumnsRightBy:") ~typ:(llong @-> returning (void)) x
let scrollRowToVisible x ~inColumn self = msg_send ~self ~cmd:(selector "scrollRowToVisible:inColumn:") ~typ:(llong @-> llong @-> returning (void)) x inColumn
...
let selectRow x ~inColumn self = msg_send ~self ~cmd:(selector "selectRow:inColumn:") ~typ:(llong @-> llong @-> returning (void)) x inColumn
let selectRowIndexes x ~inColumn self = msg_send ~self ~cmd:(selector "selectRowIndexes:inColumn:") ~typ:(id @-> llong @-> returning (void)) x inColumn
let selectedCell self = msg_send ~self ~cmd:(selector "selectedCell") ~typ:(returning (id))
let selectedCellInColumn x self = msg_send ~self ~cmd:(selector "selectedCellInColumn:") ~typ:(llong @-> returning (id)) x
...
let selectedRowInColumn x self = msg_send ~self ~cmd:(selector "selectedRowInColumn:") ~typ:(llong @-> returning (llong)) x
let selectedRowIndexesInColumn x self = msg_send ~self ~cmd:(selector "selectedRowIndexesInColumn:") ~typ:(llong @-> returning (id)) x
...
let setColumnResizingType x self = msg_send ~self ~cmd:(selector "setColumnResizingType:") ~typ:(ullong @-> returning (void)) x
...
let setLastColumn x self = msg_send ~self ~cmd:(selector "setLastColumn:") ~typ:(llong @-> returning (void)) x
let setMatrixClass x self = msg_send ~self ~cmd:(selector "setMatrixClass:") ~typ:(_Class @-> returning (void)) x
let setMaxVisibleColumns x self = msg_send ~self ~cmd:(selector "setMaxVisibleColumns:") ~typ:(llong @-> returning (void)) x
...
let setTitle x ~ofColumn self = msg_send ~self ~cmd:(selector "setTitle:ofColumn:") ~typ:(id @-> llong @-> returning (void)) x ofColumn
...
let setWidth x ~ofColumn self = msg_send ~self ~cmd:(selector "setWidth:ofColumn:") ~typ:(double @-> llong @-> returning (void)) x ofColumn
...
let titleFrameOfColumn x self = msg_send_stret ~self ~cmd:(selector "titleFrameOfColumn:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
let titleHeight self = msg_send ~self ~cmd:(selector "titleHeight") ~typ:(returning (double))
let titleOfColumn x self = msg_send ~self ~cmd:(selector "titleOfColumn:") ~typ:(llong @-> returning (id)) x
...
let widthOfColumn x self = msg_send ~self ~cmd:(selector "widthOfColumn:") ~typ:(llong @-> returning (double)) x