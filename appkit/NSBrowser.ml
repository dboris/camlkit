...
let frameOfColumn x self = msg_send ~self ~cmd:(selector "frameOfColumn:") ~typ:(llong @-> returning (CGRect.t)) x
let frameOfInsideOfColumn x self = msg_send ~self ~cmd:(selector "frameOfInsideOfColumn:") ~typ:(llong @-> returning (CGRect.t)) x
let frameOfRow x ~inColumn self = msg_send ~self ~cmd:(selector "frameOfRow:inColumn:") ~typ:(llong @-> llong @-> returning (CGRect.t)) x inColumn
...
let titleFrameOfColumn x self = msg_send ~self ~cmd:(selector "titleFrameOfColumn:") ~typ:(llong @-> returning (CGRect.t)) x
