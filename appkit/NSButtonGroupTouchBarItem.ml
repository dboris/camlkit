...
let insertPopoverItem x ~atIndex self = msg_send ~self ~cmd:(selector "insertPopoverItem:atIndex:") ~typ:(id @-> llong @-> returning (void)) x atIndex
let insertView x ~atIndex self = msg_send ~self ~cmd:(selector "insertView:atIndex:") ~typ:(id @-> llong @-> returning (void)) x atIndex
...
let setCompressionOption x self = msg_send ~self ~cmd:(selector "setCompressionOption:") ~typ:(ullong @-> returning (void)) x
let setDefaultButtonImagePosition x self = msg_send ~self ~cmd:(selector "setDefaultButtonImagePosition:") ~typ:(ullong @-> returning (void)) x
