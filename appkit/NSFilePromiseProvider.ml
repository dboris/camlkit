...
let _class_ = get_class "NSFilePromiseProvider"
...
let setDragggingSequenceNumber x self = msg_send ~self ~cmd:(selector "setDragggingSequenceNumber:") ~typ:(llong @-> returning (void)) x
