...
let _class_ = get_class "NSTitlebarContainerView"
...
let dividerCursorRectForAdapter x self = msg_send_stret ~self ~cmd:(selector "dividerCursorRectForAdapter:") ~typ:(id @-> returning (CGRect.t)) ~return_type:CGRect.t x
...
let sidebarDividerCursorRect self = msg_send_stret ~self ~cmd:(selector "sidebarDividerCursorRect") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
...
let trailingSidebarDividerCursorRect self = msg_send_stret ~self ~cmd:(selector "trailingSidebarDividerCursorRect") ~typ:(returning (CGRect.t)) ~return_type:CGRect.t
