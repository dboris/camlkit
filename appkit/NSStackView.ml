...
let clippingResistancePriorityForOrientation x self = msg_send ~self ~cmd:(selector "clippingResistancePriorityForOrientation:") ~typ:(llong @-> returning (float)) (LLong.of_int x)
...
let huggingPriorityForOrientation x self = msg_send ~self ~cmd:(selector "huggingPriorityForOrientation:") ~typ:(llong @-> returning (float)) (LLong.of_int x)
...
let insertView x ~atIndex ~inGravity self = msg_send ~self ~cmd:(selector "insertView:atIndex:inGravity:") ~typ:(id @-> ullong @-> llong @-> returning (void)) x (ULLong.of_int atIndex) (LLong.of_int inGravity)
...
let setClippingResistancePriority x ~forOrientation self = msg_send ~self ~cmd:(selector "setClippingResistancePriority:forOrientation:") ~typ:(float @-> llong @-> returning (void)) x (LLong.of_int forOrientation)
...
let setEdgeInsets x self = msg_send ~self ~cmd:(selector "setEdgeInsets:") ~typ:(ptr void @-> returning (void)) x
let setHasEqualSpacing x self = msg_send ~self ~cmd:(selector "setHasEqualSpacing:") ~typ:(bool @-> returning (void)) x
let setHuggingPriority x ~forOrientation self = msg_send ~self ~cmd:(selector "setHuggingPriority:forOrientation:") ~typ:(float @-> llong @-> returning (void)) x (LLong.of_int forOrientation)
let setOrientation x self = msg_send ~self ~cmd:(selector "setOrientation:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
let setPerpendicularAlignment x self = msg_send ~self ~cmd:(selector "setPerpendicularAlignment:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
let setSecondaryAlignment x self = msg_send ~self ~cmd:(selector "setSecondaryAlignment:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
...
let setTransverseAlignment x self = msg_send ~self ~cmd:(selector "setTransverseAlignment:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
...
let setViews x ~inGravity self = msg_send ~self ~cmd:(selector "setViews:inGravity:") ~typ:(id @-> llong @-> returning (void)) x (LLong.of_int inGravity)
...
let viewsInGravity x self = msg_send ~self ~cmd:(selector "viewsInGravity:") ~typ:(llong @-> returning (id)) (LLong.of_int x)
