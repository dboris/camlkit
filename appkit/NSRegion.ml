...
let _class_ = get_class "NSRegion"
...
let initWithBitmapImageRep x ~atX ~y ~flip self = msg_send ~self ~cmd:(selector "initWithBitmapImageRep:atX:y:flip:") ~typ:(id @-> llong @-> llong @-> bool @-> returning (id)) x atX y flip
let initWithRect x self = msg_send ~self ~cmd:(selector "initWithRect:") ~typ:(CGRect.t @-> returning (id)) x
let initWithRects x ~count self = msg_send ~self ~cmd:(selector "initWithRects:count:") ~typ:(ptr (CGRect.t) @-> ullong @-> returning (id)) x count
...
let largestRect self = msg_send ~self ~cmd:(selector "largestRect") ~typ:(returning (CGRect.t))
