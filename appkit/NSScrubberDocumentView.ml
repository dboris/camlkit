...
let scrollPointAligningItemAtIndex x ~toAlignment self = msg_send_stret ~self ~cmd:(selector "scrollPointAligningItemAtIndex:toAlignment:") ~typ:(llong @-> llong @-> returning (CGPoint.t)) ~return_type:CGPoint.t x toAlignment
let scrollPointAligningItemAtIndex' x ~toAlignment ~forSelectedIndex ~approximatedScrollPoint self = msg_send_stret ~self ~cmd:(selector "scrollPointAligningItemAtIndex:toAlignment:forSelectedIndex:approximatedScrollPoint:") ~typ:(llong @-> llong @-> llong @-> CGPoint.t @-> returning (CGPoint.t)) ~return_type:CGPoint.t x toAlignment forSelectedIndex approximatedScrollPoint
