...
let adjustForContentSize x ~contentInsets self = msg_send ~self ~cmd:(selector "adjustForContentSize:contentInsets:") ~typ:(CGSize.t @-> ptr void @-> returning (void)) x contentInsets
let animatingSelections self = msg_send ~self ~cmd:(selector "animatingSelections") ~typ:(returning (bool))
let applyItemAttributes x ~startingAttributes ~withState self = msg_send ~self ~cmd:(selector "applyItemAttributes:startingAttributes:withState:") ~typ:(id @-> id @-> ptr void @-> returning (void)) x startingAttributes withState
...
let applyPinningConfiguration x self = msg_send ~self ~cmd:(selector "applyPinningConfiguration:") ~typ:(ptr void @-> returning (void)) x
let applySelectionAttributes x ~startingAttributes ~withState self = msg_send ~self ~cmd:(selector "applySelectionAttributes:startingAttributes:withState:") ~typ:(id @-> id @-> ptr void @-> returning (void)) x startingAttributes withState
...
let itemTransitionsFromAttributes x ~toAttributes ~withState self = msg_send ~self ~cmd:(selector "itemTransitionsFromAttributes:toAttributes:withState:") ~typ:(id @-> id @-> ptr void @-> returning (id)) x toAttributes withState
...
let performItemTransitions x ~withState self = msg_send ~self ~cmd:(selector "performItemTransitions:withState:") ~typ:(id @-> ptr void @-> returning (void)) x withState
...
let performSelectionTransitions x ~withState self = msg_send ~self ~cmd:(selector "performSelectionTransitions:withState:") ~typ:(id @-> ptr void @-> returning (void)) x withState
...
let scrollPointAligningItemAtIndex1 x ~toAlignment ~forState self = msg_send_stret ~self ~cmd:(selector "scrollPointAligningItemAtIndex:toAlignment:forState:") ~typ:(llong @-> llong @-> ptr void @-> returning (CGPoint.t)) ~return_type:CGPoint.t (LLong.of_int x) (LLong.of_int toAlignment) forState
...
let setModelState x self = msg_send ~self ~cmd:(selector "setModelState:") ~typ:(ptr void @-> returning (void)) x
...
let setPendingScrollPin x self = msg_send ~self ~cmd:(selector "setPendingScrollPin:") ~typ:(ptr void @-> returning (void)) x
...
let setProxyState x self = msg_send ~self ~cmd:(selector "setProxyState:") ~typ:(ptr void @-> returning (void)) x
...
let updateCornerMaskingForState x self = msg_send ~self ~cmd:(selector "updateCornerMaskingForState:") ~typ:(ptr void @-> returning (void)) x
...
let visibleContentRectForPinningConfiguration x self = msg_send_stret ~self ~cmd:(selector "visibleContentRectForPinningConfiguration:") ~typ:(ptr void @-> returning (CGRect.t)) ~return_type:CGRect.t x