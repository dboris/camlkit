...
let _class_ = get_class "NSScroller"
...
module Class = struct
  ...
  let scrollerWidthForControlSize x self = msg_send ~self ~cmd:(selector "scrollerWidthForControlSize:") ~typ:(ullong @-> returning (double)) x
...
let drawArrow x ~highlight self = msg_send ~self ~cmd:(selector "drawArrow:highlight:") ~typ:(ullong @-> bool @-> returning (void)) x highlight
let drawArrow' x ~highlightPart self = msg_send ~self ~cmd:(selector "drawArrow:highlightPart:") ~typ:(ullong @-> ullong @-> returning (void)) x highlightPart
...
let scrollerImp3 x ~overlayScrollerStateChangedTo self = msg_send ~self ~cmd:(selector "scrollerImp:overlayScrollerStateChangedTo:") ~typ:(id @-> ullong @-> returning (void)) x overlayScrollerStateChangedTo
...
let setArrowsPosition x self = msg_send ~self ~cmd:(selector "setArrowsPosition:") ~typ:(ullong @-> returning (void)) x
