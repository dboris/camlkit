...
let _class_ = get_class "NSTokenFieldCell"
...
let rangeForUserCompletion self = msg_send_stret ~self ~cmd:(selector "rangeForUserCompletion") ~typ:(returning (NSRange.t)) ~return_type:NSRange.t
...
let textView1 x ~willChangeSelectionFromCharacterRange ~toCharacterRange self = msg_send_stret ~self ~cmd:(selector "textView:willChangeSelectionFromCharacterRange:toCharacterRange:") ~typ:(id @-> NSRange.t @-> NSRange.t @-> returning (NSRange.t)) ~return_type:NSRange.t x willChangeSelectionFromCharacterRange toCharacterRange
...
let tokenAttachment' x ~doubleClickedInRect ~ofView ~atCharacterIndex self = msg_send ~self ~cmd:(selector "tokenAttachment:doubleClickedInRect:ofView:atCharacterIndex:") ~typ:(id @-> CGRect.t @-> id @-> ullong @-> returning (bool)) x doubleClickedInRect ofView atCharacterIndex
