...
let _class_ = get_class "NSScrubberSelectionLayoutAxis"
...
let selectionLayoutAttributesForItemAtIndex x ~withState ~inLayout ~presentationItemAttributes ~inView self = msg_send ~self ~cmd:(selector "selectionLayoutAttributesForItemAtIndex:withState:inLayout:presentationItemAttributes:inView:") ~typ:(llong @-> ptr void @-> id @-> id @-> id @-> returning (id)) (LLong.of_int x) withState inLayout presentationItemAttributes inView
let selectionLayoutAttributesForState x ~inLayout ~presentationItemAttributes ~inView self = msg_send ~self ~cmd:(selector "selectionLayoutAttributesForState:inLayout:presentationItemAttributes:inView:") ~typ:(ptr void @-> id @-> id @-> id @-> returning (id)) x inLayout presentationItemAttributes inView
