...
module Class = struct
  ...
  let menuZone self = msg_send ~self ~cmd:(selector "menuZone") ~typ:(returning (id))
  ...
  let setMenuZone x self = msg_send ~self ~cmd:(selector "setMenuZone:") ~typ:(id @-> returning (void)) x
  let standardImportFromDeviceMenuWithOptions x self = msg_send ~self ~cmd:(selector "standardImportFromDeviceMenuWithOptions:") ~typ:(ullong @-> returning (id)) x
end
...
let indexOfItemWithSubmenu x self = msg_send ~self ~cmd:(selector "indexOfItemWithSubmenu:") ~typ:(id @-> returning (llong)) x
...
let insertItem x ~atIndex self = msg_send ~self ~cmd:(selector "insertItem:atIndex:") ~typ:(id @-> llong @-> returning (void)) x atIndex
let insertItemWithTitle x ~action ~keyEquivalent ~atIndex self = msg_send ~self ~cmd:(selector "insertItemWithTitle:action:keyEquivalent:atIndex:") ~typ:(id @-> _SEL @-> id @-> llong @-> returning (id)) x action keyEquivalent atIndex
...
let itemWithTag x self = msg_send ~self ~cmd:(selector "itemWithTag:") ~typ:(llong @-> returning (id)) x
...
let propertiesToUpdate self = msg_send ~self ~cmd:(selector "propertiesToUpdate") ~typ:(returning (ullong))
let recordKeyboardShortcutEvent x ~withKeyEquivalent ~modifierMask ~title self = msg_send ~self ~cmd:(selector "recordKeyboardShortcutEvent:withKeyEquivalent:modifierMask:title:") ~typ:(id @-> id @-> ullong @-> id @-> returning (void)) x withKeyEquivalent modifierMask title
