...
module Class = struct
  let stringArrayForEnumType x self = msg_send ~self ~cmd:(selector "stringArrayForEnumType:") ~typ:(llong @-> returning (id)) x
end
...
let setParamType x self = msg_send ~self ~cmd:(selector "setParamType:") ~typ:(llong @-> returning (void)) x
let setParameterized x self = msg_send ~self ~cmd:(selector "setParameterized:") ~typ:(bool @-> returning (void)) x
let setReturnType x self = msg_send ~self ~cmd:(selector "setReturnType:") ~typ:(llong @-> returning (void)) x
