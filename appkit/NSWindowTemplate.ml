...
let _class_ = get_class "NSWindowTemplate"
...
let contentMaxSize self = msg_send ~self ~cmd:(selector "contentMaxSize") ~typ:(returning (CGSize.t))
let contentMinSize self = msg_send ~self ~cmd:(selector "contentMinSize") ~typ:(returning (CGSize.t))
...
let setAutoPositionMask x self = msg_send ~self ~cmd:(selector "setAutoPositionMask:") ~typ:(ullong @-> returning (void)) x
...
let setInterfaceStyle x self = msg_send ~self ~cmd:(selector "setInterfaceStyle:") ~typ:(ullong @-> returning (void)) x
...
let setWindowBackingLocation x self = msg_send ~self ~cmd:(selector "setWindowBackingLocation:") ~typ:(ullong @-> returning (void)) x
let setWindowSharingType x self = msg_send ~self ~cmd:(selector "setWindowSharingType:") ~typ:(ullong @-> returning (void)) x
