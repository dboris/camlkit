...
let pullDownTrackingRectForBounds x self = msg_send ~self ~cmd:(selector "pullDownTrackingRectForBounds:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
