...
let _class_ = get_class "NSSplitViewController"
...
let insertSplitViewItem x ~atIndex self = msg_send ~self ~cmd:(selector "insertSplitViewItem:atIndex:") ~typ:(id @-> llong @-> returning (void)) x atIndex
...
let splitView1 x ~additionalEffectiveRectOfDividerAtIndex self = msg_send_stret ~self ~cmd:(selector "splitView:additionalEffectiveRectOfDividerAtIndex:") ~typ:(id @-> llong @-> returning (CGRect.t)) ~return_type:CGRect.t x additionalEffectiveRectOfDividerAtIndex
...
let splitView3 x ~doubleClickedOnDividerAtIndex self = msg_send ~self ~cmd:(selector "splitView:doubleClickedOnDividerAtIndex:") ~typ:(id @-> llong @-> returning (bool)) x doubleClickedOnDividerAtIndex
let splitView4 x ~shouldHideDividerAtIndex self = msg_send ~self ~cmd:(selector "splitView:shouldHideDividerAtIndex:") ~typ:(id @-> llong @-> returning (bool)) x shouldHideDividerAtIndex
let splitView5 x ~shouldCollapseSubview ~forDoubleClickOnDividerAtIndex self = msg_send ~self ~cmd:(selector "splitView:shouldCollapseSubview:forDoubleClickOnDividerAtIndex:") ~typ:(id @-> id @-> llong @-> returning (bool)) x shouldCollapseSubview forDoubleClickOnDividerAtIndex
let splitView6 x ~effectiveRect ~forDrawnRect ~ofDividerAtIndex self = msg_send_stret ~self ~cmd:(selector "splitView:effectiveRect:forDrawnRect:ofDividerAtIndex:") ~typ:(id @-> CGRect.t @-> CGRect.t @-> llong @-> returning (CGRect.t)) ~return_type:CGRect.t x effectiveRect forDrawnRect ofDividerAtIndex
