...
let associateView x ~withColumn self = msg_send ~self ~cmd:(selector "associateView:withColumn:") ~typ:(id @-> llong @-> returning (void)) x withColumn
...
let associatedViewsForColumn x self = msg_send ~self ~cmd:(selector "associatedViewsForColumn:") ~typ:(llong @-> returning (id)) x
...
let insertColumnAtIndex x self = msg_send ~self ~cmd:(selector "insertColumnAtIndex:") ~typ:(llong @-> returning (void)) x
...
let moveViewsFromColumn x ~toColumn self = msg_send ~self ~cmd:(selector "moveViewsFromColumn:toColumn:") ~typ:(llong @-> llong @-> returning (void)) x toColumn
...
let performHandler x ~onAssociatedViewsWithColumn self = msg_send ~self ~cmd:(selector "performHandler:onAssociatedViewsWithColumn:") ~typ:(ptr void @-> llong @-> returning (void)) x onAssociatedViewsWithColumn
...
let removeColumnAtIndex x self = msg_send ~self ~cmd:(selector "removeColumnAtIndex:") ~typ:(llong @-> returning (void)) x
...
let setGroupRowStyle2 x self = msg_send ~self ~cmd:(selector "setGroupRowStyle2:") ~typ:(llong @-> returning (void)) x
...
let setView x ~atColumn self = msg_send ~self ~cmd:(selector "setView:atColumn:") ~typ:(id @-> llong @-> returning (void)) x atColumn
let updateKeyViewLoop self = msg_send ~self ~cmd:(selector "updateKeyViewLoop") ~typ:(returning (id))
let updateLayer self = msg_send ~self ~cmd:(selector "updateLayer") ~typ:(returning (void))
let viewAtColumn x self = msg_send ~self ~cmd:(selector "viewAtColumn:") ~typ:(llong @-> returning (id)) x
