...
let invokeSelector1 x ~withArguments ~forBinding ~atIndex ~error self = msg_send ~self ~cmd:(selector "invokeSelector:withArguments:forBinding:atIndex:error:") ~typ:(_SEL @-> id @-> id @-> ullong @-> ptr (id) @-> returning (bool)) x withArguments forBinding atIndex error
...
let mutableArrayValueForBinding' x ~atIndex ~resolveMarkersToPlaceholders self = msg_send ~self ~cmd:(selector "mutableArrayValueForBinding:atIndex:resolveMarkersToPlaceholders:") ~typ:(id @-> ullong @-> bool @-> returning (id)) x atIndex resolveMarkersToPlaceholders
...
let mutableSetValueForBinding' x ~atIndex ~resolveMarkersToPlaceholders self = msg_send ~self ~cmd:(selector "mutableSetValueForBinding:atIndex:resolveMarkersToPlaceholders:") ~typ:(id @-> ullong @-> bool @-> returning (id)) x atIndex resolveMarkersToPlaceholders
...
let setValue1 x ~forBinding ~atIndex ~error self = msg_send ~self ~cmd:(selector "setValue:forBinding:atIndex:error:") ~typ:(ptr (id) @-> id @-> ullong @-> ptr (id) @-> returning (bool)) x forBinding atIndex error
...
let valueForBinding1 x ~atIndex ~resolveMarkersToPlaceholders self = msg_send ~self ~cmd:(selector "valueForBinding:atIndex:resolveMarkersToPlaceholders:") ~typ:(id @-> ullong @-> bool @-> returning (id)) x atIndex resolveMarkersToPlaceholders
