...
include NSTableRowView

let _class_ = get_class "NSCachedTableRowView"

module Class = struct
  let defaultIdentifier self = msg_send ~self ~cmd:(selector "defaultIdentifier") ~typ:(returning (id))
end
