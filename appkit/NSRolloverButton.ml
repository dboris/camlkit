...
let _class_ = get_class "NSRolloverButton"
...
let setCustomAlignmentRectInsets x self = msg_send ~self ~cmd:(selector "setCustomAlignmentRectInsets:") ~typ:(ptr void @-> returning (void)) x
