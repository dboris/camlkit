...
let _class_ = get_class "NSSecureTextStorage"
...
let doubleClickAtIndex x self = msg_send_stret ~self ~cmd:(selector "doubleClickAtIndex:") ~typ:(ullong @-> returning (NSRange.t)) ~return_type:NSRange.t x
