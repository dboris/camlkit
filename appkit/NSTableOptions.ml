...
let addColumns x self = msg_send ~self ~cmd:(selector "addColumns:") ~typ:(llong @-> returning (void)) x
...
let addRows x self = msg_send ~self ~cmd:(selector "addRows:") ~typ:(llong @-> returning (void)) x
...
let removeColumns x self = msg_send ~self ~cmd:(selector "removeColumns:") ~typ:(llong @-> returning (void)) x
let removeRows x self = msg_send ~self ~cmd:(selector "removeRows:") ~typ:(llong @-> returning (void)) x
...
let setHorizontalAlignment x self = msg_send ~self ~cmd:(selector "setHorizontalAlignment:") ~typ:(llong @-> returning (void)) x
let setVerticalAlignment x self = msg_send ~self ~cmd:(selector "setVerticalAlignment:") ~typ:(ullong @-> returning (void)) x
