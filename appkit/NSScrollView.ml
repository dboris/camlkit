...
module Class = struct
  ...
  let contentSizeForFrameSize x ~hasHorizontalScroller ~hasVerticalScroller ~borderType self = msg_send ~self ~cmd:(selector "contentSizeForFrameSize:hasHorizontalScroller:hasVerticalScroller:borderType:") ~typ:(CGSize.t @-> bool @-> bool @-> ullong @-> returning (CGSize.t)) x hasHorizontalScroller hasVerticalScroller borderType
  let contentSizeForFrameSize' x ~horizontalScrollerClass ~verticalScrollerClass ~borderType ~controlSize ~scrollerStyle self = msg_send ~self ~cmd:(selector "contentSizeForFrameSize:horizontalScrollerClass:verticalScrollerClass:borderType:controlSize:scrollerStyle:") ~typ:(CGSize.t @-> _Class @-> _Class @-> ullong @-> ullong @-> llong @-> returning (CGSize.t)) x horizontalScrollerClass verticalScrollerClass borderType controlSize scrollerStyle
  let defaultAnimationForKey x self = msg_send ~self ~cmd:(selector "defaultAnimationForKey:") ~typ:(id @-> returning (id)) x
  let frameSizeForContentSize x ~hasHorizontalScroller ~hasVerticalScroller ~borderType self = msg_send ~self ~cmd:(selector "frameSizeForContentSize:hasHorizontalScroller:hasVerticalScroller:borderType:") ~typ:(CGSize.t @-> bool @-> bool @-> ullong @-> returning (CGSize.t)) x hasHorizontalScroller hasVerticalScroller borderType
  let frameSizeForContentSize' x ~horizontalScrollerClass ~verticalScrollerClass ~borderType ~controlSize ~scrollerStyle self = msg_send ~self ~cmd:(selector "frameSizeForContentSize:horizontalScrollerClass:verticalScrollerClass:borderType:controlSize:scrollerStyle:") ~typ:(CGSize.t @-> _Class @-> _Class @-> ullong @-> ullong @-> llong @-> returning (CGSize.t)) x horizontalScrollerClass verticalScrollerClass borderType controlSize scrollerStyle
...
let addFloatingHeaderView x ~forAxis self = msg_send ~self ~cmd:(selector "addFloatingHeaderView:forAxis:") ~typ:(id @-> llong @-> returning (void)) x forAxis
let addFloatingSubview x ~forAxis self = msg_send ~self ~cmd:(selector "addFloatingSubview:forAxis:") ~typ:(id @-> llong @-> returning (void)) x forAxis
...
let computedScrollViewFrame self = msg_send ~self ~cmd:(selector "computedScrollViewFrame") ~typ:(returning (CGRect.t))
...
let setFindBarPosition x self = msg_send ~self ~cmd:(selector "setFindBarPosition:") ~typ:(llong @-> returning (void)) x
...
let setHorizontalScrollElasticity x self = msg_send ~self ~cmd:(selector "setHorizontalScrollElasticity:") ~typ:(llong @-> returning (void)) x
...
let setVerticalScrollElasticity x self = msg_send ~self ~cmd:(selector "setVerticalScrollElasticity:") ~typ:(llong @-> returning (void)) x
