...
module Class = struct
  ...
  let contentSizeForFrameSize x ~hasHorizontalScroller ~hasVerticalScroller ~borderType self = msg_send_stret ~self ~cmd:(selector "contentSizeForFrameSize:hasHorizontalScroller:hasVerticalScroller:borderType:") ~typ:(CGSize.t @-> bool @-> bool @-> ullong @-> returning (CGSize.t)) ~return_type:CGSize.t x hasHorizontalScroller hasVerticalScroller borderType
  let contentSizeForFrameSize' x ~horizontalScrollerClass ~verticalScrollerClass ~borderType ~controlSize ~scrollerStyle self = msg_send_stret ~self ~cmd:(selector "contentSizeForFrameSize:horizontalScrollerClass:verticalScrollerClass:borderType:controlSize:scrollerStyle:") ~typ:(CGSize.t @-> _Class @-> _Class @-> ullong @-> ullong @-> llong @-> returning (CGSize.t)) ~return_type:CGSize.t x horizontalScrollerClass verticalScrollerClass borderType controlSize scrollerStyle
  let defaultAnimationForKey x self = msg_send ~self ~cmd:(selector "defaultAnimationForKey:") ~typ:(id @-> returning (id)) x
  let frameSizeForContentSize x ~hasHorizontalScroller ~hasVerticalScroller ~borderType self = msg_send_stret ~self ~cmd:(selector "frameSizeForContentSize:hasHorizontalScroller:hasVerticalScroller:borderType:") ~typ:(CGSize.t @-> bool @-> bool @-> ullong @-> returning (CGSize.t)) ~return_type:CGSize.t x hasHorizontalScroller hasVerticalScroller borderType
  let frameSizeForContentSize' x ~horizontalScrollerClass ~verticalScrollerClass ~borderType ~controlSize ~scrollerStyle self = msg_send_stret ~self ~cmd:(selector "frameSizeForContentSize:horizontalScrollerClass:verticalScrollerClass:borderType:controlSize:scrollerStyle:") ~typ:(CGSize.t @-> _Class @-> _Class @-> ullong @-> ullong @-> llong @-> returning (CGSize.t)) ~return_type:CGSize.t x horizontalScrollerClass verticalScrollerClass borderType controlSize scrollerStyle
