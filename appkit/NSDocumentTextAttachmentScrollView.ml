...
let _class_ = get_class "NSDocumentTextAttachmentScrollView"
...
let setCharacterIndex x ~layoutManager self = msg_send ~self ~cmd:(selector "setCharacterIndex:layoutManager:") ~typ:(ullong @-> id @-> returning (void)) x layoutManager
