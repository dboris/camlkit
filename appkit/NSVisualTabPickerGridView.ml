...
let addTabViewItem x ~atIndex self = msg_send ~self ~cmd:(selector "addTabViewItem:atIndex:") ~typ:(id @-> ullong @-> returning (void)) x atIndex
...
let frameOfSelectedTile self = msg_send ~self ~cmd:(selector "frameOfSelectedTile") ~typ:(returning (CGRect.t))
...
let startGridAnimation x ~completionHandler self = msg_send ~self ~cmd:(selector "startGridAnimation:completionHandler:") ~typ:(llong @-> ptr void @-> returning (void)) x completionHandler
...
let visualTabPickerTileContainerView x ~closeTileAtIndex self = msg_send ~self ~cmd:(selector "visualTabPickerTileContainerView:closeTileAtIndex:") ~typ:(id @-> ullong @-> returning (void)) x closeTileAtIndex
let visualTabPickerTileContainerView1 x ~didSelectTileAtIndex self = msg_send ~self ~cmd:(selector "visualTabPickerTileContainerView:didSelectTileAtIndex:") ~typ:(id @-> ullong @-> returning (void)) x didSelectTileAtIndex
let visualTabPickerTileContainerView2 x ~highlightStateForTileAtIndex self = msg_send ~self ~cmd:(selector "visualTabPickerTileContainerView:highlightStateForTileAtIndex:") ~typ:(id @-> ullong @-> returning (bool)) x highlightStateForTileAtIndex
let visualTabPickerTileContainerView3 x ~imageForTileAtIndex self = msg_send ~self ~cmd:(selector "visualTabPickerTileContainerView:imageForTileAtIndex:") ~typ:(id @-> ullong @-> returning (id)) x imageForTileAtIndex
let visualTabPickerTileContainerView4 x ~titleForTileAtIndex self = msg_send ~self ~cmd:(selector "visualTabPickerTileContainerView:titleForTileAtIndex:") ~typ:(id @-> ullong @-> returning (id)) x titleForTileAtIndex
let visualTabPickerTileContainerView5 x ~viewForTileAtIndex self = msg_send ~self ~cmd:(selector "visualTabPickerTileContainerView:viewForTileAtIndex:") ~typ:(id @-> ullong @-> returning (id)) x viewForTileAtIndex
