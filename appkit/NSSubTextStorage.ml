...
include NSTextStorage

let _class_ = get_class "NSSubTextStorage"
...
let processEditingForTextStorage x ~edited ~range ~changeInLength ~invalidatedRange self = msg_send ~self ~cmd:(selector "processEditingForTextStorage:edited:range:changeInLength:invalidatedRange:") ~typ:(id @-> ullong @-> NSRange.t @-> llong @-> NSRange.t @-> returning (void)) x edited range changeInLength invalidatedRange
...
let textStorage' x ~edited ~range ~changeInLength ~invalidatedRange self = msg_send ~self ~cmd:(selector "textStorage:edited:range:changeInLength:invalidatedRange:") ~typ:(id @-> ullong @-> NSRange.t @-> llong @-> NSRange.t @-> returning (void)) x edited range changeInLength invalidatedRange