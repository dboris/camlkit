...
let collectionView3 x ~layout ~sectionLayoutForSection self = msg_send ~self ~cmd:(selector "collectionView:layout:sectionLayoutForSection:") ~typ:(id @-> id @-> llong @-> returning (id)) x layout (LLong.of_int sectionLayoutForSection)
let collectionView4 x ~layout ~shouldDisplayShadeRectForSection self = msg_send ~self ~cmd:(selector "collectionView:layout:shouldDisplayShadeRectForSection:") ~typ:(id @-> id @-> llong @-> returning (bool)) x layout (LLong.of_int shouldDisplayShadeRectForSection)
...
let collectionView6 x ~layout ~shouldDisplayBackgroundForSection ~withRect self = msg_send ~self ~cmd:(selector "collectionView:layout:shouldDisplayBackgroundForSection:withRect:") ~typ:(id @-> id @-> llong @-> ptr (CGRect.t) @-> returning (bool)) x layout (LLong.of_int shouldDisplayBackgroundForSection) withRect
