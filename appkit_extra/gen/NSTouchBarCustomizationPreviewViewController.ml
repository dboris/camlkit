...
let collectionView2 x ~layout ~containmentFrameForSection self = msg_send_stret ~self ~cmd:(selector "collectionView:layout:containmentFrameForSection:") ~typ:(id @-> id @-> llong @-> returning (CGRect.t)) ~return_type:CGRect.t x layout containmentFrameForSection
...
let containmentRectForSection x self = msg_send_stret ~self ~cmd:(selector "containmentRectForSection:") ~typ:(llong @-> returning (CGRect.t)) ~return_type:CGRect.t x
