...
let initWithParent x ~index ~bounds ~description ~help self = msg_send ~self ~cmd:(selector "initWithParent:index:bounds:description:help:") ~typ:(id @-> llong @-> CGRect.t @-> id @-> id @-> returning (id)) x index bounds description help