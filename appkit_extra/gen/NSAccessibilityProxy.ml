...
let _class_ = get_class "NSAccessibilityProxy"
...
let accessibilityFocusRingBoundsForBounds x self = msg_send_stret ~self ~cmd:(selector "accessibilityFocusRingBoundsForBounds:") ~typ:(CGRect.t @-> returning (CGRect.t)) ~return_type:CGRect.t x
