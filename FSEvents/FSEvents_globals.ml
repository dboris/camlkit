...
let _FSEventStreamCreate = Foreign.foreign "FSEventStreamCreate" ((ptr CFAllocator.t) @-> Foreign.funptr ~thread_registration:true ~runtime_lock:true ((ptr FSEventStream.t) @-> (ptr void) @-> ullong @-> (ptr void) @-> (ptr uint) @-> (ptr ullong) @-> returning void) @-> (ptr FSEventStreamContext.t) @-> (ptr CFArray.t) @-> ullong @-> double @-> uint @-> returning (ptr FSEventStream.t))
let _FSEventStreamCreateRelativeToDevice = Foreign.foreign "FSEventStreamCreateRelativeToDevice" ((ptr CFAllocator.t) @-> Foreign.funptr ~thread_registration:true ~runtime_lock:true ((ptr FSEventStream.t) @-> (ptr void) @-> ullong @-> (ptr void) @-> (ptr uint) @-> (ptr ullong) @-> returning void) @-> (ptr FSEventStreamContext.t) @-> int @-> (ptr CFArray.t) @-> ullong @-> double @-> uint @-> returning (ptr FSEventStream.t))
