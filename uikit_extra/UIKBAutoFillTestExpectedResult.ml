...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbautofilltestexpectedresult?language=objc}UIKBAutoFillTestExpectedResult} *)

let self = get_class "UIKBAutoFillTestExpectedResult"
