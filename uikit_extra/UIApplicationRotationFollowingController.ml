...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiapplicationrotationfollowingcontroller?language=objc}UIApplicationRotationFollowingController} *)

let self = get_class "UIApplicationRotationFollowingController"
