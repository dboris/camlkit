...
let setFreezeRequestCount x self = msg_send ~self ~cmd:(selector "setFreezeRequestCount:") ~typ:(ullong @-> returning (void)) x
...
let setTrackedSceneTargetState x self = msg_send ~self ~cmd:(selector "setTrackedSceneTargetState:") ~typ:(llong @-> returning (void)) x
