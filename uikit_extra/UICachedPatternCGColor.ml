...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicachedpatterncgcolor?language=objc}UICachedPatternCGColor} *)

let self = get_class "UICachedPatternCGColor"
