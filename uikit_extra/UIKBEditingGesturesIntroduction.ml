...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbeditinggesturesintroduction?language=objc}UIKBEditingGesturesIntroduction} *)

let self = get_class "UIKBEditingGesturesIntroduction"
