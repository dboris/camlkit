...
let setPortraitDeviceQuaternion x ~timestamp self = msg_send ~self ~cmd:(selector "setPortraitDeviceQuaternion:timestamp:") ~typ:(ptr void @-> double @-> returning (void)) x timestamp
...
let startDeviceMotionUpdatesUsingReferenceFrame x self = msg_send ~self ~cmd:(selector "startDeviceMotionUpdatesUsingReferenceFrame:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
let startDeviceMotionUpdatesUsingReferenceFrame' x ~toQueue ~withHandler self = msg_send ~self ~cmd:(selector "startDeviceMotionUpdatesUsingReferenceFrame:toQueue:withHandler:") ~typ:(ullong @-> id @-> ptr void @-> returning (void)) (ULLong.of_int x) toQueue withHandler
...
let unsafeSetPortraitDeviceQuaternion x ~timestamp self = msg_send ~self ~cmd:(selector "unsafeSetPortraitDeviceQuaternion:timestamp:") ~typ:(ptr void @-> double @-> returning (void)) x timestamp