...
let adjustToTopWithInsets x self = msg_send ~self ~cmd:(selector "adjustToTopWithInsets:") ~typ:(ptr void @-> returning (void)) x
let applyInsets x self = msg_send ~self ~cmd:(selector "applyInsets:") ~typ:(ptr void @-> returning (void)) x
let applyOffset x self = msg_send ~self ~cmd:(selector "applyOffset:") ~typ:(CGPoint.t @-> returning (void)) x
let applyShadowInsets x self = msg_send ~self ~cmd:(selector "applyShadowInsets:") ~typ:(ptr void @-> returning (void)) x
