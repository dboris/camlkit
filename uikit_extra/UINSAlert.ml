...
let updateButtonWithIdentifier x ~keyEquivalent self = msg_send ~self ~cmd:(selector "updateButtonWithIdentifier:keyEquivalent:") ~typ:(llong @-> id @-> returning (void)) x keyEquivalent
