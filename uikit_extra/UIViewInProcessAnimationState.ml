...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiviewinprocessanimationstate?language=objc}UIViewInProcessAnimationState} *)

let self = get_class "UIViewInProcessAnimationState"
