...
module C = struct
  ...
  let scopedResourceWithAbsolutePath x ~allowedAccess self = msg_send ~self ~cmd:(selector "scopedResourceWithAbsolutePath:allowedAccess:") ~typ:(id @-> llong @-> returning (id)) x (LLong.of_int allowedAccess)
  let scopedResourceWithFileURL x ~allowedAccess self = msg_send ~self ~cmd:(selector "scopedResourceWithFileURL:allowedAccess:") ~typ:(id @-> llong @-> returning (id)) x (LLong.of_int allowedAccess)
  let scopedResourceWithURL x ~allowedAccess self = msg_send ~self ~cmd:(selector "scopedResourceWithURL:allowedAccess:") ~typ:(id @-> llong @-> returning (id)) x (LLong.of_int allowedAccess)
  let scopedResourcesForAncestorsOfItemWithAbsolutePath x ~traversalStopPaths ~allowedAccess self = msg_send ~self ~cmd:(selector "scopedResourcesForAncestorsOfItemWithAbsolutePath:traversalStopPaths:allowedAccess:") ~typ:(id @-> id @-> llong @-> returning (id)) x traversalStopPaths (LLong.of_int allowedAccess)
...
let initWithAbsoluteURL x ~sandboxExtensionWrapper ~allowedAccess self = msg_send ~self ~cmd:(selector "initWithAbsoluteURL:sandboxExtensionWrapper:allowedAccess:") ~typ:(id @-> id @-> llong @-> returning (id)) x sandboxExtensionWrapper (LLong.of_int allowedAccess)
...
let setAllowedAccess x self = msg_send ~self ~cmd:(selector "setAllowedAccess:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
...
let setUnderlyingSandboxAssertionHandle x self = msg_send ~self ~cmd:(selector "setUnderlyingSandboxAssertionHandle:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
