...
let attributedStringAtIndex x self = msg_send ~self ~cmd:(selector "attributedStringAtIndex:") ~typ:(ullong @-> returning (id)) x
let baseLineAtIndex x self = msg_send ~self ~cmd:(selector "baseLineAtIndex:") ~typ:(ullong @-> returning (double)) x
...
let extendAtEnd x self = msg_send ~self ~cmd:(selector "extendAtEnd:") ~typ:(ullong @-> returning (ullong)) x
let extendAtStart x self = msg_send ~self ~cmd:(selector "extendAtStart:") ~typ:(ullong @-> returning (ullong)) x
let extendToParagraph self = msg_send ~self ~cmd:(selector "extendToParagraph") ~typ:(returning (void))
let getBounds x ~transform ~index self = msg_send ~self ~cmd:(selector "getBounds:transform:index:") ~typ:(ptr (CGRect.t) @-> ptr void @-> ullong @-> returning (bool)) x transform index
let htmlAtIndex x self = msg_send ~self ~cmd:(selector "htmlAtIndex:") ~typ:(ullong @-> returning (id)) x
...
let initWithPage2 x ~fromIndex ~toIndex self = msg_send ~self ~cmd:(selector "initWithPage:fromIndex:toIndex:") ~typ:(id @-> ullong @-> ullong @-> returning (id)) x fromIndex toIndex
...
let textAtIndex x self = msg_send ~self ~cmd:(selector "textAtIndex:") ~typ:(ullong @-> returning (id)) x