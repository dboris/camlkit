...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactory_monolith?language=objc}UIKBRenderFactory_Monolith} *)

let self = get_class "UIKBRenderFactory_Monolith"
