...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uibuttonconfigurationvisualprovidertvos?language=objc}UIButtonConfigurationVisualProviderTVOS} *)

let self = get_class "UIButtonConfigurationVisualProviderTVOS"
