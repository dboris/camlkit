...
let collectionView x ~layout ~minimumInteritemSpacingForSectionAtIndex self = msg_send ~self ~cmd:(selector "collectionView:layout:minimumInteritemSpacingForSectionAtIndex:") ~typ:(id @-> id @-> llong @-> returning (double)) x layout (LLong.of_int minimumInteritemSpacingForSectionAtIndex)
let collectionView' x ~layout ~minimumLineSpacingForSectionAtIndex self = msg_send ~self ~cmd:(selector "collectionView:layout:minimumLineSpacingForSectionAtIndex:") ~typ:(id @-> id @-> llong @-> returning (double)) x layout (LLong.of_int minimumLineSpacingForSectionAtIndex)
