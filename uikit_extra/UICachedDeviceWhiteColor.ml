...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicacheddevicewhitecolor?language=objc}UICachedDeviceWhiteColor} *)

let self = get_class "UICachedDeviceWhiteColor"
