...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidebugginginformationvcdetailviewcontroller?language=objc}UIDebuggingInformationVCDetailViewController} *)

let self = get_class "UIDebuggingInformationVCDetailViewController"
