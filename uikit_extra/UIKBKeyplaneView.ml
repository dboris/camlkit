...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbkeyplaneview?language=objc}UIKBKeyplaneView} *)

let self = get_class "UIKBKeyplaneView"
...
let useDefaultKeyplaneCacheTokenForRenderFlags x self = msg_send ~self ~cmd:(selector "useDefaultKeyplaneCacheTokenForRenderFlags:") ~typ:(llong @-> returning bool) (LLong.of_int x)
