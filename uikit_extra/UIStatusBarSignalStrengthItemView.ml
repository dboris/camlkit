...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarsignalstrengthitemview?language=objc}UIStatusBarSignalStrengthItemView} *)

let self = get_class "UIStatusBarSignalStrengthItemView"
