...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardemojisplitcategorycell?language=objc}UIKeyboardEmojiSplitCategoryCell} *)

let self = get_class "UIKeyboardEmojiSplitCategoryCell"
