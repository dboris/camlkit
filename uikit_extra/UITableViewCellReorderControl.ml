...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewcellreordercontrol?language=objc}UITableViewCellReorderControl} *)

let self = get_class "UITableViewCellReorderControl"
