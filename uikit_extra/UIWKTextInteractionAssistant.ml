...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiwktextinteractionassistant?language=objc}UIWKTextInteractionAssistant} *)

let self = get_class "UIWKTextInteractionAssistant"
...
let scheduleReplacementsForText' x ~withOptions self = msg_send ~self ~cmd:(selector "scheduleReplacementsForText:withOptions:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int withOptions)
...
let selectTextForReplacement x ~withOptions self = msg_send ~self ~cmd:(selector "selectTextForReplacement:withOptions:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int withOptions)
...
let selectionChangedWithGestureAt x ~withGesture ~withState ~withFlags self = msg_send ~self ~cmd:(selector "selectionChangedWithGestureAt:withGesture:withState:withFlags:") ~typ:(CGPoint.t @-> llong @-> llong @-> llong @-> returning void) x (LLong.of_int withGesture) (LLong.of_int withState) (LLong.of_int withFlags)
let selectionChangedWithTouchAt x ~withSelectionTouch ~withFlags self = msg_send ~self ~cmd:(selector "selectionChangedWithTouchAt:withSelectionTouch:withFlags:") ~typ:(CGPoint.t @-> llong @-> llong @-> returning void) x (LLong.of_int withSelectionTouch) (LLong.of_int withFlags)
...
let shouldTryReplacementsForText x ~withOptions self = msg_send ~self ~cmd:(selector "shouldTryReplacementsForText:withOptions:") ~typ:(id @-> ullong @-> returning bool) x (ULLong.of_int withOptions)
...
let showReplacementsForText x ~withOptions self = msg_send ~self ~cmd:(selector "showReplacementsForText:withOptions:") ~typ:(id @-> ullong @-> returning void) x (ULLong.of_int withOptions)
