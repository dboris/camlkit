...
module Class = struct
  let slotStyleWithAccessibilityButtonShapes x ~accessibilityContrast ~displayRange ~displayScale ~layoutDirection ~legibilityWeight ~localization ~preferredContentSizeCategory ~tintColor ~userInterfaceIdiom ~userInterfaceStyle self = msg_send ~self ~cmd:(selector "slotStyleWithAccessibilityButtonShapes:accessibilityContrast:displayRange:displayScale:layoutDirection:legibilityWeight:localization:preferredContentSizeCategory:tintColor:userInterfaceIdiom:userInterfaceStyle:") ~typ:(ullong @-> ullong @-> ullong @-> bool @-> ullong @-> ullong @-> id @-> ullong @-> ptr void @-> ullong @-> ullong @-> returning (id)) x accessibilityContrast displayRange displayScale layoutDirection legibilityWeight localization preferredContentSizeCategory tintColor userInterfaceIdiom userInterfaceStyle
  let slotStyleWithAccessibilityContrast x ~displayRange ~displayScale ~layoutDirection ~legibilityWeight ~localization ~preferredContentSizeCategory ~tintColor ~userInterfaceIdiom ~userInterfaceStyle self = msg_send ~self ~cmd:(selector "slotStyleWithAccessibilityContrast:displayRange:displayScale:layoutDirection:legibilityWeight:localization:preferredContentSizeCategory:tintColor:userInterfaceIdiom:userInterfaceStyle:") ~typ:(ullong @-> ullong @-> bool @-> ullong @-> ullong @-> id @-> ullong @-> ptr void @-> ullong @-> ullong @-> returning (id)) x displayRange displayScale layoutDirection legibilityWeight localization preferredContentSizeCategory tintColor userInterfaceIdiom userInterfaceStyle
...
let gradeWithOnlyFails x ~allowedLocalizations self = msg_send ~self ~cmd:(selector "gradeWithOnlyFails:allowedLocalizations:") ~typ:(ullong @-> id @-> returning (ullong)) x allowedLocalizations
...
let initWithAccessibilityButtonShapes x ~accessibilityContrast ~displayRange ~displayScale ~layoutDirection ~legibilityWeight ~localization ~preferredContentSizeCategory ~tintColor ~userInterfaceIdiom ~userInterfaceStyle self = msg_send ~self ~cmd:(selector "initWithAccessibilityButtonShapes:accessibilityContrast:displayRange:displayScale:layoutDirection:legibilityWeight:localization:preferredContentSizeCategory:tintColor:userInterfaceIdiom:userInterfaceStyle:") ~typ:(ullong @-> ullong @-> ullong @-> bool @-> ullong @-> ullong @-> id @-> ullong @-> ptr void @-> ullong @-> ullong @-> returning (id)) x accessibilityContrast displayRange displayScale layoutDirection legibilityWeight localization preferredContentSizeCategory tintColor userInterfaceIdiom userInterfaceStyle
