...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiexpandedbaritemstableviewcontroller?language=objc}UIExpandedBarItemsTableViewController} *)

let self = get_class "UIExpandedBarItemsTableViewController"
