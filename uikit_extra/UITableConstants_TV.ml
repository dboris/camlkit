...
let _class_ = get_class "UITableConstants_TV"
...
let defaultDeleteImageForUserInterfaceStyle x self = msg_send ~self ~cmd:(selector "defaultDeleteImageForUserInterfaceStyle:") ~typ:(llong @-> returning (id)) x
...
let defaultDetailTextColorForUserInterfaceStyle x self = msg_send ~self ~cmd:(selector "defaultDetailTextColorForUserInterfaceStyle:") ~typ:(llong @-> returning (id)) x
...
let defaultHeaderTextColorForTableViewStyle' x ~userInterfaceStyle self = msg_send ~self ~cmd:(selector "defaultHeaderTextColorForTableViewStyle:userInterfaceStyle:") ~typ:(llong @-> llong @-> returning (id)) x userInterfaceStyle
...
let defaultTextColorForUserInterfaceStyle x self = msg_send ~self ~cmd:(selector "defaultTextColorForUserInterfaceStyle:") ~typ:(llong @-> returning (id)) x
