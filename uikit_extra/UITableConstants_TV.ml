...
let shouldUseRoundedGroupsForTableViewStyle x ~backgroundInsets self = msg_send ~self ~cmd:(selector "shouldUseRoundedGroupsForTableViewStyle:backgroundInsets:") ~typ:(llong @-> ptr void @-> returning (bool)) (LLong.of_int x) backgroundInsets
