...
let decrememntElement x self = msg_send ~self ~cmd:(selector "decrememntElement:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
...
let incrememntElement x self = msg_send ~self ~cmd:(selector "incrememntElement:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
...
let processInputString x ~forElement self = msg_send ~self ~cmd:(selector "processInputString:forElement:") ~typ:(id @-> ullong @-> returning (bool)) x (ULLong.of_int forElement)
...
let setBackingDatePickerMode x self = msg_send ~self ~cmd:(selector "setBackingDatePickerMode:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
