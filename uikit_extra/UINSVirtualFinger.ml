...
module Class = struct
  let virtualFingerWithIndex x ~location self = msg_send ~self ~cmd:(selector "virtualFingerWithIndex:location:") ~typ:(llong @-> CGPoint.t @-> returning (id)) x location
end
...
let initWithIndex x self = msg_send ~self ~cmd:(selector "initWithIndex:") ~typ:(llong @-> returning (id)) x
...
let scanWithTimestamp x self = msg_send ~self ~cmd:(selector "scanWithTimestamp:") ~typ:(ullong @-> returning (void)) x
...
let swipeInDirection x ~distance ~duration self = msg_send ~self ~cmd:(selector "swipeInDirection:distance:duration:") ~typ:(CGPoint.t @-> double @-> ullong @-> returning (void)) x distance duration
let swipeInDirection' x ~distance ~duration ~autoLiftTouch self = msg_send ~self ~cmd:(selector "swipeInDirection:distance:duration:autoLiftTouch:") ~typ:(CGPoint.t @-> double @-> ullong @-> bool @-> returning (void)) x distance duration autoLiftTouch
