...
let setGesturePhase x self = msg_send ~self ~cmd:(selector "setGesturePhase:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
let setMomentumPhase x self = msg_send ~self ~cmd:(selector "setMomentumPhase:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
let setRelativePhase x self = msg_send ~self ~cmd:(selector "setRelativePhase:") ~typ:(ullong @-> returning (void)) (ULLong.of_int x)
