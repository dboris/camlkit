...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidebugginginformationhierarchycell?language=objc}UIDebuggingInformationHierarchyCell} *)

let self = get_class "UIDebuggingInformationHierarchyCell"
