...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarcarplaydockitemview?language=objc}UIStatusBarCarPlayDockItemView} *)

let self = get_class "UIStatusBarCarPlayDockItemView"
