...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeycommanddiscoverabilityhudview?language=objc}UIKeyCommandDiscoverabilityHUDView} *)

let self = get_class "UIKeyCommandDiscoverabilityHUDView"
