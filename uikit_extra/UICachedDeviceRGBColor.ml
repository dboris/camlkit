...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicacheddevicergbcolor?language=objc}UICachedDeviceRGBColor} *)

let self = get_class "UICachedDeviceRGBColor"
