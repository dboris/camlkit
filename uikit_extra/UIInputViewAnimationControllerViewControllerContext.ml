...
let fromKeyboardFrame self = msg_send ~self ~cmd:(selector "fromKeyboardFrame") ~typ:(returning CGRect.t)
...
let toKeyboardFrame self = msg_send ~self ~cmd:(selector "toKeyboardFrame") ~typ:(returning CGRect.t)