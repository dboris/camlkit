...
let preferredEdgeForPermittedArrowDirections x self = msg_send ~self ~cmd:(selector "preferredEdgeForPermittedArrowDirections:") ~typ:(llong @-> returning (ullong)) (LLong.of_int x)
