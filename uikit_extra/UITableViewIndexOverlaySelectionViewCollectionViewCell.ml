...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewindexoverlayselectionviewcollectionviewcell?language=objc}UITableViewIndexOverlaySelectionViewCollectionViewCell} *)

let self = get_class "UITableViewIndexOverlaySelectionViewCollectionViewCell"
