...
module Class = struct
  ...
  let defaultFontDescriptorWithTextStyle' x ~addingSymbolicTraits ~options self = msg_send ~self ~cmd:(selector "defaultFontDescriptorWithTextStyle:addingSymbolicTraits:options:") ~typ:(id @-> uint @-> ullong @-> returning (id)) x addingSymbolicTraits options
  ...
  let preferredFontDescriptorWithTextStyle2 x ~addingSymbolicTraits ~options self = msg_send ~self ~cmd:(selector "preferredFontDescriptorWithTextStyle:addingSymbolicTraits:options:") ~typ:(id @-> uint @-> ullong @-> returning (id)) x addingSymbolicTraits options
