...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbaractivityitemview?language=objc}UIStatusBarActivityItemView} *)

let self = get_class "UIStatusBarActivityItemView"
