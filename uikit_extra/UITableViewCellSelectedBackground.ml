...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitableviewcellselectedbackground?language=objc}UITableViewCellSelectedBackground} *)

let self = get_class "UITableViewCellSelectedBackground"
