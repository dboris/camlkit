...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiapplicationscenetransitioncontext?language=objc}UIApplicationSceneTransitionContext} *)

let self = get_class "UIApplicationSceneTransitionContext"
...
let setStatusBarAnimation x self = msg_send ~self ~cmd:(selector "setStatusBarAnimation:") ~typ:(llong @-> returning void) (LLong.of_int x)
