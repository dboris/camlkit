...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipadlandscapepasscode?language=objc}UIKBRenderFactoryiPadLandscapePasscode} *)

let self = get_class "UIKBRenderFactoryiPadLandscapePasscode"
