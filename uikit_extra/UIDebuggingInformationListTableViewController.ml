...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidebugginginformationlisttableviewcontroller?language=objc}UIDebuggingInformationListTableViewController} *)

let self = get_class "UIDebuggingInformationListTableViewController"
