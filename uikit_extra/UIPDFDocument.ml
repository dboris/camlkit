...
let copyPageAtIndex x self = msg_send ~self ~cmd:(selector "copyPageAtIndex:") ~typ:(ullong @-> returning (id)) x
...
let pageAtIndex x self = msg_send ~self ~cmd:(selector "pageAtIndex:") ~typ:(ullong @-> returning (id)) x
let pageImageCache self = msg_send ~self ~cmd:(selector "pageImageCache") ~typ:(returning (id))
let purgePagesBefore x self = msg_send ~self ~cmd:(selector "purgePagesBefore:") ~typ:(ullong @-> returning (void)) x
let setDelegate x self = msg_send ~self ~cmd:(selector "setDelegate:") ~typ:(id @-> returning (void)) x
let setImageCacheCount x ~lookAhead ~withResolution self = msg_send ~self ~cmd:(selector "setImageCacheCount:lookAhead:withResolution:") ~typ:(ullong @-> ullong @-> double @-> returning (void)) x lookAhead withResolution
