...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipadpasscode?language=objc}UIKBRenderFactoryiPadPasscode} *)

let self = get_class "UIKBRenderFactoryiPadPasscode"
