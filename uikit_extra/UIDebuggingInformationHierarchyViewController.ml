...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidebugginginformationhierarchyviewcontroller?language=objc}UIDebuggingInformationHierarchyViewController} *)

let self = get_class "UIDebuggingInformationHierarchyViewController"
...
let collectionView4 x ~numberOfItemsInSection self = msg_send ~self ~cmd:(selector "collectionView:numberOfItemsInSection:") ~typ:(id @-> llong @-> returning llong) x (LLong.of_int numberOfItemsInSection)
...
let colorForIndentationLevel x self = msg_send ~self ~cmd:(selector "colorForIndentationLevel:") ~typ:(ullong @-> returning id) (ULLong.of_int x)
...
let getViewsRecursiveWithLevel x ~forView self = msg_send ~self ~cmd:(selector "getViewsRecursiveWithLevel:forView:") ~typ:(ullong @-> id @-> returning id) (ULLong.of_int x) forView
...
let originalBorderColor self = msg_send ~self ~cmd:(selector "originalBorderColor") ~typ:(returning (ptr CGColor.t))
...
let setOriginalBorderColor x self = msg_send ~self ~cmd:(selector "setOriginalBorderColor:") ~typ:((ptr CGColor.t) @-> returning void) x
