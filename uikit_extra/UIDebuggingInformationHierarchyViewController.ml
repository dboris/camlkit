...
let originalBorderColor self = msg_send ~self ~cmd:(selector "originalBorderColor") ~typ:(returning (ptr void))
...
let setOriginalBorderColor x self = msg_send ~self ~cmd:(selector "setOriginalBorderColor:") ~typ:(ptr void @-> returning (void)) x
