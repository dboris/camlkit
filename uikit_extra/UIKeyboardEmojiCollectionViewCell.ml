...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardemojicollectionviewcell?language=objc}UIKeyboardEmojiCollectionViewCell} *)

let self = get_class "UIKeyboardEmojiCollectionViewCell"
