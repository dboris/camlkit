...
let window x ~willUseFullScreenPresentationOptions self = msg_send ~self ~cmd:(selector "window:willUseFullScreenPresentationOptions:") ~typ:(id @-> ullong @-> returning (ullong)) x (ULLong.of_int willUseFullScreenPresentationOptions)
