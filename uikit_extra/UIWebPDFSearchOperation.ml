...
let _class_ = get_class "UIWebPDFSearchOperation"
...
let setNumberOfResultsToSkip x self = msg_send ~self ~cmd:(selector "setNumberOfResultsToSkip:") ~typ:(ullong @-> returning (void)) x
