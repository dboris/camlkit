...
let edgesForSafeAreaPropagation self = msg_send ~self ~cmd:(selector "edgesForSafeAreaPropagation") ~typ:(returning ullong)
...
let memoizedDynamicAnimatorWorldAdjustingInsets self = msg_send ~self ~cmd:(selector "memoizedDynamicAnimatorWorldAdjustingInsets") ~typ:(returning UIEdgeInsets.t)
let memoizedPreviousLayoutMargins self = msg_send ~self ~cmd:(selector "memoizedPreviousLayoutMargins") ~typ:(returning UIEdgeInsets.t)
let memoizedPreviousSolvedViewBoundsSize self = msg_send ~self ~cmd:(selector "memoizedPreviousSolvedViewBoundsSize") ~typ:(returning CGSize.t)
