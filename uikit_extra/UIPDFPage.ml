...
let annotationIn x ~withIndex self = msg_send ~self ~cmd:(selector "annotationIn:withIndex:") ~typ:(id @-> ullong @-> returning (id)) x withIndex
let annotations self = msg_send ~self ~cmd:(selector "annotations") ~typ:(returning (id))
let cfCompareFlagsFromNSOptions x self = msg_send ~self ~cmd:(selector "cfCompareFlagsFromNSOptions:") ~typ:(ullong @-> returning (ullong)) x
...
let deliverImageWithWidth x ~height ~receiver ~selector_ ~info self = msg_send ~self ~cmd:(selector "deliverImageWithWidth:height:receiver:selector:info:") ~typ:(ullong @-> ullong @-> id @-> _SEL @-> id @-> returning (void)) x height receiver selector_ info
...
let findString x ~fromSelection ~options self = msg_send ~self ~cmd:(selector "findString:fromSelection:options:") ~typ:(id @-> id @-> ullong @-> returning (id)) x fromSelection options
...
let initWithDocument x ~pageNumber self = msg_send ~self ~cmd:(selector "initWithDocument:pageNumber:") ~typ:(id @-> ullong @-> returning (id)) x pageNumber
