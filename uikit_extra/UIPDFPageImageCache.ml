...
let cacheImageOfPage x ~maxSize self = msg_send ~self ~cmd:(selector "cacheImageOfPage:maxSize:") ~typ:(ullong @-> CGSize.t @-> returning (void)) x maxSize
...
let deliverImageOfPage x ~maxSize ~quality ~receiver ~selector_ ~info self = msg_send ~self ~cmd:(selector "deliverImageOfPage:maxSize:quality:receiver:selector:info:") ~typ:(ullong @-> CGSize.t @-> ptr (bool) @-> id @-> _SEL @-> id @-> returning (void)) x maxSize quality receiver selector_ info
...
let getImageIfAvailableForPage x self = msg_send ~self ~cmd:(selector "getImageIfAvailableForPage:") ~typ:(ullong @-> returning (id)) x
...
let initWithDocument' x ~cacheCount ~lookAhead ~withLookAheadResolution self = msg_send ~self ~cmd:(selector "initWithDocument:cacheCount:lookAhead:withLookAheadResolution:") ~typ:(id @-> ullong @-> ullong @-> double @-> returning (id)) x cacheCount lookAhead withLookAheadResolution
