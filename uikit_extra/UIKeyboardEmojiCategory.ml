...
module Class = struct
  ...
  let categoryForType x self = msg_send ~self ~cmd:(selector "categoryForType:") ~typ:(llong @-> returning (id)) x
  let categoryIndexForCategoryType x self = msg_send ~self ~cmd:(selector "categoryIndexForCategoryType:") ~typ:(llong @-> returning (ullong)) x
  let categoryTypeForCategoryIndex x self = msg_send ~self ~cmd:(selector "categoryTypeForCategoryIndex:") ~typ:(ullong @-> returning (llong)) x
  let displayName x self = msg_send ~self ~cmd:(selector "displayName:") ~typ:(llong @-> returning (id)) x
  let emojiCategoryStringForCategoryType x self = msg_send ~self ~cmd:(selector "emojiCategoryStringForCategoryType:") ~typ:(llong @-> returning (id)) x
  ...
  let fallbackDisplayName x self = msg_send ~self ~cmd:(selector "fallbackDisplayName:") ~typ:(llong @-> returning (id)) x
...
let setCategoryType x self = msg_send ~self ~cmd:(selector "setCategoryType:") ~typ:(llong @-> returning (void)) x
let setEmoji x self = msg_send ~self ~cmd:(selector "setEmoji:") ~typ:(id @-> returning (void)) x
let setLastVisibleFirstEmojiIndex x self = msg_send ~self ~cmd:(selector "setLastVisibleFirstEmojiIndex:") ~typ:(llong @-> returning (void)) x