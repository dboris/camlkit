...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistoryboarddecodingcontext?language=objc}UIStoryboardDecodingContext} *)

let self = get_class "UIStoryboardDecodingContext"
...
let setChildViewControllerIndex x self = msg_send ~self ~cmd:(selector "setChildViewControllerIndex:") ~typ:(llong @-> returning void) (LLong.of_int x)
