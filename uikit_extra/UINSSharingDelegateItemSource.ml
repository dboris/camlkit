...
let initWithActivityItemsConfiguration x ~itemAtIndex self = msg_send ~self ~cmd:(selector "initWithActivityItemsConfiguration:itemAtIndex:") ~typ:(id @-> llong @-> returning (id)) x (LLong.of_int itemAtIndex)
