...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbautofilltesttableviewheaderfooterdata?language=objc}UIKBAutoFillTestTableViewHeaderFooterData} *)

let self = get_class "UIKBAutoFillTestTableViewHeaderFooterData"
