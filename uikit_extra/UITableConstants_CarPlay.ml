...
let self = get_class "UITableConstants_CarPlay"

let contentClipCornersForCell x ~inTableView self = msg_send ~self ~cmd:(selector "contentClipCornersForCell:inTableView:") ~typ:(id @-> id @-> returning ullong) x inTableView
...
let defaultAccessoryColorForCell x ~inTableView self = msg_send ~self ~cmd:(selector "defaultAccessoryColorForCell:inTableView:") ~typ:(id @-> id @-> returning id) x inTableView
...
let defaultCellLayoutMarginsForStyle x ~textLabelFont ~rawLayoutMargins self = msg_send ~self ~cmd:(selector "defaultCellLayoutMarginsForStyle:textLabelFont:rawLayoutMargins:") ~typ:(llong @-> id @-> UIEdgeInsets.t @-> returning UIEdgeInsets.t) (LLong.of_int x) textLabelFont rawLayoutMargins
...
let defaultDeleteMinusRectForCell x ~inTableView self = msg_send ~self ~cmd:(selector "defaultDeleteMinusRectForCell:inTableView:") ~typ:(id @-> id @-> returning CGRect.t) x inTableView
...
let defaultEditControlSizeForCell x ~inTableView self = msg_send ~self ~cmd:(selector "defaultEditControlSizeForCell:inTableView:") ~typ:(id @-> id @-> returning CGSize.t) x inTableView
let defaultFocusedAccessoryColorForCell x ~inTableView self = msg_send ~self ~cmd:(selector "defaultFocusedAccessoryColorForCell:inTableView:") ~typ:(id @-> id @-> returning id) x inTableView
...
let defaultGroupedFooterHeightForTableView x self = msg_send ~self ~cmd:(selector "defaultGroupedFooterHeightForTableView:") ~typ:(id @-> returning double) x
let defaultGroupedHeaderHeightForTableView x self = msg_send ~self ~cmd:(selector "defaultGroupedHeaderHeightForTableView:") ~typ:(id @-> returning double) x
...
let defaultHeaderFooterLayoutMarginsForTableViewStyle x self = msg_send ~self ~cmd:(selector "defaultHeaderFooterLayoutMarginsForTableViewStyle:") ~typ:(llong @-> returning UIEdgeInsets.t) (LLong.of_int x)
...
let defaultLayoutMarginsForCell x ~inTableView self = msg_send ~self ~cmd:(selector "defaultLayoutMarginsForCell:inTableView:") ~typ:(id @-> id @-> returning UIEdgeInsets.t) x inTableView
let defaultLayoutMarginsForTableView x self = msg_send ~self ~cmd:(selector "defaultLayoutMarginsForTableView:") ~typ:(id @-> returning UIEdgeInsets.t) x
...
let defaultReorderControlSizeForCell x ~withAccessoryBaseColor self = msg_send ~self ~cmd:(selector "defaultReorderControlSizeForCell:withAccessoryBaseColor:") ~typ:(id @-> id @-> returning CGSize.t) x withAccessoryBaseColor
...
let headerFooterOffsetFromContentInsetForTableView x self = msg_send ~self ~cmd:(selector "headerFooterOffsetFromContentInsetForTableView:") ~typ:(id @-> returning UIEdgeInsets.t) x
