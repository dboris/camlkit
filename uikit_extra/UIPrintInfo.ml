...
let setCoat x self = msg_send ~self ~cmd:(selector "setCoat:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
let setCopies x self = msg_send ~self ~cmd:(selector "setCopies:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
let setDuplex x self = msg_send ~self ~cmd:(selector "setDuplex:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
let setFinishingTemplate x self = msg_send ~self ~cmd:(selector "setFinishingTemplate:") ~typ:(id @-> returning (void)) x
let setFold x self = msg_send ~self ~cmd:(selector "setFold:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
...
let setLaminate x self = msg_send ~self ~cmd:(selector "setLaminate:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
...
let setOutputType x self = msg_send ~self ~cmd:(selector "setOutputType:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
...
let setPunch x self = msg_send ~self ~cmd:(selector "setPunch:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
let setQuality x self = msg_send ~self ~cmd:(selector "setQuality:") ~typ:(llong @-> returning (void)) (LLong.of_int x)
