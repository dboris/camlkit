...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiapplicationscenedeactivationassertion?language=objc}UIApplicationSceneDeactivationAssertion} *)

let self = get_class "UIApplicationSceneDeactivationAssertion"
