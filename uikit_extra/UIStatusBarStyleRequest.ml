...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarstylerequest?language=objc}UIStatusBarStyleRequest} *)

let self = get_class "UIStatusBarStyleRequest"
