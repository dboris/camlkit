...
let self = get_class "UITableConstants_IOS"
...
let defaultInsetGroupedHeaderLayoutMarginsForExtraProminentStyle x self = msg_send ~self ~cmd:(selector "defaultInsetGroupedHeaderLayoutMarginsForExtraProminentStyle:") ~typ:(bool @-> returning NSDirectionalEdgeInsets.t) x
