...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbhandwritingview?language=objc}UIKBHandwritingView} *)

let self = get_class "UIKBHandwritingView"
...
let inkColor self = msg_send ~self ~cmd:(selector "inkColor") ~typ:(returning (ptr CGColor.t))
let inkMask self = msg_send ~self ~cmd:(selector "inkMask") ~typ:(returning (ptr CGImage.t))
...
let previousPoint self = msg_send ~self ~cmd:(selector "previousPoint") ~typ:(returning void)
...
let setInkColor x self = msg_send ~self ~cmd:(selector "setInkColor:") ~typ:((ptr CGColor.t) @-> returning void) x
let setInkMask x self = msg_send ~self ~cmd:(selector "setInkMask:") ~typ:((ptr CGImage.t) @-> returning void) x
...
let setPreviousPoint x self = msg_send ~self ~cmd:(selector "setPreviousPoint:") ~typ:(void @-> returning void) x
