...
let initWithPage x ~maxSize ~queuePriority self = msg_send ~self ~cmd:(selector "initWithPage:maxSize:queuePriority:") ~typ:(id @-> CGSize.t @-> llong @-> returning (id)) x maxSize queuePriority
