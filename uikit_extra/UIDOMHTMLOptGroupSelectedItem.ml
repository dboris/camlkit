...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidomhtmloptgroupselecteditem?language=objc}UIDOMHTMLOptGroupSelectedItem} *)

let self = get_class "UIDOMHTMLOptGroupSelectedItem"
