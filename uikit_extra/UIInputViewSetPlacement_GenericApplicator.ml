...
let inputAccessoryPadding self = msg_send ~self ~cmd:(selector "inputAccessoryPadding") ~typ:(returning UIEdgeInsets.t)
let inputAssistantPadding self = msg_send ~self ~cmd:(selector "inputAssistantPadding") ~typ:(returning UIEdgeInsets.t)
