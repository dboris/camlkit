...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uidebugginginformationoverlayviewcontroller?language=objc}UIDebuggingInformationOverlayViewController} *)

let self = get_class "UIDebuggingInformationOverlayViewController"
