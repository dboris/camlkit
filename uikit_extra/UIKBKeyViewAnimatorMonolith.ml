...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbkeyviewanimatormonolith?language=objc}UIKBKeyViewAnimatorMonolith} *)

let self = get_class "UIKBKeyViewAnimatorMonolith"
