...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardcandidateviewimagerenderer?language=objc}UIKeyboardCandidateViewImageRenderer} *)

let self = get_class "UIKeyboardCandidateViewImageRenderer"
...
let highlightedBarCellBackgroundImageWithColor x ~insets self = msg_send ~self ~cmd:(selector "highlightedBarCellBackgroundImageWithColor:insets:") ~typ:(id @-> UIEdgeInsets.t @-> returning id) x insets
