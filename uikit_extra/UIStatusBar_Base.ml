...
let setOffset x ~forPartWithIdentifier self = msg_send ~self ~cmd:(selector "setOffset:forPartWithIdentifier:") ~typ:(ptr void @-> id @-> returning (void)) x forPartWithIdentifier
