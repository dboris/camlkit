...
let finalInputViewTransform self = msg_send ~self ~cmd:(selector "finalInputViewTransform") ~typ:(returning CGAffineTransform.t)
let initialInputViewTransform self = msg_send ~self ~cmd:(selector "initialInputViewTransform") ~typ:(returning CGAffineTransform.t)
let inputView self = msg_send ~self ~cmd:(selector "inputView") ~typ:(returning id)
let inputViewFrame self = msg_send ~self ~cmd:(selector "inputViewFrame") ~typ:(returning CGRect.t)
let platterInsets self = msg_send ~self ~cmd:(selector "platterInsets") ~typ:(returning UIEdgeInsets.t)
let platterViewFrame self = msg_send ~self ~cmd:(selector "platterViewFrame") ~typ:(returning CGRect.t)
let scale self = msg_send ~self ~cmd:(selector "scale") ~typ:(returning CGPoint.t)
