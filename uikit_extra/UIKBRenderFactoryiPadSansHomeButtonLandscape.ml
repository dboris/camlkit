...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryipadsanshomebuttonlandscape?language=objc}UIKBRenderFactoryiPadSansHomeButtonLandscape} *)

let self = get_class "UIKBRenderFactoryiPadSansHomeButtonLandscape"
