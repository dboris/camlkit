...
let initWithKeysTransferingOwnership x ~count self = msg_send ~self ~cmd:(selector "initWithKeysTransferingOwnership:count:") ~typ:(ptr (id) @-> ullong @-> returning (id)) x count
