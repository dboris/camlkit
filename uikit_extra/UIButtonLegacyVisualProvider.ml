...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uibuttonlegacyvisualprovider?language=objc}UIButtonLegacyVisualProvider} *)

let self = get_class "UIButtonLegacyVisualProvider"
