...
let actionImageMarginForAction self = msg_send ~self ~cmd:(selector "actionImageMarginForAction") ~typ:(returning UIEdgeInsets.t)
let actionSequenceEdgeInsets self = msg_send ~self ~cmd:(selector "actionSequenceEdgeInsets") ~typ:(returning UIEdgeInsets.t)
