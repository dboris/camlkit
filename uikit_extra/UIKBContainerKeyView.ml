...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbcontainerkeyview?language=objc}UIKBContainerKeyView} *)

let self = get_class "UIKBContainerKeyView"
