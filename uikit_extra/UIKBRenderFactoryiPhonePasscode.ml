...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbrenderfactoryiphonepasscode?language=objc}UIKBRenderFactoryiPhonePasscode} *)

let self = get_class "UIKBRenderFactoryiPhonePasscode"
