...
let frameWithContainingFrame x self = msg_send ~self ~cmd:(selector "frameWithContainingFrame:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
...
let paddedFrameWithContainingFrame x self = msg_send ~self ~cmd:(selector "paddedFrameWithContainingFrame:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
let paddedFrameWithResolvedFrame x self = msg_send ~self ~cmd:(selector "paddedFrameWithResolvedFrame:") ~typ:(CGRect.t @-> returning (CGRect.t)) x
