...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardcamerapadpresentationcontroller?language=objc}UIKeyboardCameraPadPresentationController} *)

let self = get_class "UIKeyboardCameraPadPresentationController"
