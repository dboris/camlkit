...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uiapplicationscenedeactivationmanager?language=objc}UIApplicationSceneDeactivationManager} *)

let self = get_class "UIApplicationSceneDeactivationManager"
