...
let initWithTypes x ~frame ~preferredPresentationStyle self = msg_send ~self ~cmd:(selector "initWithTypes:frame:preferredPresentationStyle:") ~typ:(id @-> CGRect.t @-> llong @-> returning (id)) x frame (LLong.of_int preferredPresentationStyle)
