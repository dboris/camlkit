...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uicompatibilitypredictiveviewcontroller?language=objc}UICompatibilityPredictiveViewController} *)

let self = get_class "UICompatibilityPredictiveViewController"
