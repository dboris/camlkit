...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistoryboardpreviewingseguetemplatestorage?language=objc}UIStoryboardPreviewingSegueTemplateStorage} *)

let self = get_class "UIStoryboardPreviewingSegueTemplateStorage"
