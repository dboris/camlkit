...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikbsplitkeyplanegenerator?language=objc}UIKBSplitKeyplaneGenerator} *)

let self = get_class "UIKBSplitKeyplaneGenerator"
