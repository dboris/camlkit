...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistatusbarquietmodeitemview?language=objc}UIStatusBarQuietModeItemView} *)

let self = get_class "UIStatusBarQuietModeItemView"
