...
let boundsForObjectAtIndex x self = msg_send_stret ~self ~cmd:(selector "boundsForObjectAtIndex:") ~typ:(ullong @-> returning (CGRect.t)) ~return_type:CGRect.t x
...
let viewAtIndex x self = msg_send ~self ~cmd:(selector "viewAtIndex:") ~typ:(ullong @-> returning (id)) x
let yForObjectAtIndex x self = msg_send ~self ~cmd:(selector "yForObjectAtIndex:") ~typ:(ullong @-> returning (double)) x