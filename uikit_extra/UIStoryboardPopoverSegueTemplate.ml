...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uistoryboardpopoverseguetemplate?language=objc}UIStoryboardPopoverSegueTemplate} *)

let self = get_class "UIStoryboardPopoverSegueTemplate"
