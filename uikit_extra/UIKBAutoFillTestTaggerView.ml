...
let pickerView1 x ~rowHeightForComponent self = msg_send ~self ~cmd:(selector "pickerView:rowHeightForComponent:") ~typ:(id @-> llong @-> returning (double)) x rowHeightForComponent
...
let pickerView3 x ~titleForRow ~forComponent self = msg_send ~self ~cmd:(selector "pickerView:titleForRow:forComponent:") ~typ:(id @-> llong @-> llong @-> returning (id)) x titleForRow forComponent
