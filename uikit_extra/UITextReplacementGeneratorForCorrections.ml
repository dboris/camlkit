...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uitextreplacementgeneratorforcorrections?language=objc}UITextReplacementGeneratorForCorrections} *)

let self = get_class "UITextReplacementGeneratorForCorrections"
...
let setMaxCountAfterAutocorrectionGuesses x self = msg_send ~self ~cmd:(selector "setMaxCountAfterAutocorrectionGuesses:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let setMaxCountAfterSpellingGuesses x self = msg_send ~self ~cmd:(selector "setMaxCountAfterSpellingGuesses:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
let setMaxEditDistance x self = msg_send ~self ~cmd:(selector "setMaxEditDistance:") ~typ:(ullong @-> returning void) (ULLong.of_int x)
