...
(** Apple docs: {{:https://developer.apple.com/documentation/uikit/uikeyboardsplitcontrolmenu_undock?language=objc}UIKeyboardSplitControlMenu_Undock} *)

let self = get_class "UIKeyboardSplitControlMenu_Undock"
